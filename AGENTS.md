...
Read local CLIENT.md and dealer.json (or their parent-directory copies), .client/project.json when present, and the relevant technical TEMPLATE.md. Shared policy: [Cars workflow](https://github.com/darkapoparka/cars/blob/0249ea3502e7165bb238ddb03a11f651509446a7/docs/WORKFLOW.md) and [publishing](https://github.com/darkapoparka/cars/blob/0249ea3502e7165bb238ddb03a11f651509446a7/docs/LEAD-PUBLISHING.md).
