...
export const currentDayNightListings: CurrentDayNightListing[] = [
  {
    ...
    transmission: 'Автоматична', body: 'Купе', features: ["Bang & Olufsen","Керамични спирачки","Carbon пакет"], image: '/variant-3/assets/isauto/inventory-1.webp'
  },
  {
    ...
    transmission: 'Автоматична', body: 'Джип', features: ["Virtual cockpit","Подгряване на седалки","4-зонов климатроник","360° камера"], image: '/variant-3/assets/isauto/inventory-2.webp'
  },
  {
    ...
    transmission: 'Автоматична', body: 'Лимузина', features: ["xDrive","Керамични спирачки","Bowers & Wilkins","Adaptive LED"], image: '/variant-3/assets/isauto/inventory-3.webp'
  },
  {
    ...
    transmission: 'Автоматична', body: 'Джип', features: ["xDrive","Sport пакет","Подгряване на седалки","Панорамен покрив"], image: '/variant-3/assets/isauto/inventory-4.webp'
  },
  {
    ...
    transmission: 'Автоматична', body: 'Лимузина', features: ["M Performance","Laser светлини","Alcantara","Virtual cockpit","Harman Kardon"], image: '/variant-3/assets/isauto/inventory-5.webp'
  },
  {
    ...
    transmission: 'Автоматична', body: 'Купе', features: ["S line","Ambient осветление","Virtual cockpit","Подгряване на седалки","Парктроник","F1 пера"], image: '/variant-3/assets/isauto/inventory-6.webp'
  }
];
