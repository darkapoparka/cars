...
export const daynightSite = {
  ...
  ...contactLinks(phoneE164), phone: '0899266666', phoneLabel: '0899 266 666', email: 'varna@isauto.net', location,
  ...
  sourceInventory: 'https://isautovarna.mobile.bg/', logoLight: '/variant-3/brand/isauto-logo-light.png', logoDark: '/variant-3/brand/isauto-logo-dark.png',
