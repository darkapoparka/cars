...
<svelte:head>
	<title>Al Hamoor Al Thahabi Marketplace | Home3</title>
	<meta
		name="description"
		content="A carwow-inspired Al Hamoor Al Thahabi marketplace homepage for buying, selling and comparing cars."
	/>
...
<main id="main-content" tabindex="-1" class="home3-shell">
	<header class="home3-header" aria-label="Home3 navigation">
		<a class="home3-logo" href={resolve('/presentation/home3')} aria-label="Al Hamoor Al Thahabi Home3">
			<span>DAY</span>
			<strong>AUTO</strong>
		</a>
	...
	<section class="home3-hero" aria-labelledby="home3-title">
		<img
			...
			src="/variant-3/assets/images/body-type/normalized/body-sedan-transparent.webp"
			alt=""
			aria-hidden="true"
		/>
		<img
			class="home3-hero__car home3-hero__car--right"
			src="/variant-3/assets/images/body-type/normalized/body-suv-transparent.webp"
			alt=""
			aria-hidden="true"
		/>
	...
	<section class="home3-market">
		...
		<section class="home3-sell-panel" aria-labelledby="home3-sell-title">
			...
			<div class="home3-sell-panel__media" aria-hidden="true">
				<img src="/variant-3/assets/images/card/card-32.png" alt="" />
			</div>
