...
<svelte:head>
	<title>LEGEND AUTO Marketplace | Home3</title>
	<meta
		name="description"
		content="A carwow-inspired LEGEND AUTO marketplace homepage for buying, selling and comparing cars."
	/>
...
<main id="main-content" tabindex="-1" class="home3-shell">
	<header class="home3-header" aria-label="Home3 navigation">
		<a class="home3-logo" href={resolve('/presentation/home3')} aria-label="LEGEND AUTO Home3">
			<span>DAY</span>
			<strong>AUTO</strong>
		</a>
