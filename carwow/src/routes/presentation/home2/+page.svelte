	...
	const guideCards = [
		{
			...
			image: '/variant-3/assets/images/pages/daynight-services-inspection-v1.webp',
			href: '/blog'
		},
		{
			title: 'Finance, registration and paperwork',
			image: '/variant-3/assets/images/pages/daynight-services-consultation-v1.webp',
			href: '/financing'
		},
		{
			title: 'Sell or part exchange with Al Hamoor Al Thahabi',
			image: '/variant-3/assets/images/sell/trade-in-promo-v1.webp',
			href: '/sell-your-car'
		}
	] as const;
...
<svelte:head>
	<title>Al Hamoor Al Thahabi Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from Al Hamoor Al Thahabi Sharjah."
	/>
...
<main id="main-content" tabindex="-1" class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		<img
			...
			src="/variant-3/assets/images/home2/daynight-hero-showroom-v2.webp"
			alt=""
			aria-hidden="true"
		/>

		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="Al Hamoor Al Thahabi Home2">
				<img src={daynightSite.logoLight} alt="Al Hamoor Al Thahabi" />
			</a>
		...
		<h1 id="home2-title">
			...
			<span>Al Hamoor Al Thahabi can help</span>
		</h1>
	...
	<section class="home2-market">
		...
		<section class="home2-sell-card" aria-labelledby="sell-car-title">
			...
			<div class="home2-sell-card__media">
				<img src="/variant-3/assets/images/home2/daynight-sell-banner-v2.webp" alt="" aria-hidden="true" />
				<span>ENTER REG</span>
			</div>
		</section>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular Al Hamoor Al Thahabi picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate Al Hamoor Al Thahabi as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/variant-3/brand/daynight-team-placeholder.svg" alt="Al Hamoor Al Thahabi consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse Al Hamoor Al Thahabi stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
