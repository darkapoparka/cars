...
<svelte:head>
	<title>Астракар Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from Астракар Варна."
	/>
...
<main id="main-content" tabindex="-1" class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="Астракар Home2">
				<img src={daynightSite.logoLight} alt="Астракар" />
			</a>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular Астракар picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate Астракар as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/variant-3/brand/daynight-team-placeholder.svg" alt="Астракар consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse Астракар stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
