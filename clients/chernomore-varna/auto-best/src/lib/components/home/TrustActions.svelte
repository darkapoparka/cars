  ...
  const actions = [
    {
      ...
      artwork: { src: '/dealer/media-pending.svg', width: 1200, height: 668, bounds: [21, 122, 1172, 552], view: 'front-pair' },
      vehicle: 'urus',
      tone: 'black',
    ...
    },
    {
      ...
      artwork: { src: '/dealer/media-pending.svg', width: 1200, height: 675, bounds: [21, 79, 1180, 583], view: 'three-quarter' },
      vehicle: 'gclass',
      tone: 'red',
    ...
    },
    {
      ...
      vehicle: 'urus',
      tone: 'black',
      mobileTitle: 'Запитване за финансиране',
