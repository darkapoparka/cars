...
const bodyArtwork = [
  ...
  { label: 'Купе', query: 'Coupe', image: '/dealer/media-pending.svg', width: 1000, height: 667 },
  { label: 'Спортбек', query: 'Sportback', image: '/dealer/media-pending.svg', width: 1000, height: 667 }
] as const;
