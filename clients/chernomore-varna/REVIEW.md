...
Once integrated into the coordinator checkout, `./scripts/start-client.ps1 -Client chernomore-varna -Prepare` and `./scripts/start-client.ps1 -Client chernomore-varna` use the repository launcher. These commands have **not** been run here.
