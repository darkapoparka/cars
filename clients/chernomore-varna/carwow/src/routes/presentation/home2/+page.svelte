<script lang="ts">
	...
	const guideCards = [
		...
		{
			title: 'Sell or part exchange with Черно море',
...
<svelte:head>
	<title>Черно море Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from Черно море Варна."
	/>
...
<main class="home2-shell">
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular Черно море picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate Черно море as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/dealer/media-pending.svg" alt="Черно море consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse Черно море stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
