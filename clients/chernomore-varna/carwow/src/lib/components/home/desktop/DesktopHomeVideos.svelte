...
<section class="home-videos" aria-label="Черно море в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Черно море в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">Черно море в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
