...
<div class="mobile-home" aria-label="Черно море — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Черно море"
				>
		...
		<h1 class="mh-hero__title">Черно море</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Черно море Варна. Всички права запазени.</span>
	</footer>
