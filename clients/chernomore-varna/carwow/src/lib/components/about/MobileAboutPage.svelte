...
<div class="mobile-about-app" aria-label="За Черно море">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Черно море в Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/dealer/media-pending.svg')}
				alt="Консултация със Черно море"
				loading="lazy"
				decoding="async"
			/>
			<div>
