<script lang="ts">
	...
	const locationText = 'Варна, Варна, гр. Варна, бул. Цар Освободител 289, пресечка с бул. Константин и Фружин, бул. Цар Освободител 289, пресечка с бул. Константин и Фружин';
