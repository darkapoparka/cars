...
const pageCopy = {
  bg: {
    badge: "Финансиране от Черно море",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Черно море ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Черно море",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Черно море team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Автосалон Черно море."
      : "A tailored vehicle financing offer from Автосалон Черно море.",
    locale,
    path: "/lease",
