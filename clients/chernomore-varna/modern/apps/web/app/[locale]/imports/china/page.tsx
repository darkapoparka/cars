...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Черно море."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Черно море.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Черно море"
      : "Import from China | Черно море",
  });
};
