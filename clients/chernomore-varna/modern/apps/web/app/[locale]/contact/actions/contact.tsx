...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Черно море.",
          "The form is ready, but message delivery is not configured yet. Call Черно море directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Черно море.",
          "Message delivery is not configured yet. Call Черно море directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Черно море."
        : "Запитването е изпратено до екипа на Черно море.",
      "Your request has been sent to the Черно море team."
    ),
  };
};
