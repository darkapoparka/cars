...
const leadSellCategories = [
  { asset: "/dealer/media-pending.svg", id: "car", labelBg: "Автомобил", labelEn: "Car" },
  { asset: "/dealer/media-pending.svg", id: "van", labelBg: "Бус", labelEn: "Van" },
  { asset: "/dealer/media-pending.svg", id: "motorbike", labelBg: "Мотоциклет", labelEn: "Motorbike" },
  { asset: "/dealer/media-pending.svg", id: "truck", labelBg: "Камион", labelEn: "Truck" },
] as const;
