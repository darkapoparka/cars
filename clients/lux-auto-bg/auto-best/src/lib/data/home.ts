...
const bodyArtwork = [
  ...
  { label: 'Купе', query: 'Coupe', image: '/dealer/inventory/11776195342993015-1.webp', width: 1000, height: 667 },
  { label: 'Спортбек', query: 'Sportback', image: '/dealer/inventory/11787687890119606-1.webp', width: 1000, height: 667 }
] as const;
