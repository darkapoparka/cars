...
const pageCopy = {
  bg: {
    badge: "Финансиране от ЛУКС АВТО",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на ЛУКС АВТО ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from ЛУКС АВТО",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The ЛУКС АВТО team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от ЛУКС АВТО."
      : "A tailored vehicle financing offer from ЛУКС АВТО.",
    locale,
    path: "/lease",
