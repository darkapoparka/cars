...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от ЛУКС АВТО."
      : "Start a request for a vehicle from China with delivery to Bulgaria from ЛУКС АВТО.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | ЛУКС АВТО"
      : "Import from China | ЛУКС АВТО",
  });
};
