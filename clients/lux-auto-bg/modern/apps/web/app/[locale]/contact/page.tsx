...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с ЛУКС АВТО за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в ул. Христина Морфова 4, кв. Кольо Ганчев.",
    locationLabel: "Шоурум · ул. Христина Морфова 4, кв. Кольо Ганчев",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на ЛУКС АВТО, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · ул. Христина Морфова 4, кв. Кольо Ганчев",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with ЛУКС АВТО about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call ЛУКС АВТО to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "ЛУКС АВТО в Стара Загора — автомобили в наличност, внос по заявка и собствен лизинг."
      : "ЛУКС АВТО in Sofia — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | ЛУКС АВТО"
      : "About and contact | ЛУКС АВТО",
  });
};
