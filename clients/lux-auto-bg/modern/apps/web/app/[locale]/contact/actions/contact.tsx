...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на ЛУКС АВТО.",
          "The form is ready, but message delivery is not configured yet. Call ЛУКС АВТО directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на ЛУКС АВТО.",
          "Message delivery is not configured yet. Call ЛУКС АВТО directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на ЛУКС АВТО."
        : "Запитването е изпратено до екипа на ЛУКС АВТО.",
      "Your request has been sent to the ЛУКС АВТО team."
    ),
  };
};
