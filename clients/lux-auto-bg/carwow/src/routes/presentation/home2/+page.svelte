	...
	const guideCards = [
		{
			...
			image: '/assets/dealer/inventory/11776195342993015-1.webp',
			href: '/blog'
		},
		{
		...
		{
			title: 'Sell or part exchange with ЛУКС АВТО',
...
<svelte:head>
	<title>ЛУКС АВТО Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from ЛУКС АВТО Стара Загора."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="ЛУКС АВТО Home2">
				<img src="/assets/dealer/brand/logo.jpg" alt="ЛУКС АВТО" />
			</a>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular ЛУКС АВТО picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate ЛУКС АВТО as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/brand/daynight-team-placeholder.svg" alt="ЛУКС АВТО consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse ЛУКС АВТО stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
