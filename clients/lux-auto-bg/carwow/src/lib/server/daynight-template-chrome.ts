...
const daynightFacebookUrl = 'https://luxauto.mobile.bg/';
const daynightInstagramUrl = 'https://luxauto.mobile.bg/';
...
const footerLinkGroups: readonly FooterLinkGroup[] = [
	{
		title: 'ЛУКС АВТО GROUP',
		links: [
			{ label: 'За ЛУКС АВТО', href: '/about' },
...
function renderFooterSocialLinks() {
	...
	const links: readonly PresentationIconLink[] = [
		...
		},
		{
			...
			title: 'Отвори локацията на ЛУКС АВТО в Google Maps',
			kind: 'external',
...
<p class="text-sm text-muted mb-16">ЛУКС АВТО предлага актуална дигитална витрина с наличност, запитвания и ясни следващи стъпки.</p>
${renderFooterSocialLinks()}
</div>
<div>
<p class="text-sm text-white font-weight-600 mb-8">Имате въпрос?</p>
<div class="flex items-center gap-12">
<a href="/contact" class="btn btn-line-1 btn-small" title="Свържете се със ЛУКС АВТО">Свържете се</a>
</div>
</div>
</div>
</div>
...
<p class="text-sm text-muted">©2026 <a class="text-sm text-white" href="/">ЛУКС АВТО</a>. Всички права запазени.</p>
...
<a href="tel:${daynightSite.phone}" class="icon" aria-label="Обади се на ЛУКС АВТО">${phoneIcon()}</a>
...
<a href="${daynightSite.mapUrl}" class="icon" target="_blank" rel="noopener" aria-label="Отвори карта до ЛУКС АВТО">${locationIcon()}</a>
<div class="daynight-header-contact__body">
...
<a class="daynight-map-preview" href="${daynightSite.mapUrl}" target="_blank" rel="noopener" aria-label="Отвори Google карта до ЛУКС АВТО">
<span class="daynight-map-preview__thumb">
<span class="daynight-map-preview__pin"></span>
</span>
<span class="daynight-map-preview__body">
<strong>ЛУКС АВТО Стара Загора</strong>
