...
<div class="mobile-about-app" aria-label="За ЛУКС АВТО">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>ЛУКС АВТО в Стара Загора помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/assets/dealer/inventory/11776195342993015-1.webp')}
				alt="Консултация със ЛУКС АВТО"
				loading="lazy"
				decoding="async"
			/>
			<div>
				<span>Шоурум в Стара Загора</span>
