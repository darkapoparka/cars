	...
	<section class="background-light mb-32">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb__icon" aria-hidden="true"><ChevronRight size={14} /></li>
				<li><span>Профил на ЛУКС АВТО</span></li>
			</ul>
		</div>
	</section>
		...
		<div class="container">
			<div class="dealer-profile-hero__grid">
				<div class="dealer-profile-hero__content">
					...
					<h1>ЛУКС АВТО Стара Загора</h1>
					<p class="h7 text-secondary line-height-28 mb-24">
						Автокъща в Стара Загора с подбрани употребявани автомобили, ясна информация за състояние,
				...
				<div class="dealer-profile-card">
					<img class="dealer-profile-card__logo" src="/assets/dealer/brand/logo.jpg" alt="" />
					<p class="dealer-profile-card__title mb-6">ЛУКС АВТО</p>
	...
	<section class="py-80">
		<div class="container">
			<div class="dealer-about-grid">
				...
				<LazyMapEmbed src={mapEmbedSrc} title="Карта до ЛУКС АВТО Стара Загора" height="330" />
			</div>
		</div>
	</section>
