<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'ЛУКС АВТО предлага проверени автомобили, финансиране и съдействие при покупка в Стара Загора.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="ЛУКС АВТО Стара Загора" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="ЛУКС АВТО Стара Загора" />
	{/if}
