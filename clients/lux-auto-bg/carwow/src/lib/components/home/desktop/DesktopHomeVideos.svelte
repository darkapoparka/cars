...
<section class="home-videos" aria-label="ЛУКС АВТО в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="ЛУКС АВТО в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">ЛУКС АВТО в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
