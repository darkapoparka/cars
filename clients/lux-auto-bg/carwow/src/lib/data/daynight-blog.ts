...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Как да следите наличността на ЛУКС АВТО',
		description:
		...
		tags: ['новини', 'наличност', 'Стара Загора']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'ЛУКС АВТО съдейства с документи, регистрация, финансиране и оглед на място в Стара Загора.'
				]
			}
		],
	...
	article({
		...
		title: 'Лизинг за употребяван автомобил в Стара Загора',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на ЛУКС АВТО може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
					'При конкретен автомобил е най-добре параметрите да се обсъдят преди финално решение.'
				]
			}
		],
		tags: ['лизинг', 'финансиране', 'Стара Загора']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'ЛУКС АВТО предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на ЛУКС АВТО често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез ЛУКС АВТО.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'ЛУКС АВТО',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'ЛУКС АВТО помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
