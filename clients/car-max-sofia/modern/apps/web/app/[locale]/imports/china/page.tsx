...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от CAR MAX."
      : "Start a request for a vehicle from China with delivery to Bulgaria from CAR MAX.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | CAR MAX"
      : "Import from China | CAR MAX",
  });
};
