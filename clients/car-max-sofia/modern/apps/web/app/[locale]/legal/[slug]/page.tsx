...
const getPrivacyFallback = (isBg: boolean): FallbackLegalPage => ({
  ...
  description: isBg
    ? "Как CAR MAX използва и защитава данните, които предоставяте при запитване за автомобил, внос, лизинг или продажба."
    : "How CAR MAX uses and protects information you provide when asking about a vehicle, import, leasing, or selling your car.",
  sections: isBg
    ? [
        {
...
const getTermsFallback = (isBg: boolean): FallbackLegalPage => ({
  ...
  description: isBg
    ? "Основните правила за използване на сайта на CAR MAX и информацията за автомобили, внос и лизинг."
    : "The core rules for using the CAR MAX website and its vehicle, import, and leasing information.",
  sections: isBg
    ? [
        {
          heading: "Роля на CAR MAX",
          body: "CAR MAX представя собствени наличности и услуги за внос, лизинг и изкупуване на автомобили. Сайтът служи за информация и контакт; конкретните търговски условия се потвърждават в индивидуална писмена оферта или договор.",
        },
        {
        ...
        },
        {
          ...
          body: "Цените, ориентировъчните месечни плащания, сроковете за доставка и наличността могат да се променят. Крайната цена, включените данъци и такси, гаранцията и доставката се потвърждават писмено от CAR MAX.",
        },
        {
    ...
    : [
        {
          heading: "CAR MAX's role",
          body: "CAR MAX presents its vehicle stock and services for imports, leasing, and purchasing vehicles. The website provides information and contact options; specific commercial terms are confirmed in an individual written quotation or agreement.",
        },
        {
        ...
        },
        {
          ...
          body: "Prices, indicative monthly payments, delivery times, and availability can change. CAR MAX will confirm the final price, included taxes and fees, warranty, and delivery in writing.",
        },
        {
      ...
      <main className="mx-auto min-h-[60dvh] max-w-5xl px-4 py-8 lg:px-6 lg:py-10">
        ...
        >
          <Link href={getLocalizedPath(normalizedLocale, "/")}>
            ...
            {isBg ? "Към CAR MAX" : "Back to CAR MAX"}
          </Link>
        </Button>
