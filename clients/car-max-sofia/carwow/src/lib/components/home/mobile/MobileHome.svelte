...
<div class="mobile-home" aria-label="CAR MAX — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="CAR MAX home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на CAR MAX"
				>
		...
		<h1 class="mh-hero__title">CAR MAX</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 CAR MAX София. Всички права запазени.</span>
	</footer>
