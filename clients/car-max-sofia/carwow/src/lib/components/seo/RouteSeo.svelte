<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'CAR MAX предлага проверени автомобили, финансиране и съдействие при покупка в София.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="CAR MAX София" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="CAR MAX София" />
	{/if}
