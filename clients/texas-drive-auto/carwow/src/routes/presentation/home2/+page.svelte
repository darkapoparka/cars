...
<svelte:head>
	...
	<meta
		name="description"
		content="Browse vehicles and explore buying and selling questions in the Texas Drive Auto preview."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="Texas Drive Auto Home2">
				<img src="/brand/daynight-logo-generated.png" alt="Texas Drive Auto" />
			</a>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/brand/daynight-team-placeholder.svg" alt="Texas Drive Auto consultant" />
			<div>
