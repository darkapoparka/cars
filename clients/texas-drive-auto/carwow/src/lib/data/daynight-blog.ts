...
const article: DayNightArticle = {
	...
	title: "How to confirm current availability at Texas Drive Auto",
	...
	readMinutes: 2,
	summary: ["Dated listing samples; confirm price and availability directly with the dealership.", "Independent preview. Forms do not send messages and no reservation is created."],
	sections: [
		{
			heading: "Before visiting",
			paragraphs: ["Call (214) 972-3233 and identify the exact vehicle you are interested in."]
		},
		{
