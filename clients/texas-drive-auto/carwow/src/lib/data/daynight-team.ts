...
export const daynightTeam: DayNightTeamMember[] = [
	{
		...
		detail: "Dated listing samples; confirm price and availability directly with the dealership. Independent preview. Forms do not send messages and no reservation is created."
	}
];
