<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Explore the Texas Drive Auto vehicle preview. Dealer financing and payment plans are not offered; buyer-arranged funding is separate.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Texas Drive Auto" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Texas Drive Auto" />
	{/if}
