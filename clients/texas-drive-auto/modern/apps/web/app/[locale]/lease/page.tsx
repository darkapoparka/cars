...
const pageCopy = {
  bg: {
    badge: "Финансиране от Texas Drive Auto",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Texas Drive Auto ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Texas Drive Auto",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Texas Drive Auto team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Texas Drive Auto."
      : "A tailored vehicle financing offer from Texas Drive Auto.",
    locale,
    path: "/lease",
