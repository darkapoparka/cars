  ...
  const phoneLinkAttributes = { href: brand.phoneHref } as const;
      ...
      >
        ...
        <div class="dn-mobile-menu__contact">
          <a class="dn-mobile-menu__call" {...phoneLinkAttributes}><MobileNavIcon name="phone" size={20} /><strong>Call</strong><span>{brand.phone}</span></a>
        ...
        <nav aria-label="Mobile navigation">
          ...
          <a href={resolve('/blog')} aria-current={page.url.pathname.startsWith('/blog') ? 'page' : undefined} onclick={() => void closeMobile(false)}><Icon name="file-invoice" size={20} /><span>Buying tips</span><Icon name="arrow-right" size={16} /></a>
          ...
          <a href={resolve('/contact')} onclick={() => void closeMobile(false)}><MobileNavIcon name="location" size={20} /><span>Contact and visit</span><Icon name="arrow-right" size={16} /></a>
        </nav>
        <div class="dn-mobile-menu__social" aria-label="Social media">
