  ...
  const actions = [
    {
      ...
      mobileCta: 'Browse',
      description: 'Browse vehicles with helpful filters.',
      bannerDescription: ['Choose a vehicle', 'with helpful filters.'],
      cta: 'View vehicles',
      href: '/listing-grid',
      icon: 'car'
    },
    {
      title: 'Sale or trade-in inquiry',
      ...
      vehicle: 'gclass',
      tone: 'red',
      mobileTitle: 'Selling / trade-in questions',
      mobileCta: 'Ask about an appraisal',
      description: 'Ask whether sale or trade-in appraisals are available.',
      bannerDescription: ['Ask about appraisal availability', 'for a sale or trade-in.'],
      cta: 'Ask about an appraisal',
    ...
    },
    {
      ...
      vehicle: 'gclass',
      tone: 'red',
      mobileTitle: 'Import questions',
      mobileCta: 'Ask about imports',
      description: 'Share a model and budget with your import question. Import services aren’t confirmed in this preview.',
      bannerDescription: ['Share your budget', 'and model with your import question.'],
      cta: 'Ask about imports',
    ...
    },
    {
      ...
      vehicle: 'urus',
      tone: 'black',
      mobileTitle: 'Buyer-arranged funding',
      mobileCta: 'View details',
      description: 'No dealer financing or payment plans. Buyers arrange their own funding.',
      bannerDescription: ['No dealer financing', 'or payment plans.'],
      cta: 'Ask for details',
...
<section class:dn-trust-actions={variant === 'banners'} class:dn-home-services={variant === 'cards'} data-banner-group={variant === 'banners' ? group : undefined} aria-label={variant === 'cards' ? 'How can we help?' : group === 'browse' ? 'Buying and selling' : 'Import questions and buyer-arranged funding'}>
  <div class="container">
    <div class="dn-trust-actions__panel">
      {#if variant === 'cards'}
        <div class="dn-services-heading dn-home-section-heading">
          <h2 class="dn-home-section-title">How can we help?</h2>
          <p>Choose a service or contact the team directly.</p>
