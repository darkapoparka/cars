  ...
  <div class="container">
    <div class="dn-section-heading dn-body-types__heading dn-home-section-heading">
      <h2 id="body-types-title" class="dn-home-section-title">
        <span class="dn-heading-desktop">Choose by body style</span>
        <span class="dn-heading-mobile">By body style</span>
      </h2>
    ...
    <div class="dn-body-types__viewport">
      <div class="dn-body-types__rail" aria-label="Vehicles by body style">
