...
<svelte:head>
  ...
  <meta
    name="description"
    content={`${data.vehicle.title}, ${data.vehicle.year}, ${data.vehicle.mileage}. Vehicle listed by ${brand.name} in ${brand.city}.`}
  />
</svelte:head>
      ...
      <div class="dn-detail-container">
        <div class="dn-detail-layout">
          <div class="dn-detail-main">
            ...
            <section class="dn-detail-card dn-detail-info-card" aria-label="Vehicle information">
              ...
              {:else if activeDetailTab === 'description'}
                ...
                >
                  <p>
                    {data.vehicle.title} is listed in the vehicle selection from {brand.name}. Contact
                    the team to confirm condition, availability, and next steps.
                  </p>
          ...
          <aside class="dn-detail-sidebar" aria-label="Vehicle information">
            <section class="dn-detail-card dn-detail-summary">
              ...
              <p class="dn-detail-summary__price">{formatVehiclePrice(data.vehicle.priceUsd)}</p>
              <p class="dn-detail-summary__availability">Confirm availability and terms with the team.</p>
              <div class="dn-detail-summary__actions">
                <a class="dn-detail-button dn-detail-button--primary" {...phoneLinkAttributes}>Call</a>
                <a class="dn-detail-button dn-detail-button--dark" href={resolve(vehicleContactHref(data.vehicle.id))}>Request a viewing</a>
              </div>
            </section>
            ...
            <section class="dn-detail-card dn-detail-dealer" aria-labelledby="seller-title">
              ...
              <div class="dn-detail-dealer__actions">
                <a class="dn-detail-button dn-detail-button--dark" href={resolve(vehicleContactHref(data.vehicle.id))}>Ask about this vehicle</a>
              </div>
            </section>
        ...
        <section class="dn-detail-related" aria-labelledby="related-title">
          <div class="dn-detail-related__header">
            <div>
              <h2 id="related-title">Featured vehicles</h2>
              <p>More vehicles to explore</p>
            </div>
            ...
            {#each data.recommendations as vehicle (vehicle.id)}
              <a class="dn-detail-related-card" href={resolve(vehicle.href as '/listing-detail-v1/1')}>
                ...
                <span>
                  ...
                  <b>{formatVehiclePrice(vehicle.priceUsd)}</b>
                </span>
              </a>
            {/each}
          </div>
