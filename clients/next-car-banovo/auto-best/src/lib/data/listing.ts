...
export const listingFilterOptions = {
  ...
  prices: ['', '15000', '25000', '40000', '60000', '90000', '120000', '200000'],
...
export const parseListingFilters = (params: URLSearchParams): ListingFilters => {
  ...
  return {
    ...
    condition: requestedCondition === 'new' || requestedCondition === 'used' || requestedCondition === 'unknown' ? requestedCondition : '',
