<script lang="ts">
	...
	const trustPoints = [
		...
		},
		{
			id: 'documents',
			title: 'Документи',
			copy: 'Документите и условията се уточняват с продавача.',
			icon: ClipboardCheck
		},
		{
			id: 'trade',
			title: 'Бартер',
			copy: 'Някои обяви допускат обсъждане на бартер; условията се уточняват индивидуално.',
			icon: Repeat
		}
	] as const;
	...
	const steps = [
		...
		'Уточнете час за оглед и възможност за проверка.',
		'Потвърдете документите и следващите стъпки с продавача.'
	] as const;
...
<div class="mobile-about-app" aria-label="За NEXT CAR">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>NEXT CAR в Баново помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/inventory/21776348634522888-1.webp')}
				alt="Консултация със NEXT CAR"
				loading="lazy"
				decoding="async"
			/>
			<div>
				<span>Шоурум в Баново</span>
