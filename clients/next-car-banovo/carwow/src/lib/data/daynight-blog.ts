...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Как да следите наличността на NEXT CAR',
		description:
			'Как да проверите подбраните обяви и да подготвите запитване за автомобил или оглед.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-28',
		author: 'NEXT CAR',
		...
		sections: [
			...
			{
				heading: 'Как да проверите наличност по запитване',
				paragraphs: [
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'NEXT CAR съдейства с документи, регистрация, финансиране и оглед на място в Баново.'
				]
			}
		],
	...
	article({
		...
		title: 'Лизинг за употребяван автомобил в Баново',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Контакт с NEXT CAR може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'NEXT CAR предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на NEXT CAR често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез NEXT CAR.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'NEXT CAR',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'NEXT CAR помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
