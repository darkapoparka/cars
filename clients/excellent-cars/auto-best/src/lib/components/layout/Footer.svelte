...
<footer class={['dn-footer', { 'dn-footer--mobile-hidden': !showMobileFooter }]}>
  <div class="container dn-footer__grid">
    <div class="dn-footer__intro">
      <a class="dn-footer__logo" href={resolve('/')}><img src="/assets/excellent/logo-cars.jpg" alt={brand.name} width="220" height="58" /></a>
      <p>Подбрани премиум автомобили, внос и лизинг по договаряне с директен контакт с екипа.</p>
    </div>
    <nav aria-label="Автомобили">
      ...
      <a href={resolve('/listing-grid?condition=new')}>Нови автомобили</a>
    </nav>
