...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Excellent Cars за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Възраждане 1.",
    locationLabel: "Шоурум · Възраждане 1",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Excellent Cars, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Възраждане 1",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Excellent Cars about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Vazrazhdane 1.",
    locationLabel: "Showroom · Vazrazhdane 1",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Excellent Cars to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Vazrazhdane 1",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Excellent Cars в Варна — автомобили в наличност, внос по заявка и лизинг по договаряне."
      : "Excellent Cars in Varna — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Excellent Cars"
      : "About and contact | Excellent Cars",
  });
};
        ...
        <section className="relative isolate hidden overflow-hidden border-white/10 border-b lg:block">
          <div className="absolute inset-0 -z-20 bg-[#08090a]">
            <Image
              ...
              priority
              sizes="100vw"
              src="/assets/excellent/vehicle-01-1.webp"
            />
          </div>
          <div
            aria-hidden="true"
