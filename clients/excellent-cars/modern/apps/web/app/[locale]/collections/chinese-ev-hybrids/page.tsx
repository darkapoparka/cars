...
const collectionCopy = {
  bg: {
    ...
    truth:
      "Excellent Cars не твърди официално партньорство с показаните марки. Всяка оферта се потвърждава индивидуално.",
  },
  en: {
    ...
    truth:
      "Excellent Cars does not claim an official partnership with the displayed brands. Every offer is confirmed individually.",
  },
} as const;
