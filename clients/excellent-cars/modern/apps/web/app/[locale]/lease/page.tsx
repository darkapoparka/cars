...
const pageCopy = {
  bg: {
    badge: "Финансиране от Excellent Cars",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Excellent Cars ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Excellent Cars",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Excellent Cars team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Excellent Cars."
      : "A tailored vehicle financing offer from Excellent Cars.",
    locale,
    path: "/lease",
