<script lang="ts">
	...
	const locationText = 'Варна, Варна, гр. Варна, Възраждане 1, бул. Ян Хунияди / Цар Освободител';
	...
	const mapSrc = `https://www.google.com/maps?q=${encodeURIComponent(`${daynightSite.name}, ${daynightSite.location}`)}&output=embed`;
</script>
