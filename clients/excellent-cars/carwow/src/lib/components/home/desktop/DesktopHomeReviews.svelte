<script lang="ts">
  ...
  {
    "id": "info-0",
    "description": "Потвърдете наличността и условията за избрания автомобил.",
  ...
  {
    "id": "info-1",
    "description": "Уговорете оглед и тест драйв по телефона.",
    "avatar": "/assets/excellent/vehicle-02-1.webp",
    "name": "Оглед и тест драйв",
    "meta": "Excellent Cars"
  },
  {
    "id": "info-2",
    "description": "Проверка в избран от клиента сервиз преди покупка.",
    "avatar": "/assets/excellent/vehicle-03-1.webp",
    "name": "Проверка в сервиз по избор на клиента",
    "meta": "Excellent Cars"
  }
];
	...
	const actionCards: ActionCard[] = [
		...
		},
		{
			...
			bullets: [
				...
				'Получете обратна връзка от екипа на Excellent Cars.',
