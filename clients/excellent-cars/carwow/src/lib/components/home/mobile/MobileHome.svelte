...
<div class="mobile-home" aria-label="Excellent Cars — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Excellent Cars home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/excellent/logo-header.png')}
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Excellent Cars"
				>
		...
		<h1 class="mh-hero__title">Excellent Cars</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Excellent Cars Варна. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, Възраждане 1, бул. Ян Хунияди / Цар Освободител</strong>
			</div>
