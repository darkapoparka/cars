...
export const footerSocialLinks: FooterSocialLink[] = [{label:'Mobile.bg',href:daynightSite.sourceInventory,title:'Обявите на Excellent Cars в Mobile.bg',icon:'mobilebg',external:true}];
