...
<div class="mobile-about-app" aria-label="За Excellent Cars">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Excellent Cars в Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/assets/excellent/vehicle-01-1.webp')}
				alt="Консултация със Excellent Cars"
				loading="lazy"
				decoding="async"
			/>
			<div>
