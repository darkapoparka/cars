...
export const daynightTeam: DayNightTeamMember[] = [
	{
		...
		name: "Екип продажби Excellent Cars",
		...
		detail:
			"Консултантите на Excellent Cars помагат с избор според бюджет, пробег, оборудване и реална наличност. При нужда подготвят оглед, запазване на автомобил и координация на следващите стъпки."
	},
	{
