...
const article: DayNightArticle = {
	...
	title: "Как да потвърдите актуална наличност в Excellent Cars",
	...
	readMinutes: 2,
	summary: ["Подбрани публикувани обяви към 07.09.2026. Наличностите и условията се потвърждават по телефона.", "Независим демонстрационен преглед. Формите не изпращат съобщения и не създават резервация."],
	sections: [
		{
			heading: "Преди посещение",
			paragraphs: ["Обадете се на 0895 996 559 и посочете точния автомобил, който Ви интересува."]
		},
		{
