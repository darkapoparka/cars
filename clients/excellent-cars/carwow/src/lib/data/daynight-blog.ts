...
const article: DayNightArticle = {
	...
	readMinutes: 2,
	summary: ["Подбрани публикувани обяви към 07.09.2026. Наличностите и условията се потвърждават по телефона.", "Свържете се с автокъщата преди посещение и потвърдете наличността."],
	sections: [
		{
