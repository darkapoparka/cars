<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'F1rst Motors предлага проверени автомобили, финансиране и съдействие при покупка в София.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="F1rst Motors София" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="F1rst Motors София" />
	{/if}
