...
<div class="mobile-about-app" aria-label="За F1rst Motors">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="F1rst Motors начало">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>F1rst Motors в София помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				...
				alt="Консултация със F1rst Motors"
				loading="lazy"
				decoding="async"
			/>
			<div>
