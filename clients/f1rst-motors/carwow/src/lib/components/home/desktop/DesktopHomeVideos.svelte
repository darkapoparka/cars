...
<section class="home-videos" aria-label="F1rst Motors в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="F1rst Motors в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">F1rst Motors в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
