...
<div class="mobile-home" aria-label="F1rst Motors — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="F1rst Motors home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на F1rst Motors"
				>
		...
		<h1 class="mh-hero__title">F1rst Motors</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 F1rst Motors София. Всички права запазени.</span>
	</footer>
