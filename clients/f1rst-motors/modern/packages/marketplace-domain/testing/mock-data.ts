...
export const mockListings: VehicleListing[] = [
  {
    ...
    description:
      "Очакван внос от F1rst Motors. M50d с 360 камери, панорама, HUD и обдухване. Премиум SUV за оглед в София - Студентски град.",
  ...
  },
  {
    ...
    description:
      "GLE 400d Coupe 4MATIC AMG с 360 и Burmester. Наличен при F1rst Motors - София.",
