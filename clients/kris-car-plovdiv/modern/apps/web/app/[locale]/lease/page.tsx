...
const pageCopy = {
  bg: {
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Крис Кар ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Крис Кар team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Крис Кар."
      : "A tailored vehicle financing offer from Крис Кар.",
    locale,
    path: "/lease",
...
export default async function LeasePage({
  ...
  const vehicles = listings.map((listing) => ({
    ...
    imageUrl: listing.images[0]?.url || "/dealer/stock/11744304007224639-1.webp",
