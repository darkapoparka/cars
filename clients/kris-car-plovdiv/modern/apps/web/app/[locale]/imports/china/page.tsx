...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Крис Кар."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Крис Кар.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Крис Кар"
      : "Import from China | Крис Кар",
  });
};
