...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Крис Кар за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Индустриална зона - Изток.",
    locationLabel: "Шоурум · Индустриална зона - Изток",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Крис Кар, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Индустриална зона - Изток",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Крис Кар about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Industrial Zone East.",
    locationLabel: "Showroom · Industrial Zone East",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Крис Кар to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Industrial Zone East",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Крис Кар в Пловдив — автомобили в наличност, внос по заявка и финансиране по запитване."
      : "Крис Кар in Plovdiv — vehicles in stock, import on request, and financing enquiries.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Крис Кар"
      : "About and contact | Крис Кар",
  });
};
          ...
          >
            ...
            >
              <Image
                ...
                src="/dealer/stock/11762013228736167-1.webp"
              />
              <div
                aria-hidden="true"
        ...
        <section className="relative isolate hidden overflow-hidden border-white/10 border-b lg:block">
          <div className="absolute inset-0 -z-20 bg-[#08090a]">
            <Image
              ...
              priority
              sizes="100vw"
              src="/dealer/stock/11788863173361582-1.webp"
            />
          </div>
          <div
            aria-hidden="true"
