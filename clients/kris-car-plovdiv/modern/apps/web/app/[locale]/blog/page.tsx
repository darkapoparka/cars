...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Практични материали от Крис Кар за избор на автомобил, внос, оглед и финансиране."
      : "Practical Крис Кар guidance on choosing, importing, inspecting, and financing a vehicle.",
    locale,
    path: "/blog",
...
const BlogIndex = async ({ params }: BlogProps) => {
  ...
  const jsonLd: WithContext<Blog> = {
    ...
    "@type": "Blog",
    description: isBg
      ? "Практични материали от Крис Кар за вноса и избора на автомобил."
      : "Practical Крис Кар guidance on importing and choosing a vehicle.",
