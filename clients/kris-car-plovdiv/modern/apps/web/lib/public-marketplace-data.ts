...
const withLeadSiteDemoIdentity = (listing: VehicleListing): VehicleListing => ({ ...listing, badges: listing.badges.filter(badge => badge !== "certified" && badge !== "verified"), seller: { ...listing.seller, logoUrl: leadSite.logoPath, verificationStatus: "unverified" } });
