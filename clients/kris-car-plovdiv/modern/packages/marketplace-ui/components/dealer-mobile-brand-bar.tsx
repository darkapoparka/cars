...
export const DealerMobileBrandBar = ({
  ...
  void wordmarkTone; // Original published logo is a complete white-panel lockup.
  ...
  return (
    ...
    >
      ...
      <Link
        ...
        onClick={onNavigate}
      >
        <span className={cn("relative block h-11", logoWidthClassName)}>
          <Image alt={leadSite.name} className="h-full w-full object-contain" width={284} height={104} priority sizes="144px" src={leadSite.logoPath} />
        </span>
      </Link>
