...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Как да следите наличността на Крис Кар',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Крис Кар съдейства с документи, регистрация, финансиране и оглед на място в Пловдив.'
				]
			}
		],
	...
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на Крис Кар може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Крис Кар предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на Крис Кар често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез Крис Кар.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'Крис Кар',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Крис Кар помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
