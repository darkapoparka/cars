...
export const daynightReviewDisclosure = "В този демонстрационен сайт няма публикувани клиентски отзиви или оценки.";

export const daynightReviewCount = daynightReviews.length;
export const daynightReviewCountLabel = "Няма добавени клиентски мнения";
