<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Крис Кар предлага обяви за автомобили, финансиране и съдействие при покупка в Пловдив.';
	const DEFAULT_OG_IMAGE = '/dealer/stock/21781080017250424-1.webp';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Крис Кар Пловдив" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Крис Кар Пловдив" />
	{/if}
