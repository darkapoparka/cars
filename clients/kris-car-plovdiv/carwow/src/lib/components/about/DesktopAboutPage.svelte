<script lang="ts">
	...
	const support = [
		{ title: 'Избор и оглед', icon: CarFront, description: 'Разгледай автомобилите в селекцията. Ще уточним оборудването, състоянието и удобен час за оглед.', href: '/inventory', action: 'Виж автомобилите' },
	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				src={resolve('/dealer/stock/21781080017250424-1.webp')}
				alt="Илюстративна визия на Крис Кар: Mercedes-Benz и Lamborghini с ключове за бартер"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					Крис Кар е автокъща в Пловдив. При нас можеш да разгледаш автомобилите в селекцията, да
					уговориш оглед и да обсъдиш продажба или бартер на твоя автомобил.
				</p>
				<p>
					Разгледай автомобилите онлайн или ни посети в Индустриална зона - Изток. Екипът ще уточни
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до Крис Кар Пловдив" height="280" />
				{:else}
					<button class="about-map-preview" onclick={() => (mapVisible = true)}>
						<MapPin size={36} aria-hidden="true" />
						<strong>Индустриална зона - Изток, Пловдив</strong>
