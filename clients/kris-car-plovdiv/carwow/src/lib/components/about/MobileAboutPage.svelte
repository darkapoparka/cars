	...
	const trustPoints = [
		{
			id: 'history',
			title: 'Ясна история',
			copy: 'Проверка на документи, състояние и наличност за потвърждение.',
			icon: ShieldCheck
		},
		{
			id: 'documents',
...
<div class="mobile-about-app" aria-label="За Крис Кар">
	<header class="mobile-about-hero">
		<img
			class="mobile-about-hero__bg"
			src={resolve('/dealer/stock/21788856265448667-1.webp')}
			alt=""
			aria-hidden="true"
		/>
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="Крис Кар начало">
		...
		<div class="mobile-about-hero__copy">
			<span>За нас</span>
			<h1>Обяви за автомобили и ясен процес</h1>
			<p>Крис Кар в Пловдив помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/dealer/stock/11788863173361582-1.webp')}
				alt="Консултация със Крис Кар"
				loading="lazy"
				decoding="async"
			/>
			<div>
