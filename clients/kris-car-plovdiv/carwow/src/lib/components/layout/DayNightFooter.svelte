					...
					>
						<div>
							<a
								...
								aria-label="Крис Кар начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								Крис Кар предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										title="Виж автомобилите в селекцията в mobile.bg"
										aria-label="Виж автомобилите в селекцията в mobile.bg"
										class={socialLinkClasses}
									>
								...
								<li>
									<a
										{...mapLinkProps}
										title="Отвори локацията на Крис Кар в Google Maps"
										aria-label="Отвори локацията на Крис Кар в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със Крис Кар."
								>
									Свържете се
								</a>
							</div>
