			...
			<div class="daynight-home-hero__stage-content daynight-home-container">
				<div class="daynight-home-hero__location-wrap">
					...
					>
						...
						<span>Цариградско шосе, до бензиностанция Алпи</span>
					</button>
					<button
						type="button"
						id="daynight-home-hero-map-preview"
						class="daynight-home-hero__location-preview"
						aria-label="Отвори Google Maps до Крис Кар"
						onclick={openMap}
					>
						<span class="daynight-home-hero__location-map" aria-hidden="true">
							...
							<span class="daynight-home-hero__location-map-label">Крис Кар</span>
						</span>
						<span class="daynight-home-hero__location-preview-copy">
							<strong>Крис Кар Пловдив</strong>
							<span>Цариградско шосе, до бензиностанция Алпи, Индустриална зона - Изток, Пловдив</span>
