...
<section class="home-videos" aria-label="Галерии на автомобилите">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Галерии на автомобилите" href={youtubeChannelUrl} label="Всички обяви">
			{#snippet titleContent()}
				<span class="home-videos__title">Снимки от обявите</span>
			{/snippet}
...
<style>
	...
	.home-video__image img, .home-video__image a { display: block; width: 100%; height: 100%; min-height: 200px; border: 0; object-fit: cover; }
</style>
