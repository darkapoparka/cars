...
<div class="mobile-home" aria-label="Крис Кар — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Крис Кар home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Крис Кар"
				>
		...
		<h1 class="mh-hero__title">Крис Кар</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Крис Кар Пловдив. Всички права запазени.</span>
	</footer>
