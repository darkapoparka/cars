...
export const footerSocialLinks: FooterSocialLink[] = [{label:"Mobile.bg",href:daynightSite.sourceInventory,title:"Публикуваните обяви на Крис Кар",icon:"mobilebg",external:true}];
...
export const brandLogos: Record<string, string> = {
	...
	Volkswagen: '/assets/images/brand/mobile/volkswagen.svg',
