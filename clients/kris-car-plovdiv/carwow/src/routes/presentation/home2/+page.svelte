<script lang="ts">
	...
	const guideCards = [
		...
		{
			title: 'Sell or part exchange with Крис Кар',
...
<svelte:head>
	<title>Крис Кар Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from Крис Кар Пловдив."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="Крис Кар Home2">
				<img src="/dealer/brand/logo-light.png" alt="Крис Кар" />
			</a>
	...
	<section class="home2-market">
		...
		<section class="home2-sell-card" aria-labelledby="sell-car-title">
			...
			<div class="home2-sell-card__media">
				<img src="/dealer/stock/11744304007224639-1.webp" alt="" aria-hidden="true" />
				<span>ENTER REG</span>
			</div>
		</section>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular Крис Кар picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate Крис Кар as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/dealer/stock/11780494813207389-1.webp" alt="Крис Кар consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse Крис Кар stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
