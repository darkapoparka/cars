<script lang="ts">
	...
	const detail = $derived.by(() => {
		if (isVehicleMissing) return 'Обявата е свалена или продадена. Разгледай автомобилите в селекцията.';
...
<svelte:head>
	<title>{page.status} · Крис Кар</title>
</svelte:head>
...
<main id="main-content" class="daynight-error" aria-labelledby="daynight-error-title">
	<div class="daynight-error__card">
		<a class="daynight-error__brand" href={resolve('/')}>
			<img src={resolve('/dealer/brand/logo-light.png')} alt="Крис Кар" />
		</a>
