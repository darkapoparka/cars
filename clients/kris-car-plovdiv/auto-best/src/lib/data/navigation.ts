...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/dealer/stock/11762013228736167-1.webp', href: '/about-us' },
        { id: 'about-import', title: 'Въпрос за внос', detail: 'Попитайте дали е възможен внос.', image: '/dealer/stock/11788863173361582-1.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Финансиране по запитване', detail: 'Обсъдете условията директно с екипа.', image: '/dealer/stock/11780494813207389-1.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
      ...
      cta: { id: 'about-cta', label: 'Свържете се с екипа', href: '/contact', detail: 'Наличност, оглед, внос и финансиране по запитване.' }
    }
  },
  {
    id: 'guides',
    ...
    menu: {
      ...
      features: [
        { id: 'guides-inspection', title: 'Проверка преди покупка', detail: 'История, документи и състояние.', image: '/dealer/stock/11788863173361582-1.webp', href: '/blog-detail/1' },
        { id: 'guides-import', title: 'Внос и документи', detail: 'Основните стъпки преди регистрация.', image: '/dealer/stock/11744304007224639-1.webp', href: '/blog-detail/2' },
        { id: 'guides-leasing', title: 'Лизинг и условия', detail: 'Какво да уточните преди финансиране.', image: '/dealer/stock/21788856265448667-1.webp', href: '/blog-detail/3' }
      ],
      groups: [
        {
          id: 'guides-library',
