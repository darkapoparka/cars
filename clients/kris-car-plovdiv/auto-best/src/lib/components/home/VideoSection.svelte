  ...
  <div class="container">
    <div class="dn-videos__panel">
      <div class="dn-videos__heading dn-home-section-heading">
        <h2 id="videos-title" class="dn-home-section-title"><span class="dn-videos__intro">Галерии от обявите</span></h2>
        <p>Снимки на конкретните автомобили от Крис Кар. Наличността се потвърждава.</p>
        <a class="dn-videos__channel dn-home-section-action" href={brand.sourceInventory} target="_blank" rel="noopener noreferrer">
        ...
        {#each featuredVideos as video (video.id)}
          <article class="dn-video-card">
            <div class="dn-video-card__media">
              <a class="dn-video-card__play" href={video.href} aria-label={`Разгледайте ${video.title}`}>
            ...
            <div class="dn-video-card__content">
              ...
              <div class="dn-video-card__actions">
                <a href={video.href} target="_blank" rel="noopener noreferrer" aria-label={`${video.title} — галерия на автомобила (нов раздел)`}>
                  Разгледайте обявата <Icon name="arrow-right" size={16} />
                </a>
              </div>
            </div>
          </article>
        {/each}
        <a class="dn-videos__all-card" href={brand.sourceInventory} target="_blank" rel="noopener noreferrer">
          <span class="dn-videos__all-icon"><Icon name="arrow-right" size={40} /></span>
          <strong>Всички обяви</strong>
          <span>Разгледайте обявата</span>
