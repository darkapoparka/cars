<script lang="ts">
  ...
  const phoneLinkAttributes = { href: brand.phoneHref } as const;
      ...
      >
        ...
        <div class="dn-mobile-menu__social" aria-label="Публикувани контакти"><a href={brand.phoneHref}><Icon name="phone" /><span>Телефон</span></a><a href={brand.mapUrl} target="_blank" rel="noopener noreferrer"><Icon name="map-pin" /><span>Карта</span></a><a href={brand.sourceInventory} target="_blank" rel="noopener noreferrer"><Icon name="arrow-right" /><span>Mobile.bg</span></a></div>
