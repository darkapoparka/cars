      ...
      <div class="dn-detail-container">
        <div class="dn-detail-layout">
          ...
          <aside class="dn-detail-sidebar" aria-label="Информация за автомобила">
            ...
            <section class="dn-detail-card dn-detail-dealer" aria-label="IS AUTO">
              <a class="dn-detail-dealer-banner" href={resolve(vehicleContactHref(data.vehicle.id))}>
                <img src="/assets/images/lead/pdp-seller-clean-mobile.webp" alt="IS AUTO — доверен дилър. Обсъдете автомобила." width="360" height="270" loading="lazy" decoding="async" />
              </a>
            </section>
