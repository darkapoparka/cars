...
export const companyServices: CompanyService[] = [
  {
    ...
    "description": "Автомобили с бензинов, дизелов и електрически двигател в публикувания каталог на Навара кар.",
  ...
  },
  {
    "index": "02",
    "icon": "import",
    "title": "Съдействие за регистрация",
    "description": "В обявите е посочено съдействие за регистрация в КАТ Варна или за транзитни номера. Обхватът и разходите се уточняват с продавача.",
  ...
  },
  {
    ...
    "description": "Част от обявите са означени с „Лизинг“. Няма потвърдени публични лихви, срокове, доставчик или условия за одобрение в този преглед.",
...
export const contactTopics: ContactTopic[] = [
  {
    ...
    "description": "Свържете се с Navara Car, за да потвърдите наличност, данни и следваща стъпка."
  },
  {
    "id": "inspection",
    "label": "Оглед",
