  ...
  <div class="container dn-hero__inner dn-route-hero__layout">
    <div class="dn-hero__copy dn-route-hero__copy">
      <h1 id="home-hero-title">
        <span class="dn-hero__title-desktop">Изберете автомобил от {brand.name}</span>
        <span class="dn-hero__title-mobile">Автомобили от {brand.name}</span>
      </h1>
      <p class="dn-hero__location">{brand.city} · Кайсиева градина · Обяви към 08.09.2026</p>
    </div>
  </div>
</section>
