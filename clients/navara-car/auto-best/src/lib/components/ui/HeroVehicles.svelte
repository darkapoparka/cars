...
<div class="dn-hero-vehicles" class:dn-hero-vehicles--mobile={mobile} data-pair={pair} aria-hidden="true">
  {#if mobile}<picture><source media="(max-width: 767px)" srcset={source.vehicles[4].images[1]} /><img class="dn-hero-vehicles__front" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" alt="" width="600" height="600" decoding="async" /></picture>{/if}
...
<style>
  ...
  @media (max-width: 767px) {
    .dn-hero-vehicles--mobile {
      ...
      height: 128px; overflow: hidden; pointer-events: none;
    }
  ...
  @media (min-width: 1440px) {
    .dn-hero-vehicles {
      ...
      display: block; position: absolute; inset: 0; height: 540px; overflow: hidden; pointer-events: none;
    }
    ...
    .dn-hero-vehicles__car--left { left: var(--car-edge); }
