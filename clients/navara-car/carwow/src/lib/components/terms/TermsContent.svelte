<script lang="ts">
	...
	const usageNotice =
		'Това е демонстрационен преглед, а не официалният сайт или договорни условия на Навара кар. Формите не изпращат данни.';
	const photosNotice =
	...
	const accuracyNotice =
		'Информацията е събрана от публични обяви към 08.09.2026 г. и не е проверка на техническото състояние или собствеността.';
	const stockNotice =
	...
	const updatesNotice =
		'Показаната селекция е исторически преглед. За промени проверете оригиналните обяви и се свържете директно с автокъщата.';

	const sharedListItems = [
		'Лизинг е посочен в част от обявите. Бартер, изкупуване и конкретни финансови условия не са потвърдени.',
