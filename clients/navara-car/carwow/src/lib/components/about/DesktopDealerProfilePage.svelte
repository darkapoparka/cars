<script lang="ts">
	...
	const highlights = [
		'Автомобили от обяви с реална наличност',
	...
	<section class="background-light mb-32">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb__icon" aria-hidden="true"><ChevronRight size={14} /></li>
				<li><span>Профил на Навара кар</span></li>
			</ul>
		</div>
	</section>
		...
		<div class="container">
			<div class="dealer-profile-hero__grid">
				<div class="dealer-profile-hero__content">
					...
					<h1>Навара кар Варна</h1>
					<p class="h7 text-secondary line-height-28 mb-24">
						Автокъща във Варна с подбрани употребявани автомобили, ясна информация за състояние,
				...
				<div class="dealer-profile-card">
					<img class="dealer-profile-card__logo" src="/navara/wordmark.svg" alt="" />
					<p class="dealer-profile-card__title mb-6">Навара кар</p>
	...
	<section class="py-80">
		<div class="container">
			<div class="dealer-about-grid">
				...
				<LazyMapEmbed src={mapEmbedSrc} title="Карта до Навара кар Варна" height="330" />
			</div>
		</div>
	</section>
