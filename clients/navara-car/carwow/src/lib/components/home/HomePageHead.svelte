<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Навара кар предлага проверени автомобили, финансиране и съдействие при покупка във Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Навара кар Варна" />
	...
	<meta property="og:image:alt" content="Навара кар Варна" />
