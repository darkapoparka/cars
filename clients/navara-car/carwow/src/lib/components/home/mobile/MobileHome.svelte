...
<div class="mobile-home" aria-label="Навара кар — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Навара кар home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Навара кар"
				>
		...
		<h1 class="mh-hero__title">Навара кар</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Навара кар Варна. Всички права запазени.</span>
	</footer>
