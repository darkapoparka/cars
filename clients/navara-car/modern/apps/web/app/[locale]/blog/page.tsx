...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Практични материали от Navara Car за избор на автомобил, внос, оглед и финансиране."
      : "Practical Navara Car guidance on choosing, importing, inspecting, and financing a vehicle.",
    locale,
    path: "/blog",
...
const BlogIndex = async ({ params }: BlogProps) => {
  ...
  const jsonLd: WithContext<Blog> = {
    ...
    "@type": "Blog",
    description: isBg
      ? "Практични материали от Navara Car за вноса и избора на автомобил."
      : "Practical Navara Car guidance on importing and choosing a vehicle.",
