...
export const financingRequestCopy = {
  bg: {
    ...
    sending: "Изпращане…",
    success: "Запитването е подготвено",
    successBody:
      "Нищо не е изпратено. Обадете се на Навара кар, за да уточните конкретните условия.",
    term: "Срок",
  ...
  en: {
    ...
    send: "Send request",
    sending: "Sending…",
    success: "Enquiry prepared",
    successBody: "Nothing was sent. Call Navara Car to discuss the terms.",
    term: "Term",
