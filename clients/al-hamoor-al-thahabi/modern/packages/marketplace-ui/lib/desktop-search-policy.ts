...
const organizationSuggestions: readonly SearchSuggestionDefinition[] = [
  {
    descriptionBg: "Проверен дилър · Sharjah",
    descriptionEn: "Verified dealer · Sharjah",
    id: "sofia-premium-cars",
    keywords: "sofia premium cars dealer дилър софия bmw audi",
    kind: "dealer",
    label: "Sharjah Premium Cars",
    popular: true,
    value: "Sharjah Premium Cars",
  },
  {
    descriptionBg: "Вносител от Китай · Sharjah",
    descriptionEn: "Importer from China · Sharjah",
    id: "china-ev-import",
  ...
  {
    descriptionBg: "Дилъри и вносители в Sharjah",
    descriptionEn: "Dealers and importers in Sharjah",
