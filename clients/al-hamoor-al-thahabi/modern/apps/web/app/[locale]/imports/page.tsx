...
const importFaqs = {
  bg: [
    ...
    {
      answer:
        "Не е нужен акаунт. Оставете телефон и екипът на Al Hamoor Al Thahabi ще се свърже с вас, за да уточни следващата стъпка.",
  ...
  en: [
    ...
    {
      answer:
        "No account is required. Leave a phone number and the Al Hamoor Al Thahabi team will contact you about the next step.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Изпратете линк или данни за автомобил от чужбина. Al Hamoor Al Thahabi ще уточни заявката за внос и доставка до България."
      : "Send a listing link or vehicle details from abroad. Al Hamoor Al Thahabi will discuss the import request and delivery to Bulgaria.",
    locale,
    path,
    title: isBg
      ? "Внос на автомобил по заявка | Al Hamoor Al Thahabi"
      : "Vehicle import request | Al Hamoor Al Thahabi",
  });
};
