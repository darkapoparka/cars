...
export const financingRequestCopy = {
  bg: {
    ...
    successBody:
      "Екипът на Al Hamoor Al Thahabi ще се свърже с вас за конкретните условия.",
    term: "Срок",
  ...
  en: {
    ...
    successBody: "The Al Hamoor Al Thahabi team will contact you to confirm the terms.",
    term: "Term",
