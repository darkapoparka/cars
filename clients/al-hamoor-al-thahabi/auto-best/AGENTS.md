# Dealer project: al-hamoor-al-thahabi / auto-best

This is an independent personalized dealer copy. Canonical editable source is Cars clients/al-hamoor-al-thahabi/. The dedicated dealer repository is a publishing mirror. Make lasting fixes in canonical source or the versioned packaging layer and regenerate; preserve unmatched mirror fixes first. This copy is not a reusable template master.

Read local CLIENT.md and dealer.json (or their parent-directory copies), .client/project.json when present, and the relevant technical TEMPLATE.md. Shared policy: [Cars workflow](https://github.com/darkapoparka/cars/blob/05a738254b3db1cad568be3f8d3a26b3fd8b1909/docs/WORKFLOW.md) and [publishing](https://github.com/darkapoparka/cars/blob/05a738254b3db1cad568be3f8d3a26b3fd8b1909/docs/LEAD-PUBLISHING.md).
...
Run from this variant directory. Node 22.12+ on the 22 line; npm/package-lock.json. Use an explicitly free port and verify its owner.
