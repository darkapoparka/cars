...
export const listingFilterOptions = {
  ...
  versions: ['', ...new Set(featuredVehicles.flatMap(v => v.equipment))],
  equipment: [...new Set(featuredVehicles.flatMap(v => v.equipment))] satisfies readonly VehicleEquipment[],
  years: ['', ...new Set(featuredVehicles.map(v => String(v.yearNumber)).sort().reverse())],
  prices: ['', '15000', '25000', '40000', '50000', '60000', '100000'],
...
const normalize = (value: string) => value.toLocaleLowerCase('en-AE').trim();
...
export const filterListingVehicles = (vehicles: readonly Vehicle[], filters: ListingFilters) => {
  ...
  return [...filtered].sort((a, b) => {
    ...
    if (filters.sort === 'price-asc') return a.priceAmount === b.priceAmount ? a.id - b.id : a.priceAmount === null ? 1 : b.priceAmount === null ? -1 : a.priceAmount - b.priceAmount;
    if (filters.sort === 'price-desc') return a.priceAmount === b.priceAmount ? a.id - b.id : a.priceAmount === null ? 1 : b.priceAmount === null ? -1 : b.priceAmount - a.priceAmount;
