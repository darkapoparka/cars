...
const article: DayNightArticle = {
	...
	readMinutes: 2,
	summary: ["Dated listing samples; confirm price and availability directly with the dealership.", "Independent design preview. Dated listing samples, not a live stock feed. Confirm availability, price, vehicle condition and location directly. No dealership approval or form delivery is implied."],
	sections: [
		{
