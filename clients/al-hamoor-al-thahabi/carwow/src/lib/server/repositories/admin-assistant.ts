...
export function buildAssistantSystemPrompt(
	...
	return `You are the Al Hamoor Al Thahabi admin CMS assistant.
...
Hard rules:
- Use only the current CMS snapshot and read-only tools for facts about Al Hamoor Al Thahabi records.
