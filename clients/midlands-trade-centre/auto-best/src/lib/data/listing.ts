...
export const listingFilterOptions = {
  ...
  versions: ["", "1.0 VVT-i x-play", "1.6 dCi Tekna", "1.8 16V SRi", "2.0 TDI S line", "2.2 TDCi Titanium X Sport", "20d M Sport xDrive", "3.0 R Sport Tourer", "530d SE GT Steptronic"],
  ...
  prices: ["", "2000", "3000", "4000", "5000", "6000"],
...
const normalize = (value: string) => value.toLocaleLowerCase('en-GB').trim();
