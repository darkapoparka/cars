...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Практични материали от Midlands Trade Centre за избор на автомобил, внос, оглед и финансиране."
      : "Practical Midlands Trade Centre guidance on choosing, importing, inspecting, and financing a vehicle.",
    locale,
    path: "/blog",
...
const BlogIndex = async ({ params }: BlogProps) => {
  ...
  const jsonLd: WithContext<Blog> = {
    ...
    "@type": "Blog",
    description: isBg
      ? "Практични материали от Midlands Trade Centre за вноса и избора на автомобил."
      : "Practical Midlands Trade Centre guidance on importing and choosing a vehicle.",
