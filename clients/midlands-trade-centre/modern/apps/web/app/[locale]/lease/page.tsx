...
const pageCopy = {
  bg: {
    badge: "Финансиране от Midlands Trade Centre",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Midlands Trade Centre ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Midlands Trade Centre",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Midlands Trade Centre team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Midlands Trade Centre Limited."
      : "A tailored vehicle financing offer from Midlands Trade Centre Limited.",
    locale,
    path: "/lease",
