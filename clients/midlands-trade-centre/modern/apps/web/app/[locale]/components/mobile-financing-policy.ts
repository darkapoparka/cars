...
export const financingRequestCopy = {
  bg: {
    ...
    successBody:
      "Екипът на Midlands Trade Centre ще се свърже с вас за конкретните условия.",
    term: "Срок",
  ...
  en: {
    ...
    successBody: "The Midlands Trade Centre team will contact you to confirm the terms.",
    term: "Term",
