...
const organizationSuggestions: readonly SearchSuggestionDefinition[] = [
  {
    descriptionBg: "Проверен дилър · Birmingham",
    descriptionEn: "Verified dealer · Birmingham",
    id: "sofia-premium-cars",
    keywords: "sofia premium cars dealer дилър софия bmw audi",
    kind: "dealer",
    label: "Birmingham Premium Cars",
    popular: true,
    value: "Birmingham Premium Cars",
  },
  {
    descriptionBg: "Вносител от Китай · Birmingham",
    descriptionEn: "Importer from China · Birmingham",
    id: "china-ev-import",
  ...
  {
    descriptionBg: "Дилъри и вносители в Birmingham",
    descriptionEn: "Dealers and importers in Birmingham",
