...
<section class="home-videos" aria-label="Приселци в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Приселци в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">Приселци в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
