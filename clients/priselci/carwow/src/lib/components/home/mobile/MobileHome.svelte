...
<div class="mobile-home" aria-label="Приселци — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Приселци home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/priselci/wordmark-light.svg')}
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Приселци"
				>
		...
		<h1 class="mh-hero__title">Приселци</h1>
		...
		<section class="mh-cta-wrap" aria-label="Призив за действие">
			<div class="mh-cta">
				<div class="mh-cta__copy">
					<strong>{total} обяви · Оглед в Варна</strong>
	...
	<footer class="mh-footer">
		<div class="mh-footer__brand">
			<img
				...
				src={resolve('/assets/priselci/wordmark.svg')}
				alt={daynightSite.name}
			/>
			<p>
				Автомобили във Варна. Свържете се с нас за наличност, информация и оглед.
			</p>
		</div>
		...
		<span class="mh-footer__copy">© 2026 Приселци Варна. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, бул. „Цар Освободител“ 285, бул. „Цар Освободител“ 285</strong>
			</div>
