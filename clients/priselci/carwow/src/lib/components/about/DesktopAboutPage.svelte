<script lang="ts">
	...
	const demoNames = ['Александър Петров', 'Николай Димитров', 'Мария Иванова', 'Елена Георгиева'];
		...
		{#snippet afterPanel()}
			<nav class="about-hero-contact" aria-label="Контакти и социални мрежи">
				<a href={daynightSite.mapUrl} target="_blank" rel="noopener noreferrer"
					><MapPin size={18} />бул. „Цар Освободител“ 285</a
				>
		...
		<div class="about-container">
			...
			<div class="about-social-row">
				<a class="about-reviews-link about-text-link" href={resolve('/reviews')}
					>Отзиви — няма потвърдени публикации <ArrowRight size={18} /></a
				>
			</div>
		</div>
	</section>
	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				src={resolve('/assets/priselci/vehicle-05-1.webp')}
				alt="Илюстративна визия на Приселци: Mercedes-Benz и Lamborghini с ключове за бартер"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					Приселци е автокъща в Варна. При нас можеш да разгледаш наличните автомобили, да
					уговориш оглед и да обсъдиш продажба или бартер на твоя автомобил.
				</p>
				<p>
					Разгледай автомобилите онлайн или ни посети в бул. „Цар Освободител“ 285. Екипът ще уточни
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			<div class="about-visit__copy">
				...
				<div class="about-visit-hours"><Clock3 size={20} aria-hidden="true" /><div><strong>Работно време: по телефона</strong><span>Свържете се предварително</span></div></div>
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до Приселци Варна" height="280" />
				{:else}
					<button class="about-map-preview" onclick={() => (mapVisible = true)}>
						<MapPin size={36} aria-hidden="true" />
						<strong>бул. „Цар Освободител“ 285, Варна</strong>
