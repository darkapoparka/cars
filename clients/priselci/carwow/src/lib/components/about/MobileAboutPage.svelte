<script lang="ts">
	...
	const trustPoints = [
		...
		},
		{
			id: 'trade',
			title: 'Бартер',
			copy: 'Попитайте дали е възможна замяна за конкретния автомобил.',
			icon: Repeat
		}
	] as const;
...
<div class="mobile-about-app" aria-label="За Приселци">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Приселци в Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
