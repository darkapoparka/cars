<script lang="ts">
	...
	const dealerJsonLd = $derived(
		JSON.stringify({
			...
			image: `${origin}/assets/priselci/wordmark.svg`,
			logo: `${origin}/assets/priselci/wordmark.svg`,
			url: `${origin}/`,
			telephone: '0886251705',
			...(daynightSite.email ? { email: daynightSite.email } : {}),
			address: {
				'@type': 'PostalAddress',
				streetAddress: 'гр. Варна, бул. „Цар Освободител“ 285, бул. „Цар Освободител“ 285',
