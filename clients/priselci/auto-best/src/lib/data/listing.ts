...
export const listingFilterOptions = {
  makes: ["","VW","Seat","Renault","Peugeot","Ford","Mercedes-Benz","Citroen","Audi","Dacia","BMW","Nissan"],
  bodies: ["","Hatchback","Wagon","SUV","Convertible","Minivan","Sedan"],
  fuels: ['', 'Дизел', 'Бензин'],
  ...
  prices: ['', '2000', '3000', '4000', '5000', '6000', '8000', '10000'],
