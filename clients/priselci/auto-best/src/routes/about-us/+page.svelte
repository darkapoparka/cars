...
<svelte:head>
  ...
  <meta name="description" content={`${brand.name} — употребявани автомобили, внос по заявка, лизинг след потвърждение, бартер и огледи с предварителна уговорка в ${brand.city}.`} />
</svelte:head>
