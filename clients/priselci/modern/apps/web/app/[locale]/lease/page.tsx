...
const pageCopy = {
  bg: {
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Приселци ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Приселци team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Автокъща Приселци."
      : "A tailored vehicle financing offer from Автокъща Приселци.",
    locale,
    path: "/lease",
...
export default async function LeasePage({
  ...
  const vehicles = listings.map((listing) => ({
    ...
    imageUrl: listing.images[0]?.url || "/assets/priselci/vehicle-05-1.webp",
