...
const pageCopy = {
  bg: {
    ...
    faqs: [
      {
        answer:
          "Попитайте автокъщата дали предлага изкупуване или замяна. Услугата не е потвърдена за този демо сайт.",
      ...
      {
        answer:
          "Финалната оценка се прави след оглед на място в шоурума ни в бул. „Цар Освободител“ 285, Варна.",
  ...
  en: {
    ...
    faqs: [
      ...
      {
        answer:
          "The final appraisal follows an in-person inspection at our showroom in Tsar Osvoboditel 285, Varna.",
