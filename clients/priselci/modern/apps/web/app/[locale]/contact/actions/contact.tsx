...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Приселци.",
          "The form is ready, but message delivery is not configured yet. Call Приселци directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Приселци.",
          "Message delivery is not configured yet. Call Приселци directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Приселци."
        : "Запитването е изпратено до екипа на Приселци.",
      "Your request has been sent to the Приселци team."
    ),
  };
};
