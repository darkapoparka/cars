...
const pageCopy = {
  bg: {
    ...
    title: "Употребявани автомобили. Внос. Лизинг.",
    description:
      "Вижте автомобилите в наличност или говорете директно с Приселци за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в бул. „Цар Освободител“ 285.",
    locationLabel: "Шоурум · бул. „Цар Освободител“ 285",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Приселци, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · бул. „Цар Освободител“ 285",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Приселци about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Tsar Osvoboditel 285.",
    locationLabel: "Showroom · Tsar Osvoboditel 285",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Приселци to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Tsar Osvoboditel 285",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Автокъща Приселци в Варна — автомобили в наличност, внос по заявка и лизинг след потвърждение."
      : "Автокъща Приселци in Varna — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Приселци"
      : "About and contact | Приселци",
  });
};
        ...
        <section className="relative isolate hidden overflow-hidden border-white/10 border-b lg:block">
          <div className="absolute inset-0 -z-20 bg-[#08090a]">
            <Image
              ...
              priority
              sizes="100vw"
              src="/assets/priselci/vehicle-05-1.webp"
            />
          </div>
          <div
            aria-hidden="true"
