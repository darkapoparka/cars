...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Приселци."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Приселци.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Приселци"
      : "Import from China | Приселци",
  });
};
