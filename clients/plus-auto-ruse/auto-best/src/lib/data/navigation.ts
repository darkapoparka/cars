...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/dealer/stock/21788436132804046-1.webp', href: '/about-us' },
        { id: 'about-import', title: 'Внос по заявка', detail: 'Доставка по ваши критерии.', image: '/dealer/stock/21786648411892061-1.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Условия за плащане', detail: 'Обсъдете условията директно с екипа.', image: '/dealer/stock/21761073805702575-1.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'guides-inspection', title: 'Проверка преди покупка', detail: 'История, документи и състояние.', image: '/dealer/stock/21788436132804046-1.webp', href: '/blog-detail/1' },
        { id: 'guides-import', title: 'Внос и документи', detail: 'Основните стъпки преди регистрация.', image: '/dealer/stock/21780935283938344-1.webp', href: '/blog-detail/2' },
        { id: 'guides-leasing', title: 'Лизинг и условия', detail: 'Какво да уточните преди финансиране.', image: '/dealer/stock/11788812131352849-1.webp', href: '/blog-detail/3' }
      ],
      groups: [
        {
          id: 'guides-library',
