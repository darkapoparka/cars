...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Plus Auto за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Русе.",
    locationLabel: "Шоурум · Русе",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Plus Auto, за да уточним оглед и конкретна оферта.",
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Plus Auto about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Plus Auto to arrange an inspection and a concrete offer.",
    ...
    services: [
      ...
      {
        title: "Payment terms to confirm",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Plus Auto в Русе — автомобили в наличност, внос по заявка и условия за плащане."
      : "Plus Auto in Ruse — vehicles in stock, import on request, and payment terms to confirm.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Plus Auto"
      : "About and contact | Plus Auto",
  });
};
