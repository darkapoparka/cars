...
<div class="mobile-home" aria-label="Plus Auto — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Plus Auto home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Plus Auto"
				>
		...
		<h1 class="mh-hero__title">Plus Auto</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Plus Auto Русе. Всички права запазени.</span>
	</footer>
