...
const stepsAnswer: readonly FaqAnswerParagraph[] = [
	{
		...
		text: 'Изберете обява и се обадете на търговеца. Потвърдете актуална наличност, цена, състояние, документи и място за оглед. Този сайт не запазва и не продава автомобили.'
	},
	{
		class: 'h7 text-secondary line-height-28',
		text: 'Не изпращайте лични документи през демонстрационните форми. Изискванията за конкретна сделка се уточняват директно с търговеца.'
	}
];
...
const termsAnswer: readonly FaqAnswerParagraph[] = [
	{
		class: 'h7 text-secondary line-height-28',
		text: 'Потвърдете условията по конкретната обява. Няма установена обща гаранция, доставка, кредитна оферта или автоматично приемане на бартер. Калкулаторите са илюстративни.'
	}
];
