...
<div class="mobile-about-app" aria-label="За icars">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="icars начало">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>icars · Пловдив. Публични обяви, информация за автомобилите и директен контакт за оглед.</p>
		</div>
