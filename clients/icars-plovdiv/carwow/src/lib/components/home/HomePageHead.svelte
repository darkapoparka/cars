<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'icars предлага проверени автомобили, финансиране и съдействие при покупка в Пловдив.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="icars Пловдив" />
	...
	<meta property="og:image:alt" content="icars Пловдив" />
