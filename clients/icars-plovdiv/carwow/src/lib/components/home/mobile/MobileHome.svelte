...
<div class="mobile-home" aria-label="icars — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="icars home">
				<img
					class="mh-hero__logo"
		...
		<h1 class="mh-hero__title">icars</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 icars Пловдив. Демонстрационна концепция. Не е официалният сайт.</span>
	</footer>
