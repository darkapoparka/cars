...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на icars.",
          "The form is ready, but message delivery is not configured yet. Call icars directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на icars.",
          "Message delivery is not configured yet. Call icars directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на icars."
        : "Запитването е изпратено до екипа на icars.",
      "Your request has been sent to the icars team."
    ),
  };
};
