...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от F1 - AUTO."
      : "Start a request for a vehicle from China with delivery to Bulgaria from F1 - AUTO.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | F1 - AUTO"
      : "Import from China | F1 - AUTO",
  });
};
