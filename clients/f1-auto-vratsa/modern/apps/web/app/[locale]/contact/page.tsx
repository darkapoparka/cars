...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с F1 - AUTO за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Враца.",
    locationLabel: "Шоурум · Враца",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на F1 - AUTO, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Враца",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with F1 - AUTO about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call F1 - AUTO to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "F1 - AUTO в Враца — автомобили в наличност, внос по заявка и условия за плащане."
      : "F1 - AUTO in Vratsa — vehicles in stock, import on request, and payment terms to confirm.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | F1 - AUTO"
      : "About and contact | F1 - AUTO",
  });
};
