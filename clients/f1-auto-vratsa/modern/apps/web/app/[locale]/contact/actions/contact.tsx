...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на F1 - AUTO.",
          "The form is ready, but message delivery is not configured yet. Call F1 - AUTO directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на F1 - AUTO.",
          "Message delivery is not configured yet. Call F1 - AUTO directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на F1 - AUTO."
        : "Запитването е изпратено до екипа на F1 - AUTO.",
      "Your request has been sent to the F1 - AUTO team."
    ),
  };
};
