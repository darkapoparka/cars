...
const pageCopy = {
  bg: {
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на F1 - AUTO ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The F1 - AUTO team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от F1 - AUTO."
      : "A tailored vehicle financing offer from F1 - AUTO.",
    locale,
    path: "/lease",
...
export default async function LeasePage({
  ...
  const vehicles = listings.map((listing) => ({
    ...
    imageUrl: listing.images[0]?.url || "/dealer/stock/11788845314530269-1.webp",
