...
const organizationSuggestions: readonly SearchSuggestionDefinition[] = [
  {
    descriptionBg: "Проверен дилър · Враца",
    descriptionEn: "Verified dealer · Vratsa",
    id: "sofia-premium-cars",
    keywords: "sofia premium cars dealer дилър софия bmw audi",
    kind: "dealer",
    label: "Vratsa Premium Cars",
    popular: true,
    value: "Vratsa Premium Cars",
  },
  {
    descriptionBg: "Вносител от Китай · Враца",
    descriptionEn: "Importer from China · Vratsa",
    id: "china-ev-import",
  ...
  {
    descriptionBg: "Дилъри и вносители в Враца",
    descriptionEn: "Dealers and importers in Vratsa",
