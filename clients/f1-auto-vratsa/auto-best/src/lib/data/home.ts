...
const bodyArtwork = [
  ...
  { label: 'Купе', query: 'Coupe', image: '/dealer/stock/11787722009777216-1.webp', width: 1000, height: 667 },
  { label: 'Спортбек', query: 'Sportback', image: '/dealer/stock/21788844361258125-1.webp', width: 1000, height: 667 }
] as const;
