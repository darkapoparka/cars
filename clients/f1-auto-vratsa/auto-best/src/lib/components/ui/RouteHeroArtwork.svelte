<script lang="ts">
  ...
  const images = {
    cars: '/dealer/stock/11787721565866441-1.webp',
    keys: '/dealer/stock/21786596097180428-1.webp',
    guide: '/dealer/stock/21786596097180428-1.webp',
    silver: '/dealer/stock/21786596097180428-1.webp',
    graphite: '/dealer/stock/21788844361258125-1.webp',
    portrait: '/dealer/stock/11787721565866441-1.webp',
    phone: '/dealer/stock/11788845314530269-1.webp',
    showroom: '/dealer/stock/11788845314530269-1.webp',
    email: '/dealer/stock/11787721565866441-1.webp'
  };
  const pairs = {
  ...
  const coloredImages: Partial<Record<keyof typeof images, string>> = {
    silver: '/dealer/stock/21788844361258125-1.webp',
    graphite: '/dealer/stock/11788844820686692-1.webp',
    showroom: '/dealer/stock/11787722009777216-1.webp',
    portrait: '/dealer/stock/11788845314530269-1.webp',
    guide: '/dealer/stock/11788586996533029-1.webp',
    keys: '/dealer/stock/11787722009777216-1.webp',
    phone: '/dealer/stock/11787722009777216-1.webp',
    email: '/dealer/stock/11788845314530269-1.webp'
  };
</script>
