<script lang="ts">
	...
	const leftCarSrc =
		'/dealer/stock/11788154322609171-1.webp';
	const rightCarSrc =
		'/dealer/stock/11787721565866441-1.webp';
		...
		<div class="daynight-home-hero__visual" aria-hidden="true">
			<img
				...
				srcset={desktopOnlySrcset(
					'/dealer/stock/11788845314530269-1.webp',
					1983
				)}
			...
			<div class="daynight-home-hero__stage-content daynight-home-container">
				<div class="daynight-home-hero__location-wrap">
					...
					>
						...
						<span>Враца · уточнете адреса по телефона</span>
					</button>
					<button
						type="button"
						id="daynight-home-hero-map-preview"
						class="daynight-home-hero__location-preview"
						aria-label="Отвори Google Maps до F1 - AUTO"
						onclick={openMap}
					>
						<span class="daynight-home-hero__location-map" aria-hidden="true">
							...
							<span class="daynight-home-hero__location-map-label">F1 - AUTO</span>
						</span>
						<span class="daynight-home-hero__location-preview-copy">
							<strong>F1 - AUTO Враца</strong>
							<span>Оряховско шосе, до метанстанцията, Враца</span>
