	...
	const services = [
		{
			...
			image: '/dealer/stock/11787722009777216-1.webp',
		...
		},
		{
			...
			image: '/dealer/stock/11788154322609171-1.webp',
			imagePosition: 'center bottom'
		},
		{
			id: 'financing',
			...
			image: '/dealer/stock/11788586996533029-1.webp',
			imagePosition: 'center bottom'
		},
		{
			id: 'trade-in',
			...
			image: '/dealer/stock/11787721565866441-1.webp',
			imagePosition: 'center bottom'
		},
		{
			id: 'sourcing',
...
<main id="main-content" tabindex="-1" class="desktop-services" aria-label="Услуги F1 - AUTO">
	...
	<section class="desktop-services-offers">
		<div class="container">
			<h2 class="desktop-services-sr-only">Конкретни услуги от F1 - AUTO</h2>
