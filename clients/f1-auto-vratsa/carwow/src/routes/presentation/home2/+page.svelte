	...
	const guideCards = [
		{
			...
			image: '/dealer/stock/21786596097180428-1.webp',
			href: '/blog'
		},
		{
			title: 'Finance, registration and paperwork',
			image: '/dealer/stock/21788844361258125-1.webp',
			href: '/financing'
		},
		{
			title: 'Sell or part exchange with F1 - AUTO',
...
<svelte:head>
	<title>F1 - AUTO Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from F1 - AUTO Враца."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		<img
			...
			src="/dealer/stock/11787722009777216-1.webp"
			alt=""
			aria-hidden="true"
		/>

		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="F1 - AUTO Home2">
				<img src="/dealer/logo-light.png" alt="F1 - AUTO" />
			</a>
	...
	<section class="home2-market">
		...
		<section class="home2-sell-card" aria-labelledby="sell-car-title">
			...
			<div class="home2-sell-card__media">
				<img src="/dealer/stock/11788586996533029-1.webp" alt="" aria-hidden="true" />
				<span>ENTER REG</span>
			</div>
		</section>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular F1 - AUTO picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate F1 - AUTO as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/dealer/stock/21788844361258125-1.webp" alt="F1 - AUTO consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse F1 - AUTO stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
