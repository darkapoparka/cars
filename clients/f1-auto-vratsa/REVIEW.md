...
| Modern | modern/apps/web | http://127.0.0.1:6632/cars | http://127.0.0.1:6632/bg/listing/audi-a3-530269 |
| Carwow | carwow | http://127.0.0.1:6633/ | http://127.0.0.1:6633/inventory/audi-a3-1-6-s-line-automatic-530269 |
...
From J:/cars after coordinator integration: ./scripts/start-client.ps1 -Client f1-auto-vratsa -Prepare; then ./scripts/start-client.ps1 -Client f1-auto-vratsa. The existing launcher checks ports; do not use inherited fixed-port wrappers or run Next build and dev together.
