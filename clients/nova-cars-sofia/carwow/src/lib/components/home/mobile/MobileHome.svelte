...
<div class="mobile-home" aria-label="NOVA CARS — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="NOVA CARS home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на NOVA CARS"
				>
		...
		<h1 class="mh-hero__title">NOVA CARS</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 NOVA CARS София. Всички права запазени.</span>
	</footer>
