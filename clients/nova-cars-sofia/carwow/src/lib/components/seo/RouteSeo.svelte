<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'NOVA CARS предлага проверени автомобили, финансиране и съдействие при покупка в София.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="NOVA CARS София" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="NOVA CARS София" />
	{/if}
