<script lang="ts">
	...
	const facebookLinkProps = {
		href: 'https://www.facebook.com/p/NOVA-CARS-61571170120264/',
		target: '_blank',
		rel: 'noopener'
	} as const;
	const instagramLinkProps = {
		href: 'https://www.instagram.com/novacarsluxurysales/',
		target: '_blank',
		rel: 'noopener'
	} as const;
	const mapLinkProps = {
					...
					>
						<div>
							<a
								...
								aria-label="NOVA CARS начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								NOVA CARS предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										aria-label="Отвори локацията на NOVA CARS в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със NOVA CARS."
								>
									Свържете се
								</a>
							</div>
