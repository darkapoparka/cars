...
const daynightFacebookUrl = 'https://www.facebook.com/p/NOVA-CARS-61571170120264/';
const daynightInstagramUrl = 'https://www.instagram.com/novacarsluxurysales/';
...
const footerLinkGroups: readonly FooterLinkGroup[] = [
	{
		title: 'NOVA CARS GROUP',
		links: [
			{ label: 'За NOVA CARS', href: '/about' },
...
function renderFooterSocialLinks() {
	...
	const links: readonly PresentationIconLink[] = [
		...
		},
		{
			...
			title: 'Отвори локацията на NOVA CARS в Google Maps',
			kind: 'external',
...
<p class="text-sm text-muted mb-16">NOVA CARS предлага актуална дигитална витрина с наличност, запитвания и ясни следващи стъпки.</p>
${renderFooterSocialLinks()}
</div>
<div>
<p class="text-sm text-white font-weight-600 mb-8">Имате въпрос?</p>
<div class="flex items-center gap-12">
<a href="/contact" class="btn btn-line-1 btn-small" title="Свържете се със NOVA CARS">Свържете се</a>
</div>
</div>
</div>
</div>
...
<p class="text-sm text-muted">©2026 <a class="text-sm text-white" href="/">NOVA CARS</a>. Всички права запазени.</p>
...
<a href="tel:${daynightSite.phone}" class="icon" aria-label="Обади се на NOVA CARS">${phoneIcon()}</a>
...
<a href="${daynightSite.mapUrl}" class="icon" target="_blank" rel="noopener" aria-label="Отвори карта до NOVA CARS">${locationIcon()}</a>
<div class="daynight-header-contact__body">
...
<a class="daynight-map-preview" href="${daynightSite.mapUrl}" target="_blank" rel="noopener" aria-label="Отвори Google карта до NOVA CARS">
<span class="daynight-map-preview__thumb">
<span class="daynight-map-preview__pin"></span>
</span>
<span class="daynight-map-preview__body">
<strong>NOVA CARS София</strong>
