...
const pageCopy = {
  bg: {
    badge: "Финансиране от NOVA CARS",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на NOVA CARS ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from NOVA CARS",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The NOVA CARS team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от NOVA CARS Luxury Sales."
      : "A tailored vehicle financing offer from NOVA CARS Luxury Sales.",
    locale,
    path: "/lease",
