...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на NOVA CARS.",
          "The form is ready, but message delivery is not configured yet. Call NOVA CARS directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на NOVA CARS.",
          "Message delivery is not configured yet. Call NOVA CARS directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на NOVA CARS."
        : "Запитването е изпратено до екипа на NOVA CARS.",
      "Your request has been sent to the NOVA CARS team."
    ),
  };
};
