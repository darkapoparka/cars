...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от NOVA CARS."
      : "Start a request for a vehicle from China with delivery to Bulgaria from NOVA CARS.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | NOVA CARS"
      : "Import from China | NOVA CARS",
  });
};
