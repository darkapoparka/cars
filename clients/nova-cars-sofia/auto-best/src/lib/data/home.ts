...
const bodyArtwork = [
  ...
  { label: 'Купе', query: 'Coupe', image: '/dealer/inventory/11778577413022240-1.webp', width: 1000, height: 667 },
  { label: 'Спортбек', query: 'Sportback', image: '/dealer/inventory/11785909682010785-1.webp', width: 1000, height: 667 }
] as const;
