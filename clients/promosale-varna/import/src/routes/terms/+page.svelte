...
<svelte:head>
	<title>Общи условия — Promosale Varna</title>
	<meta
		name="description"
		content="Условия за използване на Promosale Varna — информация за автомобилите, процес на внос, разходи и калкулатор, огледи, клиентски автомобили и контакт."
	/>
