...
const genericDescription: Record<Locale, string> = {
	bg: 'Promosale Varna — автомобили с проверена история и сертифициран подбор на автомобили. Прозрачни цени, оглед и съдействие при регистрация в Пловдив.',
...
const shellDescriptions: Record<string, Record<Locale, string>> = {
	...
	'/about': {
		bg: 'За Promosale Varna — екип за внос и продажба на автомобили от Европа с проверена история и прозрачни цени в Пловдив.',
	...
	'/contact': {
		bg: 'Свържи се с Promosale Varna — телефон, имейл и локация в Пловдив. Заяви консултация за внос или избор на автомобил.',
