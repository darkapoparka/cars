...
export const supportFaqs: AuxeroFaq[] = [
	...
	{
		topic: 'Checks',
		question: 'Какво проверява Promosale Varna преди покупка?',
		answer:
	...
	{
		topic: 'Selling',
		question: 'Може ли Promosale Varna да помогне при продажба на моя автомобил?',
		answer:
	...
	{
		topic: 'Compare',
		question: 'Може ли Promosale Varna да сравни няколко модела?',
		answer:
