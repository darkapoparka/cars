  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        ...
        { id: 'about-leasing', tone: 'ink', artwork: featureArtwork.finance, title: 'Въпрос за финансиране', detail: 'Обсъдете условията директно с екипа.', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
