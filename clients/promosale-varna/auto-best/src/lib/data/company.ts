...
export const companyServices: CompanyService[] = [
  {
    ...
    "icon": "inspection",
    "title": "Оглед в Варна",
    "description": "Пон.–пет. 09:30–18:30; съб. 10:00–14:00; нед. почивен ден",
...
export const contactTopics: ContactTopic[] = [
  {
    ...
    "description": "Свържете се с Promosale Varna, за да потвърдите наличност, данни и следваща стъпка."
  },
  {
    "id": "inspection",
    "label": "Оглед",
