...
const bodyArtwork = [
  ...
  { label: 'Купе', query: 'Coupe', image: '/dealer/inventory/11788223873685026-1.webp', width: 1000, height: 667 },
  { label: 'Спортбек', query: 'Sportback', image: '/dealer/inventory/21788220861447827-1.webp', width: 1000, height: 667 }
] as const;
