...
const pageCopy = {
  bg: {
    badge: "Финансиране от СТЕНЛИ КАР",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на СТЕНЛИ КАР ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from СТЕНЛИ КАР",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The СТЕНЛИ КАР team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от СТЕНЛИ КАР."
      : "A tailored vehicle financing offer from СТЕНЛИ КАР.",
    locale,
    path: "/lease",
