...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с СТЕНЛИ КАР за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в ул. Кирил Христов 78, Суходол.",
    locationLabel: "Шоурум · ул. Кирил Христов 78, Суходол",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на СТЕНЛИ КАР, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · ул. Кирил Христов 78, Суходол",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with СТЕНЛИ КАР about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call СТЕНЛИ КАР to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "СТЕНЛИ КАР в София — автомобили в наличност, внос по заявка и собствен лизинг."
      : "СТЕНЛИ КАР in Sofia — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | СТЕНЛИ КАР"
      : "About and contact | СТЕНЛИ КАР",
  });
};
