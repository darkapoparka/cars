...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на СТЕНЛИ КАР.",
          "The form is ready, but message delivery is not configured yet. Call СТЕНЛИ КАР directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на СТЕНЛИ КАР.",
          "Message delivery is not configured yet. Call СТЕНЛИ КАР directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на СТЕНЛИ КАР."
        : "Запитването е изпратено до екипа на СТЕНЛИ КАР.",
      "Your request has been sent to the СТЕНЛИ КАР team."
    ),
  };
};
