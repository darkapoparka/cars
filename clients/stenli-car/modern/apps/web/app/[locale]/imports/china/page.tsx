...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от СТЕНЛИ КАР."
      : "Start a request for a vehicle from China with delivery to Bulgaria from СТЕНЛИ КАР.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | СТЕНЛИ КАР"
      : "Import from China | СТЕНЛИ КАР",
  });
};
