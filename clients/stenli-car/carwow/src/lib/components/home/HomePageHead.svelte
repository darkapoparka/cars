<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'СТЕНЛИ КАР предлага проверени автомобили, финансиране и съдействие при покупка в София.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="СТЕНЛИ КАР София" />
	...
	<meta property="og:image:alt" content="СТЕНЛИ КАР София" />
