...
<div class="mobile-home" aria-label="СТЕНЛИ КАР — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="СТЕНЛИ КАР home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на СТЕНЛИ КАР"
				>
		...
		<h1 class="mh-hero__title">СТЕНЛИ КАР</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 СТЕНЛИ КАР София. Всички права запазени.</span>
	</footer>
