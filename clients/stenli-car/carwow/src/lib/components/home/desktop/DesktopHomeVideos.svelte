...
<section class="home-videos" aria-label="СТЕНЛИ КАР в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="СТЕНЛИ КАР в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">СТЕНЛИ КАР в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
