...
<div class="mobile-about-app" aria-label="За СТЕНЛИ КАР">
	<header class="mobile-about-hero">
		<img
			class="mobile-about-hero__bg"
			src={resolve('/assets/dealer/inventory/21669153181446436-1.webp')}
			alt=""
			aria-hidden="true"
		/>
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="СТЕНЛИ КАР начало">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>СТЕНЛИ КАР в София помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/assets/dealer/inventory/21669153181446436-1.webp')}
				alt="Консултация със СТЕНЛИ КАР"
				loading="lazy"
				decoding="async"
			/>
			<div>
