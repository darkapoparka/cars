<script lang="ts">
	...
	const facebookLinkProps = {
		href: 'https://www.facebook.com/pages/StenliCarcom/620845604605069',
		target: '_blank',
		rel: 'noopener'
	} as const;
	const instagramLinkProps = {
		href: 'https://stenlicar.com/',
		target: '_blank',
		rel: 'noopener'
	} as const;
	const mapLinkProps = {
					...
					>
						<div>
							<a
								...
								aria-label="СТЕНЛИ КАР начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								СТЕНЛИ КАР предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										aria-label="Отвори локацията на СТЕНЛИ КАР в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със СТЕНЛИ КАР."
								>
									Свържете се
								</a>
							</div>
