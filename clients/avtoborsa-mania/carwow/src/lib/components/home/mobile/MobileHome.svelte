...
<div class="mobile-home" aria-label="Мания — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Мания home">
				<img
					class="mh-hero__logo"
		...
		<h1 class="mh-hero__title">Мания</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Мания Варна. Всички права запазени.</span>
	</footer>
