...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Мания.",
          "The form is ready, but message delivery is not configured yet. Call Мания directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Мания.",
          "Message delivery is not configured yet. Call Мания directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Мания."
        : "Запитването е изпратено до екипа на Мания.",
      "Your request has been sent to the Мания team."
    ),
  };
};
