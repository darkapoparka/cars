...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Мания за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в бул. Цар Освободител, район Владислав Варненчик.",
    locationLabel: "Шоурум · бул. Цар Освободител, район Владислав Варненчик",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Мания, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · бул. Цар Освободител, район Владислав Варненчик",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Мания about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Мания to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "АВТОБОРСА МАНИЯ в Варна — автомобили в наличност, внос по заявка и възможности за финансиране след потвърждение."
      : "АВТОБОРСА МАНИЯ in Варна — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Мания"
      : "About and contact | Мания",
  });
};
