# АВТОБОРСА МАНИЯ — coordinator review
...
Once integrated and indexed in the coordinator checkout, `./scripts/start-client.ps1 -Client avtoborsa-mania -Prepare` and `./scripts/start-client.ps1 -Client avtoborsa-mania` use the repository launcher. These commands have **not** been run here.
