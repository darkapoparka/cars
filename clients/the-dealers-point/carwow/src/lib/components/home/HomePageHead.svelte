<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Dealers Point предлага проверени автомобили, финансиране и съдействие при покупка в София.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Dealers Point София" />
	...
	<meta property="og:image:alt" content="Dealers Point София" />
