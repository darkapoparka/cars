...
<section class="home-videos" aria-label="Dealers Point в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Dealers Point в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">Dealers Point в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
