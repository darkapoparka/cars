...
<div class="mobile-home" aria-label="Dealers Point — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Dealers Point home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Dealers Point"
				>
		...
		<h1 class="mh-hero__title">Dealers Point</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Dealers Point София. Всички права запазени.</span>
	</footer>
