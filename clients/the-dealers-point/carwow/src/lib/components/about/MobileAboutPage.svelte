...
<div class="mobile-about-app" aria-label="За Dealers Point">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="Dealers Point начало">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Dealers Point в София помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				...
				alt="Консултация със Dealers Point"
				loading="lazy"
				decoding="async"
			/>
			<div>
