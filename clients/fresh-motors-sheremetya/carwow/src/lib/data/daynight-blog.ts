...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Как да следите наличността на FRESH MOTORS',
		description:
		...
		tags: ['новини', 'наличност', 'Шереметя']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'FRESH MOTORS съдейства с документи, регистрация, финансиране и оглед на място в Шереметя.'
				]
			}
		],
	...
	article({
		...
		title: 'Лизинг за употребяван автомобил в Шереметя',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на FRESH MOTORS може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
					'При конкретен автомобил е най-добре параметрите да се обсъдят преди финално решение.'
				]
			}
		],
		tags: ['лизинг', 'финансиране', 'Шереметя']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'FRESH MOTORS предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на FRESH MOTORS често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез FRESH MOTORS.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'FRESH MOTORS',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'FRESH MOTORS помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
