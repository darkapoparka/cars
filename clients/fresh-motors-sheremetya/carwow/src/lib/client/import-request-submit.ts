...
export async function submitImportRequest(
	...
	if (daynightSite.previewMode) return {ok:false,status:503,error:'Демонстрационна форма: съобщението не е изпратено. Свържете се с FRESH MOTORS на 0879 975 969.'};
	try {
