...
<main id="main-content" tabindex="-1" class="desktop-services" aria-label="Услуги FRESH MOTORS">
	...
	<section class="desktop-services-offers">
		<div class="container">
			<h2 class="desktop-services-sr-only">Конкретни услуги от FRESH MOTORS</h2>
