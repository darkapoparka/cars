	...
	<section class="pb-100">
		<div class="container">
			...
			<div class="lg-grid-cols-2 md-grid-cols-1 mb-40 grid grid-cols-3 gap-x-30 gap-y-38">
				{#if daynightReviews.length === 0}<div class="testimonior-box"><p class="testimonior-box--desc">Тук няма публикувани клиентски мнения. За въпроси относно автомобил се свържете директно с FRESH MOTORS.</p><a href="/contact">Контакти</a></div>{/if}
