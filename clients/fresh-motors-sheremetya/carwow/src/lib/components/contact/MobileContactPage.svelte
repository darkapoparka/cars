	...
	const importSteps = [
		{
			...
			copy: 'Уточнете с FRESH MOTORS дали може да съдейства по избраната обява.'
		},
		{
...
<div class="mobile-contact-app">
	<header class:mobile-contact-hero--import={isImportMode} class="mobile-contact-hero">
		...
		<div class="mobile-contact-hero__copy">
			...
			<h1>
				{isImportMode ? 'Намерете автомобила. Ние ще го внесем.' : 'Свържете се със FRESH MOTORS'}
			</h1>
			<p>
				{isImportMode
