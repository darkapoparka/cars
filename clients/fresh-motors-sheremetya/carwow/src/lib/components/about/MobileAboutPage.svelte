...
<div class="mobile-about-app" aria-label="За FRESH MOTORS">
	<header class="mobile-about-hero">
		<img
			class="mobile-about-hero__bg"
			src={resolve('/dealer/stock/21785176725815752-1.webp')}
			alt=""
			aria-hidden="true"
		/>
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="FRESH MOTORS начало">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>FRESH MOTORS в Шереметя помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/dealer/stock/21785176725815752-1.webp')}
				alt="Консултация със FRESH MOTORS"
				loading="lazy"
				decoding="async"
			/>
			<div>
				<span>Шоурум в Шереметя</span>
