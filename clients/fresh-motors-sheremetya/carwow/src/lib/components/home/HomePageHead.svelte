<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'FRESH MOTORS предлага подбрани обяви, финансиране и съдействие при покупка в Шереметя.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="FRESH MOTORS Шереметя" />
	...
	<meta property="og:image:alt" content="FRESH MOTORS Шереметя" />
