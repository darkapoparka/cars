...
export const footerSocialLinks: FooterSocialLink[] = [{label:'Mobile.bg',href:daynightSite.sourceInventory,title:'Публикувани обяви на FRESH MOTORS',icon:'mobilebg',external:true}];
