<script lang="ts">
	...
	const intro =
		"Неофициална демонстрация на три дизайна за FRESH MOTORS. Не е договор, оферта или потвърждение от търговеца.";
	const usageNotice =
		"Проектът представя оформление и работа с подбрани публични обяви. Не е официално одобрен сайт на FRESH MOTORS.";
	const photosNotice =
	...
	const updatesNotice =
		"Това не са договорни условия, одобрени от FRESH MOTORS. Публично представяне и реални интеграции изискват отделно потвърждение.";
