<script lang="ts">
	...
	const guideCards = [
		...
		{
			title: 'Sell or part exchange with FRESH MOTORS',
...
<svelte:head>
	<title>FRESH MOTORS Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from FRESH MOTORS Шереметя."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="FRESH MOTORS Home2">
				<img src="/dealer/brand/logo-light.png" alt="FRESH MOTORS" />
			</a>
		...
		<h1 id="home2-title">
			...
			<span>FRESH MOTORS can help</span>
		</h1>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular FRESH MOTORS picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate FRESH MOTORS as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/dealer/stock/21785176725815752-1.webp" alt="FRESH MOTORS consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse FRESH MOTORS stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
