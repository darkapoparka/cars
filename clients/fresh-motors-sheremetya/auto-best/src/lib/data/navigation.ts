  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        ...
        { id: 'about-leasing', title: 'Съдействие за финансиране', detail: 'Обсъдете условията директно с екипа.', image: '/assets/images/lead/day-night-stock-06.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
      ...
      cta: { id: 'about-cta', label: 'Свържете се с екипа', href: '/contact', detail: 'Наличност, оглед, внос и съдействие за финансиране.' }
    }
  },
  {
    id: 'guides',
