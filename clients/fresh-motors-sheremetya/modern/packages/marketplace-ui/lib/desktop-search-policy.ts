...
const organizationSuggestions: readonly SearchSuggestionDefinition[] = [
  {
    descriptionBg: "Проверен дилър · Шереметя",
    descriptionEn: "Verified dealer · Шереметя",
    id: "sofia-premium-cars",
    keywords: "sofia premium cars dealer дилър софия bmw audi",
    kind: "dealer",
    label: "Шереметя Premium Cars",
    popular: true,
    value: "Шереметя Premium Cars",
  },
  {
    descriptionBg: "Вносител от Китай · Шереметя",
    descriptionEn: "Importer from China · Шереметя",
    id: "china-ev-import",
  ...
  {
    descriptionBg: "Дилъри и вносители в Шереметя",
    descriptionEn: "Dealers and importers in Шереметя",
