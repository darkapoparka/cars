...
const pageCopy = {
  bg: {
    badge: "Финансиране от FRESH MOTORS",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на FRESH MOTORS ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from FRESH MOTORS",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The FRESH MOTORS team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от FRESH MOTORS."
      : "A tailored vehicle financing offer from FRESH MOTORS.",
    locale,
    path: "/lease",
