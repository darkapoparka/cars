...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с FRESH MOTORS за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в обл. Велико Търново.",
    locationLabel: "Шоурум · обл. Велико Търново",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на FRESH MOTORS, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · обл. Велико Търново",
    services: [
      {
      ...
      {
        title: "Съдействие за финансиране",
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with FRESH MOTORS about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in обл. Велико Търново.",
    locationLabel: "Showroom · обл. Велико Търново",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call FRESH MOTORS to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · обл. Велико Търново",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "FRESH MOTORS, обл. Велико Търново — подбрани обяви, снимки и контакт за оглед."
      : "FRESH MOTORS, обл. Велико Търново — selected advertisements, photos and viewing contact.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | FRESH MOTORS"
      : "About and contact | FRESH MOTORS",
  });
};
