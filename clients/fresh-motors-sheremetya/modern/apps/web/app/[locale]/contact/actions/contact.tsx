...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на FRESH MOTORS.",
          "The form is ready, but message delivery is not configured yet. Call FRESH MOTORS directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на FRESH MOTORS.",
          "Message delivery is not configured yet. Call FRESH MOTORS directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на FRESH MOTORS."
        : "Запитването е изпратено до екипа на FRESH MOTORS.",
      "Your request has been sent to the FRESH MOTORS team."
    ),
  };
};
