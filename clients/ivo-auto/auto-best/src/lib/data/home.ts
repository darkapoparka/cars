...
export const editorial = [
  ...
  },
  {
    ...
    text: 'Поискайте сервизна история, документи и възможност за независим оглед преди решение.',
    image: '/assets/ivo-auto/vehicle-01-1.webp',
    href: '/blog',
    meta: 'Полезно',
    category: 'Ръководство'
  },
  {
    ...
    text: 'Попитайте продавача за конкретния автомобил и възможностите според вашите критерии.',
    image: '/assets/ivo-auto/vehicle-01-1.webp',
    href: '/blog',
    meta: 'Полезно',
    category: 'Ръководство'
