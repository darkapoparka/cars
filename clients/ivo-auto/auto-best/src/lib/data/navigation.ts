...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/assets/ivo-auto/vehicle-01-1.webp', href: '/about-us' },
        { id: 'about-import', title: 'Запитване за автомобил', detail: 'Доставка по ваши критерии.', image: '/assets/ivo-auto/vehicle-01-1.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Лизинг по запитване', detail: 'Обсъдете условията директно с екипа.', image: '/assets/ivo-auto/vehicle-01-1.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'guides-inspection', title: 'Проверка преди покупка', detail: 'История, документи и състояние.', image: '/assets/ivo-auto/vehicle-01-1.webp', href: '/blog' },
        { id: 'guides-import', title: 'Внос и документи', detail: 'Основните стъпки преди регистрация.', image: '/assets/ivo-auto/vehicle-01-1.webp', href: '/blog' },
        { id: 'guides-leasing', title: 'Лизинг и условия', detail: 'Какво да уточните преди финансиране.', image: '/assets/ivo-auto/vehicle-01-1.webp', href: '/blog' }
      ],
      groups: [
        {
          id: 'guides-library',
