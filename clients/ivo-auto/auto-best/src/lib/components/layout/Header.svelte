  ...
  >
        ...
        <div class="dn-header__inner">
          <div class="dn-logo-box">
            <a class="dn-logo" href={resolve('/')} aria-label={`${brand.name} — начало`}>
              <picture><source media="(max-width: 767px)" srcset={brand.logoLight} /><img src={brand.logo} alt={brand.name} width="220" height="58" fetchpriority="high" /></picture>
            </a>
          </div>
    ...
    {#if mobileOpen}
      ...
      >
        ...
        <div class="dn-mobile-menu__social"><a href={brand.stockUrl} target="_blank" rel="noopener noreferrer">Обяви в Mobile.bg</a></div>
