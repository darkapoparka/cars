<script lang="ts">
  ...
  const images = {
    cars: '/assets/ivo-auto/vehicle-01-1.webp',
    keys: '/assets/ivo-auto/vehicle-01-1.webp',
    guide: '/assets/ivo-auto/vehicle-01-1.webp',
    silver: '/assets/ivo-auto/vehicle-01-1.webp',
    graphite: '/assets/ivo-auto/vehicle-01-1.webp',
    portrait: '/assets/ivo-auto/vehicle-01-1.webp',
    phone: '/assets/ivo-auto/vehicle-01-1.webp',
    showroom: '/assets/ivo-auto/vehicle-01-1.webp',
    email: '/assets/ivo-auto/vehicle-01-1.webp'
  };
  const pairs = {
