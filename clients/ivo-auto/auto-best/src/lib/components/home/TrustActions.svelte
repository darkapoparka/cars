  ...
  const actions = [
    {
      ...
      artwork: { src: '/assets/ivo-auto/vehicle-01-1.webp', width: 1200, height: 668, bounds: [21, 122, 1172, 552], view: 'front-pair' },
      vehicle: 'urus',
      tone: 'black',
    ...
    },
    {
      ...
      artwork: { src: '/assets/ivo-auto/vehicle-01-1.webp', width: 1200, height: 675, bounds: [21, 79, 1180, 583], view: 'three-quarter' },
      vehicle: 'gclass',
      tone: 'red',
    ...
    },
    {
      ...
      vehicle: 'gclass',
      tone: 'red',
      mobileTitle: 'Запитване за автомобил',
    ...
    },
    {
      ...
      vehicle: 'urus',
      tone: 'black',
      mobileTitle: 'Лизинг по запитване',
