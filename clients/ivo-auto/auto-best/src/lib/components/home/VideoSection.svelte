  ...
  <div class="container">
    <div class="dn-videos__panel">
      <div class="dn-videos__heading dn-home-section-heading">
        <h2 id="videos-title" class="dn-home-section-title">Още за автомобилите</h2>
        <p>Снимки и подробности от публикуваните обяви на Иво Ауто.</p>
          ...
          <article class="dn-video-card">
            <div class="dn-video-card__media">
              <button
                ...
                aria-label={`Отворете обявата: ${video.title}`}
            ...
            <div class="dn-video-card__content">
              ...
              <div class="dn-video-card__actions">
                <a href={video.url} target="_blank" rel="noopener noreferrer" aria-label={`${video.title} — гледайте в Mobile.bg (нов раздел)`}>
