...
const collectionCopy = {
  bg: {
    ...
    truth:
      "Иво Ауто не твърди официално партньорство с показаните марки. Всяка оферта се потвърждава индивидуално.",
  },
  en: {
    ...
    truth:
      "Иво Ауто does not claim an official partnership with the displayed brands. Every offer is confirmed individually.",
  },
} as const;
