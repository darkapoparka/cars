...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Иво Ауто.",
          "The form is ready, but message delivery is not configured yet. Call Иво Ауто directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Иво Ауто.",
          "Message delivery is not configured yet. Call Иво Ауто directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Иво Ауто."
        : "Запитването е изпратено до екипа на Иво Ауто.",
      "Your request has been sent to the Иво Ауто team."
    ),
  };
};
