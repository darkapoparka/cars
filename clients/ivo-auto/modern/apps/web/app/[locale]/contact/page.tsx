...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Иво Ауто за следващия си автомобил.",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Иво Ауто, за да уточним оглед и конкретна оферта.",
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Иво Ауто about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Иво Ауто to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Иво Ауто във Варна — автомобили в наличност, внос по заявка и лизинг по запитване."
      : "Иво Ауто in Varna — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Иво Ауто"
      : "About and contact | Иво Ауто",
  });
};
        ...
        <section className="relative isolate hidden overflow-hidden border-white/10 border-b lg:block">
          <div className="absolute inset-0 -z-20 bg-[#08090a]">
            <Image
              ...
              priority
              sizes="100vw"
              src="/assets/ivo-auto/vehicle-01-1.webp"
            />
          </div>
          <div
            aria-hidden="true"
