...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Иво Ауто."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Иво Ауто.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Иво Ауто"
      : "Import from China | Иво Ауто",
  });
};
