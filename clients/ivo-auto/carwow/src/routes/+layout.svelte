<script lang="ts">
	...
	const dealerJsonLd = $derived(
		JSON.stringify({
			...
			image: `${origin}/assets/ivo-auto/wordmark.svg`,
			logo: `${origin}/assets/ivo-auto/wordmark.svg`,
			url: `${origin}/`,
			telephone: '0878720035',
			...(daynightSite.email ? { email: daynightSite.email } : {}),
			address: {
				'@type': 'PostalAddress',
				streetAddress: 'гр. Варна, Владислав Варненчик, бул. „Цар Освободител“ 256',
