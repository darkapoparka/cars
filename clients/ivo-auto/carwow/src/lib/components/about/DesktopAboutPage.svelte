<script lang="ts">
	...
	const support = [
		...
		{ title: 'Документи и финансиране', icon: FileCheck2, description: 'Попитайте за документите и условията за избрания автомобил.', href: '/services', action: 'Разгледай услугите' }
	] as const;

	const teamLabels = ['Продажби', 'Бартер и оценка', 'Документи и финансиране', 'Клиентски заявки'];
	const demoNames = ['Контакт за автомобили', 'Въпроси за бартер', 'Въпроси за условия', 'Уговорете оглед'];
	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				alt="Илюстративна визия на Иво Ауто: Mercedes-Benz и Lamborghini с ключове за бартер"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					Иво Ауто е автокъща във Варна. При нас можеш да разгледаш наличните автомобили, да
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до Иво Ауто Варна" height="280" />
				{:else}
