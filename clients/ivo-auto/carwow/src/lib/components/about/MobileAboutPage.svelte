...
<div class="mobile-about-app" aria-label="За Иво Ауто">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Иво Ауто във Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
