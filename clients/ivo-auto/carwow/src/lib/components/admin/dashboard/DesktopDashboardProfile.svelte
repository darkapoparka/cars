<script lang="ts">
	...
	const locationText = 'Варна, Варна, гр. Варна, Владислав Варненчик, бул. „Цар Освободител“ 256';
	...
	const mapSrc =
		`https://www.google.com/maps?q=${encodeURIComponent(daynightSite.location)}&output=embed`;
</script>
