...
<section class="home-videos" aria-label="Обяви на Иво Ауто">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Обяви на Иво Ауто" href={youtubeChannelUrl} label="Всички обяви">
			{#snippet titleContent()}
				<span class="home-videos__title">Снимки и подробности</span>
			{/snippet}
