<script lang="ts">
	...
	const reviews: Review[] = [
  {
    ...
    "name": "Публикувани автомобили",
    "meta": "Mobile.bg"
  },
  {
    "id": "contact",
    "description": "бул. „Цар Освободител“ 256, Варна",
    "avatar": "/assets/ivo-auto/wordmark.svg",
    "name": "Посещение",
    "meta": "Свържете се за работно време и оглед."
  },
  {
    "id": "terms",
    "description": "Бартер и лизинг са посочени в обявите. Конкретните условия се уточняват по телефона.",
    "avatar": "/assets/ivo-auto/wordmark.svg",
    "name": "Условия",
    "meta": "0878 720 035"
  }
	...
	const actionCards: ActionCard[] = [
		...
		},
		{
			...
			bullets: [
				...
				'Получете обратна връзка от екипа на Иво Ауто.',
