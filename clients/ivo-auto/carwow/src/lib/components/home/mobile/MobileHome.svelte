...
<div class="mobile-home" aria-label="Иво Ауто — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Иво Ауто home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/ivo-auto/wordmark-light.svg')}
			...
			<div class="mh-hero__bar-actions">
				<button
					...
					type="button"
					aria-label="Локация: Цар Освободител 256, Варна"
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Иво Ауто"
				>
		...
		<h1 class="mh-hero__title">Иво Ауто</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Иво Ауто Варна. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, Владислав Варненчик, бул. „Цар Освободител“ 256</strong>
			</div>
