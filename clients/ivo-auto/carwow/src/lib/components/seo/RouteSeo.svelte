<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Иво Ауто предлага публикувани автомобили, финансиране и съдействие при покупка във Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Иво Ауто Варна" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Иво Ауто Варна" />
	{/if}
