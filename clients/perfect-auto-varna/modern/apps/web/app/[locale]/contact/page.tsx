...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Перфект Ауто за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Победа.",
    locationLabel: "Шоурум · Победа",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Перфект Ауто, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Победа",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Перфект Ауто about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Перфект Ауто to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Перфект Ауто в Варна — автомобили в наличност, внос по заявка и лизинг чрез партньори."
      : "Перфект Ауто in Sofia — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Перфект Ауто"
      : "About and contact | Перфект Ауто",
  });
};
          ...
          >
            ...
            >
              <Image
                ...
                src="/variant-2/images/sell/day-night-sell-centered-hero-v2.webp"
              />
              <div
                aria-hidden="true"
