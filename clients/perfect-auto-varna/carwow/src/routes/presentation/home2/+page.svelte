...
<svelte:head>
	<title>Перфект Ауто Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from Перфект Ауто Варна."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="Перфект Ауто Home2">
				<img src="/variant-3/brand/daynight-logo-generated.png" alt="Перфект Ауто" />
			</a>
		...
		<h1 id="home2-title">
			...
			<span>Перфект Ауто can help</span>
		</h1>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular Перфект Ауто picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate Перфект Ауто as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/variant-3/brand/daynight-team-placeholder.svg" alt="Перфект Ауто consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse Перфект Ауто stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
