...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Как да следите наличността на Перфект Ауто',
		description:
		...
		date: '2026-05-28',
		author: 'Перфект Ауто',
		image: '/variant-3/assets/images/blog/post-44.jpg',
		readMinutes: 3,
		summary: [
	...
	article({
		...
		date: '2026-05-26',
		author: 'Перфект Ауто',
		image: '/variant-3/assets/images/blog/post-18.jpg',
		readMinutes: 5,
		summary: [
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Перфект Ауто съдейства с документи, регистрация, финансиране и оглед на място в Варна.'
				]
			}
		],
	...
	article({
		...
		date: '2026-05-25',
		author: 'Перфект Ауто',
		image: '/variant-3/assets/images/blog/post-21.jpg',
		readMinutes: 4,
		summary: [
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на Перфект Ауто може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
	...
	article({
		...
		date: '2026-05-24',
		author: 'Перфект Ауто',
		image: '/variant-3/assets/images/blog/post-24.jpg',
		readMinutes: 4,
		summary: [
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Перфект Ауто предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на Перфект Ауто често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез Перфект Ауто.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'Перфект Ауто',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Перфект Ауто помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
