	...
	<section class="background-light mb-32">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb__icon" aria-hidden="true"><ChevronRight size={14} /></li>
				<li><span>Профил на Перфект Ауто</span></li>
			</ul>
		</div>
	</section>
		...
		<div class="container">
			<div class="dealer-profile-hero__grid">
				<div class="dealer-profile-hero__content">
					...
					<ul class="dealer-profile-hero__highlights">
						{#each highlights as highlight (highlight)}
							<li>
								<img src="/variant-3/assets/icons/check.svg" alt="" aria-hidden="true" />
								{highlight}
							</li>
						{/each}
					</ul>
				...
				<div class="dealer-profile-card">
					<img class="dealer-profile-card__logo" src="/variant-3/brand/daynight-logo-generated.png" alt="" />
					<p class="dealer-profile-card__title mb-6">Перфект Ауто</p>
	...
	<section class="py-80">
		<div class="container">
			<div class="dealer-about-grid">
				...
				<LazyMapEmbed src={mapEmbedSrc} title="Карта до Перфект Ауто Варна" height="330" />
			</div>
		</div>
	</section>
