<script lang="ts">
	...
	function teamThumb(path: string): `/variant-3/assets/${string}` {
		return path.replace('-v1.webp', '-v1-thumb.webp') as `/variant-3/assets/${string}`;
	}
...
<div class="mobile-about-app" aria-label="За Перфект Ауто">
	<header class="mobile-about-hero">
		<img
			class="mobile-about-hero__bg"
			src={resolve('/variant-3/assets/images/pages/daynight-about-lot-v1.webp')}
			alt=""
			aria-hidden="true"
		/>
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="Перфект Ауто начало">
				<img src={resolve('/variant-3/brand/daynight-logo-generated.png')} alt={daynightSite.shortName} />
			</a>
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Перфект Ауто в Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/variant-3/assets/images/pages/daynight-about-consultation-v1.webp')}
				alt="Консултация със Перфект Ауто"
				loading="lazy"
				decoding="async"
			/>
			<div>
