	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				src={resolve('/variant-3/assets/images/services/service-card-trade-in-daynight-v2.webp')}
				alt="Илюстративна визия на Перфект Ауто: Mercedes-Benz и Lamborghini с ключове за бартер"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					Перфект Ауто е автокъща в Варна. При нас можеш да разгледаш наличните автомобили, да
					уговориш оглед и да обсъдиш продажба или бартер на твоя автомобил.
				</p>
				<p>
					Разгледай автомобилите онлайн или ни посети в Победа. Екипът ще уточни
			...
			<div class="about-brands">
				{#each brands as brand (brand.brand)}
					<a href={resolve(`/inventory?brand=${encodeURIComponent(brand.brand)}`)}>
						<img src={resolve(`/variant-3/assets/images/brand/mobile/${brand.image}.svg`)} alt="" width="36" height="28" loading="lazy" />
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до Перфект Ауто Варна" height="280" />
				{:else}
					<button class="about-map-preview" onclick={() => (mapVisible = true)}>
						<MapPin size={36} aria-hidden="true" />
						<strong>Победа, Варна</strong>
