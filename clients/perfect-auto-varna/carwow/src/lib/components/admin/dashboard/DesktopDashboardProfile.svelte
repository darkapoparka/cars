	...
	const uploadFields: UploadField[] = [
		{
			...
			image: '/variant-3/assets/images/avatar/avatar-10.jpg',
		...
		},
		{
			...
			image: '/variant-3/assets/images/avatar/avatar-11.jpg',
		...
		[
			{
				id: 'Facebook',
				name: 'Facebook',
				icon: '/variant-3/assets/icons/input-facebook.svg',
				value: 'http://www.facebook.com/avitex'
			},
			{ id: 'skype', name: 'skype', icon: '/variant-3/assets/icons/input-skype.svg', value: '' },
			{ id: 'xUrl', name: 'xUrl', icon: '/variant-3/assets/icons/input-x.svg', value: '' }
		],
		[
			{ id: 'telegram', name: 'telegram', icon: '/variant-3/assets/icons/input-telegram.svg', value: '' },
			{ id: 'instagram', name: 'instagram', icon: '/variant-3/assets/icons/input-instagram.svg', value: '' },
			{ id: 'youtube', name: 'youtube', icon: '/variant-3/assets/icons/input-youtube.svg', value: '' }
		]
	];

	const locationText = 'Варна, Варна, гр. Варна, бул. Цар Освободител 110, кв. Победа';
...
{#snippet clearButton(target: string)}
	<button type="button" class="input-clear-btn" data-target={target}>
		<img
			src={resolve('/variant-3/assets/icons/clear.svg')}
			alt="Clear"
			data-daynight-img="1"
			decoding="async"
			loading="eager"
