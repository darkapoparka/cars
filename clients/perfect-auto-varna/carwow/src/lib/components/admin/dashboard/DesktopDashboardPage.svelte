	...
	const dashboardMenuItems = $derived.by((): DashboardMenuItem[] => [
		{
			id: 'profile',
			href: '/dashboard',
			icon: '/variant-3/assets/images/dashboard/Dashboard.svg',
		...
		},
		{
			...
			icon: '/variant-3/assets/images/dashboard/MyListing.svg',
		...
		},
		{
			...
			icon: '/variant-3/assets/images/dashboard/AddListing.svg',
		...
		},
		{
			...
			icon: '/variant-3/assets/images/dashboard/MyFavorites.svg',
		...
		},
		{
			...
			icon: '/variant-3/assets/images/dashboard/MyReviews.svg',
		...
		},
		{
			...
			icon: '/variant-3/assets/images/dashboard/Messages.svg',
		...
		},
		{
			...
			icon: '/variant-3/assets/images/dashboard/MyProfile.svg',
		...
		},
		{
			...
			icon: '/variant-3/assets/images/dashboard/ChangePassword.svg',
		...
		},
		{
			id: 'logout',
			href: '/',
			icon: '/variant-3/assets/images/dashboard/Logout.svg',
			label: 'Изход'
		}
	]);
</script>
...
<div class="dashboard-container">
	<div class="dashboard-sidebar">
		...
		<p class="dashboard-bottom text-muted text-center text-sm" style="margin-top: auto;">
			©2026 <a class="text-sm text-white" href={resolve('/')} target="_blank">Перфект Ауто</a>. All
			Rights Reserved.
		</p>
	</div>
				...
				<div class="header-inner daynight-dashboard-header__inner" id="site-header-inner">
					...
					<div class="daynight-dashboard-header__actions">
						...
						<a class="daynight-dashboard-header__user" href={resolve('/dashboard/profile')}>
							<img
								class="avatar"
								src={resolve('/variant-3/assets/images/dashboard/dashbroard_avatar.png')}
								alt=""
								data-daynight-img="1"
								decoding="async"
								loading="eager"
