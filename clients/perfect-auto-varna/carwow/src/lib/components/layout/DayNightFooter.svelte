					...
					>
						<div>
							<a
								...
								aria-label="Перфект Ауто начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								Перфект Ауто предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										aria-label="Отвори локацията на Перфект Ауто в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със Перфект Ауто."
								>
									Свържете се
								</a>
							</div>
