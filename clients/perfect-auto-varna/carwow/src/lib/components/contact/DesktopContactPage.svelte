<script lang="ts">
	...
	const contactBannerSrc: AssetHref =
		'/variant-3/assets/daynight-auto-v3/class-b-banners/webp/contact-showroom-entrance-banner-1x-2400x1100.webp';
					...
					<div class="contact-page-info">
						<div class="daynight-contact-info-body">
							<h2 class="daynight-contact-title h3">
								{isImportMode ? 'Заявка за внос на автомобил' : 'Свържете се със Перфект Ауто'}
							</h2>
		...
		<section class="daynight-contact-map bg-white">
			<div class="mx-auto w-full max-w-1920">
				<div class="widget-gg-map radius-8 daynight-contact-map__frame flex overflow-hidden">
					...
					></iframe>
					<div class="daynight-contact-map__overlay" aria-label="Локация Перфект Ауто">
						<p class="daynight-contact-map__eyebrow">Перфект Ауто</p>
...
<style>
	...
	.daynight-contact-map__frame {
		...
		background-image:
			...
			url('/variant-3/assets/daynight-auto-v3/class-b-banners/webp/contact-showroom-entrance-banner-1x-2400x1100.webp');
