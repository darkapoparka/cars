...
<div class="mobile-home" aria-label="Перфект Ауто — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Перфект Ауто home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Перфект Ауто"
				>
		...
		<h1 class="mh-hero__title">Перфект Ауто</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Перфект Ауто Варна. Всички права запазени.</span>
	</footer>
