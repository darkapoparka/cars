...
<section class="home-videos" aria-label="Перфект Ауто в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Перфект Ауто в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">Перфект Ауто в <img src="/variant-3/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
