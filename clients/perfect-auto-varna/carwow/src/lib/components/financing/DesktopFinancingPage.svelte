<script lang="ts">
	...
	const steps: Step[] = [
		...
		},
		{
			...
			copy: 'Изберете автомобил от наличността, уточнете условията с екипа и запазете оглед в Варна.',
			href: '/inventory'
		}
	];
	...
	const blogCards: BlogCard[] = [
		...
		{
			image: '/variant-3/assets/images/blog/post-23.jpg',
			href: '/sell-your-car',
			category: 'ПОЛЕЗНО',
						...
						<ul class="benefit-list mb-40">
							{#each benefits as benefit (benefit.title)}
								<li class="benefit-item">
									<img class="benefit-check" src={asset('/variant-3/assets/icons/check.svg')} alt="" />
									<div>
