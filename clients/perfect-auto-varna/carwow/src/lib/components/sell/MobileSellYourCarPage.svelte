...
<div class="mobile-sell">
	<header class="ms-hero">
		<img
			class="ms-hero__bg"
			src={resolve('/variant-3/assets/images/sell/trade-in-promo-v1.webp')}
			alt=""
			aria-hidden="true"
		/>
		<MobileHeroBar />
			...
			<div class="ms-sheet__surface">
				<header class="ms-info-hero">
					<img
						src={resolve(
							activeInfo === 'process'
								? '/variant-3/assets/images/sell/process-disclosure-list-v1.webp'
								: '/variant-3/assets/images/sell/kristian-trust-disclosure-list-v1.webp'
						)}
						alt=""
						aria-hidden="true"
					/>
