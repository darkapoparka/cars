...
function renderFooterSocialLinks() {
	...
	const links: readonly PresentationIconLink[] = [
		...
		},
		{
			...
			title: 'Отвори локацията на Перфект Ауто в Google Maps',
			kind: 'external',
...
<form class="form-footer relative" action="/variant-3/contact" method="get">
...
<p class="text-sm text-muted mb-16">Перфект Ауто предлага актуална дигитална витрина с наличност, запитвания и ясни следващи стъпки.</p>
${renderFooterSocialLinks()}
</div>
<div>
<p class="text-sm text-white font-weight-600 mb-8">Имате въпрос?</p>
<div class="flex items-center gap-12">
<a href="/variant-3/contact" class="btn btn-line-1 btn-small" title="Свържете се със Перфект Ауто">Свържете се</a>
</div>
</div>
</div>
</div>
...
<p class="text-sm text-muted">©2026 <a class="text-sm text-white" href="/variant-3/">Перфект Ауто</a>. Всички права запазени.</p>
<ul class="footer-bottom-links">
<li><a href="/variant-3/terms">Условия за ползване</a></li>
<li><a href="/variant-3/terms">Поверителност</a></li>
<li><a href="/variant-3/terms">Бисквитки</a></li>
</ul>
</div>
</div>
</div>
...
<a href="tel:${daynightSite.phone}" class="icon" aria-label="Обади се на Перфект Ауто">${phoneIcon()}</a>
...
<a href="${daynightSite.mapUrl}" class="icon" target="_blank" rel="noopener" aria-label="Отвори карта до Перфект Ауто">${locationIcon()}</a>
<div class="daynight-header-contact__body">
...
<a class="daynight-map-preview" href="${daynightSite.mapUrl}" target="_blank" rel="noopener" aria-label="Отвори Google карта до Перфект Ауто">
...
<form class="search-modal__form daynight-header-search-form" action="/variant-3/inventory" method="get" role="search">
...
<a class="daynight-mega__footer-button" href="/variant-3/inventory">Виж всички автомобили</a>
...
<a href="/variant-3/" class="daynight-header-logo" aria-label="${daynightSite.shortName}">
...
export function renderStickyHeaderLogo(logoSrc = daynightSite.logoLight) {
	return `<a href="/variant-3/" class="daynight-sticky-logo" aria-label="${daynightSite.shortName}">
...
<a href="/variant-3/admin/login" class="${accountClass}">
${accountIcon()}
Екип вход
</a>
<a href="/variant-3/sell-your-car/request" class="btn btn-primary btn-large font-weight-600">
${plusCircleIcon()}
...
<a href="/variant-3/compare" class="header-action-btn header-action-icon" aria-label="Сравни">
${compareIcon()}
</a>
<a href="/variant-3/favorites" class="header-action-btn header-action-icon" aria-label="Запазени автомобили" data-badge="2">
${heartIcon()}
</a>
