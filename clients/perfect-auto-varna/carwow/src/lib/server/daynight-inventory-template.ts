...
function renderViewDetailsLink(route: string) {
	return `<a href="${route}" class="view-details">Виж детайли<img class="ml-4" src="/variant-3/assets/icons/CaretCircleRight.svg" alt="" aria-hidden="true"></a>`;
}
...
<li><img src="/variant-3/assets/icons/icon-gauge.svg" alt="" aria-hidden="true"><span>${escapeHtml(vehicle.mileage)}</span></li>
<li><img src="/variant-3/assets/icons/calendar.svg" alt="" aria-hidden="true"><span>${vehicle.year}</span></li>
<li><img src="/variant-3/assets/icons/gaspump.svg" alt="" aria-hidden="true"><span>${escapeHtml(vehicle.fuel)}</span></li>
</ul>`;
}

function renderCompareLink() {
	return `<a href="/variant-3/compare" class="compare-details btn btn-small" title="Сравни автомобили">${renderCompareIcon()}Сравни</a>`;
}
...
${renderCompareLink()}
<a href="${route}" class="view-details">Виж детайли<img class="ml-4" src="/variant-3/assets/icons/CaretCircleRight.svg" alt="" aria-hidden="true"></a>
</div>
</div>
</div>`;
}
...
<button class="daynight-inventory-searchbar__submit flex items-center gap-8 justify-center" type="submit"><img src="/variant-3/assets/icons/search.svg" alt="" aria-hidden="true"><span>Търси</span></button>
</div>
<div class="daynight-inventory-filter-group daynight-inventory-filterbar">
<button class="daynight-inventory-filter-toggle daynight-inventory-quick-sidebar" type="button" data-daynight-open-sidebar aria-label="Филтри"><img src="/variant-3/assets/icons/filter.svg" alt="" aria-hidden="true"></button>
