...
function replaceCommonCopy(html: string) {
	...
	return replaceHeaderSearch(
		replaceHeaderTopBarControls(
			replaceHeaderContact(
				html
					.replaceAll('/variant-3/assets/images/logo-white.png', daynightSite.logoLight)
					.replaceAll('/variant-3/assets/images/logo.png', primaryLogo)
					...
					.replaceAll('Dealer Listing', 'Профил на Перфект Ауто Варна')
					.replaceAll(
						'Mike Hanley (@mike_hanley) is a writer who draws. He’s the Bestselling author of “Number of The Year”.',
						'Перфект Ауто публикува практични съвети за покупка, оглед, документи, финансиране и последващи стъпки.'
					)
					.replaceAll('Mike Hanley', 'Перфект Ауто')
					.replaceAll('@mike_hanley', '@daynightauto')
					.replaceAll('Michael Carter', 'Клиент на Перфект Ауто')
					.replaceAll('Sophia Carter', 'Клиент от Варна')
					.replaceAll('Contact', 'Контакти')
					.replaceAll('About', 'За нас')
					.replaceAll('News', 'Полезно')
					.replaceAll('Контакти Us', 'Контакти')
					.replaceAll('Heather Dick', 'Клиент на Перфект Ауто')
					.replaceAll(
					...
					.replace(
						...
						(match) =>
							match
								.replace('href="#"', 'href="/variant-3/admin/login"')
...
const daynightPageAssets = {
	aboutExterior: '/variant-3/assets/images/pages/daynight-about-lot-v1.webp',
	aboutConsultation: '/variant-3/assets/images/pages/daynight-about-consultation-v1.webp',
	aboutShowroomVehicle: '/variant-3/assets/images/pages/daynight-about-showroom-suv-v1.webp',
	servicesInspection: '/variant-3/assets/images/pages/daynight-services-inspection-v1.webp',
	servicesConsultation: '/variant-3/assets/images/pages/daynight-services-consultation-v1.webp',
	dealerProfileMark: '/variant-3/brand/daynight-logo-generated.png'
} as const;
...
> = {
	'about-us.html': {
		modifier: 'about',
		title: 'За Перфект Ауто',
		description:
			'Проверени автомобили, ясна история и съдействие от избора до документите в Варна.',
...
function buildDayNightMapIframe(height: string, loading: 'lazy' | 'eager' = 'lazy') {
	...
	return `<iframe title="Карта до Перфект Ауто Варна" data-map-src="${daynightMapEmbedSrc}" data-daynight-scroll-map height="${height}" style="border:0;width: 100%;" allowfullscreen="" loading="${loading}" referrerpolicy="no-referrer-when-downgrade"></iframe>`;
}
...
function renderTeamContactActions(member: (typeof daynightTeam)[number]) {
	...
	return `<ul class="contact">
								...
								<li>
									<a href="mailto:${member.email}" title="Имейл към Перфект Ауто" aria-label="Имейл към Перфект Ауто">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
function renderContactPageSocialLinks() {
	return `<ul class="contact-page-info-social flex gap-8">
							...
							<li>
								<a href="tel:${daynightSite.phone}" class="hover-stroke-white" title="Свържете се с Перфект Ауто по телефон или Viber." aria-label="Свържете се с Перфект Ауто по телефон или Viber.">
									<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
							...
							<li>
								<a href="${daynightSite.mapUrl}" target="_blank" rel="noopener" class="hover-stroke-white" title="Отвори локацията на Перфект Ауто в Google Maps" aria-label="Отвори локацията на Перфект Ауто в Google Maps">
									<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
		...
		<section class="tf-spacing-8 pt-0">
			<div class="container">
				<div class="title-section flex align-end justify-between mb-30">
					...
					<a href="/variant-3/inventory" class="btn btn-line btn-large hover-fill-white effect-line-primary">
						Виж наличните
	...
	return `<header class="header bg-white daynight-dashboard-header" id="header_main">
					<div class="header-container-fluid relative">
						<div class="header-inner daynight-dashboard-header__inner" id="site-header-inner">
							<a class="daynight-dashboard-header__brand daynight-header-logo" href="/variant-3/" aria-label="${escapeHtml(daynightSite.name)}">
							...
							<div class="daynight-dashboard-header__actions">
								<a class="daynight-dashboard-header__ghost" href="/variant-3/inventory">Налични автомобили</a>
								<a class="daynight-dashboard-header__user" href="/variant-3/admin/settings">
									<img class="avatar" src="/variant-3/assets/images/dashboard/dashbroard_avatar.png" alt="">
									<span>Клиентски профил</span>
								</a>
								<a class="daynight-dashboard-header__cta" href="/variant-3/admin/listings/new">
...
function restoreTemplateAssetPaths(html: string) {
	return html
		.replaceAll(
			'/variant-3/assets/images/dashboard/Моят профил.svg',
			'/variant-3/assets/images/dashboard/Dashboard.svg'
		)
		.replaceAll(
			'/variant-3/assets/images/dashboard/MyАвтомобили.svg',
			'/variant-3/assets/images/dashboard/MyListing.svg'
		)
		.replaceAll(
			'/variant-3/assets/images/dashboard/AddАвтомобили.svg',
			'/variant-3/assets/images/dashboard/AddListing.svg'
		)
		.replaceAll(
			'/variant-3/assets/images/dashboard/MyМоите отзиви.svg',
			'/variant-3/assets/images/dashboard/MyReviews.svg'
		)
		.replaceAll('/variant-3/assets/images/dashboard/Запитвания.svg', '/variant-3/assets/images/dashboard/Messages.svg')
		.replaceAll('/variant-3/assets/images/dashboard/Съобщения.svg', '/variant-3/assets/images/dashboard/Messages.svg')
		.replaceAll('/variant-3/assets/images/dashboard/Изход.svg', '/variant-3/assets/images/dashboard/Logout.svg')
		.replaceAll('/variant-3/assets/icons/X-Бял.svg', '/variant-3/assets/icons/X-White.svg')
		.replaceAll(
			'/variant-3/assets/images/dashboard/Сигурност на профила.svg',
			'/variant-3/assets/images/dashboard/ChangePassword.svg'
		);
}
...
function replaceSharedVehicleSnippets(html: string) {
	...
	return (
		html
			...
			.replaceAll('/variant-3/assets/images/card/card-1.jpg', first.image)
			.replaceAll('/variant-3/assets/images/card/card-2.png', second.image)
			.replaceAll('/variant-3/assets/images/card/card-3.png', third.image)
			.replaceAll('/variant-3/assets/images/card/card-4.jpg', fourth.image)
			.replaceAll('/variant-3/assets/images/card/card-5.jpg', fifth.image)
...
function replaceMapModeEmbed(html: string, templateFile: string) {
	...
	const mapEmbed = `<div id="map" data-map-zoom="16" data-map-scroll="true"><iframe title="Карта до Перфект Ауто Варна" data-map-src="${daynightMapEmbedSrc}" data-daynight-scroll-map width="100%" height="100%" style="border:0;display:block;" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>`;
	...
	return `<tr>
							<td>
								<div class="flex items-center gap-8">
									<img src="/variant-3/assets/icons/${icon}.svg" alt="" aria-hidden="true">
...
function renderReviewStars() {
	return Array.from(
		{ length: 5 },
		() => '<img src="/variant-3/assets/icons/star-6.svg" alt="" aria-hidden="true">'
	).join('');
}
...
function renderSupportReviewsSection() {
	...
	<div class="container">
		<div class="title-section mb-30">
			...
			<a href="/variant-3/reviews" class="btn btn-line-style-2 effect-line-primary hover-fill-white btn-large">Виж всички</a>
		</div>
	...
	<div class="container">
		<div class="daynight-about-location">
			<div class="daynight-about-location__content">
				<p class="eyebrow">Шоурум в Варна</p>
				<h2>Автомобили с ясна история и подреден процес</h2>
				<p class="text-secondary h7 line-height-28">Перфект Ауто предлага внимателно подбрани автомобили с реална наличност, съдействие при оглед, документи, регистрация, финансиране и бартер.</p>
				<ul class="daynight-about-location__list">
					<li><img src="/variant-3/assets/icons/check.svg" alt="" aria-hidden="true">Огледи на място и в доверен сервиз</li>
					<li><img src="/variant-3/assets/icons/check.svg" alt="" aria-hidden="true">Съдействие за документи, регистрация и финансиране</li>
					<li><img src="/variant-3/assets/icons/check.svg" alt="" aria-hidden="true">Бартер, оценка и търсене по задание</li>
				</ul>
				<div class="daynight-about-location__actions">
					<a href="/variant-3/inventory" class="btn btn-primary btn-large font-weight-600">Виж автомобили</a>
			...
			<div class="daynight-about-location__visual">
				<div class="daynight-about-location__images">
					<img src="${daynightPageAssets.aboutShowroomVehicle}" alt="Шоурум на Перфект Ауто">
					<img src="${daynightPageAssets.aboutConsultation}" alt="Консултация със Перфект Ауто">
				</div>
...
function polishServicesPageStructure(html: string) {
	...
	output = replaceSectionByMarker(output, 'Изберете автомобил с подкрепа от Перфект Ауто', '');
...
function replacePdpCopy(html: string, routePath: string) {
	...
	let output = html
		...
		.replaceAll('Mike Hanley', salesTeam?.name ?? 'Перфект Ауто')
		.replaceAll('Verified Dealer', 'Проверена автокъща')
		.replaceAll('/variant-3/assets/images/pages/sale-agent-9.jpg', salesTeam?.image ?? daynightSite.logoDark)
		...
		.replaceAll(
			'/variant-3/assets/images/inner-page/slide-listing-details-5.jpg',
			vehicle.gallery[0] ?? vehicle.image
		)
		.replaceAll(
			'/variant-3/assets/images/inner-page/slide-listing-details-6.jpg',
			vehicle.gallery[1] ?? vehicle.image
		)
		.replaceAll(
			'/variant-3/assets/images/inner-page/slide-listing-details-7.jpg',
...
function renderBlogSidebarSearch() {
	return `<form action="/variant-3/blog" class="widget-search w-full mb-34" data-daynight-blog-search-form>
...
function renderBlogStandardContent(articles: DayNightArticle[]) {
	...
	if (!featured) {
		return `<p class="h5 text-secondary mb-40">Очаквайте публикации от Перфект Ауто.</p>`;
	}
...
function renderBlogDetailSocialList(article: DayNightArticle) {
	...
	const shareUrl = encodeURIComponent(`https://perfektauto.mobile.bg${blogArticleRoute(article)}`);
...
function renderBlogDetailAuthorBox() {
	...
	<div class="listing-details--contact-dealer mb-20">
		...
		<div class="content">
			<a href="/variant-3/about/daynight-auto-plovdiv" class="h4 mb-4 font-weight-600">Перфект Ауто</a>
			<p class="text-secondary mb-18">Автокъща в Варна</p>
			<ul class="blog-detail-social flex gap-12">
				...
				<li><a href="mailto:${daynightSite.email}" aria-label="Имейл към Перфект Ауто">${renderBlogSocialIcon('mail')}</a></li>
			</ul>
		</div>
	</div>
	<p class="h7 line-height-28">Перфект Ауто публикува практични съвети и новини за наличност, покупка, оглед, документи, регистрация и финансиране на употребявани автомобили в Варна.</p>
</div>`;
}
	...
	const comments = [
		{
			...
			avatar: '/variant-3/assets/images/blog/comments-post-1.jpg',
			inner: false
		},
		{
			...
			avatar: '/variant-3/assets/images/blog/comments-post-2.jpg',
			inner: true
		},
		{
			name: 'Перфект Ауто',
...
<div class="flex flex-col gap-24 mb-42">
	${comments
		.map(
			(
				comment
			) => `<a href="/variant-3/contact" class="comments-post${comment.inner ? ' comments-post--inner' : ''}">
		<div class="avatar">
...
function renderBlogDetailCommentForm() {
	return `<form action="/variant-3/contact?intent=blog-comment" class="blog-detail-comment-form">
		...
		<div class="quote mb-28">
			<div class="content">
				...
				<p class="h7 flex items-center gap-8">
					<img src="/variant-3/assets/icons/line.svg" alt="quote">
					Перфект Ауто
				</p>
			</div>
			<img class="icon-quote" src="/variant-3/assets/icons/quote.svg" alt="quote">
		</div>
...
function replaceBlogDetailCopy(
	...
	let output = html
		...
		.replaceAll('/variant-3/assets/images/blog/blog-details.jpg', article.image)
		.replaceAll('/variant-3/assets/images/blog/blog-details-2.jpg', article.image)
		.replaceAll('/variant-3/assets/images/blog/post-40.jpg', article.image)
		.replaceAll('/variant-3/assets/images/blog/post-43.jpg', article.image)
		.replaceAll('/variant-3/assets/images/blog/post-41.jpg', secondaryArticle.image)
		.replaceAll('/variant-3/assets/images/blog/post-42.jpg', tertiaryArticle.image)
		.replaceAll('/variant-3/assets/images/blog/post-4.jpg', secondaryArticle.image)
		.replaceAll('/variant-3/assets/images/blog/post-5.jpg', tertiaryArticle.image)
		.replaceAll('/variant-3/assets/images/blog/post-6.jpg', relatedArticles[2]?.image ?? article.image)
		...
		.replaceAll('John Smith', 'Перфект Ауто')
		...
		.replaceAll('Nelson Mandela', 'Перфект Ауто')
		.replaceAll(
...
function replaceSupportPageCopy(html: string, templateFile: string, routePath: string) {
	if (templateFile === 'about-us.html') {
		let output = html
			.replaceAll('About Us', 'За Перфект Ауто')
			.replaceAll(
				'Premium vehicles for every lifestyle',
				'проверени употребявани автомобили, съдействие за документи, регистрация, финансиране и огледи в Варна.'
			)
			...
			.replaceAll(
				'At Перфект Ауто, we make car ownership simple and accessible with expert guidance, personalized solutions, and exceptional service. Our team is committed to helping you find the perfect vehicle while ensuring a hassle-free experience.',
				'Екипът на Перфект Ауто помага с избор на автомобил, оглед, документи, регистрация, финансиране и следващи стъпки без излишен шум.'
			)
			...
			.replaceAll('Individual Service Team', 'Консултанти на Перфект Ауто')
			.replaceAll('Индивидуална услуга Team', 'Консултанти на Перфект Ауто')
			...
			.replace(
				...
				'<p class="text-secondary h7 line-height-28 mb-32">Перфект Ауто предлага внимателно подбрани и проверени автомобили с гарантиран произход, коректна оценка при изкупуване и пълно съдействие от избора до документите, регистрацията и финансирането.</p>'
			)
			.replace(
				/At Перфект Ауто, we make car ownership simple and accessible[\s\S]*?hassle-free experience\./,
				'Перфект Ауто предлага внимателно подбрани и проверени автомобили с гарантиран произход, коректна оценка при изкупуване и пълно съдействие от избора до документите, регистрацията и финансирането.'
			)
			.replaceAll('/variant-3/assets/images/pages/about-1.jpg', daynightPageAssets.aboutExterior)
			.replaceAll('/variant-3/assets/images/pages/about-2.jpg', daynightPageAssets.aboutConsultation)
			.replaceAll('/variant-3/assets/images/card/why-choose-us.webp', daynightPageAssets.aboutShowroomVehicle)
	...
	if (templateFile === 'sell-your-car.html') {
		return html
			...
			.replaceAll('Get a fair price', 'Получете предложение за покупка или бартер от Перфект Ауто')
			.replaceAll('Certified Dealers', 'Перфект Ауто')
			.replaceAll(
				...
				'Опишете автомобила, изпратете снимки и екипът на Перфект Ауто ще Ви изпрати следващи стъпки за оглед, покупка или бартер.'
			)
			...
			.replaceAll(
				...
				'Екипът на Перфект Ауто ще Ви изпрати следващи стъпки за оглед, покупка или бартер.'
			)
			...
			.replaceAll('Get In Touch With Us', 'Свържете се със Перфект Ауто')
			.replaceAll(
			...
			.replaceAll(
				...
				'Обикновено са нужни талон, документ за собственост, лична карта и допълнителни документи според конкретния автомобил. Екипът на Перфект Ауто уточнява точния набор при оглед.'
			)
			.replaceAll(
	...
	if (templateFile === 'services-center.html') {
		let output = html
			...
			.replaceAll(
				...
				'Свържете се със Перфект Ауто за документи, регистрация, финансиране, бартер, оглед, доставка или търсене на автомобил по задание.'
			)
			...
			.replaceAll(
				...
				'Изберете автомобил с подкрепа от Перфект Ауто'
			)
			.replaceAll(
				...
				'Съдействаме при оглед, документи, финансиране, бартер и регистрация в Варна.'
			)
			.replaceAll(
				'Experience hassle-free car shopping with our app. Browse, compare, and buy used cars wherever you are – it’s fast, simple, and convenient.',
				'Съдействаме при оглед, документи, финансиране, бартер и регистрация в Варна.'
			...
			.replaceAll(
				'/variant-3/assets/images/banner/bg-service-center.jpg',
				daynightPageAssets.servicesInspection
			)
			.replaceAll('/variant-3/assets/images/pages/services-center.png', daynightPageAssets.servicesInspection)
			.replaceAll(
				'/variant-3/assets/images/home/banner-download-app.jpg',
				daynightPageAssets.servicesConsultation
			)
			.replaceAll('/variant-3/assets/icons/ТелефонCall-2.svg', '/variant-3/assets/icons/PhoneCall-2.svg')
			.replace(
	...
	if (templateFile === 'clients-reviews.html') {
		return html
			.replaceAll('Clients Reviews', 'Отзиви от клиенти')
			.replaceAll('What our clients say', 'Реални впечатления от клиенти на Перфект Ауто')
			.replaceAll(
			...
			.replaceAll('Emily Johnson', 'Клиент на Перфект Ауто')
			.replaceAll('Benjamin Parker', 'Клиент от Варна')
			.replaceAll('Olivia Williams', 'Клиент на Перфект Ауто')
			.replaceAll('Sophia Martinez', 'Клиент от Варна')
			.replaceAll('Daniel Wright', 'Клиент на Перфект Ауто')
			.replaceAll('Sarah Nguyen', 'Клиент от Варна')
			.replaceAll('Manager, NexTech', 'Клиент на Перфект Ауто')
			.replaceAll('Freelance Designer', 'Клиент от Варна')
			.replaceAll('Entrepreneur', 'Клиент на Перфект Ауто')
			.replaceAll('Accountant', 'Клиент от Варна')
			.replaceAll('CEO BMW', 'Клиент на Перфект Ауто')
			.replaceAll('CEO Перфект Ауто', 'Клиент на Перфект Ауто')
			.replaceAll('James Anderson', 'Клиент от Варна')
			.replaceAll('Project Manager', 'Клиент на Перфект Ауто')
			.replaceAll('Avitex', 'Перфект Ауто')
			.replaceAll('Tesla', 'Перфект Ауто')
			.replaceAll('Aurexo', 'Перфект Ауто');
	}

	if (templateFile === 'sale-agents.html') {
		let output = html
			.replaceAll('Sale Agents', 'Екипът на Перфект Ауто')
			.replaceAll('Our Agents', 'Консултанти')
			.replaceAll('Brooklyn Simmons', daynightTeam[0]?.name ?? 'Екипът на Перфект Ауто')
			.replaceAll(
				'Darrell Steward',
				daynightTeam[1]?.name ?? daynightTeam[0]?.name ?? 'Екипът на Перфект Ауто'
			)
			.replaceAll(
				'Senior Dealer Partner',
				daynightTeam[0]?.role.toLowerCase() ?? 'консултант продажби'
			)
			.replaceAll('Mike Hanley', daynightTeam[0]?.name ?? 'Екипът на Перфект Ауто');
	...
	if (templateFile === 'sale-agents-details.html') {
		...
		let output = html
			...
			.replaceAll('Mike Hanley', member?.name ?? 'Екипът на Перфект Ауто')
			...
			.replaceAll('Randynox', 'Клиент на Перфект Ауто')
			.replaceAll('Mista Nyroom', 'Клиент от Варна')
			...
			.replaceAll(
				'/variant-3/assets/images/pages/sale-agent-9.jpg',
		...
		output = output.replace(
			...
			'<a href="/variant-3/contact?intent=review" class="btn btn-primary btn-large font-weight-600 capitalize" title="Отзивите се потвърждават от екипа преди публикуване.">Изпратете отзив</a>'
		);
	...
	if (templateFile === 'dealer-details.html') {
		let output = html
			.replaceAll('Dealer Listing', 'Профил на Перфект Ауто Варна')
			.replaceAll('Dealer Details', 'Профил на Перфект Ауто Варна')
			.replaceAll('Dealer Detail', 'Профил на Перфект Ауто Варна')
			.replaceAll('Aurexo Atlanta', 'Перфект Ауто Варна')
			.replaceAll('Euro Workshop', 'Перфект Ауто Варна')
			...
			.replaceAll(
				...
				'Перфект Ауто Варна предлага проверени употребявани автомобили, съдействие за документи, регистрация, финансиране, бартер и оглед в доверен сервиз. Екипът работи с ясна информация за цена, пробег, състояние и следващи стъпки след избора на автомобил.'
			)
			.replaceAll(
			...
			.replaceAll('/variant-3/assets/images/pages/volvo.png', daynightPageAssets.dealerProfileMark)
			.replace(/<p class="mb-8">Name<\/p>/g, '<p class="mb-8">Име</p>')
			.replace(/<p class="mb-8">Email<\/p>/g, '<p class="mb-8">Имейл</p>')
			.replace(/<p class="mb-8">Review<\/p>/g, '<p class="mb-8">Отзив</p>')
			.replace(/<p class="mb-12">Rating<\/p>/g, '<p class="mb-12">Оценка</p>')
		...
		output = output.replace(
			/<form action="#">/i,
			'<form action="/variant-3/contact?intent=review" title="Отзивите се потвърждават от екипа преди публикуване.">'
		);
	...
	if (templateFile === 'contact-us.html') {
		let output = promoteContactContentBeforeMap(html)
			...
			.replaceAll('Get In Touch', 'Свържете се със Перфект Ауто')
			.replaceAll('get in touch', 'Свържете се със Перфект Ауто')
		...
		output = output
			.replace(
				/<div class="bg-white radius-20 contact-page-form">\s*<p class="h3 mb-12">Свържете се със Перфект Ауто<\/p>/,
				'<div class="bg-white radius-20 contact-page-form">\n\t\t\t\t\t\t<p class="h3 mb-12">Пишете ни за автомобил</p>'
			)
			.replace(
				/<p class="text-secondary">гр\. Варна, Варна, гр. Варна, бул. Цар Освободител 110, кв. Победа<\/p>/,
				`<a href="${daynightSite.mapUrl}" target="_blank" rel="noopener" class="text-secondary">${daynightSite.location}</a>`
			);

		output = output.replace(/<form action="#">/i, '<form action="/variant-3/contact">');
	...
	if (templateFile === 'faqs.html') {
		return html
			...
			.replaceAll(
				...
				'Изберете автомобил от наличността онлайн или на място в Варна, запишете оглед и тест драйв, след което уточняваме финансиране, бартер или лизинг с екипа на Перфект Ауто.'
			)
			.replaceAll(
			...
			.replaceAll(
				...
				'Условията зависят от конкретния автомобил и избраната схема. Свържете се с екипа на Перфект Ауто за актуална информация, оценка на замяна и съдействие по документите.'
			);
	}
	...
	if (templateFile === 'calculator.html') {
		...
		const localized = html
			...
			.replace(
				...
				'Екипът на Перфект Ауто съдейства с варианти за финансиране, лизинг и собствено разсрочено плащане според автомобила и бюджета. Получавате ориентировъчни условия предварително и избирате най-подходящия вариант.'
			)
			...
			.replace(
				/An auto loan is a sum of money[\s\S]*?monthly payments\./,
				'Първоначалната вноска намалява финансираната сума и месечната вноска. По-висока първоначална вноска обикновено означава по-добри условия — екипът на Перфект Ауто предлага варианти според бюджета.'
			)
			.replace(
				/An auto loan is a sum of money[\s\S]*?monthly payments\./,
				'Можете да дадете настоящия си автомобил като бартер — оценката му се приспада от цената и намалява финансираната сума. Перфект Ауто прави оглед и ясна оценка преди сделката.'
			)
			.replace(
				/An auto loan is a sum of money[\s\S]*?monthly payments\./,
		...
		const budgetBoxes = budgetTiers
			.map((tier) => {
				...
				return `<div class="price-box"><a href="/variant-3/inventory?price=${tier.value}" class="h7 font-weight-500 mb-8 text-underline">${count} ${count === 1 ? 'автомобил' : 'автомобила'}</a><p class="h4">${tier.label}</p></div>`;
			})
			.join('\n');
		...
		return (
			html
				...
				.replaceAll(
					...
					'Перфект Ауто полага усилия съдържанието да е точно и актуално, но не носи отговорност за непълноти или технически грешки в обявите.'
				)
				.replaceAll(
					...
					'Перфект Ауто може да актуализира услугите и условията по всяко време, като валидна е версията, публикувана към момента на ползване на сайта. '
				)
				.replaceAll(
					'Etiam eleifend metus at nunc ultricies facilisis. Morbi finibus tristique interdum. Nullam vel eleifend est, eu posuere risus. Vestibulum ligula ex, ullamcorper sit amet molestie',
				...
				.replaceAll(
					...
					'Огледът и тестът се организират предварително по уговорка в Варна.'
				)
				.replaceAll(
					...
					'Информацията в този сайт има информативен характер. Актуалните цени, наличност и условия за финансиране се потвърждават директно със Перфект Ауто преди сделка.'
				)
		);
	}
...
function replaceAccountPageCopy(html: string, templateFile: string) {
	...
	if (templateFile === 'add-listings.html') {
		return withAccountChrome
			...
			.replaceAll('Save & Publish', 'Изпрати към Перфект Ауто')
			.replaceAll('Submit Listing', 'Изпрати към Перфект Ауто')
	...
	if (templateFile === 'message.html') {
		return withAccountChrome
			...
			.replaceAll('Brooklyn Simmons', 'Клиент от Варна')
			.replaceAll('Arlene McCoy', 'Клиент от Варна')
			.replaceAll('Darrell Steward', 'Перфект Ауто')
			.replaceAll('Theresa Webb', 'Клиент от сайта')
			.replaceAll('Aurexo Support', 'Перфект Ауто')
			.replaceAll('Перфект Ауто Support', 'Перфект Ауто')
			.replaceAll('Send Message', 'Изпрати съобщение')
			.concat(html.includes('Перфект Ауто') ? '' : ' Перфект Ауто');
	}
...
function replaceVisibleTemplateFiller(html: string, templateFile: string) {
	...
	let output = html
		...
		.replaceAll('Why Choose Us?', 'Защо Перфект Ауто?')
		.replaceAll('Why Choose Us', 'Защо Перфект Ауто')
		.replaceAll(
		...
		.replace(
			...
			'<a href="/variant-3/inventory" class="btn btn-white btn-large font-weight-600 max-w-min text-primary">Виж наличните автомобили</a>'
		)
		...
		.replaceAll('Certified Dealers', 'Перфект Ауто')
		.replaceAll(
			'Answer a few questions about your vehicle, and then connect with one of thousands of Перфект Ауто who can pay you directly for your used car.',
			'Опишете автомобила, изпратете снимки и екипът на Перфект Ауто ще Ви изпрати следващи стъпки за оглед, покупка или бартер.'
		)
		.replaceAll('Reach Out to Us', 'Свържете се със Перфект Ауто')
		.replaceAll('Reach Out To Us', 'Свържете се със Перфект Ауто')
		.replaceAll('Get In Touch', 'Свържете се със Перфект Ауто')
		.replaceAll('get in touch', 'Свържете се със Перфект Ауто')
		.replaceAll('Have any Question?', 'Имате въпрос?')
		...
		.replaceAll(
			...
			'Получавайте нови наличности и полезни съвети от Перфект Ауто.'
		)
		.replaceAll(
		...
		.replaceAll('Follow Us On social media:', 'Последвайте Перфект Ауто:')
		...
		.replaceAll(
			'To purchase a car from our dealership, start by exploring our inventory online or visiting us in person to find the vehicle that suits your needs. Schedule a test drive to ensure it’s the right fit, then review financing or leasing options with our team.',
			'Изберете автомобил от наличността, свържете се за оглед и уточнете документи, финансиране или бартер с екипа на Перфект Ауто.'
		)
		.replaceAll(
			'Provide the necessary documents, such as your ID, proof of insurance, and income verification. Once terms are agreed upon, finalize the paperwork, inspect the car, and drive away with your new vehicle!',
		...
		.replaceAll(
			'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sed euismod justo, sit amet efficitur dui. Aliquam sodales vestibulum velit, eget sollicitudin quam. Donec non aliquam eros. Etiam sit amet lectus vel justo dignissim condimentum.',
			'Информацията в сайта има информативен характер. Актуални цени, наличност, условия за финансиране и конкретни документи се потвърждават директно със Перфект Ауто преди сделка.'
		)
		.replaceAll(
			'In malesuada neque quis libero laoreet posuere. In consequat vitae ligula quis rutrum. Morbi dolor orci, maximus a pulvinar sed, bibendum ac lacus. Suspendisse in consectetur lorem. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aliquam elementum, est sed interdum cursus, felis ex pharetra nisi, ut elementum tortor urna eu nulla. Donec rhoncus in purus quis blandit.',
		...
		.replaceAll(
			'Etiam eleifend metus at nunc ultricies facilisis. Morbi finibus tristique interdum. Nullam vel eleifend est, eu posuere risus. Vestibulum ligula ex, ullamcorper sit amet molestie',
			'Перфект Ауто може да съдейства с документи, регистрация, финансиране, бартер и проверка според конкретния случай.'
		)
		.replaceAll('EXPERT REVIEW', 'Съвети')
		...
		.replaceAll('by Admin', 'Перфект Ауто')
		.replaceAll('Super Admin', 'Клиентски профил')
		.replaceAll('Or Purchase New Package', 'Заявка към Перфект Ауто')
		...
		.replaceAll('Apply for Dealer Listings', 'Заявка към Перфект Ауто')
		.replaceAll('Apply for 50 Dealer Listings', 'Разширена заявка към Перфект Ауто')
		.replaceAll('Apply for 150 Dealer Listings', 'Персонална заявка към Перфект Ауто')
		...
		.replaceAll('24/7 Live Chat Support', 'Отговор от екипа на Перфект Ауто')
		...
		.replaceAll('Verified Dealer', 'Проверена автокъща')
		.replaceAll('Emily Johnson', 'Клиент на Перфект Ауто')
		.replaceAll('CEO Avitex', 'Клиент на Перфект Ауто')
		.replaceAll('Benjamin Parker', 'Клиент от Варна')
		.replaceAll('CEO Tesla', 'Клиент от Варна')
		.replaceAll('Olivia Williams', 'Клиент на Перфект Ауто')
		.replaceAll('CEO BMW', 'Клиент на Перфект Ауто')
		.replaceAll('CEO Перфект Ауто', 'Клиент на Перфект Ауто')
		.replaceAll('James Anderson', 'Клиент от Варна')
		.replaceAll('Project Manager', 'Клиент на Перфект Ауто')
		.replaceAll('Robert Fox', salesTeam?.name ?? 'Перфект Ауто Sales Team')
		.replaceAll('Bessie Cooper', tradeInTeam?.name ?? 'Перфект Ауто Trade-In Team')
		.replaceAll('Brooklyn Simmons', salesTeam?.name ?? 'Перфект Ауто Sales Team')
		.replaceAll('Kristin Watson', tradeInTeam?.name ?? 'Перфект Ауто Trade-In Team')
		.replaceAll('Guy Hawkins', salesTeam?.name ?? 'Перфект Ауто Sales Team')
		.replaceAll('Darrell Steward', salesTeam?.name ?? 'Перфект Ауто Sales Team')
		.replaceAll('Cody Fisher', tradeInTeam?.name ?? 'Перфект Ауто Trade-In Team')
		.replaceAll('Eleanor Pena', salesTeam?.name ?? 'Перфект Ауто Sales Team')
		.replaceAll('Los Angeles,California', 'Варна, България')
		.replaceAll('FROM:', 'Локация:')
		.replaceAll('two-sided marketplace business', 'дейността на Перфект Ауто')
		.replaceAll(
		...
		.replaceAll('How the adventure ended will...', 'Проверен автомобил от Перфект Ауто.')
		.replaceAll('How the adventure ended will be seen soon.', 'Проверен автомобил от Перфект Ауто.')
		.replaceAll('Vehicle Information', 'Данни за автомобила')
		.replaceAll('Car Details', 'Данни за автомобила')
		.replace(
		...
		.replace(
			...
			'<a href="/variant-3/contact" class="h4 font-weight-600 mb-8 capitalize" title="Свържете се със Перфект Ауто за тази услуга">'
		)
		.replace(
			/<a href="#" class="h4 font-weight-600 mb-8">/g,
			'<a href="/variant-3/sell-your-car/request" class="h4 font-weight-600 mb-8" title="Изпратете заявка към Перфект Ауто">'
		)
		.replace(
			/<a href="#" class="([^"]*\bhover-fill-white\b[^"]*)">/g,
			'<a href="/variant-3/contact" class="$1">'
		)
		.replace(
		...
		.replace(
			...
			'<a href="/variant-3/contact" title="Мобилно приложение на Перфект Ауто"><img class="h-40" src="/variant-3/assets/images/brand/app-store-primary.png" alt="app-store">'
		)
		.replace(
			/<a href="#">\s*<img class="h-40" src="\/assets\/images\/brand\/google-play-primary\.png" alt="google-play">/g,
			'<a href="/variant-3/contact" title="Мобилно приложение на Перфект Ауто"><img class="h-40" src="/variant-3/assets/images/brand/google-play-primary.png" alt="google-play">'
		)
		.replaceAll(
			'Darrell Steward is a dedicated automotive professional with over 15 years of experience in the car dealership industry. Known for his customer-first approach and in-depth knowledge of the market, Darrell has helped countless clients find their perfect vehicle while ensuring a seamless and enjoyable buying experience.',
			salesTeam?.bio ??
...
function replaceRemainingPresentationLinks(html: string, templateFile: string, routePath: string) {
	...
	if (templateFile === 'listing-details-3.html') {
		output = syncDeadCardAnchorsToCardRoutes(output)
			.replace(
				...
				'<a href="/variant-3/compare" class="btn btn-medium btn-line open-modal padding-button-medium gap-5 font-weight-600" title="Сравни автомобила">'
			)
			.replace(
				/<a class="listing-details-item--button" href="#">\s*<img src="\/assets\/icons\/playcircle\.svg" alt="play">\s*Play Video\s*<\/a>/g,
				'<a class="listing-details-item--button" href="/variant-3/contact" title="Видео преглед"><img src="/variant-3/assets/icons/playcircle.svg" alt="" aria-hidden="true">Видео преглед</a>'
			)
			.replace(
			...
			.replace(
				...
				'<a href="/variant-3/terms" class="text-underline text-highlight" id="coreDropdownBtn">Автомобил по ДДС</a>'
			)
			.replace(
				/<a href="#" class="text-underline text-highlight ?">Vehicle in the VAT system<\/a>/g,
				'<a href="/variant-3/terms" class="text-underline text-highlight">Автомобил по ДДС</a>'
			)
			.replace(
				/<a href="#" class="h4 mb-8 font-weight-600">Перфект Ауто<\/a>/g,
				'<a href="/variant-3/about/daynight-auto-plovdiv" class="h4 mb-8 font-weight-600">Перфект Ауто</a>'
			)
			.replace(
				/<a href="#">\s*гр\. Варна, Варна, гр. Варна, бул. Цар Освободител 110, кв. Победа\s*<\/a>/g,
			...
			.replace(
				...
				'<a href="/variant-3/terms" class="text-xs text-underline text-highlight">Споразумение с потребителите.</a>'
			);
	}
	...
	if (templateFile === 'dealer-details.html') {
		...
		output = output
			...
			.replace(
				...
				`<ul class="contact-info mb-28">
								<li class="items-center">
									<p class="icon"><img src="/variant-3/assets/icons/PhoneCall.svg" alt="phone"></p>
			...
			.replace(
				...
				'<form action="/variant-3/contact?intent=review" class="add-review-form" title="Отзивите се потвърждават от екипа преди публикуване.">'
			)
			.replace(
	...
	if (templateFile === 'sale-agents-details.html') {
		...
		output = output
			...
			.replace(
				...
				'<form action="/variant-3/contact?intent=team" class="send-inquiry">'
			)
			.replace(
				/<form action="#" class="add-review-form">/i,
				'<form action="/variant-3/contact?intent=review" class="add-review-form" title="Отзивите се потвърждават от екипа преди публикуване.">'
			...
			.replaceAll(
				member?.name ?? '',
				member?.name ?? daynightTeam[0]?.name ?? 'Екипът на Перфект Ауто'
			);
	}
	...
	if (templateFile === 'services-center.html') {
		output = output
			...
			.replace(
				/<a href="tel:0888 802 226" class="text-sm text-white">0888 802 226<\/a>\s*<a href="tel:0888 802 226" class="text-sm text-white">0888 802 226<\/a>/,
				'<a href="tel:0888 802 226" class="text-sm text-white">0888 802 226</a><a href="mailto:demo@getrich.local" class="text-sm text-white">demo@getrich.local</a>'
			)
			...
			.replace(
				/<form action="#" class="send-inquiry">/i,
				'<form action="/variant-3/services?service=inspection#services-request" class="send-inquiry">'
			)
			.replace(
				/name="SendInquiryphone" id="SendInquiryphone" type="number"/,
				'name="SendInquiryphone" id="SendInquiryphone" type="tel"'
	...
	if (templateFile === 'add-listings-2.html') {
		output = output
			.replace(
				...
				'<a href="/variant-3/sell-your-car/request?preview=1" class="btn btn-line-1 px-24 btn-large font-weight-600" title="Преглед на заявката">Преглед на заявката</a>'
			)
			.replace(
				/<a href="#" class="btn btn-primary px-24 btn-large font-weight-600">\s*Изпрати заявка\s*<\/a>/g,
				'<a href="/variant-3/sell-your-car/request" class="btn btn-primary px-24 btn-large font-weight-600">Изпрати заявка</a>'
			)
			.replace(/<a class="item" href="#">/g, `<a class="item" href="/variant-3/contact">`);
	}
	...
	if (templateFile === 'financing.html') {
		output = output
			...
			.replace(
				...
				'<a href="/variant-3/contact?intent=financing" class="h4 font-weight-600 mb-8 capitalize text-center">Изпратете запитване</a>'
			)
			.replace(
				/<a href="#" class="h4 font-weight-600 mb-8 capitalize text-center">\s*Търсете според месечния бюджет\s*<\/a>/g,
				'<a href="/variant-3/calculator" class="h4 font-weight-600 mb-8 capitalize text-center">Търсете според месечния бюджет</a>'
			)
			.replace(
				/<a href="#" class="h4 font-weight-600 mb-8 capitalize text-center">Изберете подходяща оферта<\/a>/g,
				'<a href="/variant-3/inventory" class="h4 font-weight-600 mb-8 capitalize text-center">Изберете подходяща оферта</a>'
			);
	}
	...
	if (templateFile === 'blog-details-1.html' || templateFile === 'blog-details-2.html') {
		output = output
			.replace(
				...
				'<a href="/variant-3/contact" class="comments-post$1">'
			)
			.replace(
				/<a href="#" class="h4 mb-8 font-weight-600">Перфект Ауто<\/a>/g,
				'<a href="/variant-3/about/daynight-auto-plovdiv" class="h4 mb-8 font-weight-600">Перфект Ауто</a>'
			...
			.replace(
				/<a class="text-white" href="#">Перфект Ауто<\/a>/g,
				'<a class="text-white" href="/variant-3/about/daynight-auto-plovdiv">Перфект Ауто</a>'
			)
			.replace(
				/<a class="text-white" href="#">Aug\. 8, 2025<\/a>/g,
				'<a class="text-white" href="/variant-3/blog">Aug. 8, 2025</a>'
			)
			.replace(
				/<a class="uppercase text-underline text-highlight" href="#">СЪВЕТИ<\/a>/g,
				'<a class="uppercase text-underline text-highlight" href="/variant-3/blog">СЪВЕТИ</a>'
			);
	}
...
export function applyDayNightTemplateContent(
	...
	return restoreTemplateAssetPaths(output)
		.replaceAll('Car Dealer, Rental & Listing HTML Template', 'Перфект Ауто Варна')
		.replaceAll('Aurexo |', 'Перфект Ауто |');
}
