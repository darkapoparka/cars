  ...
  <div class="container">
    <div class="dn-videos__panel">
      <div class="dn-videos__heading dn-home-section-heading">
        <h2 id="videos-title" class="dn-home-section-title"><span class="dn-videos__intro">Видео подбор в</span><span class="dn-videos__brand-mark"><SocialBrandIcon name="youtube" size={32} /></span>YouTube</h2>
        <p>Все още няма одобрен видео подбор за това демо.</p>
      ...
      <div class="dn-videos__grid">
        {#if featuredVideos.length === 0}<p>Няма одобрен видео подбор за това демо.</p>{/if}
