...
const leadSiteModeArtwork: Record<MarketplaceMode, string> = {
  buy: "/dealer/media-pending.svg",
  imports: "/dealer/media-pending.svg",
  lease: "/dealer/media-pending.svg",
  sell: "/dealer/media-pending.svg",
};
          ...
          <div className="flex flex-col gap-3">
            <div>
              <p className="font-semibold text-sm">
                ...
                {isBg ? "бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково" : "Studentski grad"}
              </p>
