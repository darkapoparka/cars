...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с ПРЕСТИЖ за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково.",
    locationLabel: "Шоурум · бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на ПРЕСТИЖ, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with ПРЕСТИЖ about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call ПРЕСТИЖ to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Автосалон ПРЕСТИЖ в Варна — автомобили в наличност, внос по заявка и възможности за финансиране след потвърждение."
      : "Автосалон ПРЕСТИЖ in Варна — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
