...
const pageCopy = {
  bg: {
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на ПРЕСТИЖ ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The ПРЕСТИЖ team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Автосалон ПРЕСТИЖ."
      : "A tailored vehicle financing offer from Автосалон ПРЕСТИЖ.",
    locale,
    path: "/lease",
