...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от ПРЕСТИЖ."
      : "Start a request for a vehicle from China with delivery to Bulgaria from ПРЕСТИЖ.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | ПРЕСТИЖ"
      : "Import from China | ПРЕСТИЖ",
  });
};
