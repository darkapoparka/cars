...
<div class="mobile-home" aria-label="ПРЕСТИЖ — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="ПРЕСТИЖ home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на ПРЕСТИЖ"
				>
		...
		<h1 class="mh-hero__title">ПРЕСТИЖ</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 ПРЕСТИЖ Варна. Всички права запазени.</span>
	</footer>
