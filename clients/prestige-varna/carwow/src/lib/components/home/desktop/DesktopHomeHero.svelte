			...
			<div class="daynight-home-hero__stage-content daynight-home-container">
				<div class="daynight-home-hero__location-wrap">
					...
					>
						...
						<span>бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково · бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково</span>
					</button>
					<button
						type="button"
						id="daynight-home-hero-map-preview"
						class="daynight-home-hero__location-preview"
						aria-label="Отвори Google Maps до ПРЕСТИЖ"
						onclick={openMap}
					>
						<span class="daynight-home-hero__location-map" aria-hidden="true">
							...
							<span class="daynight-home-hero__location-map-label">Автосалон ПРЕСТИЖ</span>
						</span>
						<span class="daynight-home-hero__location-preview-copy">
							<strong>ПРЕСТИЖ Варна</strong>
							<span>гр. Варна, бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково, бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково</span>
