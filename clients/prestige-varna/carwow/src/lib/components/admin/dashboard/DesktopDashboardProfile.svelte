<script lang="ts">
	...
	const locationText = 'Варна, Варна, гр. Варна, бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково, бул. Цар Освободител, 15–20 м преди последния светофар за Владиславово, вляво към Аксаково';
