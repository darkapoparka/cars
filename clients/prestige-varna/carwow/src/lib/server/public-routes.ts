...
export const DEFAULT_DESCRIPTION = `Демонстрационен каталог с избрани публични обяви на ${dealer.name}, записани към ${dealer.observedAt}. Потвърдете актуалния статус директно с продавача.`;
