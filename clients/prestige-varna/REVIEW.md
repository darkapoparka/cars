...
Once integrated into the coordinator checkout, `./scripts/start-client.ps1 -Client prestige-varna -Prepare` and `./scripts/start-client.ps1 -Client prestige-varna` use the repository launcher. These commands have **not** been run here.
