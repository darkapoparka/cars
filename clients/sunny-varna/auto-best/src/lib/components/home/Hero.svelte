...
<section class="dn-hero dn-route-hero" aria-labelledby="home-hero-title">
  ...
  <div class="container dn-hero__inner dn-route-hero__layout">
    <div class="dn-hero__copy dn-route-hero__copy">
      <h1 id="home-hero-title"><span class="dn-hero__title-desktop">Изберете своя автомобил</span><span class="dn-hero__title-mobile">Намери автомобил</span></h1>
      <p class="dn-hero__location">{brand.name} · {brand.city} · Потвърдете оглед по телефона</p>
    </div>
  </div>
</section>
