...
export const posts: BlogPost[] = [
	{
		...
		title: 'Какво проверява OUTLETCARS.BG — Варна преди внос на автомобил от Европа',
		...
		content: [
			'Преди да препоръча автомобил, OUTLETCARS.BG — Варна проверява произход, пробег, сервизна история, състояние и документи, за да знае купувачът какво одобрява още преди колата да напусне Европа.',
			'Най-силните предложения идват от проследими източници с ясни снимки, история и сервизен контекст.',
			'След одобрение OUTLETCARS.BG — Варна организира транспорта, митническите стъпки и подготовката за регистрация.'
		]
	},
	{
	...
	},
	{
		...
		title: 'Как OUTLETCARS.BG — Варна преглежда клиентски автомобил',
		...
		content: [
			...
			'След преглед OUTLETCARS.BG — Варна може да обсъди директна оферта, съдействие при продажба или публикуване на колата като клиентски автомобил.',
