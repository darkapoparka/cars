...
export const supportFaqs: AuxeroFaq[] = [
	{
		...
		answer:
			'Европа често предлага добре оборудвани автомобили с проследима история и конкурентна цена. OUTLETCARS.BG — Варна проверява конкретния автомобил, документи, пробег, снимки и ориентировъчна крайна цена преди препоръка.'
	},
	{
		topic: 'Timing',
	...
	{
		topic: 'Checks',
		question: 'Какво проверява OUTLETCARS.BG — Варна преди покупка?',
		answer:
	...
	},
	{
		...
		answer:
			'Документите зависят от конкретния автомобил и сделка. OUTLETCARS.BG — Варна потвърждава наличните документи за покупка, транспорт, митница и регистрация преди предаване.'
	},
	{
		topic: 'Warranty',
	...
	{
		topic: 'Selling',
		question: 'Може ли OUTLETCARS.BG — Варна да помогне при продажба на моя автомобил?',
		answer:
			'Да. Изпратете VIN, пробег, снимки, сервизна история, състояние, документи и очаквана цена. OUTLETCARS.BG — Варна може да предложи директна оферта, клиентска обява или съдействие при продажба.'
	},
	{
		topic: 'Viewing',
	...
	{
		topic: 'Compare',
		question: 'Може ли OUTLETCARS.BG — Варна да сравни няколко модела?',
		answer:
