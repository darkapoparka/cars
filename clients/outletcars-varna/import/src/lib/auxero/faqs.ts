...
export const supportFaqs: AuxeroFaq[] = [
	...
	{
		topic: 'Checks',
		question: 'Какво проверява OUTLETCARS.BG преди покупка?',
		answer:
	...
	{
		topic: 'Selling',
		question: 'Може ли OUTLETCARS.BG да помогне при продажба на моя автомобил?',
		answer:
	...
	{
		topic: 'Compare',
		question: 'Може ли OUTLETCARS.BG да сравни няколко модела?',
		answer:
