...
const agentDetailSummary =
	'OUTLETCARS.BG води всеки разговор практично: детайли за източника, оглед и състояние, стъпки по внос или регистрация и записване на огледи се потвърждават преди следващата стъпка.';
...
export const agentDetailFromAgent = (agent: Agent): AuxeroAgentDetailContent => {
	...
	return {
		...
		inventoryHeading: `Автомобили в OUTLETCARS.BG (${inventoryCount})`,
		name: agent.name,
		sidebar: {
			address: daynightContact.addressLabel,
			callHref: daynightContact.primaryPhoneHref,
			callLabel: 'Обади се на OUTLETCARS.BG',
			consentLabel:
		...
		verifiedLabel: 'Потвърден консултант на OUTLETCARS.BG'
	};
};
