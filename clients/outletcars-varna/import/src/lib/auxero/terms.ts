...
export const auxeroTermsPageTitle = 'Условия за използване на OUTLETCARS.BG — Варна';
...
export const auxeroTermsSections: AuxeroTermsSection[] = [
	{
		...
		body: [
			'OUTLETCARS.BG — Варна представя информация за автомобилите на база налични обяви, клиентски заявки, данни от доставчици, снимки, доклади и вътрешни бележки от проверка.',
	...
	},
	{
		...
		body: [
			'Огледите се уговарят предварително, за да може OUTLETCARS.BG — Варна да подготви автомобила, документите и важния контекст за клиента.',
	...
	},
	{
		...
		body: [
			...
			'OUTLETCARS.BG — Варна може да поиска допълнителна информация преди препоръка за цена, публикуване, директна оферта или съдействие при продажба.'
		]
	},
	{
		id: 'section6',
		...
		body: [
			...
			'Не изпращайте чувствителни платежни данни през публичните форми на сайта. Потвърждавайте официалните инструкции за плащане директно с OUTLETCARS.BG — Варна преди превод.'
		]
	}
];
