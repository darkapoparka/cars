<script lang="ts">
	...
	const banner = {
		...
		eyebrow: 'OUTLETCARS.BG финансиране',
	...
	const steps = [
		...
		{
			text: 'Изпрати запитване с избрания автомобил. OUTLETCARS.BG подготвя офертата с партньорска банка.',
			title: 'Заяви оферта'
		},
		{
...
<AuxeroPublicShell
	...
	title="Финансиране — OUTLETCARS.BG"
>
