<script lang="ts">
	...
	const banner = {
		...
		eyebrow: 'OUTLETCARS.BG — Варна финансиране',
	...
	const steps = [
		...
		{
			text: 'Изпрати запитване с избрания автомобил. OUTLETCARS.BG — Варна подготвя офертата с партньорска банка.',
			title: 'Заяви оферта'
		},
		{
...
<AuxeroPublicShell
	...
	title="Финансиране — OUTLETCARS.BG — Варна"
>
