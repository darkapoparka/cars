...
const replaceHero = (html: string) => {
	...
	<h1 class="search-cars__title">Find Your Next OUTLETCARS.BG — Варна Vehicle</h1>
...
const home05HeroSlide = () => `<div class="swiper-slide">
	<h1 class="search-cars__title text-center effect-item effect-up delay-3">Browse, Compare, Drive <br class="lg-hide"> With OUTLETCARS.BG — Варна!</h1>
...
<section class="py-100 background-light">
	<div class="container">
		<div class="title-section mb-40 wow fadeInUp" data-wow-delay="0.1s">
			<h2 class="capitalize">OUTLETCARS.BG — Варна Vehicles</h2>
...
<section class="py-100 flat-tabs">
	<div class="container">
		<div class="flex items-center justify-center mb-40 wow fadeInUp">
			<h2>OUTLETCARS.BG — Варна by Budget</h2>
		</div>
...
<section class="py-100">
	<div class="container wow fadeIn" data-wow-delay="0.1s">
		<div class="title-section mb-30 wow fadeInDown" data-wow-delay="0.1s">
			<h2 class="capitalize">OUTLETCARS.BG — Варна notes</h2>
				...
				<a href="/blog/${featured.slug}" class="post-style-2 radius-none daynight-no-image-zoom overflow-hidden">
					...
					<div class="content">
						...
						<div class=" flex gap-8 justify-start">
							<span class="text-white text-xs">by OUTLETCARS.BG — Варна</span>
			...
			<div class="col-lg-6">
				${[second, third]
					...
					<div class="content">
						...
						<div class=" flex gap-8 justify-start">
							<span class="text-xs">by OUTLETCARS.BG — Варна</span>
...
<section class="py-100 flat-tabs background-light radius-40">
	<div class="container">
		<div class="flex items-center justify-center mb-40 wow fadeInUp" data-wow-delay="0.1s">
			<h2>New OUTLETCARS.BG — Варна Vehicles</h2>
		</div>
		...
		<div class="flex justify-center mt-40">
			<a href="/inventory" class="btn btn-primary btn-large font-weight-600">View OUTLETCARS.BG — Варна Inventory</a>
		</div>
	</div>
</section>
<!-- /New Vehicles -->`;
	...
	<div class="container">
		<div class="why-choose-us style2">
			<div class="wow fadeIn" data-wow-delay="0.1s">
				<img class="move5" src="/assets/daynight/proof-studio-import-handoff.webp" alt="OUTLETCARS.BG — Варна vehicle handoff">
			</div>
			<div class="wow fadeIn" data-wow-delay="0.2s">
				<h2 class="mb-15">Why Choose OUTLETCARS.BG — Варна?</h2>
				<p class="text-muted mb-20">OUTLETCARS.BG — Варна keeps each purchase grounded in source checks, practical import guidance, document review, and viewing appointments before the next commitment.</p>
				<ul class="list mb-32">
		...
		<div class="grid grid-cols-4 gap-30 md-grid-cols-2 counter-spacing">
			${[
				[String(vehicles.length), 'OUTLETCARS.BG — Варна Listings'],
...
<section class="py-100 bg-primary radius-40">
	<div class="container">
		<div class="title-section mb-40 wow fadeInUp" data-wow-delay="0.1s">
			<h2 class="text-white capitalize">Featured OUTLETCARS.BG — Варна Searches</h2>
	...
	<div class="container">
		<div class="row items-center">
						...
						<div class="grid gap-22 gap-x-16 grid-cols-2 mb-20 md-grid-cols-1">
							...
							<div class="md-colspan-1">
								...
								<select name="basis">
									...
									<option>Confirm with OUTLETCARS.BG — Варна</option>
								</select>
							</div>
							<div>
			...
			<div class="col-lg-6 text-center wow fadeInUp">
				<img class="max-w-628 ml-60 move3" src="/assets/daynight/cta/premium-cars-banner-v2.webp" alt="OUTLETCARS.BG — Варна import calculator">
			</div>
		</div>
	</div>
</section>
...
<section class="py-100">
	<div class="container">
		<div class="cta-box radius-16" style="background-image: url('${daynightAssets.footerImage}')">
			<div class="content">
				<p class="h2 text-white mb-16">Find your next OUTLETCARS.BG — Варна vehicle</p>
...
const homeBlogTeaser = () => {
	...
	<div class="container">
		<div class="title-section mb-38 wow fadeInDown" data-wow-delay="0.1s">
			<h2>Latest OUTLETCARS.BG — Варна Notes</h2>
		...
		<div class="grid grid-cols-2 lg-grid-cols-1 gap-30">
			...
			<div class="sale-agent-box active">
				...
				<div class="card-bottom flex items-center justify-between gap-16">
					...
					<ul class="contact">
						<li><a href="${daynightContact.primaryPhoneHref}" aria-label="Call OUTLETCARS.BG — Варна"><img src="/assets/icons/PhoneCall.svg" alt="phone"></a></li>
						<li><a href="${daynightContact.emailHref}" aria-label="Email OUTLETCARS.BG — Варна"><img src="/assets/icons/input-telegram.svg" alt="email"></a></li>
					</ul>
				</div>
			</div>
		</div>
