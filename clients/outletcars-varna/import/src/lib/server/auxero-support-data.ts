...
const contactCtaSection = () => `<section class="relative py-100">
	...
	<div class="overlay image">
		<img class="lazyload parallax" data-src="${escapeHtml(daynightAssets.hero)}" src="${escapeHtml(daynightAssets.hero)}" alt="OUTLETCARS.BG">
	</div>
	<div class="container relative index-10">
		<h2 class="mb-12 text-white capitalize">Говори с OUTLETCARS.BG</h2>
		...
		<div class="flex">
			<a href="/contact" class="btn btn-white text-primary btn-large-3 font-weight-600">Свържи се с OUTLETCARS.BG</a>
		</div>
	</div>
</section>`;
...
const applySellYourCarData = (html: string) => {
	...
	<div class="container">
		<h1 class="h2 daynight-sell-page-title">Продай автомобила си с OUTLETCARS.BG</h1>
		...
		<div class="row daynight-sell-hero-grid">
			<div class="col-lg-6 lg-mb-40 daynight-sell-copy">
				...
				<div class="flex gap-28 items-center sm-flex-col sm-items-start sm-gap-16 daynight-sell-actions">
					<a href="/contact" class="btn btn-primary btn-large-3 font-weight-600">Свържи се с OUTLETCARS.BG</a>
	...
	<div class="container">
		<div class="why-choose-us style2 style3">
			<div class="wow fadeIn" data-wow-delay="0.1s">
				<img class="move5" src="/assets/daynight/cta/sell-car-banner-v2.webp" alt="Продай автомобила си с OUTLETCARS.BG">
			</div>
			<div class="wow fadeIn" data-wow-delay="0.2s">
				<h2 class="mb-12">Защо OUTLETCARS.BG?</h2>
	...
	<div class="container">
		...
		<div class="grid grid-cols-2 xl-grid-cols-2 lg-grid-cols-1 gap-30">
			<div class="flex justify-center flex-col wow fadeInUp">
				<h2 class="mb-12 capitalize">Услуги от OUTLETCARS.BG</h2>
				...
				<div class="flex"><a href="/contact" class="btn btn-primary btn-large-3 font-weight-600">Свържи се с OUTLETCARS.BG</a></div>
			</div>
			<div class="ml-24 flex lg-ml-0 wow fadeInUp radius-20 overflow-hidden">
				<img class="w-full" src="/assets/daynight/services/premium-cars-banner-generated.webp" alt="OUTLETCARS.BG services">
			</div>
		</div>
	</div>
</section>
...
<section class="relative py-100">
	<div class="overlay-parallax"></div>
	<div class="overlay image">
		<img class="lazyload parallax" data-src="/assets/daynight/proof-studio-import-handoff.webp" src="/assets/daynight/proof-studio-import-handoff.webp" alt="OUTLETCARS.BG service support">
	</div>
	<div class="container relative index-10">
				...
				<ul class="grid grid-cols-2 lg-grid-cols-1 gap-12">
					<li class="contact gap-12">
						...
						<div class="flex flex-col gap-4">
							<p class="text-sm text-muted">Контакт с OUTLETCARS.BG</p>
			...
			<div class="col-lg-6">
				<div class="about-content">
					...
					<div class="flex gap-28 items-center">
						<a href="/contact" class="btn btn-primary btn-large font-weight-600">Свържи се с OUTLETCARS.BG</a>
...
const applyFaqData = (html: string) => {
	...
	<div class="container mb-60">
		...
		<div class="tf-spacing-style3"></div>
		<p class="h3 mb-20 text-center capitalize">OUTLETCARS.BG помощ</p>
...
const applyTermsData = (html: string) => {
	...
	<div class="container">
		<h1 class="h2 capitalize">Условия за използване на OUTLETCARS.BG</h1>
		<div class="tf-spacing-style3"></div>
...
<section class="pb-100">
	...
	<div class="container">
		...
		<p class="mb-40 text-center text-secondary h7 line-height-28">Изчисли ориентировъчна крайна цена за автомобил от Европа преди точна разбивка от OUTLETCARS.BG.</p>
...
const blogCard = (
	...
	<div class="content">
		<div class="flex gap-12 justify-start mb-12">
			<span class="text-sm">от OUTLETCARS.BG</span>
...
const applyBlogListData = (html: string) => {
	...
	<div class="container"><h1 class="h2">Съвети от OUTLETCARS.BG</h1></div>
	<div class="tf-spacing-style3"></div>
	<div class="container">
	...
	<div class="content">
		<div class="container">
			...
			<ul class="flex items-center flex-wrap gap-20">
				<li><a class="text-white" href="/agents">от OUTLETCARS.BG</a></li>
	...
	<div class="container innerpage-container">
		<div class="innerpage__content md-mb-30">
					...
					index === 1
						? `<div class="quote mb-28">
							<div class="content">
								...
								<p class="h7 flex items-center gap-8"><img src="/assets/icons/line.svg" alt="quote">OUTLETCARS.BG</p>
							</div>
			...
			<div class="flex justify-between mb-40 gap-16 md-flex-col">
				<ul class="blog-detail-tags flex gap-12">
					...
					<li><a href="/services">OUTLETCARS.BG</a></li>
				</ul>
		...
		<div class="innerpage__sidebar">
			<form action="/blog" class="widget-search w-full mb-34">
				<input class="input-normal" type="text" name="q" placeholder="Търси в съветите на OUTLETCARS.BG">
			...
			<div class="mb-32">
				<div class="listing-details--contact-dealer style-3 mb-20">
					<img src="${escapeHtml(agents[1]?.image ?? daynightConsultants[1].image)}" alt="OUTLETCARS.BG consultant">
				...
				<p class="mb-16">Изпрати VIN, линк към обява, бюджет или срок и OUTLETCARS.BG ще прегледа конкретния случай.</p>
			</div>
				...
				${related
					.map(
						(
							...
							<div class="content">
								<div class="flex gap-12 md-gap-6 justify-start mb-6"><span class="text-xs">от OUTLETCARS.BG</span><span class="text-xs">${escapeHtml(item.date)}</span></div>
