...
<svelte:head>
	<title>Общи условия — OUTLETCARS.BG — Варна</title>
	<meta
		name="description"
		content="Условия за използване на OUTLETCARS.BG — Варна — информация за автомобилите, процес на внос, разходи и калкулатор, огледи, клиентски автомобили и контакт."
	/>
