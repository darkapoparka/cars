...
<svelte:head>
	<title>OUTLETCARS.BG — Варна Admin Login</title>
</svelte:head>
			...
			<div class="relative flex h-full flex-col justify-between p-12">
				...
				<div class="max-w-xl">
					...
					<p class="mt-5 max-w-lg text-base leading-7 text-white/75">
						Use the admin CMS to manage OUTLETCARS.BG — Варна stock, customer requests, staff assignments,
		...
		<div class="flex items-center justify-center p-6">
			<Card.Root class="w-full max-w-md">
				<Card.Header>
					...
					<Card.Description>Use the OUTLETCARS.BG — Варна admin account to open the CMS.</Card.Description>
				</Card.Header>
				<Card.Content>
					<form
						method="POST"
