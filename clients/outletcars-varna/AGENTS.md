# Dealer project: outletcars-varna

This is an independent personalized dealer copy. Canonical editable source is Cars clients/outletcars-varna/. The dedicated dealer repository is a publishing mirror. Make lasting fixes in canonical source or the versioned packaging layer and regenerate; preserve unmatched mirror fixes first. This copy is not a reusable template master.

Read local CLIENT.md and dealer.json (or their parent-directory copies), .client/project.json when present, and the relevant technical TEMPLATE.md. Shared policy: [Cars workflow](https://github.com/darkapoparka/cars/blob/1c77c23f356c3a39c857d99049f41cc7dfd5ed5f/docs/WORKFLOW.md) and [publishing](https://github.com/darkapoparka/cars/blob/1c77c23f356c3a39c857d99049f41cc7dfd5ed5f/docs/LEAD-PUBLISHING.md).
...
Published entry: /variant-2/. Exact template identity is in .client/project.json.
