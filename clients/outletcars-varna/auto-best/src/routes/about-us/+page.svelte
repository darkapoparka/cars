...
<svelte:head>
  ...
  <meta name="description" content={`${brand.name} — премиум автомобили, внос по заявка, финансиране по запитване, бартер и огледи с предварителна уговорка в ${brand.city}.`} />
</svelte:head>
