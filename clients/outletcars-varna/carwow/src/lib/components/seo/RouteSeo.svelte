<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'OUTLETCARS.BG — Варна предлага проверени автомобили, финансиране и съдействие при покупка във Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="OUTLETCARS.BG — Варна Варна" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="OUTLETCARS.BG — Варна Варна" />
	{/if}
