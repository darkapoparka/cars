...
<div class="mobile-home" aria-label="OUTLETCARS.BG — Варна — начало">
	<header class="mh-hero">
		...
		<h1 class="mh-hero__title">OUTLETCARS.BG — Варна</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 OUTLETCARS.BG — Варна Варна. Всички права запазени.</span>
	</footer>
