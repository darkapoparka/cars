...
<section class="home-videos" aria-label="OUTLETCARS.BG — Варна в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="OUTLETCARS.BG — Варна в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">OUTLETCARS.BG — Варна в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
