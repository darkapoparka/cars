					...
					>
						<div>
							<a
								...
								aria-label="OUTLETCARS.BG — Варна начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								OUTLETCARS.BG — Варна предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										aria-label="Отвори локацията на OUTLETCARS.BG — Варна в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със OUTLETCARS.BG — Варна."
								>
									Свържете се
								</a>
							</div>
			...
			>
				<p class="m-0 text-sa-sm leading-[22px] text-sa-surface/60">
					©2026 <a
						...
						href={resolve('/')}>OUTLETCARS.BG — Варна</a
