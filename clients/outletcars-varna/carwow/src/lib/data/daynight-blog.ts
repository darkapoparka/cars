...
export const daynightArticles: DayNightArticle[] = [
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'OUTLETCARS.BG — Варна съдейства с документи, регистрация, финансиране и оглед на място във Варна.'
				]
			}
		],
	...
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на OUTLETCARS.BG — Варна може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'OUTLETCARS.BG — Варна предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на OUTLETCARS.BG — Варна често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез OUTLETCARS.BG — Варна.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'OUTLETCARS.BG — Варна',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'OUTLETCARS.BG — Варна помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
