<script lang="ts">
	...
	const guideCards = [
		...
		{
			title: 'Sell or part exchange with OUTLETCARS.BG — Варна',
...
<svelte:head>
	<title>OUTLETCARS.BG — Варна Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from OUTLETCARS.BG — Варна Варна."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<h1 id="home2-title">
			...
			<span>OUTLETCARS.BG — Варна can help</span>
		</h1>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular OUTLETCARS.BG — Варна picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate OUTLETCARS.BG — Варна as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse OUTLETCARS.BG — Варна stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
