<script lang="ts">
	...
	const guideCards = [
		...
		{
			title: 'Sell or part exchange with ЕКСТРА КАР-СМ',
...
<svelte:head>
	<title>ЕКСТРА КАР-СМ Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from ЕКСТРА КАР-СМ Варна."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<h1 id="home2-title">
			...
			<span>ЕКСТРА КАР-СМ can help</span>
		</h1>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular ЕКСТРА КАР-СМ picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate ЕКСТРА КАР-СМ as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/dealer/media-pending.svg" alt="ЕКСТРА КАР-СМ consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse ЕКСТРА КАР-СМ stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
