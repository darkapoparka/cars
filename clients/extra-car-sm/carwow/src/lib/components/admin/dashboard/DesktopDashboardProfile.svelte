<script lang="ts">
	...
	const locationText = 'Варна, Варна, гр. Варна, бул. Цар Освободител, преди светофара за Джъмбо, район Владислав Варненчик, бул. Цар Освободител, преди светофара за Джъмбо, район Владислав Варненчик';
