<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'ЕКСТРА КАР-СМ предлага проверени автомобили, финансиране и съдействие при покупка в Варна.';
	const DEFAULT_OG_IMAGE = '/dealer/media-pending.svg';
...
<svelte:head>
	...
	<meta property="og:site_name" content="ЕКСТРА КАР-СМ Варна" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="ЕКСТРА КАР-СМ Варна" />
	{/if}
