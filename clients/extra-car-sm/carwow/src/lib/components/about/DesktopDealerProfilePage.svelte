	...
	<section class="background-light mb-32">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb__icon" aria-hidden="true"><ChevronRight size={14} /></li>
				<li><span>Профил на ЕКСТРА КАР-СМ</span></li>
			</ul>
		</div>
	</section>
		...
		<div class="container">
			<div class="dealer-profile-hero__grid">
				...
				<div class="dealer-profile-card">
					...
					<p class="dealer-profile-card__title mb-6">ЕКСТРА КАР-СМ</p>
	...
	<section class="py-80">
		<div class="container">
			<div class="dealer-about-grid">
				...
				<LazyMapEmbed src={mapEmbedSrc} title="Карта до ЕКСТРА КАР-СМ Варна" height="330" />
			</div>
		</div>
	</section>
