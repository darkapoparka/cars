...
<div class="mobile-about-app" aria-label="За ЕКСТРА КАР-СМ">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>ЕКСТРА КАР-СМ в Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/dealer/media-pending.svg')}
				alt="Консултация със ЕКСТРА КАР-СМ"
				loading="lazy"
				decoding="async"
			/>
			<div>
