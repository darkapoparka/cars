...
<section class="home-videos" aria-label="ЕКСТРА КАР-СМ в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="ЕКСТРА КАР-СМ в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">ЕКСТРА КАР-СМ в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
