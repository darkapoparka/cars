...
<div class="mobile-home" aria-label="ЕКСТРА КАР-СМ — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="ЕКСТРА КАР-СМ home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на ЕКСТРА КАР-СМ"
				>
		...
		<h1 class="mh-hero__title">ЕКСТРА КАР-СМ</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 ЕКСТРА КАР-СМ Варна. Всички права запазени.</span>
	</footer>
