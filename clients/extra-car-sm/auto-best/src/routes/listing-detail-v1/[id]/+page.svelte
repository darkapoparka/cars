<script lang="ts">
  ...
  const overview = $derived([
    ...
    { label: 'Статус', value: data.vehicle.sourceStatus },
    { label: 'Данъчна бележка', value: data.vehicle.taxNote },
    { label: 'Локация', value: 'Потвърдете с продавача' }
  ]);
</script>
...
<svelte:head>
  ...
  <meta
    name="description"
    content={`${data.vehicle.title}, ${data.vehicle.year}, ${data.vehicle.mileage}. ${data.vehicle.sourceStatus}. Данни от обява на ${brand.name}.`}
  />
</svelte:head>
        ...
        <div class="dn-detail-layout">
          <div class="dn-detail-main">
            ...
            <div class="dn-detail-card dn-detail-media-card">
              <figure class="dn-detail-gallery">
                ...
                <img
                  ...
                  decoding="async"
                />
              <figcaption><a href={data.vehicle.evidenceUrl} target="_blank" rel="noopener noreferrer">Оригинална обява и снимки</a>. Снимките в демото очакват одобрение.</figcaption>
              </figure>
            </div>
            ...
            <section class="dn-detail-card dn-detail-info-card" aria-label="Информация за автомобила">
              ...
              {:else if activeDetailTab === 'description'}
                ...
                >
                  <p>
                    {data.vehicle.description} Данните са наблюдавани на {data.vehicle.observedAt}; не са независима проверка на автомобила.
                  </p>
          ...
          <aside class="dn-detail-sidebar" aria-label="Информация за автомобила">
            <section class="dn-detail-card dn-detail-summary">
              ...
              <p class="dn-detail-summary__availability">{data.vehicle.sourceStatus}. {data.vehicle.taxNote}</p>
