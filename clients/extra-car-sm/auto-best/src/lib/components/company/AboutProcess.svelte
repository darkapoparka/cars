...
<section class="dn-about-process dn-section" id="process" aria-labelledby="about-process-title">
  <div class="container">
    <div class="dn-about-section-heading">
      ...
      <p>Подбираме автомобили според вашите критерии, организираме оглед в {brand.city} и обсъждаме внос, бартер или възможности за финансиране след потвърждение директно с екипа.</p>
