...
Once integrated and indexed in the coordinator checkout, `./scripts/start-client.ps1 -Client extra-car-sm -Prepare` and `./scripts/start-client.ps1 -Client extra-car-sm` use the repository launcher. These commands have **not** been run here.
