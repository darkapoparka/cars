...
const pageCopy = {
  bg: {
    badge: "Финансиране от Фреш Ауто",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Фреш Ауто ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Фреш Ауто",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Фреш Ауто team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Фреш Ауто."
      : "A tailored vehicle financing offer from Фреш Ауто.",
    locale,
    path: "/lease",
...
export default async function LeasePage({
  ...
  const vehicles = listings.map((listing) => ({
    ...
    imageUrl: listing.images[0]?.url || "/dealer/stock/11786096960383049-1.webp",
