...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Фреш Ауто.",
          "The form is ready, but message delivery is not configured yet. Call Фреш Ауто directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Фреш Ауто.",
          "Message delivery is not configured yet. Call Фреш Ауто directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Фреш Ауто."
        : "Запитването е изпратено до екипа на Фреш Ауто.",
      "Your request has been sent to the Фреш Ауто team."
    ),
  };
};
