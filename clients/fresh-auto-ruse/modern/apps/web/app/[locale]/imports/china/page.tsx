...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Фреш Ауто."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Фреш Ауто.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Фреш Ауто"
      : "Import from China | Фреш Ауто",
  });
};
