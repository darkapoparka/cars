...
| Modern | modern/apps/web | http://127.0.0.1:6632/cars | http://127.0.0.1:6632/bg/listing/peugeot-3008-383049 |
| Carwow | carwow | http://127.0.0.1:6633/ | http://127.0.0.1:6633/inventory/peugeot-3008-gt-line-383049 |
...
From J:/cars after coordinator integration: ./scripts/start-client.ps1 -Client fresh-auto-ruse -Prepare; then ./scripts/start-client.ps1 -Client fresh-auto-ruse. The existing launcher checks ports; do not use inherited fixed-port wrappers or run Next build and dev together.
