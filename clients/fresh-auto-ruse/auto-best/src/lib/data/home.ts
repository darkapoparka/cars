...
const bodyArtwork = [
  ...
  { label: 'Купе', query: 'Coupe', image: '/dealer/stock/21781675547654182-1.webp', width: 1000, height: 667 },
  { label: 'Спортбек', query: 'Sportback', image: '/dealer/stock/11786094729774131-1.webp', width: 1000, height: 667 }
] as const;
