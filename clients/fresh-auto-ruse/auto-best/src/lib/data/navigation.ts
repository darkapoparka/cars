...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/dealer/stock/11783143816803427-1.webp', href: '/about-us' },
        { id: 'about-import', title: 'Произход и документи', detail: 'Доставка по ваши критерии.', image: '/dealer/stock/11787310277898087-1.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Условия за плащане', detail: 'Обсъдете условията директно с екипа.', image: '/dealer/stock/21781675547654182-1.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'guides-inspection', title: 'Проверка преди покупка', detail: 'История, документи и състояние.', image: '/dealer/stock/11783143816803427-1.webp', href: '/blog-detail/1' },
        { id: 'guides-import', title: 'Произход и документи', detail: 'Основните стъпки преди регистрация.', image: '/dealer/stock/21772531694315778-1.webp', href: '/blog-detail/2' },
        { id: 'guides-leasing', title: 'Лизинг и условия', detail: 'Какво да уточните преди финансиране.', image: '/dealer/stock/11779353271465012-1.webp', href: '/blog-detail/3' }
      ],
      groups: [
        {
          id: 'guides-library',
