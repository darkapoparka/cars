...
export const companyServices: CompanyService[] = [
  ...
  },
  {
    ...
    description: 'Уточнете произхода и документите на избрания автомобил по конкретната обява.',
  ...
  },
  {
    index: '04',
    icon: 'trade-in',
    title: 'Въпрос за замяна',
    description: 'Попитайте дали избраната обява допуска замяна. Не е обещано приемане на бартер.',
