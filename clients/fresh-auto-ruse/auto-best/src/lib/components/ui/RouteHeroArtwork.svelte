<script lang="ts">
  ...
  const images = {
    cars: '/dealer/stock/21772531694315778-1.webp',
    keys: '/dealer/stock/11779353271465012-1.webp',
    guide: '/dealer/stock/11779353271465012-1.webp',
    silver: '/dealer/stock/11779353271465012-1.webp',
    graphite: '/dealer/stock/11786094729774131-1.webp',
    portrait: '/dealer/stock/21772531694315778-1.webp',
    phone: '/dealer/stock/11786096960383049-1.webp',
    showroom: '/dealer/stock/11786096960383049-1.webp',
    email: '/dealer/stock/21772531694315778-1.webp'
  };
  const pairs = {
  ...
  const coloredImages: Partial<Record<keyof typeof images, string>> = {
    silver: '/dealer/stock/11786094729774131-1.webp',
    graphite: '/dealer/stock/11787310277898087-1.webp',
    showroom: '/dealer/stock/21781675547654182-1.webp',
    portrait: '/dealer/stock/11786096960383049-1.webp',
    guide: '/dealer/stock/21786097412257292-1.webp',
    keys: '/dealer/stock/21781675547654182-1.webp',
    phone: '/dealer/stock/21781675547654182-1.webp',
    email: '/dealer/stock/11786096960383049-1.webp'
  };
</script>
