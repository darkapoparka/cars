<script lang="ts">
	...
	const leftCarSrc =
		'/dealer/stock/11783143816803427-1.webp';
	const rightCarSrc =
		'/dealer/stock/21772531694315778-1.webp';
		...
		<div class="daynight-home-hero__visual" aria-hidden="true">
			<img
				...
				srcset={desktopOnlySrcset(
					'/dealer/stock/11786096960383049-1.webp',
					1983
				)}
			...
			<div class="daynight-home-hero__stage-content daynight-home-container">
				<div class="daynight-home-hero__location-wrap">
					...
					>
						...
						<span>Русе · уточнете адреса по телефона</span>
					</button>
					<button
						type="button"
						id="daynight-home-hero-map-preview"
						class="daynight-home-hero__location-preview"
						aria-label="Отвори Google Maps до Фреш Ауто"
						onclick={openMap}
					>
						<span class="daynight-home-hero__location-map" aria-hidden="true">
							...
							<span class="daynight-home-hero__location-map-label">Фреш Ауто</span>
						</span>
						<span class="daynight-home-hero__location-preview-copy">
							<strong>Фреш Ауто Русе</strong>
							<span>Главен път за Варна, 100 м след Джъмбо, Русе</span>
