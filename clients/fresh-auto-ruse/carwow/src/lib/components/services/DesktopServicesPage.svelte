	...
	const services = [
		{
			...
			image: '/dealer/stock/21781675547654182-1.webp',
		...
		},
		{
			...
			image: '/dealer/stock/11783143816803427-1.webp',
			imagePosition: 'center bottom'
		},
		{
			id: 'financing',
			...
			image: '/dealer/stock/21786097412257292-1.webp',
			imagePosition: 'center bottom'
		},
		{
			id: 'trade-in',
			...
			image: '/dealer/stock/21772531694315778-1.webp',
			imagePosition: 'center bottom'
		},
		{
			id: 'sourcing',
...
<main id="main-content" tabindex="-1" class="desktop-services" aria-label="Услуги Фреш Ауто">
	...
	<section class="desktop-services-offers">
		<div class="container">
			<h2 class="desktop-services-sr-only">Конкретни услуги от Фреш Ауто</h2>
