	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				src={resolve('/dealer/stock/21772531694315778-1.webp')}
				alt="Илюстративна визия на Фреш Ауто: Mercedes-Benz и Lamborghini с ключове за бартер"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					Фреш Ауто е автокъща в Русе. При нас можеш да разгледаш наличните автомобили, да
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до Фреш Ауто Русе" height="280" />
				{:else}
