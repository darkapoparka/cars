...
<div class="mobile-about-app" aria-label="За Фреш Ауто">
	<header class="mobile-about-hero">
		<img
			class="mobile-about-hero__bg"
			src={resolve('/dealer/stock/11783143816803427-1.webp')}
			alt=""
			aria-hidden="true"
		/>
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="Фреш Ауто начало">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Фреш Ауто в Русе помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/dealer/stock/11786094729774131-1.webp')}
				alt="Консултация със Фреш Ауто"
				loading="lazy"
				decoding="async"
			/>
			<div>
