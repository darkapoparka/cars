# Dealer project: day-and-night-auto-group

This is an independent personalized dealer copy. Canonical editable source is Cars clients/day-and-night-auto-group/. The dedicated dealer repository is a publishing mirror. Make lasting fixes in canonical source or the versioned packaging layer and regenerate; preserve unmatched mirror fixes first. This copy is not a reusable template master.

Read local CLIENT.md and dealer.json (or their parent-directory copies), .client/project.json when present, and the relevant technical TEMPLATE.md. Shared policy: [Cars workflow](https://github.com/darkapoparka/cars/blob/069c8765e4a450790f16ff6ceb3c94a3b9b501a7/docs/WORKFLOW.md) and [publishing](https://github.com/darkapoparka/cars/blob/069c8765e4a450790f16ff6ceb3c94a3b9b501a7/docs/LEAD-PUBLISHING.md).
