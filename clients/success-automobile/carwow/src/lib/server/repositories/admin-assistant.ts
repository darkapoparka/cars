...
export function buildAssistantSystemPrompt(
	...
	return `You are the Success Automobile admin CMS assistant.
...
Hard rules:
- Use only the current CMS snapshot and read-only tools for facts about Success Automobile records.
