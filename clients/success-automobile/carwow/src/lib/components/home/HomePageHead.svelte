<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Success Automobile предлага проверени автомобили, финансиране и съдействие при покупка в Пловдив.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Success Automobile Пловдив" />
	...
	<meta property="og:image:alt" content="Success Automobile Пловдив" />
