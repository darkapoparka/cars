					...
					>
						<div>
							<a
								...
								aria-label="Success Automobile начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								Success Automobile предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										aria-label="Отвори локацията на Success Automobile в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със Success Automobile."
								>
									Свържете се
								</a>
							</div>
			...
			>
				<p class="m-0 text-sa-sm leading-[22px] text-sa-surface/60">
					©2026 <a
						...
						href={resolve('/')}>Success Automobile</a
