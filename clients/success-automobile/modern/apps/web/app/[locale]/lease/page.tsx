...
const pageCopy = {
  bg: {
    badge: "Финансиране от Success Automobile",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Success Automobile ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Success Automobile",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Success Automobile team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Success Automobile."
      : "A tailored vehicle financing offer from Success Automobile.",
    locale,
    path: "/lease",
