...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Success Automobile за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Индустриална зона — Тракия.",
    locationLabel: "Шоурум · Индустриална зона — Тракия",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Success Automobile, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Индустриална зона — Тракия",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Success Automobile about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Success Automobile to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Success Automobile в Пловдив — автомобили в наличност, внос по заявка и условия за плащане."
      : "Success Automobile in Пловдив — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Success Automobile"
      : "About and contact | Success Automobile",
  });
};
