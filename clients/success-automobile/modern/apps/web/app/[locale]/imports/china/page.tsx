...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Success Automobile."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Success Automobile.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Success Automobile"
      : "Import from China | Success Automobile",
  });
};
