...
describe("Success Automobile localized metadata", () => {
  it("brands Bulgarian pages and emits canonical locale metadata", () => {
    ...
    expect(metadata.title).toBe("Автомобили | Success Automobile");
    expect(metadata.applicationName).toBe("Success Automobile");
