<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Капитол предлага проверени автомобили, финансиране и съдействие при покупка в Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Капитол Варна" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Капитол Варна" />
	{/if}
