...
<div class="mobile-home" aria-label="Капитол — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Капитол home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Капитол"
				>
		...
		<h1 class="mh-hero__title">Капитол</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Капитол Варна. Всички права запазени.</span>
	</footer>
