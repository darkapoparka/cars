...
<section class="home-videos" aria-label="Капитол в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Капитол в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">Капитол в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
