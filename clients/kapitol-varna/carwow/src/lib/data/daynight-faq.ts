...
const answers = {
	...
	'financing-documents': paragraphs(
		'Няма потвърден списък с документи или финансова оферта за този демо проект. Попитайте продавача дали за избрания автомобил се предлага финансиране, кой го предоставя и какви документи изисква. Не изпращайте лични документи през демото.'
	),
	reserve: paragraphs(
	...
	'trade-in-accepted': paragraphs(
		'Приемането на автомобил за бартер не е потвърдено за тази демонстрация. Попитайте продавача дали разглежда такова предложение за конкретната сделка. Формата не означава приемане на автомобила или обещание за изкупуване.'
	),
	...
	delivery: paragraphs(
		'Доставка до друг град не е потвърдена услуга за тази демонстрация. Попитайте продавача дали може да бъде организирана за избрания автомобил, при какъв срок и цена. Дата за очакван внос в обявата не е обещание за доставка до Вас.'
	)
} as const;
