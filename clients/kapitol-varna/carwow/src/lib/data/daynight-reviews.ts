...
export const daynightReviewDisclosure = 'Няма одобрени клиентски отзиви или потвърден рейтинг за това демо.';

export const daynightReviewCount = daynightReviews.length;
export const daynightReviewCountLabel = 'Няма одобрени отзиви';
