<script lang="ts">
	...
	const guideCards = [
		...
		{
			title: 'Sell or part exchange with Капитол',
...
<svelte:head>
	<title>Капитол Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from Капитол Варна."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="Капитол Home2">
				<img src="/dealer/logo-pending.svg" alt="Капитол" />
			</a>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular Капитол picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate Капитол as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/dealer/media-pending.svg" alt="Капитол consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse Капитол stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
