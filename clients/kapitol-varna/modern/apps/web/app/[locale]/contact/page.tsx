...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Капитол за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в бул. Цар Освободител 236.",
    locationLabel: "Шоурум · бул. Цар Освободител 236",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Капитол, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · бул. Цар Освободител 236",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Капитол about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Капитол to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "КАПИТОЛ в Варна — автомобили в наличност, внос по заявка и възможности за финансиране след потвърждение."
      : "КАПИТОЛ in Варна — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Капитол"
      : "About and contact | Капитол",
  });
};
