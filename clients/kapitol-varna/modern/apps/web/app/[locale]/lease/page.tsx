...
const pageCopy = {
  bg: {
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Капитол ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Капитол team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от КАПИТОЛ."
      : "A tailored vehicle financing offer from КАПИТОЛ.",
    locale,
    path: "/lease",
