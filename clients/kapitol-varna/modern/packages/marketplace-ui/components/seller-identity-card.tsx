...
export const LeadSiteListingIdentityCard = ({
  ...
  return (
    ...
    >
      ...
      {listing.sourceUrl ? <a href={listing.sourceUrl} target="_blank" rel="noopener noreferrer">{isBg ? "Оригинална обява и снимки" : "Original advertisement and photos"}</a> : null}
