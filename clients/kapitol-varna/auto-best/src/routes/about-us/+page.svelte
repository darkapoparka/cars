...
<svelte:head>
  ...
  <meta name="description" content={`${brand.name} — премиум автомобили, внос по заявка, възможности за финансиране след потвърждение, бартер и огледи с предварителна уговорка в ${brand.city}.`} />
</svelte:head>
