...
Once integrated into the coordinator checkout, `./scripts/start-client.ps1 -Client kapitol-varna -Prepare` and `./scripts/start-client.ps1 -Client kapitol-varna` use the repository launcher. These commands have **not** been run here.
