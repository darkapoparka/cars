...
export function buildAssistantSystemPrompt(
	...
	return `You are the Champion Auto Pro admin CMS assistant.
...
Hard rules:
- Use only the current CMS snapshot and read-only tools for facts about Champion Auto Pro records.
