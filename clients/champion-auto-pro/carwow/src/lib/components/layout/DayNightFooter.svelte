<script lang="ts">
	...
	const facebookLinkProps = {
		href: 'https://championautopro.mobile.bg/', hidden: true,
		target: '_blank',
		rel: 'noopener'
	} as const;
					...
					>
						<div>
							<a
								...
								aria-label="Champion Auto Pro начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								Champion Auto Pro предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										aria-label="Отвори локацията на Champion Auto Pro в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със Champion Auto Pro."
								>
									Свържете се
								</a>
							</div>
			...
			>
				<p class="m-0 text-sa-sm leading-[22px] text-sa-surface/60 max-[767px]:ml-[15px]">
					©2026 <a
						...
						href={resolve('/')}>Champion Auto Pro</a
