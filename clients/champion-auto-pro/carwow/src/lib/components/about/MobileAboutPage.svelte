...
<div class="mobile-about-app" aria-label="За Champion Auto Pro">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Champion Auto Pro в Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				...
				alt="Консултация със Champion Auto Pro"
				loading="lazy"
				decoding="async"
			/>
			<div>
