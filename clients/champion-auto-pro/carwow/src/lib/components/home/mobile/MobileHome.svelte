...
<div class="mobile-home" aria-label="Champion Auto Pro — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Champion Auto Pro home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/champion/logo.png')}
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Champion Auto Pro"
				>
		...
		<h1 class="mh-hero__title">Champion Auto Pro</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Champion Auto Pro Варна. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, Цар Освободител 302, бул. Цар Освободител 302</strong>
			</div>
