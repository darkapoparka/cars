<script lang="ts">
  ...
  {
    "id": "stock",
    "description": "Подбрани автомобили от публикуваните обяви. Потвърдете актуалната наличност по телефона.",
    "avatar": "/assets/champion/logo.png",
    "name": "Champion Auto Pro",
    "meta": "Автомобили"
  },
  {
    "id": "trade",
    "description": "Автокъщата публикува възможности за бартер и изкупуване. Условията се договарят индивидуално.",
    "avatar": "/assets/champion/logo.png",
    "name": "Champion Auto Pro",
    "meta": "Бартер"
  },
  {
    "id": "visit",
    "description": "бул. „Цар Освободител“ 302 / Автомивка Izgi Europe Motor. Понеделник – петък: 09:30–18:00. Събота: 10:00–15:00. Неделя: почивен ден",
    "avatar": "/assets/champion/logo.png",
    "name": "Champion Auto Pro",
    "meta": "Посещение"
  }
	...
	const actionCards: ActionCard[] = [
		...
		},
		{
			...
			bullets: [
				...
				'Получете обратна връзка от екипа на Champion Auto Pro.',
