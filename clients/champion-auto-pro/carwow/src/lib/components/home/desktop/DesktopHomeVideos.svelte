...
<section class="home-videos" aria-label="Автомобили отблизо">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Автомобили отблизо" href={youtubeChannelUrl} label="Всички обяви">
