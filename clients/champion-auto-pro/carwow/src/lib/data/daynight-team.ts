...
export const daynightTeam: DayNightTeamMember[] = [
	{
		...
		name: "Екип продажби Champion Auto Pro",
		...
		detail:
			"Консултантите на Champion Auto Pro помагат с избор според бюджет, пробег, оборудване и реална наличност. При нужда подготвят оглед, запазване на автомобил и координация на следващите стъпки."
	},
	{
