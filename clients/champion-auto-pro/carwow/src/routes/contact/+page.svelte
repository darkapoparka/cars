<script lang="ts">
	...
	const currentSeo = $derived(
		browser && page.url.searchParams.get('intent') === 'import'
			? {
					title: 'Внос на автомобил | Champion Auto Pro Варна',
					description:
						'Изпратете обява или опишете желания автомобил и получете конкретни варианти за внос от Champion Auto Pro.'
				}
			: data.seo
	);
</script>
