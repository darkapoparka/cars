...
const pageCopy = {
  bg: {
    heroImageAlt: "Champion Auto Pro — Варна",
    title: "Премиум автомобили. Внос. Лизинг.",
    description:
      "Вижте автомобилите в наличност или говорете директно с Champion Auto Pro за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Цар Освободител 302.",
    locationLabel: "Шоурум · Цар Освободител 302",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Champion Auto Pro, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Цар Освободител 302",
    services: [
      {
  ...
  en: {
    heroImageAlt: "Champion Auto Pro — Varna",
    title: "Premium vehicles. Imports. Leasing.",
    description:
      "Browse the vehicles in stock or speak directly with Champion Auto Pro about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Tsar Osvoboditel 302.",
    locationLabel: "Showroom · Tsar Osvoboditel 302",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Champion Auto Pro to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Tsar Osvoboditel 302",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Champion Auto Pro в Варна — автомобили в наличност, внос по заявка и собствен лизинг."
      : "Champion Auto Pro in Varna — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Champion Auto Pro"
      : "About and contact | Champion Auto Pro",
  });
};
