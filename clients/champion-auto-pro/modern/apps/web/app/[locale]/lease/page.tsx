...
const pageCopy = {
  bg: {
    badge: "Финансиране от Champion Auto Pro",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Champion Auto Pro ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Champion Auto Pro",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Champion Auto Pro team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Champion Auto Pro."
      : "A tailored vehicle financing offer from Champion Auto Pro.",
    locale,
    path: "/lease",
