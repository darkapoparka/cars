...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Champion Auto Pro."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Champion Auto Pro.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Champion Auto Pro"
      : "Import from China | Champion Auto Pro",
  });
};
