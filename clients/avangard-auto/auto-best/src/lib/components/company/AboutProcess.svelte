...
<section class="dn-about-process dn-section" id="process" aria-labelledby="about-process-title">
  <div class="container">
    <div class="dn-about-section-heading">
      ...
      <p>Разгледайте обявите и уговорете оглед в {brand.city}. Публикуваните предложения включват съдействие при регистрация, транспорт в България и възможност за лизинг.</p>
