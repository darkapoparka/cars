  ...
  <div class="container">
    <div class="dn-videos__panel">
      <div class="dn-videos__heading dn-home-section-heading">
        <h2 id="videos-title" class="dn-home-section-title"><span class="dn-videos__intro">Следвайте ни в</span><span class="dn-videos__brand-mark"><SocialBrandIcon name="facebook" size={32} /></span>Facebook</h2>
        <p>Автомобили от обявите на AVANGARD AUTO.</p>
        <a class="dn-videos__channel dn-home-section-action" href={brand.youtubeUrl} target="_blank" rel="noopener noreferrer">
          <span>Всички публикации</span>
          <Icon name="arrow-right" size={16} />
          <span class="dn-sr-only"> в Facebook (нов раздел)</span>
        </a>
      </div>
      ...
      <div class="dn-videos__grid">
          ...
          <article class="dn-video-card">
            ...
            <div class="dn-video-card__content">
              ...
              <div class="dn-video-card__actions">
                <a href={video.url} target="_blank" rel="noopener noreferrer" aria-label={`${video.title} — гледайте в Facebook (нов раздел)`}>
                  Отворете обявата <Icon name="arrow-right" size={16} />
                </a>
        ...
        <a class="dn-videos__all-card" href={brand.youtubeUrl} target="_blank" rel="noopener noreferrer">
          <span class="dn-videos__all-icon"><SocialBrandIcon name="facebook" size={40} /></span>
          <strong>Всички публикации</strong>
          <span>Отворете обявата</span>
