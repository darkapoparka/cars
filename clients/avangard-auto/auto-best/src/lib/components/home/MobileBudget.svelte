<script lang="ts">
  ...
  const budgetTiles = [
    ...
    {
      label: '10–20 000 €',
      detail: `${featuredVehicles.filter((vehicle) => vehicle.priceEur > 10000 && vehicle.priceEur <= 20000).length} автомобила`,
      href: '/listing-grid?price_min=10000&price_max=20000',
    ...
    },
    {
      ...
      image: featuredVehicles[11].image
    },
    {
      label: 'Виж всички',
