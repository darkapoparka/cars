...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/assets/avangard/vehicle-15-1.webp', href: '/about-us' },
        { id: 'about-import', title: 'Транспорт в България', detail: 'Доставка по ваши критерии.', image: '/assets/avangard/vehicle-16-1.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Лизинг', detail: 'Обсъдете условията директно с екипа.', image: '/assets/avangard/vehicle-01-1.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
      ...
      cta: { id: 'about-cta', label: 'Свържете се с екипа', href: '/contact', detail: 'Наличност, оглед, внос и лизинг.' }
    }
  },
  {
    id: 'guides',
    ...
    menu: {
      ...
      features: [
        { id: 'guides-inspection', title: 'Проверка преди покупка', detail: 'История, документи и състояние.', image: '/assets/avangard/vehicle-12-1.webp', href: '/blog' },
        { id: 'guides-import', title: 'Внос и документи', detail: 'Основните стъпки преди регистрация.', image: '/assets/avangard/vehicle-13-1.webp', href: '/blog' },
        { id: 'guides-leasing', title: 'Лизинг и условия', detail: 'Какво да уточните преди финансиране.', image: '/assets/avangard/vehicle-14-1.webp', href: '/blog' }
      ],
      groups: [
        {
          id: 'guides-library',
