...
export const editorial = [
  ...
  },
  {
    ...
    text: 'Уточнете историята, документите и техническото състояние преди покупка.',
  ...
  {
    title: 'Има ли съдействие при регистрация?',
    text: 'Обявите предлагат съдействие при регистрация и транзитни номера в КАТ. Уточнете условията с екипа.',
