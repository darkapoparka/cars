...
export const companyServices: CompanyService[] = [
  ...
  },
  {
    ...
    description: 'В обявите се предлага транспорт в България. Попитайте за цена и условия.',
  ...
  },
  {
    ...
    description: 'Попитайте екипа за възможностите за вашия автомобил.',
...
export const contactTopics: ContactTopic[] = [
  ...
  },
  {
    ...
    label: 'Внос',
    title: 'Транспорт в България',
    description: 'Попитайте за регистрация, транзитни номера и транспорт на избрания автомобил.',
  ...
  },
  {
    ...
    label: 'Бартер',
    title: 'Въпрос за автомобил',
    description: 'Попитайте екипа дали може да съдейства за вашия автомобил. Няма потвърдена услуга за изкупуване или бартер.',
    mobileDescription: 'Поискайте оценка за вашия автомобил.'
  }
];
