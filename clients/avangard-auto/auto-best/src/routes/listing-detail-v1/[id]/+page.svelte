          ...
          <div class="dn-detail-main">
            ...
            <div class="dn-detail-card dn-detail-media-card">
              <figure class="dn-detail-gallery">
                ...
                <img
                  src={data.vehicle.gallery[selectedPhoto % data.vehicle.gallery.length]}
                  ...
                  decoding="async"
                />
                <button class="dn-detail-gallery__count" type="button" aria-label="Следваща снимка" onclick={() => selectedPhoto += 1}>{(selectedPhoto % data.vehicle.gallery.length) + 1} / {data.vehicle.gallery.length}</button>
              </figure>
            </div>
