...
const pageCopy = {
  bg: {
    badge: "Финансиране от AVANGARD AUTO",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Контакт с AVANGARD AUTO ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from AVANGARD AUTO",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The AVANGARD AUTO team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от AVANGARD AUTO."
      : "A tailored vehicle financing offer from AVANGARD AUTO.",
    locale,
    path: "/lease",
