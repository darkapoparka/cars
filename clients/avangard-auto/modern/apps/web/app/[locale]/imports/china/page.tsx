...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от AVANGARD AUTO."
      : "Start a request for a vehicle from China with delivery to Bulgaria from AVANGARD AUTO.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | AVANGARD AUTO"
      : "Import from China | AVANGARD AUTO",
  });
};
