...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с AVANGARD AUTO за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Владислав Варненчик.",
    locationLabel: "Шоурум · Владислав Варненчик",
    mapAction: "Отворете картата",
    servicesTitle: "Изберете правилната посока.",
    servicesDescription:
      "От наличен автомобил до транспорт в България — екипът ни е на една връзка разстояние.",
    sellHandoffAction: "Обадете се за оферта",
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на AVANGARD AUTO, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Владислав Варненчик",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with AVANGARD AUTO about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Vladislav Varnenchik.",
    locationLabel: "Showroom · Vladislav Varnenchik",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call AVANGARD AUTO to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Vladislav Varnenchik",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "AVANGARD AUTO в Варна — автомобили в наличност, транспорт в България и лизинг."
      : "AVANGARD AUTO in Varna — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | AVANGARD AUTO"
      : "About and contact | AVANGARD AUTO",
  });
};
        ...
        <section className="relative isolate hidden overflow-hidden border-white/10 border-b lg:block">
          <div className="absolute inset-0 -z-20 bg-[#08090a]">
            <Image
              ...
              priority
              sizes="100vw"
              src="/assets/avangard/social-cover.jpg"
            />
          </div>
          <div
            aria-hidden="true"
