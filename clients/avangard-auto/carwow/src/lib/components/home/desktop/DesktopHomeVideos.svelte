...
<section class="home-videos" aria-label="AVANGARD AUTO — избрани автомобили">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="AVANGARD AUTO — избрани автомобили" href={youtubeChannelUrl} label="Facebook">
			{#snippet titleContent()}
				<span class="home-videos__title">AVANGARD AUTO</span>
			{/snippet}
