<script lang="ts">
	...
	const support = [
		...
		{ title: 'Въпрос за автомобил', icon: ArrowLeftRight, description: 'Попитай екипа дали може да съдейства за твоя автомобил. Услугите се потвърждават индивидуално.', href: '/sell-your-car', action: 'Продай или замени' },
	...
	const teamLabels = ['Продажби', 'Въпрос за автомобил', 'Документи и финансиране', 'Клиентски заявки'];
	const demoNames = ['Автомобили', 'Контакт', 'Регистрация', 'Посещение'];
		...
		<div class="about-container">
			...
			<div class="about-social-row">
				<a class="about-reviews-link about-text-link" href={resolve('/reviews')}
					>Полезна информация <ArrowRight size={18} /></a
				>
			</div>
		</div>
	</section>
	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				src={resolve('/assets/avangard/vehicle-03-1.webp')}
				alt="Илюстративна визия на AVANGARD AUTO: Mercedes-Benz и Lamborghini с ключове за бартер"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					AVANGARD AUTO е автокъща във Варна. При нас можеш да разгледаш наличните автомобили, да
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до AVANGARD AUTO Варна" height="280" />
				{:else}
