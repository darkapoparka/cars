...
<div class="mobile-about-app" aria-label="За AVANGARD AUTO">
	<header class="mobile-about-hero">
		<img
			class="mobile-about-hero__bg"
			src={resolve('/assets/avangard/vehicle-05-1.webp')}
			alt=""
			aria-hidden="true"
		/>
		...
		<div class="mobile-about-hero__copy">
			...
			<p>AVANGARD AUTO във Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/assets/avangard/vehicle-06-1.webp')}
				alt="Консултация със AVANGARD AUTO"
				loading="lazy"
				decoding="async"
			/>
			<div>
