<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'AVANGARD AUTO представя обяви за автомобили, финансиране и съдействие при покупка във Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="AVANGARD AUTO Варна" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="AVANGARD AUTO Варна" />
	{/if}
