	...
	const services = [
		{
			...
			summary: 'Уговорете оглед и уточнете документите и състоянието преди покупка.',
		...
		},
		{
			...
			summary: 'Съдействие при регистрация и транзитни номера, обявено в Mobile.bg.',
		...
		},
		{
			...
			summary: 'Попитайте дали автокъщата може да съдейства за вашия автомобил. Бартер и изкупуване не са потвърдени услуги.',
		...
		},
		{
			...
			summary: 'Разгледайте публикуваните обяви. За други автомобили попитайте екипа.',
			image: '/assets/avangard/vehicle-03-1.webp',
			imagePosition: 'center bottom'
		},
		{
...
<main id="main-content" tabindex="-1" class="desktop-services" aria-label="Услуги AVANGARD AUTO">
	...
	<section class="desktop-services-offers">
		<div class="container">
			<h2 class="desktop-services-sr-only">Конкретни услуги от AVANGARD AUTO</h2>
