...
const stepsAnswer: readonly FaqAnswerParagraph[] = [
	{
		...
		text: 'Изберете публикуван автомобил и се свържете с AVANGARD AUTO за наличност, оглед и условия. Възможностите извън публикуваните услуги се уточняват индивидуално.'
	},
	{
...
const termsAnswer: readonly FaqAnswerParagraph[] = [
	{
		class: 'h7 text-secondary line-height-28',
		text: 'Условията зависят от конкретния автомобил и избраната схема. Свържете се с екипа на AVANGARD AUTO за актуална информация, съдействие по документите.'
	}
];
