...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Дневни новини от AVANGARD AUTO',
		description:
			'Кратък дневен преглед на наличността, търсените марки и практичните стъпки за оглед в AVANGARD AUTO.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-28',
		author: 'AVANGARD AUTO',
	...
	article({
		...
		description:
			'Обновления за интересни автомобили, които пристигат в наличността на AVANGARD AUTO Варна.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-27',
		author: 'AVANGARD AUTO',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'AVANGARD AUTO съдейства с документи, регистрация, финансиране и оглед на място във Варна.'
				]
			}
		],
	...
	article({
		...
		title: 'Лизинг за употребяван автомобил във Варна',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Контакт с AVANGARD AUTO може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'AVANGARD AUTO предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на AVANGARD AUTO често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез AVANGARD AUTO.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'AVANGARD AUTO',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'AVANGARD AUTO помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
