<script lang="ts">
  ...
  const images = {
    ...
    portrait: '/dealer/inventory/21783937913461083-1.webp',
    phone: '/dealer/inventory/21786378692115915-1.webp',
    showroom: '/dealer/inventory/11787674075681544-1.webp',
    email: '/dealer/inventory/21781003069917784-1.webp'
  };
  const pairs = {
