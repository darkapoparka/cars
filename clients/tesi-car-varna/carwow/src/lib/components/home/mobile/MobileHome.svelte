...
<div class="mobile-home" aria-label="Теси Кар — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Теси Кар home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Теси Кар"
				>
		...
		<h1 class="mh-hero__title">Теси Кар</h1>
			...
			<div class="mh-brand-grid">
				...
				<a class="mh-brandcard mh-brandcard--all" href={inventoryHref}>
					<span class="mh-brandcard__all-icon" aria-hidden="true">
						<img src={resolve('/dealer/logo.png')} alt="" loading="lazy" />
					</span>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Теси Кар Варна. Всички права запазени.</span>
	</footer>
