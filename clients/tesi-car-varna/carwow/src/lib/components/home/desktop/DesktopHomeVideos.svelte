...
<section class="home-videos" aria-label="Теси Кар в YouTube">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Теси Кар в YouTube" href={youtubeChannelUrl} label="Всички видеа">
			{#snippet titleContent()}
				<span class="home-videos__title">Теси Кар в <img src="/assets/brands/youtube-logo.png" alt="YouTube" width="186" height="62" /></span>
			{/snippet}
