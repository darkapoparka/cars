<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Теси Кар предлага проверени автомобили, финансиране и съдействие при покупка в Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Теси Кар Варна" />
	...
	<meta property="og:image:alt" content="Теси Кар Варна" />
