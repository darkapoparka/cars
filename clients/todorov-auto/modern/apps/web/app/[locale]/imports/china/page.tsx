...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Автосалон Тодоров."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Автосалон Тодоров.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Автосалон Тодоров"
      : "Import from China | Автосалон Тодоров",
  });
};
