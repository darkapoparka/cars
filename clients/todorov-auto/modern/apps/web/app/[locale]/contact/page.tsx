...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Автосалон Тодоров за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Изгрев.",
    locationLabel: "Шоурум · Изгрев",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Автосалон Тодоров, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Изгрев",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Автосалон Тодоров about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Автосалон Тодоров to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    title: isBg
      ? "За нас и контакти | Автосалон Тодоров"
      : "About and contact | Автосалон Тодоров",
  });
};
