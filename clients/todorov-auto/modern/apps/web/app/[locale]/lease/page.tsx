...
const pageCopy = {
  bg: {
    badge: "Финансиране от Автосалон Тодоров",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Автосалон Тодоров ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Автосалон Тодоров",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Автосалон Тодоров team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Автосалон Тодоров."
      : "A tailored vehicle financing offer from Автосалон Тодоров.",
    locale,
    path: "/lease",
