...
const organizationSuggestions: readonly SearchSuggestionDefinition[] = [
  {
    ...
    kind: "dealer",
    label: "Бургас Premium Cars",
    popular: true,
    value: "Бургас Premium Cars",
  },
  {
    descriptionBg: "Вносител от Китай · Бургас",
    descriptionEn: "Importer from China · Бургас",
    id: "china-ev-import",
  ...
  {
    descriptionBg: "Дилъри и вносители в Бургас",
    descriptionEn: "Dealers and importers in Бургас",
