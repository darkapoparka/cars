...
describe("Автосалон Тодоров localized metadata", () => {
  it("brands Bulgarian pages and emits canonical locale metadata", () => {
    ...
    expect(metadata.title).toBe("Автомобили | Автосалон Тодоров");
    expect(metadata.applicationName).toBe("Автосалон Тодоров");
