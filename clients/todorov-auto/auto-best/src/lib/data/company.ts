...
export const companyServices: CompanyService[] = [
  ...
  },
  {
    ...
    "description": "Публикувано съдействие за регистрация. Уточнете документите и разходите за конкретния автомобил.",
  ...
  },
  {
    "index": "03",
    "icon": "leasing",
    "title": "Застрахователни услуги",
    "description": "Услугата е посочена в публичния профил. Конкретното покритие и цена се уточняват отделно.",
...
export const contactTopics: ContactTopic[] = [
  {
    "id": "general",
    "label": "Общ въпрос",
    "title": "Контакт с Автосалон Тодоров",
    "description": "Автомобили в Бургас. Изберете, сравнете и уговорете оглед."
  },
  {
    "id": "inspection",
    "label": "Оглед",
