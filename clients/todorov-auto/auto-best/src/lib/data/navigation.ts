...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/dealer/stock/11763371717307272-1.webp', href: '/about-us' },
        { id: 'about-import', title: 'Документи и произход', detail: 'Попитайте за конкретния автомобил.', image: '/dealer/stock/11704208021161812-1.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Условия за плащане', detail: 'Обсъдете условията директно с екипа.', image: '/dealer/stock/11735041255980884-1.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
