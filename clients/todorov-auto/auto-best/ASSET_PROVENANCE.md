...
- Автосалон Тодоров logo and representative stock images are lead-specific media retained for this registered Sales Demo.
...
Use Автосалон Тодоров's Instagram `https://www.instagram.com/dayandnight_autogroup/` and Facebook `https://www.facebook.com/deninoshtautogroup/`, explicitly labelled as the dealership profiles in all three saved owner-channel video descriptions (watch IDs6S3dLIgeAT8, zG6rjLpT4u8, w_XaGmIWJFM). YouTube points to the owner-supplied Автосалон Тодоров channel already used by the homepage videos. Extracted source descriptions: artifacts/banner-social-correction/social-source-descriptions.txt; originals remain under artifacts/video-section.
