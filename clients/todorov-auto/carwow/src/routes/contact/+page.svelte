<script lang="ts">
	...
	const currentSeo = $derived(
		browser && page.url.searchParams.get('intent') === 'import'
			? {
					title: 'Внос на автомобил | Автосалон Тодоров Бургас',
					description:
						'Изпратете обява или опишете желания автомобил и получете конкретни варианти за внос от Автосалон Тодоров.'
				}
			: data.seo
	);
</script>
