...
export function buildAssistantSystemPrompt(
	...
	return `You are the Автосалон Тодоров admin CMS assistant.
...
Hard rules:
- Use only the current CMS snapshot and read-only tools for facts about Автосалон Тодоров records.
