<script lang="ts">
	...
	const steps = [
		...
		'Оглед в Бургас и финализиране с екипа.'
	] as const;
...
<div class="mobile-financing-app" aria-label="Финансиране от Автосалон Тодоров">
	<header class="mobile-financing-hero">
		...
		<div class="mobile-financing-hero__copy">
			...
			<p>Ясни условия, ориентировъчна месечна вноска и съдействие от екипа в Бургас.</p>
		</div>
