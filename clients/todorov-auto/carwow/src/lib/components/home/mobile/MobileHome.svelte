...
<div class="mobile-home" aria-label="Автосалон Тодоров — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Автосалон Тодоров home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Автосалон Тодоров"
				>
		...
		<h1 class="mh-hero__title">Автосалон Тодоров</h1>
