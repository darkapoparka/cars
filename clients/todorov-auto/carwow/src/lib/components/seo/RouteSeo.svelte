<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Автосалон Тодоров предлага проверени автомобили, финансиране и съдействие при покупка в Бургас.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Автосалон Тодоров Бургас" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Автосалон Тодоров Бургас" />
	{/if}
