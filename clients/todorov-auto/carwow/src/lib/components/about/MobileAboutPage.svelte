...
<div class="mobile-about-app" aria-label="За Автосалон Тодоров">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="Автосалон Тодоров начало">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Автосалон Тодоров · Бургас. Публични обяви, информация за автомобилите и директен контакт за оглед.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				...
				alt="Консултация със Автосалон Тодоров"
				loading="lazy"
				decoding="async"
			/>
			<div>
				<span>Шоурум в Бургас</span>
