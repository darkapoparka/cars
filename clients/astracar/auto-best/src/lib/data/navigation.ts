...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        ...
        { id: 'about-import', title: 'Внос и регистрация', detail: 'Доставка по ваши критерии.', image: '/assets/images/lead/day-night-stock-03.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Лизинг по запитване', detail: 'Обсъдете условията директно с екипа.', image: '/assets/images/lead/day-night-stock-06.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'guides-inspection', title: 'Проверка преди покупка', detail: 'История, документи и състояние.', image: '/assets/astracar/vehicle-01-1.webp', href: '/blog' },
        { id: 'guides-import', title: 'Внос и документи', detail: 'Основните стъпки преди регистрация.', image: '/assets/astracar/vehicle-01-1.webp', href: '/blog' },
        { id: 'guides-leasing', title: 'Лизинг и условия', detail: 'Какво да уточните преди финансиране.', image: '/assets/astracar/vehicle-01-1.webp', href: '/blog' }
      ],
      groups: [
        {
          id: 'guides-library',
