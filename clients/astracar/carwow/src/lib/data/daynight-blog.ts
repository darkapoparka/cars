...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Дневни новини от Астракар',
		description:
			'Кратък дневен преглед на наличността, търсените марки и практичните стъпки за оглед в Астракар.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-28',
		author: 'Астракар',
	...
	article({
		...
		description:
			'Обновления за интересни автомобили, които пристигат в наличността на Астракар Варна.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-27',
		author: 'Астракар',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Астракар съдейства с документи, регистрация, финансиране и оглед на място в Варна.'
				]
			}
		],
	...
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на Астракар може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Астракар предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
	...
	article({
		...
		sections: [
			{
				heading: 'Защо автомобилите искат повече внимание',
				paragraphs: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на Астракар често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез Астракар.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'Астракар',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Астракар помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
