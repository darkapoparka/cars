...
export const daynightSite = {
	...
	location,
	locationShort: "бул. „Цар Освободител“ 282",
	locationLandmark: "бул. „Цар Освободител“ 282",
	hoursLabel: "Обадете се за работно време и оглед.",
	...
	sourceInventory: "https://astracar.mobile.bg/",
	...
	heroTitle: "Астракар",
	heroSubtitle: "Варна · Подбрани публикувани обяви. Наличностите и условията се потвърждават с Астракар.",
