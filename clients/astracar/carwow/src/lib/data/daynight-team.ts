...
export const daynightTeam: DayNightTeamMember[] = [
	{
		...
		detail:
			"Консултантите на Астракар помагат с избор според бюджет, пробег, оборудване и реална наличност. При нужда подготвят оглед, запазване на автомобил и координация на следващите стъпки."
	},
	{
