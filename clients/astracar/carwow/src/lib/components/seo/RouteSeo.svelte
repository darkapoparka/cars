<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Астракар предлага проверени автомобили, финансиране и съдействие при покупка в Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Астракар Варна" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Астракар Варна" />
	{/if}
