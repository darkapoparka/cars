...
<section class="home-videos" aria-label="Астракар в Mobile.bg">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Астракар в Mobile.bg" href={youtubeChannelUrl} label="Всички обяви">
			{#snippet titleContent()}
				<span class="home-videos__title">Астракар в Mobile.bg</span>
			{/snippet}
