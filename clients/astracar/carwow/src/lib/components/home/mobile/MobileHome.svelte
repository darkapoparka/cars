<script lang="ts">
	...
	const brandCountLabel = (count: number) =>
		count > 0 ? `${count} ${count === 1 ? 'автомобил' : 'автомобила'}` : 'Внос и регистрация';
...
<div class="mobile-home" aria-label="Астракар — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Астракар home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/astracar/astracar-logo.png')}
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Астракар"
				>
		...
		<h1 class="mh-hero__title">Астракар</h1>
	...
	<footer class="mh-footer">
		<div class="mh-footer__brand">
			...
			/>
			<p>
				Автокъща в Варна с подбрани употребявани автомобили. Съдействие за документи, регистрация,
		...
		<span class="mh-footer__copy">© 2026 Астракар Варна. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, Цар Освободител 282, бул. „Цар Освободител“ 282</strong>
			</div>
