...
export const footerSocialLinks: FooterSocialLink[] = [{label:'Mobile.bg',href:daynightSite.sourceInventory,title:'Обявите на Астракар',icon:'mobilebg',external:true}];
