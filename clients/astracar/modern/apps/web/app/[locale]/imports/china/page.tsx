...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Астракар."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Астракар.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Астракар"
      : "Import from China | Астракар",
  });
};
