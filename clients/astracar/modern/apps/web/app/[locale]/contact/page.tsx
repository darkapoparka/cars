...
const pageCopy = {
  bg: {
    heroImageAlt: "BMW X7 от публикуваните обяви на Астракар",
    title: "Автомобили. Внос. Лизинг.",
    description:
      "Вижте автомобилите в наличност или говорете директно с Астракар за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Цар Освободител 282.",
    locationLabel: "Шоурум · Цар Освободител 282",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Астракар, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Цар Освободител 282",
    services: [
      {
  ...
  en: {
    heroImageAlt: "BMW X7 advertised by Astracar",
    title: "Premium vehicles. Imports. Leasing.",
    description:
      "Browse the vehicles in stock or speak directly with Астракар about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Tsar Osvoboditel 282.",
    locationLabel: "Showroom · Tsar Osvoboditel 282",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Астракар to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Tsar Osvoboditel 282",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Астракар в Варна — автомобили в наличност, внос по заявка и лизинг по запитване."
      : "Астракар in Varna — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Астракар"
      : "About and contact | Астракар",
  });
};
        ...
        <section className="relative isolate hidden overflow-hidden border-white/10 border-b lg:block">
          <div className="absolute inset-0 -z-20 bg-[#08090a]">
            <Image
              ...
              priority
              sizes="100vw"
              src="/assets/astracar/vehicle-10-1.webp"
            />
          </div>
          <div
            aria-hidden="true"
