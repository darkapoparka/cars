...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Астракар.",
          "The form is ready, but message delivery is not configured yet. Call Астракар directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Астракар.",
          "Message delivery is not configured yet. Call Астракар directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Астракар."
        : "Запитването е изпратено до екипа на Астракар.",
      "Your request has been sent to the Астракар team."
    ),
  };
};
