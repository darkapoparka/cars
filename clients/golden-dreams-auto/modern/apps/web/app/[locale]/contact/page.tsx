...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с G Auto за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Струмско.",
    locationLabel: "Шоурум · Струмско",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на G Auto, за да уточним оглед и конкретна оферта.",
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with G Auto about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Strumsko.",
    locationLabel: "Showroom · Strumsko",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call G Auto to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Strumsko",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    title: isBg
      ? "За нас и контакти | G Auto"
      : "About and contact | G Auto",
  });
};
