...
const pageCopy = {
  bg: {
    badge: "Финансиране от NEXT AUTO",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на NEXT AUTO ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from NEXT AUTO",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The NEXT AUTO team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от NEXT AUTO."
      : "A tailored vehicle financing offer from NEXT AUTO.",
    locale,
    path: "/lease",
