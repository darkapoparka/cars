...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на NEXT AUTO.",
          "The form is ready, but message delivery is not configured yet. Call NEXT AUTO directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на NEXT AUTO.",
          "Message delivery is not configured yet. Call NEXT AUTO directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на NEXT AUTO."
        : "Запитването е изпратено до екипа на NEXT AUTO.",
      "Your request has been sent to the NEXT AUTO team."
    ),
  };
};
