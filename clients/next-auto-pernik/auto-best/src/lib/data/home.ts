...
const bodyArtwork = [
  ...
  { label: 'Купе', query: 'Coupe', image: '/dealer/inventory/11778859949237318-1.webp', width: 1000, height: 667 },
  { label: 'Спортбек', query: 'Sportback', image: '/dealer/inventory/21769068381599366-1.webp', width: 1000, height: 667 }
] as const;
