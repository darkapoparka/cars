...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/dealer/inventory/21769068381599366-1.webp', href: '/about-us' },
        { id: 'about-import', title: 'Внос по заявка', detail: 'Доставка по ваши критерии.', image: '/dealer/inventory/11787752937990488-1.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Лизинг и финансиране', detail: 'Обсъдете условията директно с екипа.', image: '/dealer/inventory/21787665633476009-1.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
