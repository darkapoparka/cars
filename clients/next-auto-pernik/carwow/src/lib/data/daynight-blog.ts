...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Как да следите наличността на NEXT AUTO',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'NEXT AUTO съдейства с документи, регистрация, финансиране и оглед на място в Перник.'
				]
			}
		],
	...
	article({
		...
		title: 'Лизинг за употребяван автомобил в Перник',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на NEXT AUTO може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
					'При конкретен автомобил е най-добре параметрите да се обсъдят преди финално решение.'
				]
			}
		],
		tags: ['лизинг', 'финансиране', 'Перник']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'NEXT AUTO предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на NEXT AUTO често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез NEXT AUTO.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'NEXT AUTO',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'NEXT AUTO помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
