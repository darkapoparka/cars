...
<div class="mobile-about-app" aria-label="За NEXT AUTO">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>NEXT AUTO в Перник помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/assets/dealer/inventory/11787752937990488-1.webp')}
				alt="Консултация със NEXT AUTO"
				loading="lazy"
				decoding="async"
			/>
			<div>
				<span>Шоурум в Перник</span>
