<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'NEXT AUTO предлага проверени автомобили, финансиране и съдействие при покупка в Перник.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="NEXT AUTO Перник" />
	...
	<meta property="og:image:alt" content="NEXT AUTO Перник" />
