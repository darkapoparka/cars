...
<div class="mobile-home" aria-label="NEXT AUTO — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="NEXT AUTO home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на NEXT AUTO"
				>
		...
		<h1 class="mh-hero__title">NEXT AUTO</h1>
		...
		<section class="mh-cta-wrap" aria-label="Призив за действие">
			<div class="mh-cta">
				<div class="mh-cta__copy">
					<strong>{total} обяви · Оглед в Перник</strong>
	...
	<footer class="mh-footer">
		<div class="mh-footer__brand">
			...
			/>
			<p>
				Автокъща в Перник с подбрани употребявани автомобили. Съдействие за документи, регистрация,
		...
		<span class="mh-footer__copy">© 2026 NEXT AUTO Перник. Всички права запазени.</span>
	</footer>
