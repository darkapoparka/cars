...
export const daynightSite = {
	...
	email: "",
	location,
	locationShort: "ул. Свобода, на гърба на Гробищен парк",
	locationLandmark: "ул. Свобода, на гърба на Гробищен парк, Пазарджик",
	hoursLabel: "Пон.–пет. 09:30–19:00 · Съб.–нед. 09:30–17:00 · Потвърдете огледа по телефона",
	...
	heroTitle: "ELIQ AUTO",
	heroSubtitle: "Пазарджик · Датирана извадка от обяви; потвърдете цената и наличността директно с автокъщата.",
