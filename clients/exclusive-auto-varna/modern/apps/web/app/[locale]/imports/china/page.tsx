...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Exclusive Auto."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Exclusive Auto.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Exclusive Auto"
      : "Import from China | Exclusive Auto",
  });
};
