...
const pageCopy = {
  bg: {
    badge: "Финансиране от Exclusive Auto",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Exclusive Auto ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Exclusive Auto",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Exclusive Auto team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Exclusive Auto."
      : "A tailored vehicle financing offer from Exclusive Auto.",
    locale,
    path: "/lease",
