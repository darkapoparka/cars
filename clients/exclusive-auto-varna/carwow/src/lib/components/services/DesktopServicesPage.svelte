	...
	const services = [
		{
			...
			summary: 'Попитайте за оглед, документи и възможност за независим преглед на избрания автомобил.',
		...
		},
		{
			...
			summary: 'Уточнете кои документи и разходи са включени в конкретната сделка.',
		...
		},
		{
			id: 'financing',
			title: 'Финансиране',
			summary: 'Поискайте индивидуални условия; в демото няма кредитна оферта или одобрение.',
		...
		},
		{
			...
			summary: 'Подгответе данни за автомобила си и попитайте дали е възможен бартер.',
		...
		},
		{
			...
			summary: 'Продавачът посочва внос по поръчка. Обсъдете конкретен автомобил, бюджет и условия.',
		...
		},
		{
			...
			summary: 'Доставка, цена на транспорта и срокове се уточняват директно с продавача.',
...
<main id="main-content" tabindex="-1" class="desktop-services" aria-label="Услуги Exclusive Auto">
	...
	<section class="desktop-services-offers">
		<div class="container">
			<h2 class="desktop-services-sr-only">Конкретни услуги от Exclusive Auto</h2>
