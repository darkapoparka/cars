...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Аутолайф."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Аутолайф.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Аутолайф"
      : "Import from China | Аутолайф",
  });
};
