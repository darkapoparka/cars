...
const collectionCopy = {
  bg: {
    ...
    emptyDescription:
      "Вносът от Китай не е потвърдена услуга. Разгледайте публикуваните автомобили.",
    ...
    truth:
      "Аутолайф не твърди официално партньорство с показаните марки. Всяка оферта се потвърждава индивидуално.",
  },
  en: {
    ...
    truth:
      "Аутолайф does not claim an official partnership with the displayed brands. Every offer is confirmed individually.",
  },
} as const;
