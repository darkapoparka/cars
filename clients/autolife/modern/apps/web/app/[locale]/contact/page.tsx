...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Аутолайф за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Телефон за наличност и оглед. ГП4, разклон за Тополи.",
    locationLabel: "Шоурум · Тополи",
    mapAction: "Отворете картата",
    servicesTitle: "Изберете правилната посока.",
    servicesDescription:
      "Обадете се за актуална наличност, цена и работно време.",
    sellHandoffAction: "Обадете се за оферта",
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Аутолайф, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Тополи",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Аутолайф about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Topoli.",
    locationLabel: "Showroom · Topoli",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Аутолайф to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Topoli",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Аутолайф в Варна — публикувани автомобили и контакт за оглед."
      : "Аутолайф in Varna — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Аутолайф"
      : "About and contact | Аутолайф",
  });
};
