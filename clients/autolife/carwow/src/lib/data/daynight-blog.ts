...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Дневни новини от Аутолайф',
		description:
			'Кратък дневен преглед на наличността, търсените марки и практичните стъпки за оглед в Аутолайф.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-28',
		author: 'Аутолайф',
	...
	article({
		...
		description:
			'Обновления за интересни автомобили, които пристигат в наличността на Аутолайф Варна.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-27',
		author: 'Аутолайф',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Аутолайф съдейства с документи, регистрация, финансиране и оглед на място в Варна.'
				]
			}
		],
	...
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на Аутолайф може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Аутолайф предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на Аутолайф често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез Аутолайф.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'Аутолайф',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Аутолайф помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
