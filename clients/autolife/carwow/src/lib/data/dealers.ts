...
export const dealers: Dealer[] = [
	{
		...
		rating: 4.8,
		specialties: ['Публикувани автомобили', 'Оглед с уговорка', 'Финансиране']
	},
	{
		slug: "day-night-auto-group-documents",
		name: "Аутолайф Документи и съдействие",
		location: "Варна",
		address: daynightSite.location,
		phone: daynightSite.phoneLabel,
		logo: daynightSite.logoDark,
	...
	},
	{
		...
		name: "Аутолайф Подбор на автомобил",
		location: "Варна",
		address: daynightSite.location,
		phone: daynightSite.phoneLabel,
		logo: '/assets/autolife/wordmark.svg',
		cover: '/assets/autolife/wordmark.svg',
		inventory: daynightSite.inventoryCount,
		rating: 4.7,
