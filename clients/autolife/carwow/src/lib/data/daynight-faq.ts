...
const stepsAnswer: readonly FaqAnswerParagraph[] = [
	{
		...
		text: 'Изберете публикуван автомобил и се обадете за наличност, цена и оглед във Варна. Възможностите за лизинг се уточняват индивидуално.'
	},
	{
...
const termsAnswer: readonly FaqAnswerParagraph[] = [
	{
		class: 'h7 text-secondary line-height-28',
		text: 'Условията зависят от конкретния автомобил. За актуална информация се обадете на 0895 766 736. Замяна и изкупуване не са потвърдени услуги.'
	}
];
