import autolifeStock from './autolife-stock.json';
...
const listingToVehicle = (listing: CurrentDayNightListing): Car => {
	...
	return {
		...
		monthly: 'Лизинг: попитайте за условия',
		image: listing.image,
