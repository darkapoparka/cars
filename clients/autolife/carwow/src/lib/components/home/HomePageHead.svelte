<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Аутолайф предлага проверени автомобили, финансиране и съдействие при покупка в Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Аутолайф Варна" />
	...
	<meta property="og:image:alt" content="Аутолайф Варна" />
