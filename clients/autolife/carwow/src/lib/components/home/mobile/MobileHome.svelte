<script lang="ts">
	...
	const brandCountLabel = (count: number) =>
		count > 0 ? `${count} ${count === 1 ? 'автомобил' : 'автомобила'}` : 'Търсене на автомобил';
...
<div class="mobile-home" aria-label="Аутолайф — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Аутолайф home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/autolife/wordmark-light.svg')}
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Аутолайф"
				>
		...
		<h1 class="mh-hero__title">Аутолайф</h1>
	...
	<footer class="mh-footer">
		<div class="mh-footer__brand">
			<img
				...
				src={resolve('/assets/autolife/wordmark.svg')}
		...
		<span class="mh-footer__copy">© 2026 Аутолайф Варна. Всички права запазени.</span>
	</footer>
	...
	>
		...
		{:else}
			<div class="mh-search-sheet mh-search-sheet--sell">
				<header>
					<div>
						<span>Запитване за автомобил</span>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, ГП4, разклон за с. Тополи</strong>
			</div>
