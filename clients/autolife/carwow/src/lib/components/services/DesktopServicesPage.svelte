	...
	const services = [
		{
			...
			summary: 'Попитайте за документи, история и възможност за независим преглед.',
		...
		},
		{
			...
			summary: 'Уточнете с продавача документите и стъпките след покупката.',
		...
		},
		{
			id: 'financing',
			title: 'Финансиране',
			summary: 'Лизинг е отбелязан в обявите. Попитайте за доставчик и конкретни условия.',
		...
		},
		{
			...
			summary: 'Бартерът и оценката не са потвърдени услуги. Попитайте по телефона.',
		...
		},
		{
			...
			summary: 'Споделете търсения модел. Търсене по поръчка не е потвърдена услуга.',
		...
		},
		{
			...
			summary: 'Доставката не е потвърдена услуга. Уточнете възможностите по телефона.',
...
<main id="main-content" tabindex="-1" class="desktop-services" aria-label="Услуги Аутолайф">
	...
	<section class="desktop-services-offers">
		<div class="container">
			<h2 class="desktop-services-sr-only">Конкретни услуги от Аутолайф</h2>
