<script lang="ts">
	...
	const trustPoints = [
		...
		},
		{
			id: 'documents',
			title: 'Документи',
			copy: 'Уточнете документите и условията с продавача.',
			icon: ClipboardCheck
		},
		{
			id: 'trade',
			title: 'Бартер',
			copy: 'Попитайте за възможност за замяна; услугата не е потвърдена.',
			icon: Repeat
		}
	] as const;
...
<div class="mobile-about-app" aria-label="За Аутолайф">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Аутолайф публикува автомобили във Варна. Обадете се за наличност и оглед.</p>
		</div>
