...
export const editorial = [
  ...
  },
  {
    ...
    text: 'Преди покупка поискайте документи, история и независима техническа проверка.',
  ...
  },
  {
    ...
    text: 'Обадете се, за да обсъдите търсения модел. Внос по поръчка не е потвърдена услуга.',
