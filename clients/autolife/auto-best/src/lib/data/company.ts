...
export const companyServices: CompanyService[] = [
  {
    ...
    description: `Обадете се за наличност и удобен час за посещение.`,
  ...
  },
  {
    ...
    description: 'Обсъдете търсения модел и публикуваните предложения.',
  ...
  },
  {
    ...
    description: 'Попитайте дали се разглежда предложение за замяна. Услугата не е потвърдена.',
