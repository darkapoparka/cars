...
export const listingFilterOptions = {
  makes: ["","BMW","Seat","Ford","VW","Audi","Citroen","Mercedes-Benz","Peugeot","Volvo"],
  bodies: ["","SUV","Van","Hatchback","Wagon","Sedan"],
  fuels: ['', 'Дизел', 'Бензин'],
