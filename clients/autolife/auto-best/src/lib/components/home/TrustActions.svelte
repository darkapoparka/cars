<script lang="ts">
  ...
  const actions = [
    ...
    },
    {
      ...
      description: 'Възможностите за замяна се уточняват по телефона.',
      bannerDescription: ['Попитайте за възможност', 'за продажба или бартер.'],
    ...
    },
    {
      ...
      mobileCta: 'Попитай',
      description: 'Споделете модел и бюджет за търсен автомобил.',
      bannerDescription: ['Споделете своя бюджет', 'и търсен модел.'],
      cta: 'Попитайте за модел',
...
<style>
  ...
  .dn-trust-card--red { background: #a46d24; }
