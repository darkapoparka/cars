<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Valentino предлага проверени автомобили, финансиране и съдействие при покупка в София.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Valentino София" />
	...
	<meta property="og:image:alt" content="Valentino София" />
