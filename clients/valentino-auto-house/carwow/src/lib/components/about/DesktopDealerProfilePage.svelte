<script lang="ts">
	...
	const highlights = [
		'Данни по публикувани обяви с реална наличност',
...
<div class="dealer-page">
	<section class="background-light mb-32">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb__icon" aria-hidden="true"><ChevronRight size={14} /></li>
				<li><span>Профил на Valentino</span></li>
			</ul>
		</div>
	</section>
		...
		<div class="container">
			<div class="dealer-profile-hero__grid">
				...
				<div class="dealer-profile-card">
					<img class="dealer-profile-card__logo" src="/brand/logo.webp" alt="" />
					<p class="dealer-profile-card__title mb-6">Valentino</p>
	...
	<section class="py-80">
		<div class="container">
			<div class="dealer-about-grid">
				...
				<LazyMapEmbed src={mapEmbedSrc} title="Карта до Valentino София" height="330" />
			</div>
		</div>
	</section>
	...
	<section class="background-light py-80">
		<div class="container">
			<div class="title-section mb-30">
				<h2>Екип</h2>
				<a href={resolve('/team')} class="sa-cta sa-cta-ghost">Контакт с екипа</a>
			</div>
