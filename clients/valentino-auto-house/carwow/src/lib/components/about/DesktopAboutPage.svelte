<script lang="ts">
	...
	const support = [
		...
		{ title: 'Продажба и бартер', icon: ArrowLeftRight, description: 'Подгответе данни за автомобила и обсъдете възможностите по телефона. Демото не изпраща заявка.', href: '/sell-your-car', action: 'Продай или замени' },
		{ title: 'Документи и финансиране', icon: FileCheck2, description: 'Уточнете документите, регистрацията и възможностите за финансиране с продавача.', href: '/services', action: 'Разгледай услугите' }
	] as const;
	...
	<section class="about-section about-team" aria-labelledby="about-team-title">
		<div class="about-container">
			<div class="about-section-heading">
				...
				<DesktopBrowseLink href={resolve('/team')} label="Контакт с екипа" />
			</div>
					...
					<article class="about-team-card">
						<a class="about-team-card__image" href={resolve(teamHref(member.slug))}
							><img
								...
								alt={`Публикуван бизнес контакт: ${member.name}`}
								width="500"
								height="500"
								loading="lazy"
							/></a
	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				alt="Автомобил от датираната селекция на Valentino"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					Valentino е автокъща в София. При нас можеш да разгледаш наличните автомобили, да
					уговориш оглед и да обсъдиш продажба или бартер на твоя автомобил.
				</p>
				<p>
					Разгледай автомобилите онлайн или ни посети в Горубляне. Екипът ще уточни
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до Valentino София" height="280" />
				{:else}
					<button class="about-map-preview" onclick={() => (mapVisible = true)}>
						<MapPin size={36} aria-hidden="true" />
						<strong>Горубляне, София</strong>
