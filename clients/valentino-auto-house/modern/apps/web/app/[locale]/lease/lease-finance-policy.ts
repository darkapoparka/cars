...
export const leaseSelectorCopy = {
  bg: {
    ...
    note: "Избраните стойности са предпочитания, не публикувани условия или кредитно одобрение. Месечна вноска не се предлага от това демо.",
    phoneAction: "Обадете се за условията",
    priceLabel: "Цена",
  ...
  en: {
    ...
    note: "Selected values are preferences, not published terms or credit approval. This demo does not offer a monthly payment.",
    phoneAction: "Call to discuss terms",
    priceLabel: "Price",
