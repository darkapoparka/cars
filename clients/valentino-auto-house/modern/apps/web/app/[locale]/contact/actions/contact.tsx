...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Valentino.",
          "The form is ready, but message delivery is not configured yet. Call Valentino directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Valentino.",
          "Message delivery is not configured yet. Call Valentino directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Valentino."
        : "Запитването е изпратено до екипа на Valentino.",
      "Your request has been sent to the Valentino team."
    ),
  };
};
