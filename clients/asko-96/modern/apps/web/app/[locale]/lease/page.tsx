...
const pageCopy = {
  bg: {
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на АСКО 96 ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The АСКО 96 team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от АСКО 96."
      : "A tailored vehicle financing offer from АСКО 96.",
    locale,
    path: "/lease",
