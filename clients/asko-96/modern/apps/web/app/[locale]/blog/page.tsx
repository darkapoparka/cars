...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Практични материали от АСКО 96 за избор на автомобил, внос, оглед и финансиране."
      : "Practical АСКО 96 guidance on choosing, importing, inspecting, and financing a vehicle.",
    locale,
    path: "/blog",
...
const BlogIndex = async ({ params }: BlogProps) => {
  ...
  const jsonLd: WithContext<Blog> = {
    ...
    "@type": "Blog",
    description: isBg
      ? "Практични материали от АСКО 96 за вноса и избора на автомобил."
      : "Practical АСКО 96 guidance on importing and choosing a vehicle.",
