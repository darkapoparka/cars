...
const pageCopy = {
  bg: {
    heroImageAlt: "АСКО 96, София",
    title: "Премиум автомобили. Внос. Лизинг.",
    description:
      "Вижте автомобилите в наличност или говорете директно с АСКО 96 за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Ботевградско шосе.",
    locationLabel: "Шоурум · Ботевградско шосе",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на АСКО 96, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Ботевградско шосе",
    services: [
      {
  ...
  en: {
    heroImageAlt: "ASKO96 showroom in Sofia",
    title: "Premium vehicles. Imports. Leasing.",
    description:
      "Browse the vehicles in stock or speak directly with АСКО 96 about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in Botevgradsko shose.",
    locationLabel: "Showroom · Botevgradsko shose",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call АСКО 96 to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Botevgradsko shose",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "АСКО 96 в София — автомобили в наличност, внос по заявка и собствен лизинг."
      : "АСКО 96 in Sofia — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | АСКО 96"
      : "About and contact | АСКО 96",
  });
};
