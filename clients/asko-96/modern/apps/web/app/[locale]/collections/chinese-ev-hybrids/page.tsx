...
const collectionCopy = {
  bg: {
    ...
    truth:
      "АСКО 96 не твърди официално партньорство с показаните марки. Всяка оферта се потвърждава индивидуално.",
  },
  en: {
    ...
    truth:
      "АСКО 96 does not claim an official partnership with the displayed brands. Every offer is confirmed individually.",
  },
} as const;
