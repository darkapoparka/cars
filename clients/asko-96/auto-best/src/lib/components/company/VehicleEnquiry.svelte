...
<style>
  ...
  .dn-enquiry-primary { display: flex; width: 100%; min-height: 52px; align-items: center; justify-content: center; gap: 12px; padding: 12px 20px; border: 0; border-radius: var(--dn-radius-button); background: var(--dn-red); color: var(--dn-accent-ink); font-size: 16px; font-weight: 600; line-height: 1.4; }
  ...
  .dn-enquiry-link-go { display: grid; width: 48px; height: 48px; flex: 0 0 48px; place-items: center; border: 0; border-radius: 12px; background: var(--dn-red); color: var(--dn-accent-ink); }
