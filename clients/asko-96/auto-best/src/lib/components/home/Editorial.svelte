...
<style>
  ...
  .dn-editorial__banner {
    ...
    padding: 82px 0 0;
    border-radius: 24px;
    background-image: url('/assets/asko96/asko96-showroom.jpg');
  ...
  .dn-editorial-item__link:focus-visible {
    outline: 3px solid rgba(215, 174, 53, 0.28);
    outline-offset: -3px;
  }
  ...
  @media (min-width: 992px) {
    .dn-editorial__banner { background: var(--dn-red); color: var(--dn-accent-ink); min-height: 234px; overflow: hidden; }
    .dn-editorial__banner h2, .dn-editorial__banner p { color: var(--dn-accent-ink); }
