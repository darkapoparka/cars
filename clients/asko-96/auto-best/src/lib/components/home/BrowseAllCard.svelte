...
<style>
  ...
  @media (max-width: 767px) {
    ...
    .action { display: flex; min-height: 44px; align-items: center; justify-content: center; gap: 8px; margin-top: 8px; padding: 8px 18px; border-radius: var(--dn-pill); background: var(--dn-red); color: var(--dn-accent-ink); font-size: 14px; font-weight: 600; }
