  ...
  <div class="container">
    <div class="dn-videos__panel">
      <div class="dn-videos__heading dn-home-section-heading">
        ...
        <p>Автомобилни видеа от официалния канал на АСКО 96.</p>
...
<style>
  ...
  .dn-video-card__actions a:hover { color: var(--dn-accent-text); }
  .dn-videos__channel:hover { color: var(--dn-accent-text); text-decoration: underline; text-underline-offset: 4px; }
  ...
  @media (max-width: 767px) {
    ...
    .dn-videos__all-arrow { display: flex; min-height: 44px; align-items: center; gap: 8px; padding: 8px 18px; margin-top: 4px; border-radius: var(--dn-pill); background: var(--dn-red); color: var(--dn-accent-ink); font-size: 14px; font-weight: 600; }
