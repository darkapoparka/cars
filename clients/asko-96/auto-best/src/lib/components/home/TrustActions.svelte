...
<style>
  ...
  .dn-trust-card--red { background: var(--dn-red); color: var(--dn-accent-ink); }
  .dn-trust-card.dn-trust-card--red p { color: var(--dn-accent-ink); }
  ...
  .dn-service-card .dn-trust-card__icon { display: block; width: 60px; height: 60px; margin-bottom: 20px; color: var(--dn-accent-text); }
  ...
  .dn-service-card .dn-trust-card__action { width: 100%; padding-inline: 10px; border: 1px solid var(--dn-red); color: var(--dn-accent-text); font-size: 14px; }
  .dn-service-card .dn-trust-card__action:hover { background: var(--dn-red); color: var(--dn-accent-ink); }
  ...
  @media (max-width: 991px) {
    ...
    .dn-service-card .dn-trust-card__action:hover { background: transparent; color: var(--dn-accent-text); }
    ...
    .dn-trust-card__icon { display: block; width: 38px; height: 38px; margin-bottom: 10px; color: var(--dn-accent-text); }
