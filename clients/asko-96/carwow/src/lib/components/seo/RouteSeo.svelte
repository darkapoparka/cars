<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'АСКО 96 предлага автомобили в София, финансиране и съдействие при покупка в София.';
	const DEFAULT_OG_IMAGE = '/assets/asko96/asko96-showroom.jpg';
...
<svelte:head>
	...
	<meta property="og:site_name" content="АСКО 96 София" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="АСКО 96 София" />
	{/if}
