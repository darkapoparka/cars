<script lang="ts">
	...
	const demoNames = ['Автомобили', 'Замяна и изкупуване', 'Собствен лизинг', 'Контакт с АСКО 96'];
		...
		{#snippet afterPanel()}
			<nav class="about-hero-contact" aria-label="Контакти и социални мрежи">
				<a href={daynightSite.mapUrl} target="_blank" rel="noopener noreferrer"
					><MapPin size={18} />Ботевградско шосе 300</a
				>
				...
				<div class="about-hero-socials">
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						aria-label="YouTube"><img src="/assets/icons/youtube-footer.svg" width="20" height="20" alt="" /></a
					>
		...
		<div class="about-container">
			...
			<div class="about-social-row">
				<a class="about-reviews-link about-text-link" href={resolve('/reviews')}
					>Услуги на АСКО 96 <ArrowRight size={18} /></a
				>
			</div>
		</div>
	</section>
	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				alt="Илюстративна визия на АСКО 96: Mercedes-Benz и Lamborghini с ключове за бартер"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					АСКО 96 е автокъща в София. При нас можеш да разгледаш наличните автомобили, да
					уговориш оглед и да обсъдиш продажба или бартер на твоя автомобил.
				</p>
				<p>
					Разгледай автомобилите онлайн или ни посети в Ботевградско шосе 300. Екипът ще уточни
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			<div class="about-visit__copy">
				...
				<div class="about-visit-hours"><Clock3 size={20} aria-hidden="true" /><div><strong>Понеделник–петък: 9:00–18:00</strong><span>Събота 10:00–16:00 · Неделя: почивен ден</span></div></div>
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до АСКО 96 София" height="280" />
				{:else}
					<button class="about-map-preview" onclick={() => (mapVisible = true)}>
						<MapPin size={36} aria-hidden="true" />
						<strong>Ботевградско шосе 300, София</strong>
