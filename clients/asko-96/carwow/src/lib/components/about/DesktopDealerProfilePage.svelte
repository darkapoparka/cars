	...
	<section class="background-light mb-32">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb__icon" aria-hidden="true"><ChevronRight size={14} /></li>
				<li><span>Профил на АСКО 96</span></li>
			</ul>
		</div>
	</section>
			...
			<div class="dealer-profile-hero__grid">
				...
				<div class="dealer-profile-card">
					<img
						...
						src="/assets/asko96/asko96-wordmark.png"
						alt=""
					/>
					<p class="dealer-profile-card__title mb-6">АСКО 96</p>
	...
	<section class="py-80">
		<div class="container">
			<div class="dealer-about-grid">
				...
				<LazyMapEmbed src={mapEmbedSrc} title="Карта до АСКО 96 София" height="330" />
			</div>
		</div>
	</section>
