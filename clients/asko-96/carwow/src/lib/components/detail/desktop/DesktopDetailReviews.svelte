...
<div class="mb-16 flex items-center justify-between gap-16">
	<p class="h4">Услуги на АСКО 96</p>
</div>
	...
	<div class="rating-box__content">
		<div class="rating-box__overview">
			<div class="rating-box__average">
				<span class="rating-box__score">АСКО</span>
...
<div id="reviewForm">
	<p class="h4 mb-8 capitalize">Попитайте екипа</p>
	...
	<a
		...
		title="Услуги и информацияте се потвърждават от екипа преди публикуване."
	>
		Свържете се
	</a>
</div>
