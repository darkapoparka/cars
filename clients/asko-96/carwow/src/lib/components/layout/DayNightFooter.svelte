<script lang="ts">
	...
	const facebookLinkProps = {
		href: 'https://www.facebook.com/p/Asko96-100050328800477/',
		target: '_blank',
		rel: 'noopener'
	} as const;
	const instagramLinkProps = {
		href: 'https://www.youtube.com/@asko96bulgaria',
		target: '_blank',
		rel: 'noopener'
	} as const;
	const mapLinkProps = {
					...
					>
						<div>
							<a
								...
								aria-label="АСКО 96 начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								АСКО 96 предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										class={socialLinkClasses}
									>
										<img src="/assets/icons/youtube-footer.svg" width="20" height="20" alt="" />
									</a>
								</li>
								<li>
									<a
								...
								<li>
									<a
										{...mapLinkProps}
										title="Отвори локацията на АСКО 96 в Google Maps"
										aria-label="Отвори локацията на АСКО 96 в Google Maps"
										class={socialLinkClasses}
									>
