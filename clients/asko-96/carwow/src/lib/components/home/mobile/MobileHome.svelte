...
<div class="mobile-home" aria-label="АСКО 96 — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="АСКО 96 home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				<button
					...
					type="button"
					aria-label="Локация: Индустриална зона, София"
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на АСКО 96"
				>
		...
		<h1 class="mh-hero__title">АСКО 96</h1>
	...
	<footer class="mh-footer">
		...
		<nav class="mh-footer__social" aria-label="Социални канали и обяви">
			{#snippet footerSocialIcon(icon: FooterSocialIcon)}
				...
				{:else if icon === 'instagram'}<img src="/assets/icons/youtube-footer.svg" width="20" height="20" alt="" />
				{:else}
		...
		<span class="mh-footer__copy">© 2026 АСКО 96 София. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			<header>
				<div>
					<span>Локация</span>
					<strong id="mh-location-title">Индустриална зона, София</strong>
				</div>
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>София</span>
				<strong>гр. София, бул. „Ботевградско шосе“ 300</strong>
			</div>
