<script lang="ts">
	...
	const dealerJsonLd = $derived(
		JSON.stringify({
			...
			image: `${origin}/assets/asko96/asko96-wordmark.png`,
			logo: `${origin}/assets/asko96/asko96-wordmark.png`,
			url: `${origin}/`,
			telephone: '0899769696',
			...(daynightSite.email ? { email: daynightSite.email } : {}),
			address: {
				'@type': 'PostalAddress',
				streetAddress: 'гр. София, бул. „Ботевградско шосе“ 300',
