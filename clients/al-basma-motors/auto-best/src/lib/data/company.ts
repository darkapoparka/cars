...
export const companyServices: CompanyService[] = [
  {
    ...
    "description": "Independent preview. Forms do not send messages and no reservation is created.",
...
export const contactTopics: ContactTopic[] = [
  {
    ...
    "description": "Contact Al Basma to confirm availability, details, and the next step."
  },
  {
    "id": "inspection",
    "label": "Viewing",
