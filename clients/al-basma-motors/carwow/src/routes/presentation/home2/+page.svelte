...
<svelte:head>
	...
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from Al Basma София."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="Al Basma Home2">
				<img src="/brand/daynight-logo-generated.png" alt="Al Basma" />
			</a>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/brand/daynight-team-placeholder.svg" alt="Al Basma consultant" />
			<div>
