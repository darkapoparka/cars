<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Al Basma предлага проверени автомобили, финансиране и съдействие при покупка в София.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Al Basma София" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Al Basma София" />
	{/if}
