...
export const daynightTeam: DayNightTeamMember[] = [
	{
		...
		detail: "Independent, unpublished design concept. Dated listing samples, not a live stock feed. Confirm price, specifications and availability directly with the showroom. Forms only prepare drafts; nothing is delivered. Independent preview. Forms do not send messages and no reservation is created."
	}
];
