...
export const daynightReviewDisclosure='No customer reviews are imported into this demo.';
export const daynightReviewCount=0;
export const daynightReviewCountLabel='0 verified reviews';
export const daynightReviewLinkLabel='No reviews imported';
