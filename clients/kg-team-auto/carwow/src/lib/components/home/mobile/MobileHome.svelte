...
<div class="mobile-home" aria-label="K-G Team Auto — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="K-G Team Auto home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на K-G Team Auto"
				>
		...
		<h1 class="mh-hero__title">K-G Team Auto</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 K-G Team Auto Пловдив. Всички права запазени.</span>
	</footer>
