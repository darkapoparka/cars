...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		<img
			...
			src="/dealer/21785829117309786-1.webp"
			alt=""
			aria-hidden="true"
		/>
		...
		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="K-G Team Auto Home2">
				<img src="/dealer/logo.png" alt="K-G Team Auto" />
			</a>
	...
	<section class="home2-market">
		...
		<section class="home2-sell-card" aria-labelledby="sell-car-title">
			...
			<div class="home2-sell-card__media">
				<img src="/dealer/hero-car-2.webp" alt="" aria-hidden="true" />
				<span>ENTER REG</span>
			</div>
		</section>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/dealer/11678716951277480-1.webp" alt="K-G Team Auto consultant" />
			<div>
