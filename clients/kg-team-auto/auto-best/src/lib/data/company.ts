...
export const companyServices: CompanyService[] = [
  {
    ...
    "description": "Работното време не е публикувано. Потвърдете по телефона преди посещение.",
...
export const contactTopics: ContactTopic[] = [
  {
    ...
    "description": "Свържете се с K-G Team Auto, за да потвърдите наличност, данни и следваща стъпка."
  },
  {
    "id": "inspection",
    "label": "Оглед",
