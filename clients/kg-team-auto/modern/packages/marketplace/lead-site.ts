...
export const leadSite: LeadSiteConfig = {
  ...
  city: "Пловдив",
  district: { bg: "Пловдив", en: "Пловдив" },
  sellCategoryAssets: {
  ...
  socialLinks: {},
  staticDemoMode: true,
  tagline: "Датирани примерни обяви, не потвърдена наличност. Проверете цена, състояние и местоположение при продавача.",
};
