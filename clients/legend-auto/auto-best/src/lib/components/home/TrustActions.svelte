<script lang="ts">
  ...
  const actions = [
    ...
    },
    {
      ...
      vehicle: 'gclass',
      tone: 'red',
      mobileTitle: 'Уговори оглед',
      mobileCta: 'Свържи се',
      description: 'Потвърдете наличността и уговорете удобен час.',
      bannerDescription: ['Потвърдете наличността', 'и уговорете оглед.'],
      cta: 'Уговорете оглед',
    ...
    },
    {
      ...
      description: 'Споделете модел и бюджет за запитване за автомобил.',
    ...
    },
    {
      ...
      vehicle: 'urus',
      tone: 'black',
      mobileTitle: 'Условия за покупка',
