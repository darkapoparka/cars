  ...
  >
    ...
    {#if mobileOpen}
      ...
      >
        ...
        <div class="dn-mobile-menu__social" aria-label="Социални мрежи">{#if brand.instagramUrl}
          <a {...{ href: brand.instagramUrl }} target="_blank" rel="noopener noreferrer"><SocialBrandIcon name="instagram" /><span>Instagram</span></a>{/if}{#if brand.youtubeUrl}
          <a {...{ href: brand.youtubeUrl }} target="_blank" rel="noopener noreferrer"><SocialBrandIcon name="youtube" /><span>YouTube</span></a>{/if}{#if brand.facebookUrl}
          <a {...{ href: brand.facebookUrl }} target="_blank" rel="noopener noreferrer"><SocialBrandIcon name="facebook" /><span>Facebook</span></a>{/if}
        </div>
