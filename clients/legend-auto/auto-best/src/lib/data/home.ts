...
export const editorial = [
  ...
  },
  {
    ...
    text: 'Поискайте документите за автомобила и обсъдете проверка на състоянието преди решение.',
  ...
  },
  {
    ...
    text: 'Разгледайте обявите и потвърдете с автокъщата подходящ автомобил и условия.',
