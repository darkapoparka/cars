  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        ...
        { id: 'about-import', title: 'Запитване за автомобил', detail: 'Доставка по ваши критерии.', image: '/assets/images/lead/day-night-stock-03.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Условия за покупка', detail: 'Обсъдете условията директно с екипа.', image: '/assets/images/lead/day-night-stock-06.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
      ...
      cta: { id: 'about-cta', label: 'Свържете се с екипа', href: '/contact', detail: 'Наличност, оглед, внос и условия за покупка.' }
    }
  },
  {
    id: 'guides',
