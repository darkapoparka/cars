...
<svelte:head>
  ...
  <meta name="description" content={`${brand.name} — премиум автомобили, запитване за автомобил, условия за покупка, бартер и огледи с предварителна уговорка в ${brand.city}.`} />
</svelte:head>
