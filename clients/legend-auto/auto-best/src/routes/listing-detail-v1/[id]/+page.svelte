            ...
            <div class="dn-detail-card dn-detail-media-card">
              <figure class="dn-detail-gallery">
                ...
                <img
                  ...
                  decoding="async"
                />
                <button class="dn-detail-gallery__count" type="button" aria-label="Следваща снимка" onclick={() => photoIndex = (photoIndex + 1) % data.vehicle.gallery.length}>{photoIndex + 1} / {data.vehicle.gallery.length}</button>
              </figure>
            </div>
