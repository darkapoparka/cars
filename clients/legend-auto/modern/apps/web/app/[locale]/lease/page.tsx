...
const pageCopy = {
  bg: {
    badge: "Финансиране от LEGEND AUTO",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на LEGEND AUTO ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from LEGEND AUTO",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The LEGEND AUTO team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от LEGEND AUTO."
      : "A tailored vehicle financing offer from LEGEND AUTO.",
    locale,
    path: "/lease",
