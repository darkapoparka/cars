...
const pageCopy = {
  bg: {
    heroImageAlt: "Автомобил от обявите на LEGEND AUTO",
    title: "Автомобили. Огледи. Варна.",
    description:
      "Вижте автомобилите в наличност или говорете директно с LEGEND AUTO за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "За автомобил и оглед: 0899 877 305. Варна, бул. Цар Освободител 289, срещу МАКАО.",
    locationLabel: "Шоурум · бул. Цар Освободител 289",
    mapAction: "Отворете картата",
    servicesTitle: "Изберете правилната посока.",
    servicesDescription:
      "От наличен автомобил до запитване за автомобил — екипът ни е на една връзка разстояние.",
    sellHandoffAction: "Обадете се за оферта",
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на LEGEND AUTO, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · бул. Цар Освободител 289",
    services: [
      {
  ...
  en: {
    heroImageAlt: "Vehicle advertised by LEGEND AUTO",
    title: "Vehicles. Viewings. Varna.",
    description:
      "Browse the vehicles in stock or speak directly with LEGEND AUTO about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "Call 0899 877 305 about vehicles and viewings. Tsar Osvoboditel 289, Varna, opposite Macau.",
    locationLabel: "Showroom · Tsar Osvoboditel 289",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call LEGEND AUTO to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Tsar Osvoboditel 289",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "LEGEND AUTO в Варна — автомобили в наличност, запитване за автомобил и условия за покупка."
      : "LEGEND AUTO in Varna — vehicles in stock, import on request, and purchase enquiries.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | LEGEND AUTO"
      : "About and contact | LEGEND AUTO",
  });
};
