...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на LEGEND AUTO.",
          "The form is ready, but message delivery is not configured yet. Call LEGEND AUTO directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на LEGEND AUTO.",
          "Message delivery is not configured yet. Call LEGEND AUTO directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на LEGEND AUTO."
        : "Запитването е изпратено до екипа на LEGEND AUTO.",
      "Your request has been sent to the LEGEND AUTO team."
    ),
  };
};
