...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от LEGEND AUTO."
      : "Start a request for a vehicle from China with delivery to Bulgaria from LEGEND AUTO.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | LEGEND AUTO"
      : "Import from China | LEGEND AUTO",
  });
};
