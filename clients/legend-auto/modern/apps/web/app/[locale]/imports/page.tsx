...
const importFaqs = {
  bg: [
    ...
    {
      answer:
        "Не е нужен акаунт. Оставете телефон и екипът на LEGEND AUTO ще се свърже с вас, за да уточни следващата стъпка.",
  ...
  en: [
    ...
    {
      answer:
        "No account is required. Leave a phone number and the LEGEND AUTO team will contact you about the next step.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Изпратете линк или данни за автомобил от чужбина. LEGEND AUTO ще уточни заявката за внос и доставка до България."
      : "Send a listing link or vehicle details from abroad. LEGEND AUTO will discuss the import request and delivery to Bulgaria.",
    locale,
    path,
    title: isBg
      ? "Внос на автомобил по заявка | LEGEND AUTO"
      : "Vehicle import request | LEGEND AUTO",
  });
};
...
export default async function ImportsPage({ params, searchParams }: PageProps) {
  ...
  return (
    ...
    >
      ...
      >
<p role="note" className="px-6 py-3 text-sm">Демонстрационна страница. LEGEND AUTO не е потвърдил тази услуга. За реални условия се обадете на 0899 877 305. Формите не изпращат съобщение до автокъщата.</p>
