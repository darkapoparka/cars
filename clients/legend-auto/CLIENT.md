...
Final targeted numeric/contact supplement: all source prices and mileage are finite and match stock.json; under EUR 20,000 renders 12 vehicles and under 100,000 km renders 2. Phone links, retained real Viber links where configured, and mobile gallery photo change passed. Exact framework timestamps and evidence are in qa-final/FINAL.md.
