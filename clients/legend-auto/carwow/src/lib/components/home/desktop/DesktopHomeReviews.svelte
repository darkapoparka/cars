<script lang="ts">
  ...
  {
    "id": "info-0",
    "description": "Разгледайте автомобилите на LEGEND AUTO. Потвърдете наличността преди посещение.",
  ...
  {
    "id": "info-1",
    "description": "Обадете се на 0899 877 305 за автомобила и удобен час за оглед.",
    "avatar": "/assets/legend-auto/logo-original.png",
    "name": "Оглед",
    "meta": "Предварителна уговорка"
  },
  {
    "id": "info-2",
    "description": "Транспортът е посочен в обявите на LEGEND AUTO. Уточнете цената и условията по телефона.",
    "avatar": "/assets/legend-auto/logo-original.png",
    "name": "Транспорт",
    "meta": "До всяка точка на страната"
  }
];
	...
	const actionCards: ActionCard[] = [
		...
		},
		{
			...
			bullets: [
				...
				'Получете обратна връзка от екипа на LEGEND AUTO.',
