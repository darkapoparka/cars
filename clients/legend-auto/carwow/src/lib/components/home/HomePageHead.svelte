<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'LEGEND AUTO предлага проверени автомобили, финансиране и съдействие при покупка във Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="LEGEND AUTO Варна" />
	...
	<meta property="og:image:alt" content="LEGEND AUTO Варна" />
