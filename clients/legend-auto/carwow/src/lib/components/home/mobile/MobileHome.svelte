<script lang="ts">
	...
	const brandCountLabel = (count: number) =>
		count > 0 ? `${count} ${count === 1 ? 'автомобил' : 'автомобила'}` : 'Запитване за автомобил';
...
<div class="mobile-home" aria-label="LEGEND AUTO — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="LEGEND AUTO home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/legend-auto/logo-original.png')}
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на LEGEND AUTO"
				>
		...
		<h1 class="mh-hero__title">LEGEND AUTO</h1>
		...
		<section class="mh-cta-wrap" aria-label="Призив за действие">
			<div class="mh-cta">
				<div class="mh-cta__copy">
					...
					<span>Автомобили · огледи · транспорт в страната</span>
				</div>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 LEGEND AUTO Варна. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, бул. Цар Освободител 289, срещу МАКАО</strong>
			</div>
