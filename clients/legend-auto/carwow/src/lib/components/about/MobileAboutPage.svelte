<script lang="ts">
	...
	const trustPoints = [
		...
		},
		{
			id: 'documents',
			title: 'Документи',
			copy: 'Обсъдете документите за конкретния автомобил.',
			icon: ClipboardCheck
		},
		{
			id: 'trade',
			title: 'Налични автомобили',
			copy: 'Разгледайте предложенията и потвърдете наличността.',
			icon: Repeat
		}
	] as const;
...
<div class="mobile-about-app" aria-label="За LEGEND AUTO">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>LEGEND AUTO във Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				...
				alt="Консултация със LEGEND AUTO"
				loading="lazy"
				decoding="async"
			/>
			<div>
