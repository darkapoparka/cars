<script lang="ts">
	...
	const shareUrl = $derived(`https://legendauto1.mobile.bg/blog/${article.slug}`);
		...
		<div class="bloc-details-container">
			...
			<div class="mb-40">
				<div class="listing-details--contact-dealer mb-20">
					<img src="/assets/legend-auto/logo-original.png" alt={daynightSite.shortName} />
					<div class="content">
				...
				<p class="h7 line-height-28">
					LEGEND AUTO публикува практични съвети и новини за наличност, покупка, оглед, документи,
					регистрация и финансиране на употребявани автомобили във Варна.
				</p>
			</div>
