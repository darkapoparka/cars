...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Дневни новини от LEGEND AUTO',
		description:
			'Кратък дневен преглед на наличността, търсените марки и практичните стъпки за оглед в LEGEND AUTO.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-28',
		author: 'LEGEND AUTO',
	...
	article({
		...
		description:
			'Обновления за интересни автомобили, които пристигат в наличността на LEGEND AUTO Варна.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-27',
		author: 'LEGEND AUTO',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'LEGEND AUTO съдейства с документи, регистрация, финансиране и оглед на място във Варна.'
				]
			}
		],
	...
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на LEGEND AUTO може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'LEGEND AUTO предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на LEGEND AUTO често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез LEGEND AUTO.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'LEGEND AUTO',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'LEGEND AUTO помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
