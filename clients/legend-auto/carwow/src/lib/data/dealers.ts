...
export const dealers: Dealer[] = [
	...
	},
	{
		...
		name: "LEGEND AUTO Документи и съдействие",
		location: "Варна",
		address: daynightSite.location,
		phone: daynightSite.phoneLabel,
		logo: daynightSite.logoDark,
	...
	},
	{
		...
		name: "LEGEND AUTO Подбор на автомобил",
		location: "Варна",
		address: daynightSite.location,
		phone: daynightSite.phoneLabel,
		logo: '/assets/legend-auto/logo-original.png',
		cover: '/assets/legend-auto/logo-original.png',
		inventory: daynightSite.inventoryCount,
		rating: 4.7,
