...
const getPrivacyFallback = (isBg: boolean): FallbackLegalPage => ({
  ...
  description: isBg
    ? "Как Keen Auto Mall използва и защитава данните, които предоставяте при запитване за автомобил, внос, лизинг или продажба."
    : "How Keen Auto Mall uses and protects information you provide when asking about a vehicle, import, leasing, or selling your car.",
  sections: isBg
    ? [
        {
...
const getTermsFallback = (isBg: boolean): FallbackLegalPage => ({
  ...
  description: isBg
    ? "Основните правила за използване на сайта на Keen Auto Mall и информацията за автомобили, внос и лизинг."
    : "The core rules for using the Keen Auto Mall website and its vehicle, import, and leasing information.",
  sections: isBg
    ? [
        {
          heading: "Роля на Keen Auto Mall",
          body: "Keen Auto Mall представя собствени наличности и услуги за внос, лизинг и изкупуване на автомобили. Сайтът служи за информация и контакт; конкретните търговски условия се потвърждават в индивидуална писмена оферта или договор.",
        },
        {
        ...
        },
        {
          ...
          body: "Цените, ориентировъчните месечни плащания, сроковете за доставка и наличността могат да се променят. Крайната цена, включените данъци и такси, гаранцията и доставката се потвърждават писмено от Keen Auto Mall.",
        },
        {
    ...
    : [
        {
          heading: "Keen Auto Mall's role",
          body: "Keen Auto Mall presents its vehicle stock and services for imports, leasing, and purchasing vehicles. The website provides information and contact options; specific commercial terms are confirmed in an individual written quotation or agreement.",
        },
        {
        ...
        },
        {
          ...
          body: "Prices, indicative monthly payments, delivery times, and availability can change. Keen Auto Mall will confirm the final price, included taxes and fees, warranty, and delivery in writing.",
        },
        {
      ...
      <main className="mx-auto min-h-[60dvh] max-w-5xl px-4 py-8 lg:px-6 lg:py-10">
        ...
        >
          <Link href={getLocalizedPath(normalizedLocale, "/")}>
            ...
            {isBg ? "Към Keen Auto Mall" : "Back to Keen Auto Mall"}
          </Link>
        </Button>
