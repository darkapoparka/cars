...
const pageCopy = {
  bg: {
    badge: "Финансиране от Keen Auto Mall",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Keen Auto Mall ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Keen Auto Mall",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Keen Auto Mall team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Keen Auto Mall."
      : "A tailored vehicle financing offer from Keen Auto Mall.",
    locale,
    path: "/lease",
