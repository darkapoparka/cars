...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Keen Auto Mall за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Pompano Beach.",
    locationLabel: "Шоурум · Pompano Beach",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Keen Auto Mall, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Pompano Beach",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the dated vehicle samples or speak directly with Keen Auto Mall about your next vehicle.",
    ...
    locationLabel: "Showroom · Pompano Beach",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · Pompano Beach",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Keen Auto Mall в Pompano Beach — автомобили в наличност, внос по заявка и собствен лизинг."
      : "Keen Auto Mall in Pompano Beach — dated vehicle samples, vehicle enquiry, and purchase enquiries.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Keen Auto Mall"
      : "About and contact | Keen Auto Mall",
  });
};
