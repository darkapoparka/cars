<script lang="ts">
  ...
  const phoneLinkAttributes = { href: brand.phoneHref } as const;
      ...
      <aside class="dn-blog-detail__sidebar" aria-label="More useful information">
        ...
        <section class="dn-blog-widget dn-blog-widget--contact">
          ...
          <a class="dn-blog-widget__primary" {...phoneLinkAttributes}>Call us · {brand.phone}</a>
          <a class="dn-blog-widget__secondary" href={resolve('/contact')}>Contact</a>
        </section>
