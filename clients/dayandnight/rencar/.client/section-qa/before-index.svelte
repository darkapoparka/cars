              ...
              <div class="row align-items-center">
                <div class="col-md-12 col-lg-6">
                  <div class="hero-content">
                    <h4 class="hero-sub-title" data-animation="fadeInUp" data-delay=".2s"><i class="far fa-car"></i> Day &amp; Night Auto Group</h4>
                    <h3 class="hero-title" data-animation="fadeInUp" data-delay=".4s">Изберете своя <span>модел</span></h3>
                ...
                <div class="col-md-12 col-lg-6">
                  <div class="hero-img" data-animation="fadeInRight" data-delay=".2s">
                    <img src="/daynight/day-night-cutout-gclass-v1.webp" alt="">
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="row g-3">
                    <div class="col-6">
                      <div class="img-1 mb-3">
                        <img src="/daynight/day-night-about-showroom-v1-light.webp" alt="">
                      </div>
                      <div class="img-3">
                        <img src="/daynight/day-night-studio-keys-v1.webp" alt="">
                      </div>
                    </div>
                    <div class="col-6 align-self-center">
                      <div class="img-2">
                        <img src="/daynight/day-night-showroom-color-v1.webp" alt="">
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="cta-wrap wow fadeInUp" data-wow-delay=".2s" style="background-image: url(/assets/img/cta/01.jpg)">
            <div class="row align-items-center">
              ...
              <div class="col-lg-5 text-center text-lg-end">
                <div class="mb-20">
                  <a href="tel:+359877733110" class="cta-number"><i class="far fa-headset"></i>0877 733 110</a>
                </div>
                <div class="cta-btn">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="download-content">
                  <div class="site-heading mb-4">
                    ...
                    <h4 class="site-title mb-10">Day &amp; Night Android <span>and IOS App is</span> Available!</h4>
                    <p>
