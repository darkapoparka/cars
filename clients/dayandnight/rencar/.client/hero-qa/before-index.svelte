<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <section class="about-area about-centered py-120" aria-labelledby="about-heading">
        <div class="container">
          <div class="site-heading mb-3">
            <span class="site-title-tagline"><i class="far fa-car" aria-hidden="true"></i> За нас</span>
            <h3 class="site-title" id="about-heading">Как можем да <span>помогнем</span></h3>
          </div>
          <p class="about-text">Разгледайте колекцията или обсъдете продажба, бартер и внос по заявка.</p>
          <div class="about-content">
            <div class="about-item">
              <div class="icon"><i class="far fa-car" aria-hidden="true"></i></div>
              <div class="content">
            ...
            <div class="about-item">
              <div class="icon"><i class="far fa-handshake" aria-hidden="true"></i></div>
              <div class="content">
            ...
            <div class="about-item">
              <div class="icon"><i class="far fa-truck" aria-hidden="true"></i></div>
              <div class="content">
