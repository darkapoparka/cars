<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Car Booking</h3>
                ...
                <div class="car-booking-form">
                  <form action="#">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-label" for="field-0">Car Rent Duration</label>
                          <select class="select" aria-label="For 1 Days" id="field-0">
                            <option value="1">For 1 Days</option>
                            <option value="2">For 5 Days</option>
                            <option value="3">For 10 Days</option>
                            <option value="4">For 15 Days</option>
                            <option value="5" selected="">For 1 Months</option>
                            <option value="6">For 2 Months</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-label" for="field-1">Car Rent Quantity</label>
                          <select class="select" aria-label="1 Cars" id="field-1">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-label" for="field-2">Need Driving Service</label>
                          <select class="select" aria-label="Yes ( pay extra $100 )" id="field-2">
                            <option value="1">Yes ( pay extra $100 )</option>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-label" for="field-3">Driver Age</label>
                          <select class="select" name="driver-age" aria-label="Choose Age" id="field-3">
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-label" for="field-4">Write Additional Note</label>
                          <textarea rows="5" class="form-control" placeholder="Write note here..." aria-label="Write note here..." id="field-4"></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="car-booking-extra">
                        <h4>Add Extra Services</h4>
                        <div class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" role="switch" id="booking-extra1" checked="">
                          <label class="form-check-label" for="booking-extra1">Extra Services One</label>
                        </div>
                        <div class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" role="switch" id="booking-extra2">
                          <label class="form-check-label" for="booking-extra2">Extra Services Two</label>
                        </div>
                        <div class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" role="switch" id="booking-extra3">
                          <label class="form-check-label" for="booking-extra3">Extra Services Three</label>
                        </div>
                        <div class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" role="switch" id="booking-extra4">
                          <label class="form-check-label" for="booking-extra4">Extra Services Four</label>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 mt-30">
                      <button type="submit" class="theme-btn">Continue Booking<i class="fas fa-arrow-right"></i></button>
                    </div>
                  </form>
                </div>
              </div>
