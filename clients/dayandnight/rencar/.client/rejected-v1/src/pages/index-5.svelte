<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="hero-section hs-4">
        <div class="hero-single" style="background-image: url(/assets/img/shape/03.png)">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="hero-content text-center">
                  <h3 class="hero-title">Make Your <span>Travel Safe</span> And Faster</h3>
                  <div class="text-shape"><span>rental cars</span></div>
                  <div class="hero-img">
      ...
      <div class="car-type-area bg py-100">
        <div class="container">
          <div class="row">
      ...
      <div class="car-area car-border pt-120">
        <div class="container">
          <div class="row">
