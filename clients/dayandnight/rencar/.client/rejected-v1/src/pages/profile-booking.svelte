<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">My Booking</h3>
            ...
            <div class="col-lg-4 col-xl-3">
              <div class="user-sidebar">
                ...
                <ul class="sidebar-list">
                  ...
                  <li>
                    <a class="active" href="/profile-booking.html"><i class="far fa-shopping-bag icon"></i> My Booking</a>
                  </li>
                  <li>
                  ...
                  <div class="col-lg-12">
                    <div class="user-card mb-0">
                      <div class="header">
                        ...
                        <div class="right">
                          <div class="filter">
                            <select class="select" aria-label="Default">
                          ...
                          <a href="/book-ride.html" class="theme-btn">Book Ride<i class="fas fa-arrow-right"></i></a>
                        </div>
                      </div>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="content">
                                  <div class="img">
                                    <a href="#top" aria-label="Rencar home"><img src="/assets/img/car/01.png" alt=""></a>
                                  </div>
                                  <div class="info">
                                    <h4><a href="#top">Mercedes Benz Car</a></h4>
                                    <p>Book ID: #123456</p>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td>
                                <a href="#top" class="action-icon-btn btn-success" data-bs-toggle="tooltip" data-bs-title="Details" aria-label="eye"><i class="far fa-eye"></i></a>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <div class="content">
                                  <div class="img">
                                    <a href="#top" aria-label="Rencar home"><img src="/assets/img/car/02.png" alt=""></a>
                                  </div>
                                  <div class="info">
                                    <h4><a href="#top">Mercedes Benz Car</a></h4>
                                    <p>Book ID: #123456</p>
                            ...
                            <tr>
                              <td>
                                <div class="content">
                                  <div class="img">
                                    <a href="#top" aria-label="Rencar home"><img src="/assets/img/car/03.png" alt=""></a>
                                  </div>
                                  <div class="info">
                                    <h4><a href="#top">Mercedes Benz Car</a></h4>
                                    <p>Book ID: #123456</p>
                            ...
                            <tr>
                              <td>
                                <div class="content">
                                  <div class="img">
                                    <a href="#top" aria-label="Rencar home"><img src="/assets/img/car/04.png" alt=""></a>
                                  </div>
                                  <div class="info">
                                    <h4><a href="#top">Mercedes Benz Car</a></h4>
                                    <p>Book ID: #123456</p>
                            ...
                            <tr>
                              <td>
                                <div class="content">
                                  <div class="img">
                                    <a href="#top" aria-label="Rencar home"><img src="/assets/img/car/05.png" alt=""></a>
                                  </div>
                                  <div class="info">
                                    <h4><a href="#top">Mercedes Benz Car</a></h4>
                                    <p>Book ID: #123456</p>
                      ...
                      <div class="pagination-area mb-3">
                        <div>
                          <ul class="pagination mt-4">
                            ...
                            <li class="page-item active"><a class="page-link" href="#top">1</a></li>
                            <li class="page-item"><a class="page-link" href="#top">2</a></li>
                            <li class="page-item"><a class="page-link" href="#top">3</a></li>
                            <li class="page-item">
