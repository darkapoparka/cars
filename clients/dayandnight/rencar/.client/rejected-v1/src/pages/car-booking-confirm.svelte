<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Car Booking Confirm</h3>
          <ul class="breadcrumb-menu">
            <li><a href="/index.html">Home</a></li>
            <li class="active">Car Booking Confirm</li>
          </ul>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-md-8 mx-auto">
              <div class="booking-confirm-content">
                ...
                <a href="#top" class="theme-btn"><span class="fas fa-arrow-right"></span> Order More</a>
              </div>
            </div>
            <div class="col-md-8 mx-auto mt-5">
              <div class="booking-summary">
                <h3>Order Summary (#124586)</h3>
                  ...
                  <div class="row g-5">
                    <div class="col-lg-6">
                      <div class="booking-summary-list">
                        ...
                        <ul>
                          ...
                          <li>People <span>1 People</span></li>
                    ...
                    <div class="col-lg-6">
                      <div class="booking-summary-list">
                        <h4>Billing Info</h4>
                        <ul>
                          <li>Name <span>Nikola Jonson</span></li>
                          <li>
                            Email
                    ...
                    <div class="col-lg-6">
                      <div class="booking-summary-list">
                        <h4>Order Info</h4>
                        <ul>
                          <li>Order Id <span>#124586</span></li>
                          <li>Payment Status <span class="text-success">Completed</span></li>
                          <li>Payment Method <span>Card</span></li>
                          <li>Tax <span>10%</span></li>
                          <li class="fw-bold">Total Payment <span>600.00</span></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                </div>
                <a href="#top" class="theme-btn">Print Order <i class="far fa-print"></i></a>
              </div>
            </div>
          </div>
        </div>
