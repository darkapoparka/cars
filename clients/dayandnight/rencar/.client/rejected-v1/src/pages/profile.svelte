          ...
          <div class="container position-relative">
            ...
            <div class="mobile-menu-right">
              ...
              <div class="account-profile">
                <a href="/dashboard.html" aria-label="Rencar home"><img src="/assets/img/account/03.jpg" alt=""></a>
              </div>
              ...
              <div class="user-sidebar">
                <div class="sidebar-top">
                  <div class="profile-img">
                    ...
                    <button type="button" class="profile-img-btn" aria-label="camera"><i class="far fa-camera"></i></button>
                    <input type="file" class="profile-img-file" aria-label="file">
                  </div>
                  <h4>Antoni Jonson</h4>
                ...
                <ul class="sidebar-list">
                  <li>
                    <a href="/dashboard.html"><i class="far fa-gauge-high icon"></i> Dashboard</a>
                  </li>
                  <li>
                    <a class="active" href="/profile.html"><i class="far fa-user-tie-hair icon"></i> My Profile</a>
                  </li>
                  <li>
                    <a href="/profile-booking.html"><i class="far fa-shopping-bag icon"></i> My Booking</a>
                  </li>
                  <li>
                    <a href="/profile-cancel-booking.html"><i class="far fa-xmark-circle icon"></i> Cancel Booking</a>
                  </li>
                  <li>
                    <a href="/profile-wishlist.html"><i class="far fa-heart icon"></i> My Wishlist</a>
                  </li>
                  <li>
                    <a href="/profile-payment.html"><i class="far fa-credit-card icon"></i> Payment History</a>
                  </li>
                  <li>
                    <a href="/profile-setting.html"><i class="far fa-gear icon"></i> Settings</a>
                  </li>
                  <li>
                    <a href="#top"><i class="far fa-sign-out icon"></i> Logout</a>
                  </li>
                </ul>
              </div>
            </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="Antoni" placeholder="First Name" aria-label="First Name" id="field-0">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="form-label" for="field-1">Last Name</label>
                                <input type="text" class="form-control" value="Jonson" placeholder="Last Name" aria-label="Last Name" id="field-1">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="form-label" for="field-2">Email</label>
                                <input type="text" class="form-control" value="antoni@example.com" placeholder="Email" aria-label="Email" id="field-2">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="form-label" for="field-3">Phone</label>
                                <input type="text" class="form-control" value="+2 134 562 458" placeholder="Phone" aria-label="Phone" id="field-3">
                              </div>
                            </div>
                            <div class="col-md-12">
                              <div class="form-group">
                                <label class="form-label" for="field-4">Address</label>
                                <input type="text" class="form-control" value="New York, USA" placeholder="Address" aria-label="Address" id="field-4">
                              </div>
                            </div>
                            <div class="col-md-12">
                              <div class="form-group">
                                <label class="form-label" for="field-5">About Me</label>
                                <textarea class="form-control" rows="4" placeholder="Write Here..." aria-label="Write Here..." id="field-5">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.
                                </textarea>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="user-form">
                          <form action="#">
                            <div class="row">
                              <div class="col-md-4">
                                <div class="form-group">
                                  <label class="form-label" for="field-6">Old Password</label>
                                  <input type="password" class="form-control" placeholder="Old Password" aria-label="Old Password" id="field-6">
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                  <label class="form-label" for="field-7">New Password</label>
                                  <input type="password" class="form-control" placeholder="New Password" aria-label="New Password" id="field-7">
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                  <label class="form-label" for="field-8">Re-Type Password</label>
                                  <input type="password" class="form-control" placeholder="Re-Type Password" aria-label="Re-Type Password" id="field-8">
                                </div>
                              </div>
                            </div>
