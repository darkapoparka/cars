<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="hero-section hs-1">
        <div class="hero-single" style="background-image: url(/assets/img/hero/hero-1.jpg)">
          <div class="container">
            <div class="row">
              <div class="col-md-12 col-lg-7">
                <div class="hero-content">
                  <h4 class="hero-sub-title wow fadeInUp" data-wow-delay=".2s"><i class="far fa-car"></i> Welcome To Rencar!</h4>
                  <h3 class="hero-title wow fadeInUp" data-wow-delay=".4s">
                    Find Affordable <span>Dream Cars</span> For Your Rental
                  </h3>
                  <p class="wow fadeInUp" data-wow-delay=".6s">
                    ...
                    Internet tend to repeat injected.
                  </p>
      ...
      <div class="car-type-area py-120">
        <div class="container">
          <div class="row">
            <div class="col-12">
      ...
      <div class="counter-area">
        <div class="counter-wrap cw-full">
          <div class="container">
            <div class="row g-4">
      ...
      <div class="service-area bg pt-80 pb-150">
          ...
          <div class="service-slider owl-carousel">
            ...
            <div class="item">
              <div class="service-item wow fadeInUp" data-wow-delay=".4s">
                ...
                <div class="service-icon">
                  <img src="/assets/img/icon/wedding-car.svg" alt="">
                </div>
                <div class="service-content">
                  <h4><a href="/service-single.html">Wedding Ceremony</a></h4>
                  <p>
                    It is long established fact that reader will distract majority have suffered alteration the readable content layout.
                  </p>
                  <a href="/service-single.html" class="theme-btn">Details<i class="fas fa-arrow-right"></i></a>
