<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Dashboard</h3>
            ...
            <div class="col-lg-4 col-xl-3">
              <div class="user-sidebar">
                ...
                <ul class="sidebar-list">
                  <li>
                    <a class="active" href="/dashboard.html"><i class="far fa-gauge-high icon"></i> Dashboard</a>
                  </li>
                  <li>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="user-card mb-0">
                      <div class="header">
                        <h4 class="title">Upcoming Booking</h4>
                        <div class="header-right">
                          <a href="/profile-booking.html" class="theme-btn">View All<i class="fas fa-arrow-right"></i></a>
                        </div>
                      </div>
