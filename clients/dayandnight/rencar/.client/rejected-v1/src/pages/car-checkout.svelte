<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Car Booking Checkout</h3>
          <ul class="breadcrumb-menu">
            <li><a href="/index.html">Home</a></li>
            <li class="active">Car Booking Checkout</li>
          </ul>
        </div>
      </div>
      ...
      <div class="car-booking py-120">
        <div class="container">
          <div class="row">
            <div class="col-lg-4">
              <div class="car-booking-sidebar">
                <h3 class="title">Booking Car Info</h3>
                <div class="car-booking-selected">
                  <div class="img">
                    <img src="/assets/img/car/02.png" alt="">
                  </div>
                  <div class="info">
                    <h4>Toyota Sports Car</h4>
                    <span class="car-price">$390 <sub>/ For 10 days</sub></span>
                  </div>
                </div>
                <div class="car-booking-list">
                  <h4>Car Info</h4>
                  <ul>
                    <li>Car <span>Toyota Sports</span></li>
                    <li>Rent Quantity <span>1 Cars</span></li>
                    <li>Traveler <span>1 Traveler</span></li>
                    <li>Driving Service <span>Yes(Pay Extra $100)</span></li>
                  </ul>
                </div>
                <div class="car-booking-list">
                  <h4>Rent Date &amp; Time</h4>
                  <ul>
                    <li>From <span>03-10-2026 | 12:30 AM</span></li>
                    <li>To <span>03-15-2026 | 12:30 AM</span></li>
                    <li>Duration <span>For 1 Months</span></li>
                  </ul>
                </div>
                <div class="car-booking-list">
                  <h4>Rent Location</h4>
                  <ul>
                    <li>Pick Up <span>New York, USA</span></li>
                    <li>Drop Off <span>New York, USA</span></li>
                  </ul>
                </div>
                <div class="car-booking-list">
                  <h4>Extra Services</h4>
                  <ul>
                    <li>Extra Service One</li>
                    <li>Extra Service Two</li>
                  </ul>
                </div>
                <div class="car-booking-list">
                  <h4>Payment Summary</h4>
                  <ul>
                    <li>1x GPS <span>$15.00</span></li>
                    <li>Insurance Fee <span>$20.00</span></li>
                    <li>Transfer Fee <span>$25.00</span></li>
                    <li>Disposition Fee <span>$22.00</span></li>
                    <li>Driving Fee <span>$100.00</span></li>
                    <li>Tax Fee <span>10%</span></li>
                  </ul>
                </div>
                <div class="car-booking-list booking-total">
                  <ul>
                    <li>Total Pay: <span>$600.00</span></li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <div class="car-booking-form">
                  <form action="#">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-label" for="field-0">First Name</label>
                          <input type="text" class="form-control" placeholder="Your First Name" aria-label="Your First Name" id="field-0">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-label" for="field-1">Last Name</label>
                          <input type="text" class="form-control" placeholder="Your Last Name" aria-label="Your Last Name" id="field-1">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-label" for="field-2">Email</label>
                          <input type="email" class="form-control" placeholder="Your Email" aria-label="Your Email" id="field-2">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-label" for="field-3">Phone</label>
                          <input type="text" class="form-control" placeholder="Your Phone" aria-label="Your Phone" id="field-3">
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-label" for="field-4">Address</label>
                          <input type="text" class="form-control" placeholder="Your Address" aria-label="Your Address" id="field-4">
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-label" for="field-5">Address 2</label>
                          <input type="text" class="form-control" placeholder="Your Address 2" aria-label="Your Address 2" id="field-5">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="form-label" for="field-6">City</label>
                          <input type="text" class="form-control" placeholder="Your City" aria-label="Your City" id="field-6">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="form-label" for="field-7">State</label>
                          <input type="text" class="form-control" placeholder="Your State" aria-label="Your State" id="field-7">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="form-label" for="field-8">Zip</label>
                          <input type="text" class="form-control" placeholder="Your Zip" aria-label="Your Zip" id="field-8">
                        </div>
                      </div>
                    </div>
                    <div class="mt-4">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label class="form-label" for="field-9">Card Holder Name</label>
                            <input type="text" class="form-control" placeholder="Name On Card" aria-label="Name On Card" id="field-9">
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label class="form-label" for="field-10">Card Number</label>
                            <input type="text" class="form-control" placeholder="Your Card Number" aria-label="Your Card Number" id="field-10">
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label class="form-label" for="field-11">Expire Date</label>
                            <input type="text" class="form-control" placeholder="Expire" aria-label="Expire" id="field-11">
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label class="form-label" for="field-12">CCV</label>
                            <input type="text" class="form-control" placeholder="CVV" aria-label="CVV" id="field-12">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 mt-30">
                      <button type="submit" class="theme-btn">Confirm Booking<i class="fas fa-arrow-right"></i></button>
                    </div>
                  </form>
                </div>
              </div>
