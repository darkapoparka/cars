...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Аутомаркет.",
          "The form is ready, but message delivery is not configured yet. Call Аутомаркет directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Аутомаркет.",
          "Message delivery is not configured yet. Call Аутомаркет directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Аутомаркет."
        : "Запитването е изпратено до екипа на Аутомаркет.",
      "Your request has been sent to the Аутомаркет team."
    ),
  };
};
