...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Аутомаркет за следващия си автомобил.",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Аутомаркет, за да уточним оглед и конкретна оферта.",
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Аутомаркет about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Аутомаркет to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Аутомаркет Варна в Варна — автомобили в наличност, внос по заявка и лизинг чрез партньори."
      : "Аутомаркет Варна in Sofia — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Аутомаркет"
      : "About and contact | Аутомаркет",
  });
};
