...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от Аутомаркет."
      : "Start a request for a vehicle from China with delivery to Bulgaria from Аутомаркет.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | Аутомаркет"
      : "Import from China | Аутомаркет",
  });
};
