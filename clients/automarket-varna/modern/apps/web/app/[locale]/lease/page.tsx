...
const pageCopy = {
  bg: {
    badge: "Финансиране от Аутомаркет",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Аутомаркет ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Аутомаркет",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Аутомаркет team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Аутомаркет Варна."
      : "A tailored vehicle financing offer from Аутомаркет Варна.",
    locale,
    path: "/lease",
