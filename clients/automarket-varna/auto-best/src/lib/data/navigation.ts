...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/assets/automarket/vehicle-01-1.webp', href: '/about-us' },
        { id: 'about-import', title: 'Внос по заявка', detail: 'Доставка по ваши критерии.', image: '/assets/automarket/vehicle-01-1.webp', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Запитване за лизинг', detail: 'Обсъдете условията директно с екипа.', image: '/assets/automarket/vehicle-01-1.webp', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
