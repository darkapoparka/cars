# Dealer project: automarket-varna / auto-best

This is an independent personalized dealer copy. Canonical editable source is Cars clients/automarket-varna/. The dedicated dealer repository is a publishing mirror. Make lasting fixes in canonical source or the versioned packaging layer and regenerate; preserve unmatched mirror fixes first. This copy is not a reusable template master.

Read local CLIENT.md and dealer.json (or their parent-directory copies), .client/project.json when present, and the relevant technical TEMPLATE.md. Shared policy: [Cars workflow](https://github.com/darkapoparka/cars/blob/ce78cb9d18c25c1ab89159ffb1ce58fd16b093bf/docs/WORKFLOW.md) and [publishing](https://github.com/darkapoparka/cars/blob/ce78cb9d18c25c1ab89159ffb1ce58fd16b093bf/docs/LEAD-PUBLISHING.md).
