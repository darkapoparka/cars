...
const phoneE164 = "+359886424400";
const city = "Варна";
const shortName = "Аутомаркет";
const district = "Варна";
const street = "бул. Цар Освободител — 300 м вдясно след Дом на Камиона, посока летището";
const location = "бул. Цар Освободител — 300 м вдясно след Дом на Камиона, посока летището";
...
export const daynightSite = {
	...
	email: "",
	location,
	locationShort: "бул. Цар Освободител — 300 м вдясно след Дом на Камиона, посока летището",
	locationLandmark: "бул. Цар Освободител — 300 м вдясно след Дом на Камиона, посока летището",
	...
	logoLight: "/assets/brand/logo-on-dark.webp",
	logoDark: "/assets/brand/logo-on-light.webp",
	...
	heroSubtitle: "Варна · Представителни обяви към 07.09.2026 г. Потвърдете наличността и условията по телефона.",
...
export const publicNavGroups = [
	...
	},
	{
		...
		href: '/about',
		children: [
			{ label: "За Аутомаркет", href: '/about' },
