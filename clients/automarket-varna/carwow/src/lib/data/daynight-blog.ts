export type DayNightArticleCategory = 'Новини' | 'Съвети' | 'Финансиране' | 'Документи' | 'Марки';
...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Дневни новини от Аутомаркет Варна',
		description:
			'Кратък дневен преглед на наличността, търсените марки и практичните стъпки за оглед в Аутомаркет Варна.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-28',
		author: 'Аутомаркет Варна',
		...
		sections: [
			{
				heading: 'Какво следим в ежедневните новини',
				paragraphs: [
					'В дневните публикации ще събираме кратки обновления за новопристигнали автомобили, интересни оферти, промени в търсенето и практически насоки за огледи.',
		...
		tags: ['новини', 'наличност', 'Варна']
	}),
	article({
		slug: 'novi-avtomobili-v-nalichnost-daynight-auto',
		title: 'Нови автомобили в наличност',
		description:
			'Обновления за интересни автомобили, които пристигат в наличността на Аутомаркет Варна Варна.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-27',
		author: 'Аутомаркет Варна',
		...
		readMinutes: 3,
		summary: [
			'Публикациите тип новина са подходящи за ежедневни обновления на наличност.',
			'Всяка новина може да насочва към конкретен автомобил, марка или услуга.',
			'При интерес към автомобил е важно да се потвърди наличност преди посещение.'
		],
		sections: [
			{
				heading: 'Защо дневните обновления помагат',
				paragraphs: [
					'Пазарът на употребявани автомобили се движи бързо, затова кратките новини помагат на клиентите да следят какво е актуално.',
					'Този тип съдържание работи добре и за SEO, защото създава редовни страници около реални търсения: марка, модел, бюджет, локация и услуга.'
				]
			},
			{
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Аутомаркет Варна съдейства с документи, регистрация, финансиране и оглед на място в Варна.'
				]
			}
		],
	...
	article({
		...
		title: 'Лизинг за употребяван автомобил в Варна',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на Аутомаркет Варна може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
					'При конкретен автомобил е най-добре параметрите да се обсъдят преди финално решение.'
				]
			}
		],
		tags: ['лизинг', 'финансиране', 'Варна']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Аутомаркет Варна предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
	...
	article({
		...
		sections: [
			{
				heading: 'Защо употребявани автомобилите искат повече внимание',
				paragraphs: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на Аутомаркет Варна често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез Аутомаркет Варна.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'Аутомаркет Варна',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Аутомаркет Варна помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
