...
function renderFooterSocialLinks() {
	...
	const links: readonly PresentationIconLink[] = [
		...
		},
		{
			...
			title: `Свържете се с ${daynightSite.shortName} по телефон по телефона.`,
			kind: 'direct',
			icon: whitePhoneIcon
		},
		{
		...
		},
		{
			...
			title: 'Отвори локацията на Аутомаркет Варна в Google Maps',
			kind: 'external',
...
<p class="text-sm text-muted mb-16">Аутомаркет Варна предлага актуална дигитална витрина с наличност, запитвания и ясни следващи стъпки.</p>
${renderFooterSocialLinks()}
</div>
<div>
<p class="text-sm text-white font-weight-600 mb-8">Имате въпрос?</p>
<div class="flex items-center gap-12">
<a href="/contact" class="btn btn-line-1 btn-small" title="Свържете се със Аутомаркет Варна">Свържете се</a>
</div>
</div>
</div>
</div>
...
<p class="text-sm text-muted">©2026 <a class="text-sm text-white" href="/">Аутомаркет Варна</a>. Всички права запазени.</p>
...
<a href="tel:${daynightSite.phone}" class="icon" aria-label="Обади се на Аутомаркет Варна">${phoneIcon()}</a>
...
<span>Изберете обаждане по телефона чат.</span>
<div class="daynight-contact-popover__actions">
<a href="tel:${daynightSite.phone}">Обади се</a>
<a href="${viberHref}">Обади се</a>
</div>
</div>
</li>
<li class="daynight-header-contact daynight-header-contact--location">
<a href="${daynightSite.mapUrl}" class="icon" target="_blank" rel="noopener" aria-label="Отвори карта до Аутомаркет Варна">${locationIcon()}</a>
<div class="daynight-header-contact__body">
...
<a class="daynight-map-preview" href="${daynightSite.mapUrl}" target="_blank" rel="noopener" aria-label="Отвори Google карта до Аутомаркет Варна">
<span class="daynight-map-preview__thumb">
<span class="daynight-map-preview__pin"></span>
</span>
<span class="daynight-map-preview__body">
<strong>Аутомаркет Варна Варна</strong>
