...
<div class="mobile-about-app" aria-label="За Аутомаркет Варна">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Аутомаркет Варна в Варна помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				...
				alt="Консултация със Аутомаркет Варна"
				loading="lazy"
				decoding="async"
			/>
			<div>
