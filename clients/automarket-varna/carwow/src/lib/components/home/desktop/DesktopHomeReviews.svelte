<script lang="ts">
  ...
  {
    "id": "service-0",
    "description": "Внос на употребявани автомобили от ЕС и доставка по поръчка.",
    "avatar": "/assets/automarket/cover.png",
    "name": "Продажба на употребявани автомобили",
    "meta": "Информация от публикуваните обяви"
  },
  {
    "id": "service-1",
    "description": "Обсъдете замяна на автомобила си срещу доплащане.",
    "avatar": "/assets/automarket/cover.png",
  ...
  {
    "id": "service-2",
    "description": "Съдействие при регистрация в КАТ и транзитни номера.",
    "avatar": "/assets/automarket/cover.png",
	...
	const actionCards: ActionCard[] = [
		...
		},
		{
			...
			bullets: [
				...
				'Получете обратна връзка от екипа на Аутомаркет Варна.',
