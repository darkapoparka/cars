...
<section class="home-videos" aria-label="Разгледайте отблизо">
	<div class="daynight-home-container">
		<DesktopSectionHeading title="Разгледайте отблизо" href={youtubeChannelUrl} label="Всички обяви">
