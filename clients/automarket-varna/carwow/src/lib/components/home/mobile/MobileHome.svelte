...
<div class="mobile-home" aria-label="Аутомаркет Варна — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="Аутомаркет Варна home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/automarket/cover.png')}
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на Аутомаркет Варна"
				>
		...
		<h1 class="mh-hero__title">Аутомаркет Варна</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 Аутомаркет Варна Варна. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, бул. Цар Освободител — 300 м вдясно след Дом на Камиона, посока летището</strong>
			</div>
