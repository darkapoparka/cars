<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Аутомаркет Варна предлага проверени автомобили, финансиране и съдействие при покупка в Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Аутомаркет Варна Варна" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Аутомаркет Варна Варна" />
	{/if}
