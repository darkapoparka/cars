					...
					>
						<div>
							<a
								...
								aria-label="Аутомаркет Варна начална страница"
							>
								<img
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								Аутомаркет Варна предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										aria-label={`Свържете се с ${daynightSite.shortName} по телефон по телефона.`}
								...
								<li>
									<a
										...
										aria-label="Отвори локацията на Аутомаркет Варна в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със Аутомаркет Варна."
								>
									Свържете се
								</a>
							</div>
			...
			>
				<p class="m-0 text-sa-sm leading-[22px] text-sa-surface/60 max-[767px]:ml-[15px]">
					©2026 <a
						...
						href={resolve('/')}>Аутомаркет Варна</a
