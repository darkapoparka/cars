<script lang="ts">
	...
	const shareUrl = $derived(`https://automarket.mobile.bg/blog/${article.slug}`);
		...
		<div class="bloc-details-container">
			...
			<div class="mb-40">
				<div class="listing-details--contact-dealer mb-20">
					<img src="/assets/automarket/cover.png" alt={daynightSite.shortName} />
					<div class="content">
				...
				<p class="h7 line-height-28">
					Аутомаркет Варна публикува практични съвети и новини за наличност, покупка, оглед, документи,
