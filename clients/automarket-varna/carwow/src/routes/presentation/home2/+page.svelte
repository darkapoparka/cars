<script lang="ts">
	...
	const guideCards = [
		...
		{
			title: 'Sell or part exchange with Аутомаркет Варна',
...
<svelte:head>
	<title>Аутомаркет Варна Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from Аутомаркет Варна Варна."
	/>
...
<main class="home2-shell">
	<section class="home2-hero" aria-labelledby="home2-title">
		<img
			...
			src="/assets/automarket/vehicle-14-1.webp"
			alt=""
			aria-hidden="true"
		/>

		<header class="home2-nav" aria-label="Home2 navigation">
			<a class="home2-logo" href={resolve('/presentation/home2')} aria-label="Аутомаркет Варна Home2">
				<img src="/assets/automarket/cover.png" alt="Аутомаркет Варна" />
			</a>
		...
		<h1 id="home2-title">
			...
			<span>Аутомаркет Варна can help</span>
		</h1>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular Аутомаркет Варна picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate Аутомаркет Варна as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-dark" aria-labelledby="easy-title">
		<div class="home2-dark__intro">
			<img src="/brand/daynight-team-placeholder.svg" alt="Аутомаркет Варна consultant" />
			<div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse Аутомаркет Варна stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
