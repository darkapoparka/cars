<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Exclusive Auto предлага публикувани автомобили, финансиране и съдействие при покупка в Варна.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Exclusive Auto Варна" />
	...
	{#if isDefaultOg}
		...
		<meta property="og:image:alt" content="Exclusive Auto Варна" />
	{/if}
