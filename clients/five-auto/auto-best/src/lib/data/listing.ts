...
export const listingFilterOptions = {
  ...
  versions: ['', 'Hybrid', 'P-HEV', 'EQ', 'TDI'],
  equipment: ['4x4', '360° камера', 'Панорамен покрив', 'Подгряване на седалки', 'Навигация', 'Парктроник', 'Безключово палене', 'Адаптивен круиз контрол'] satisfies readonly VehicleEquipment[],
  years: ['', ...new Set(featuredVehicles.map(vehicle => String(vehicle.yearNumber)))].sort(),
  prices: ['', '3000', '10000', '15000', '20000', '25000', '35000'],
  mileages: ['', '20000', '75000', '150000', '200000', '300000'],
  sorts: [
    ['default', 'Препоръчани'],
    ['newest', 'Най-нови'],
