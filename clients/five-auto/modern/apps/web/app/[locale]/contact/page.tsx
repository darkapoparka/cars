...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Exclusive Auto за следващия си автомобил.",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Exclusive Auto, за да уточним оглед и конкретна оферта.",
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Exclusive Auto about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Exclusive Auto to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Exclusive Auto в Варна — автомобили в наличност, внос по заявка и лизинг по запитване."
      : "Exclusive Auto in Varna — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Exclusive Auto"
      : "About and contact | Exclusive Auto",
  });
};
