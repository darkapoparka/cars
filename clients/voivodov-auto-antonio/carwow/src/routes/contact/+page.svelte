<script lang="ts">
	...
	const currentSeo = $derived(
		browser && page.url.searchParams.get('intent') === 'import'
			? {
					title: 'Внос на автомобил | VOIVODOV AUTO & ANTONIO Пловдив',
					description:
						'Изпратете обява или опишете желания автомобил и получете конкретни варианти за внос от VOIVODOV AUTO & ANTONIO.'
				}
			: data.seo
	);
</script>
