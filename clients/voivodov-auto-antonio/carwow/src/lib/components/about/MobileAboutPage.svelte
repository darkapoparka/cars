...
<div class="mobile-about-app" aria-label="За VOIVODOV AUTO & ANTONIO">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>VOIVODOV AUTO & ANTONIO · Пловдив. Публични обяви, информация за автомобилите и директен контакт за оглед.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		<section class="mobile-about-section" aria-labelledby="mobile-about-trust-title">
			<div class="mobile-about-heading">
				<span>VOIVODOV AUTO & ANTONIO</span>
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				...
				alt="Консултация със VOIVODOV AUTO & ANTONIO"
				loading="lazy"
				decoding="async"
			/>
			<div>
