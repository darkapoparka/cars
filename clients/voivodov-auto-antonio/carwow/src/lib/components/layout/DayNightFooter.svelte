					...
					>
						<div>
							<a
								...
								aria-label="VOIVODOV AUTO & ANTONIO начална страница"
							>
								<img
									class="mb-[22px] block h-[54px] w-[190px] object-contain"
									src="/dealer/logo-dark.png"
					...
					>
						<div>
							...
							<p class="m-0 mb-4 text-sa-sm leading-[22px] text-sa-surface/60">
								VOIVODOV AUTO & ANTONIO предлага актуална дигитална витрина с наличност, запитвания и ясни
								следващи стъпки.
							</p>
							<ul class="m-0 mb-3 flex list-none flex-wrap gap-2 p-0">
								...
								<li>
									<a
										...
										aria-label="Отвори локацията на VOIVODOV AUTO & ANTONIO в Google Maps"
										class={socialLinkClasses}
									>
						...
						>
							...
							<div class="flex items-center gap-3">
								<a
									...
									title="Свържете се със VOIVODOV AUTO & ANTONIO."
								>
									Свържете се
								</a>
							</div>
			...
			>
				<p class="m-0 text-sa-sm leading-[22px] text-sa-surface/60">
					©2026 <a
						...
						href={resolve('/')}>VOIVODOV AUTO & ANTONIO</a
