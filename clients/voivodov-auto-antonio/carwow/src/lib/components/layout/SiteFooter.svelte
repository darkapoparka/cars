<script lang="ts">
	...
	import { footerNavItems, daynightSite } from '$lib/data/daynight-site';

	const buyingLinks = footerNavItems.slice(0, 4);
	const supportLinks = footerNavItems.slice(4, 8);
</script>

<footer class="site-footer">
	<div class="site-footer__top container">
		<div class="site-footer__brand">
			<img src="/dealer/logo-dark.png" alt={daynightSite.name} />
			<p>
				Публикувани обяви в Пловдив със съдействие за оглед, документи, регистрация, финансиране
				и бартер.
			</p>
		</div>
		<div>
