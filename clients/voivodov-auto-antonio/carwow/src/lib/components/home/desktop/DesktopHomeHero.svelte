			...
			<div class="daynight-home-hero__stage-content daynight-home-container">
				<div class="daynight-home-hero__location-wrap">
					...
					>
						...
						<span>Въстанически · кв. Въстанически — точният адрес се уточнява по телефона</span>
					</button>
					<button
						type="button"
						id="daynight-home-hero-map-preview"
						class="daynight-home-hero__location-preview"
						aria-label="Отвори Google Maps до VOIVODOV AUTO & ANTONIO"
						onclick={openMap}
					>
						<span class="daynight-home-hero__location-map" aria-hidden="true">
							...
							<span class="daynight-home-hero__location-map-label">VOIVODOV AUTO & ANTONIO</span>
						</span>
						<span class="daynight-home-hero__location-preview-copy">
							<strong>VOIVODOV AUTO & ANTONIO Пловдив</strong>
							<span>гр. Пловдив, Въстанически, кв. Въстанически — точният адрес се уточнява по телефона</span>
