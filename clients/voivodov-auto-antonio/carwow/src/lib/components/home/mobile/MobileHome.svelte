...
<div class="mobile-home" aria-label="VOIVODOV AUTO & ANTONIO — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="VOIVODOV AUTO & ANTONIO home">
				<img
					class="mh-hero__logo"
			...
			<div class="mh-hero__bar-actions">
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на VOIVODOV AUTO & ANTONIO"
				>
		...
		<h1 class="mh-hero__title">VOIVODOV AUTO & ANTONIO</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 VOIVODOV AUTO & ANTONIO Пловдив. Демонстрационна концепция. Не е официалният сайт.</span>
	</footer>
