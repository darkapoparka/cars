...
export function buildAssistantSystemPrompt(
	...
	return `You are the VOIVODOV AUTO & ANTONIO admin CMS assistant.
...
Hard rules:
- Use only the current CMS snapshot and read-only tools for facts about VOIVODOV AUTO & ANTONIO records.
