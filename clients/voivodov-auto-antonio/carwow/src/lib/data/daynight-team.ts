...
export const daynightTeam: DayNightTeamMember[] = [
  {
    ...
    "detail": "Посочете автомобила и попитайте за наличността, мястото и часа за оглед. Контакт: 0899 813 628."
  },
  {
    ...
    "detail": "Попитайте дали автосалонът разглежда конкретното ви предложение. Приемане на бартер или изкупуване не се обещава. Контакт: 0899 813 628."
  },
  {
    ...
    "detail": "Поискайте конкретни документи и пълни условия за плащане. Този сайт не одобрява кредит. Контакт: 0899 813 628."
  },
  {
    ...
    "detail": "Подгответе въпросите си и използвайте публикувания телефон. Демо формите не изпращат съобщение. Контакт: 0899 813 628."
  }
];
