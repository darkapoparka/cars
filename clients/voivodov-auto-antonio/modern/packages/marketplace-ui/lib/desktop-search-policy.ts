...
const organizationSuggestions: readonly SearchSuggestionDefinition[] = [
  {
    descriptionBg: "Директен контакт · Пловдив",
    descriptionEn: "Verified dealer · Пловдив",
    id: "sofia-premium-cars",
    keywords: "sofia premium cars dealer дилър софия bmw audi",
    kind: "dealer",
    label: "Пловдив Premium Cars",
    popular: true,
    value: "Пловдив Premium Cars",
  },
  {
    descriptionBg: "Вносител от Китай · Пловдив",
    descriptionEn: "Importer from China · Пловдив",
    id: "china-ev-import",
  ...
  },
  {
    ...
    descriptionEn: "Dealers and importers in Пловдив",
