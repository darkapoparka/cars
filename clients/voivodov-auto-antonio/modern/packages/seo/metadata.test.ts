...
describe("VOIVODOV AUTO & ANTONIO localized metadata", () => {
  it("brands Bulgarian pages and emits canonical locale metadata", () => {
    ...
    expect(metadata.title).toBe("Автомобили | VOIVODOV AUTO & ANTONIO");
    expect(metadata.applicationName).toBe("VOIVODOV AUTO & ANTONIO");
