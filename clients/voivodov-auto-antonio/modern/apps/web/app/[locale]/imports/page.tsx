...
const importFaqs = {
  bg: [
    ...
    {
      answer:
        "Не е нужен акаунт. Оставете телефон и екипът на VOIVODOV AUTO & ANTONIO ще се свърже с вас, за да уточни следващата стъпка.",
  ...
  en: [
    ...
    {
      answer:
        "No account is required. Leave a phone number and the VOIVODOV AUTO & ANTONIO team will contact you about the next step.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Изпратете линк или данни за автомобил от чужбина. VOIVODOV AUTO & ANTONIO ще уточни заявката за внос и доставка до България."
      : "Send a listing link or vehicle details from abroad. VOIVODOV AUTO & ANTONIO will discuss the import request and delivery to Bulgaria.",
    locale,
    path,
    title: isBg
      ? "Внос на автомобил по заявка | VOIVODOV AUTO & ANTONIO"
      : "Vehicle import request | VOIVODOV AUTO & ANTONIO",
  });
};
