...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от VOIVODOV AUTO & ANTONIO."
      : "Start a request for a vehicle from China with delivery to Bulgaria from VOIVODOV AUTO & ANTONIO.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | VOIVODOV AUTO & ANTONIO"
      : "Import from China | VOIVODOV AUTO & ANTONIO",
  });
};
