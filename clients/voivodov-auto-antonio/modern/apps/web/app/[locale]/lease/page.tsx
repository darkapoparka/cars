...
const pageCopy = {
  bg: {
    badge: "Финансиране от VOIVODOV AUTO & ANTONIO",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на VOIVODOV AUTO & ANTONIO ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from VOIVODOV AUTO & ANTONIO",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The VOIVODOV AUTO & ANTONIO team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от VOIVODOV AUTO & ANTONIO."
      : "A tailored vehicle financing offer from VOIVODOV AUTO & ANTONIO.",
    locale,
    path: "/lease",
