...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с VOIVODOV AUTO & ANTONIO за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Въстанически.",
    locationLabel: "Шоурум · Въстанически",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на VOIVODOV AUTO & ANTONIO, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Въстанически",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with VOIVODOV AUTO & ANTONIO about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call VOIVODOV AUTO & ANTONIO to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "VOIVODOV AUTO & ANTONIO в Пловдив — автомобили в наличност, внос по заявка и условия за плащане."
      : "VOIVODOV AUTO & ANTONIO in Пловдив — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | VOIVODOV AUTO & ANTONIO"
      : "About and contact | VOIVODOV AUTO & ANTONIO",
  });
};
