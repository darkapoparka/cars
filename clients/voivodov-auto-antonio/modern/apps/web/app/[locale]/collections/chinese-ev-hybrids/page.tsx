...
const collectionCopy = {
  bg: {
    ...
    truth:
      "VOIVODOV AUTO & ANTONIO не твърди официално партньорство с показаните марки. Всяка оферта се потвърждава индивидуално.",
  },
  en: {
    ...
    truth:
      "VOIVODOV AUTO & ANTONIO does not claim an official partnership with the displayed brands. Every offer is confirmed individually.",
  },
} as const;
