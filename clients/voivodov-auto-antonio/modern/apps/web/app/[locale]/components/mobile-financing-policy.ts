...
export const financingRequestCopy = {
  bg: {
    ...
    successBody:
      "Екипът на VOIVODOV AUTO & ANTONIO ще се свърже с вас за конкретните условия.",
    term: "Срок",
  ...
  en: {
    ...
    successBody: "The VOIVODOV AUTO & ANTONIO team will contact you to confirm the terms.",
    term: "Term",
