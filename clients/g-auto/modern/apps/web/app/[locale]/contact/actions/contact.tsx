...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на G Auto.",
          "The form is ready, but message delivery is not configured yet. Call G Auto directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на G Auto.",
          "Message delivery is not configured yet. Call G Auto directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на G Auto."
        : "Запитването е изпратено до екипа на G Auto.",
      "Your request has been sent to the G Auto team."
    ),
  };
};
