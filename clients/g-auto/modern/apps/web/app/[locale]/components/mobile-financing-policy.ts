...
export const financingRequestCopy = {
  bg: {
    ...
    sending: "Изпращане…",
    success: "Черновата е подготвена",
    successBody:
      "Демото не изпраща заявки. Обадете се за конкретни условия.",
    term: "Срок",
  ...
  en: {
    ...
    successBody: "This preview does not send requests. Call to discuss the terms.",
    term: "Term",
