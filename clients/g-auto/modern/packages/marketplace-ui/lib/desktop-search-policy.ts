...
const organizationSuggestions: readonly SearchSuggestionDefinition[] = [
  {
    descriptionBg: "Проверен дилър · Благоевград",
    descriptionEn: "Verified dealer · Blagoevgrad",
    id: "sofia-premium-cars",
    keywords: "sofia premium cars dealer дилър софия bmw audi",
    kind: "dealer",
    label: "Blagoevgrad Premium Cars",
    popular: true,
    value: "Blagoevgrad Premium Cars",
  },
  {
    descriptionBg: "Вносител от Китай · Благоевград",
    descriptionEn: "Importer from China · Blagoevgrad",
    id: "china-ev-import",
  ...
  {
    descriptionBg: "Дилъри и вносители в Благоевград",
    descriptionEn: "Dealers and importers in Blagoevgrad",
