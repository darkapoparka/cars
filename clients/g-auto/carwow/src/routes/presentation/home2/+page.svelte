<script lang="ts">
	...
	const guideCards = [
		...
		{
			title: 'Sell or part exchange with G Auto',
...
<svelte:head>
	<title>G Auto Marketplace | Home2</title>
	<meta
		name="description"
		content="Browse, buy, sell and review verified cars from G Auto Благоевград."
	/>
		...
		<section class="home2-trending" aria-labelledby="trending-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Popular G Auto picks, ready to compare side by side</p>
				</div>
			</div>
		...
		<section class="home2-reviews" aria-labelledby="reviews-title">
			<div class="home2-section-title">
				...
				<div>
					...
					<p>Customers rate G Auto as excellent for buying, selling and support</p>
				</div>
			</div>
	...
	<section class="home2-explore" aria-labelledby="explore-title">
		<div class="home2-section-title home2-section-title--explore">
			...
			<div>
				...
				<p>Browse G Auto stock by the brands and body styles customers ask for most.</p>
			</div>
		</div>
