...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Как да следите наличността на G Auto',
		description:
		...
		tags: ['новини', 'наличност', 'Благоевград']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'G Auto съдейства с документи, регистрация, финансиране и оглед на място в Благоевград.'
				]
			}
		],
	...
	article({
		...
		title: 'Лизинг за употребяван автомобил в Благоевград',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на G Auto може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
					'При конкретен автомобил е най-добре параметрите да се обсъдят преди финално решение.'
				]
			}
		],
		tags: ['лизинг', 'финансиране', 'Благоевград']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'G Auto предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на G Auto често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез G Auto.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'G Auto',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'G Auto помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
