...
export const footerSocialLinks: FooterSocialLink[] = [{label:'Mobile.bg',href:daynightSite.sourceInventory,title:'Публикувани обяви на G Auto',icon:'mobilebg',external:true}];
