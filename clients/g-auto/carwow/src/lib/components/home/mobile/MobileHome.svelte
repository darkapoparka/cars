...
<div class="mobile-home" aria-label="G Auto — начало">
	<header class="mh-hero">
		...
		<h1 class="mh-hero__title">G Auto</h1>
		...
		<section class="mh-cta-wrap" aria-label="Призив за действие">
			<div class="mh-cta">
				<div class="mh-cta__copy">
					<strong>{total} обяви · Оглед в Благоевград</strong>
	...
	<footer class="mh-footer">
		<div class="mh-footer__brand">
			...
			/>
			<p>
				Автокъща в Благоевград с подбрани употребявани автомобили. Съдействие за документи, регистрация,
		...
		<span class="mh-footer__copy">© 2026 G Auto Благоевград. Всички права запазени.</span>
	</footer>
