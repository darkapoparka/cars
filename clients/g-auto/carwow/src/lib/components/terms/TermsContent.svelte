<script lang="ts">
	...
	const intro =
		"Неофициална демонстрация на три дизайна за G Auto. Не е договор, оферта или потвърждение от търговеца.";
	const usageNotice =
		"Проектът представя оформление и работа с подбрани публични обяви. Не е официално одобрен сайт на G Auto.";
	const photosNotice =
		"Снимките към обявите са от продавача. Концептуалните илюстрации в оформлението не представят налични автомобили или реални служители.";
	const accuracyNotice =
		"Цените са обявени суми в евро, отделни от първоначални и месечни вноски. Данните са от продавача; не е извършена независима техническа проверка.";
	const stockNotice =
		"Демо селекция от публикувани обяви към 09.09.2026 г. Наличността, пробегът и условията се потвърждават от G Auto. Не е жив каталог.";
	const updatesNotice =
		"Това не са договорни условия, одобрени от G Auto. Публично представяне и реални интеграции изискват отделно потвърждение.";

	const sharedListItems = ["Калкулаторите са илюстративни. Лизинг, замяна, документи и евентуален внос се уточняват пряко с продавача; демонстрацията не одобрява кредит и не приема поръчки.","Потвърдете автомобила, актуалната цена, точната локация и часа за оглед на публикувания телефон. Не изпращайте лични данни през демонстрационните форми.","Не въвеждайте лични или чувствителни данни. Формите са за преглед на интерфейса, а не потвърден канал за връзка с търговеца."];
...
<div class="terms-page">
	<section class="breadcrumb-band" aria-label="Навигационна пътека">
		<div class="terms-container">
			<ol class="breadcrumb">
				...
				<li>
					<span>Условия за преглед на демото</span>
				</li>
			</ol>
		</div>
	</section>
	...
	<section class="terms-main">
		<div class="terms-container">
			<h1>Условия за преглед на демото</h1>
