...
const article: DayNightArticle = {
	...
	title: "Как да потвърдите актуална наличност в ELIT AUTO",
	...
	readMinutes: 2,
	summary: ["Подбрани текущо рекламирани автомобили. Наличност, състояние, пробег и условия се потвърждават с продавача.", "Независим демонстрационен преглед. Формите не изпращат съобщения и не създават резервация."],
	sections: [
		{
			heading: "Преди посещение",
			paragraphs: ["Обадете се на 0887 777 887 и посочете точния автомобил, който Ви интересува."]
		},
		{
