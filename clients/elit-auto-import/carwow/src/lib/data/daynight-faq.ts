        ...
        "answer": [
          {
            ...
            "text": "Подбрани текущо рекламирани автомобили. Наличност, състояние, пробег и условия се потвърждават с продавача."
          }
        ]
      },
      {
        ...
        "answer": [
          {
            "class": "h7 text-secondary line-height-28",
            "text": "Свържете се с ELIT AUTO на 0887 777 887 преди посещение на адрес ул. „Прилеп“ 74А, м-т Пчелина."
          }
        ]
      },
      {
