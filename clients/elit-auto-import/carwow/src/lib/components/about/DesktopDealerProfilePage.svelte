	...
	<section class="background-light mb-32">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb__icon" aria-hidden="true"><ChevronRight size={14} /></li>
				<li><span>Профил на ELIT AUTO</span></li>
			</ul>
		</div>
	</section>
			...
			<div class="dealer-profile-hero__grid">
				...
				<div class="dealer-profile-card">
					<img
						...
						src="/assets/elit/logo.png"
						alt=""
					/>
					<p class="dealer-profile-card__title mb-6">ELIT AUTO</p>
	...
	<section class="py-80">
		<div class="container">
			<div class="dealer-about-grid">
				...
				<LazyMapEmbed src={mapEmbedSrc} title="Карта до ELIT AUTO Варна" height="330" />
			</div>
		</div>
	</section>
