	...
	<section class="about-section" aria-labelledby="about-story-title">
		<div class="about-container about-story">
			<img
				...
				alt="Илюстративна визия на ELIT AUTO: Mercedes-Benz и Lamborghini с ключове за бартер"
				width="1200"
				height="800"
				loading="lazy"
			/>
			<div>
				...
				<p>
					ELIT AUTO е автокъща в Варна. При нас можеш да разгледаш наличните автомобили, да
					уговориш оглед и да обсъдиш продажба или бартер на твоя автомобил.
				</p>
				<p>
					Разгледай автомобилите онлайн или ни посети в м-т Пчелина. Екипът ще уточни
	...
	<section class="about-visit" aria-labelledby="about-visit-title">
		<div class="about-container about-visit__banner">
			<div class="about-visit__copy">
				...
				<div class="about-visit-hours"><Clock3 size={20} aria-hidden="true" /><div><strong>Работно време: по телефона</strong><span>Уговорете посещение предварително</span></div></div>
			...
			<div class="about-visit__map">
				{#if mapVisible}
					<LazyMapEmbed src={mapEmbedSrc} title="Карта до ELIT AUTO Варна" height="280" />
				{:else}
					<button class="about-map-preview" onclick={() => (mapVisible = true)}>
						<MapPin size={36} aria-hidden="true" />
						<strong>м-т Пчелина, Варна</strong>
