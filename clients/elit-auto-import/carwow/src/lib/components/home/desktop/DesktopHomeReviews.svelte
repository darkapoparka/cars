<script lang="ts">
	...
	const actionCards: ActionCard[] = [
		...
		},
		{
			...
			alt: 'Въпрос за автомобил автомобил',
			title: 'Въпрос за автомобил',
			balancedTitle: 'Въпрос за автомобил',
			titleHref: '/sell-your-car',
			bullets: [
				'Изпратете снимки и данни за автомобила.',
				'Получете обратна връзка от екипа на ELIT AUTO.',
