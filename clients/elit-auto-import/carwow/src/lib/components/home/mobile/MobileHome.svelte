...
<div class="mobile-home" aria-label="ELIT AUTO — начало">
	<header class="mh-hero">
		<div class="mh-hero__bar">
			<a class="mh-hero__brand" href={resolve('/')} aria-label="ELIT AUTO home">
				<img
					class="mh-hero__logo"
					src={resolve('/assets/elit/logo.png')}
			...
			<div class="mh-hero__bar-actions">
				<button
					...
					type="button"
					aria-label="Локация: м-т Пчелина, Варна"
				...
				<a
					...
					href={phoneHref}
					aria-label="Обади се на ELIT AUTO"
				>
		...
		<h1 class="mh-hero__title">ELIT AUTO</h1>
	...
	<footer class="mh-footer">
		...
		<span class="mh-footer__copy">© 2026 ELIT AUTO Варна. Всички права запазени.</span>
	</footer>
	...
	<MobileDrawer bind:open={locationOpen} labelledBy="mh-location-title">
		<div class="mh-location-sheet">
			<header>
				<div>
					<span>Локация</span>
					<strong id="mh-location-title">м-т Пчелина, Варна</strong>
				</div>
			...
			<div class="mh-location-sheet__map" aria-hidden="true">
				...
				<span>Варна</span>
				<strong>гр. Варна, м-т Пчелина, ул. Прилеп 74А</strong>
			</div>
