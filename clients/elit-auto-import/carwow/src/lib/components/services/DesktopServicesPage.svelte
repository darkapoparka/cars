	...
	const services = [
		{
			...
			summary: 'Възможна е проверка в сервиз по Ваш избор — уговорете я предварително.',
		...
		},
		{
			...
			summary: 'Продажба с фактура и договор според публикуваните обяви.',
		...
		},
		{
			...
			summary: 'Няма публикувани условия за финансиране или бартер. Уточнете възможностите директно с автокъщата.',
...
<main id="main-content" tabindex="-1" class="desktop-services" aria-label="Услуги ELIT AUTO">
	...
	<section class="desktop-services-offers">
		<div class="container">
			<h2 class="desktop-services-sr-only">Конкретни услуги от ELIT AUTO</h2>
