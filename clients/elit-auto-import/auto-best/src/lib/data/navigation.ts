...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'about-showroom', title: 'Шоурум и подбор', detail: `Подбрани автомобили в ${brand.city}.`, image: '/assets/elit/cover.png', href: '/about-us' },
        { id: 'about-import', title: 'Внос по заявка', detail: 'Доставка по ваши критерии.', image: '/assets/elit/cover.png', href: '/contact?topic=import' },
        { id: 'about-leasing', title: 'Условия за покупка', detail: 'Обсъдете условията директно с екипа.', image: '/assets/elit/cover.png', href: '/contact?topic=leasing' }
      ],
      groups: [
        {
          id: 'about-company',
  ...
  },
  {
    ...
    menu: {
      ...
      features: [
        { id: 'guides-inspection', title: 'Проверка преди покупка', detail: 'История, документи и състояние.', image: '/assets/elit/cover.png', href: '/blog' },
        { id: 'guides-import', title: 'Внос и документи', detail: 'Основните стъпки преди регистрация.', image: '/assets/elit/cover.png', href: '/blog' },
        { id: 'guides-leasing', title: 'Лизинг и условия', detail: 'Какво да уточните преди финансиране.', image: '/assets/elit/cover.png', href: '/blog' }
      ],
      groups: [
        {
          id: 'guides-library',
