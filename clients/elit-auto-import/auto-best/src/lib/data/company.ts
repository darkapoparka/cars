...
export const companyServices: CompanyService[] = [
  ...
  },
  {
    ...
    cta: 'Обсъдете доставка'
  },
  {
    index: '04',
    icon: 'trade-in',
    title: 'Проверка в сервиз',
    description: 'Възможност за проверка в сервиз по Ваш избор.',
...
export const contactTopics: ContactTopic[] = [
  ...
  },
  {
    ...
    label: 'Проверка',
    title: 'Проверка в сервиз',
    description: 'Уточнете възможността за проверка в избран от Вас сервиз.',
    mobileDescription: 'Попитайте за проверка за продажба или бартер.'
  }
];
