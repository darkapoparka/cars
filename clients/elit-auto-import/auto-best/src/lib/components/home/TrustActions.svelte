<script lang="ts">
  ...
  const actions = [
    ...
    },
    {
      ...
      vehicle: 'gclass',
      tone: 'red',
      mobileTitle: 'Проверка',
      mobileCta: 'Попитай екипа',
      description: 'Уговорете проверка в сервиз по Ваш избор.',
      bannerDescription: ['Проверка в сервиз', 'по Ваш избор.'],
      cta: 'Попитайте за проверка',
    ...
    {
      title: 'Доставка в страната',
      vehicle: 'urus',
      tone: 'black',
      mobileTitle: 'Доставка в страната',
      mobileCta: 'Виж условия',
      description: 'Доставка със собствен транспорт — уточнете условията.',
      bannerDescription: ['Доставка в страната', 'със собствен транспорт.'],
