  ...
  const budgetTiles = [
    {
      ...
      href: '/listing-grid?price_max=15000',
      image: featuredVehicles[1].image
    },
    {
      label: '15–20 000 €',
      detail: `${featuredVehicles.filter((vehicle) => vehicle.priceEur > 15000 && vehicle.priceEur <= 20000).length} автомобила`,
      href: '/listing-grid?price_min=15000&price_max=20000',
      image: featuredVehicles[2].image
    },
    {
      label: 'Над 20 000 €',
      detail: `${featuredVehicles.filter((vehicle) => vehicle.priceEur > 20000).length} автомобила`,
      href: '/listing-grid?price_min=20000',
      image: featuredVehicles[3].image
    },
    {
      label: 'Виж всички',
