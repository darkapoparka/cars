<script lang="ts">
  ...
  const images = {
    cars: '/assets/elit/cover.png',
    keys: '/assets/elit/cover.png',
    guide: '/assets/elit/cover.png',
    silver: '/assets/elit/cover.png',
    graphite: '/assets/elit/cover.png',
    portrait: '/assets/elit/cover.png',
    phone: '/assets/elit/cover.png',
    showroom: '/assets/elit/cover.png',
    email: '/assets/elit/cover.png'
  };
  const pairs = {
