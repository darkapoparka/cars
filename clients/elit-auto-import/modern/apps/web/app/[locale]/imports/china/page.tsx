...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Започнете заявка за автомобил от Китай с доставка до България от ELIT AUTO."
      : "Start a request for a vehicle from China with delivery to Bulgaria from ELIT AUTO.",
    locale,
    path,
    title: isBg
      ? "Внос от Китай | ELIT AUTO"
      : "Import from China | ELIT AUTO",
  });
};
