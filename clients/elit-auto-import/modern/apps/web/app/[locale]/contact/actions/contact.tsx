...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на ELIT AUTO.",
          "The form is ready, but message delivery is not configured yet. Call ELIT AUTO directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на ELIT AUTO.",
          "Message delivery is not configured yet. Call ELIT AUTO directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на ELIT AUTO."
        : "Запитването е изпратено до екипа на ELIT AUTO.",
      "Your request has been sent to the ELIT AUTO team."
    ),
  };
};
