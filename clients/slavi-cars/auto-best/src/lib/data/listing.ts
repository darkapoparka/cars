...
export const listingFilterOptions = {
  ...
  versions: ['', 'Cabrio', 'M Sport', 'xDrive', 'Long'],
  ...
  years: ['', ...new Set(featuredVehicles.map(v=>v.year).sort())],
  prices: ['', '5000', '10000', '15000', '20000', '30000', '40000', '50000', '60000'],
  mileages: ['', '100000', '150000', '200000', '250000', '300000', '400000'],
  sorts: [
    ['default', 'Препоръчани'],
    ['newest', 'Най-нови'],
