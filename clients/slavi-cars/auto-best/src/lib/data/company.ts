...
export const contactPreparation: Partial<Record<ContactTopicId, { title: string; items: string[] }>> = {
  ...
  import: {
    ...
    items: ['Марка, модел и предпочитания', 'Бюджет и условия за обсъждане', 'Линк към обява, ако вече сте избрали']
  },
  leasing: {
...
export const companyServices: CompanyService[] = [
  ...
  },
  {
    ...
    description: 'Попитайте за съдействие и индивидуални условия; Slavi Cars не е пряк кредитор.',
  ...
  },
  {
    ...
    description: 'Попитайте дали се разглежда предложение за замяна; оценка не се извършва през демото.',
...
// Exact public map is owned by ShowroomMap; no inherited coordinates.
