  ...
  <div class="container">
    <div class="dn-videos__panel">
      ...
      <div class="dn-videos__grid">
        {#if featuredVideos.length === 0}<article class="dn-video-card"><div class="dn-video-card__content"><h3>Снимки на автомобилите</h3><p>Всяко предложение съдържа галерия от обявата на Slavi Cars.</p><a href="/listing-grid">Разгледайте автомобилите</a></div></article>{/if}
