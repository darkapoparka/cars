<script lang="ts">
	...
	const DEFAULT_DESCRIPTION =
		'Slavi Cars предлага подбрани обяви, финансиране и съдействие при покупка в Дупница.';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Slavi Cars Дупница" />
	...
	<meta property="og:image:alt" content="Slavi Cars Дупница" />
