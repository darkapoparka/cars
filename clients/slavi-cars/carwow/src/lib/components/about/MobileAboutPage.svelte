...
<div class="mobile-about-app" aria-label="За Slavi Cars">
	<header class="mobile-about-hero">
		<img
			class="mobile-about-hero__bg"
			src={resolve('/dealer/stock/21784972577846700-1.webp')}
			alt=""
			aria-hidden="true"
		/>
		<div class="mobile-about-hero__bar">
			<a href={resolve('/')} aria-label="Slavi Cars начало">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>Slavi Cars в Дупница помага с избор, оглед, документи, финансиране и бартер.</p>
		</div>
	...
	<main id="main-content" tabindex="-1">
		...
		<section class="mobile-about-location" aria-labelledby="mobile-about-location-title">
			<img
				src={resolve('/dealer/stock/21784972577846700-1.webp')}
				alt="Консултация със Slavi Cars"
				loading="lazy"
				decoding="async"
			/>
			<div>
				<span>Шоурум в Дупница</span>
