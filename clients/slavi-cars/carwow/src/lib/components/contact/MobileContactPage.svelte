	...
	const importSteps = [
		{
			...
			copy: 'Уточнете с Slavi Cars дали може да съдейства по избраната обява.'
		},
		{
...
<div class="mobile-contact-app">
	<header class:mobile-contact-hero--import={isImportMode} class="mobile-contact-hero">
		...
		<div class="mobile-contact-hero__copy">
			...
			<h1>
				{isImportMode ? 'Намерете автомобила. Ние ще го внесем.' : 'Свържете се със Slavi Cars'}
			</h1>
			<p>
				{isImportMode
