<script lang="ts">
	...
	const intro =
		"Неофициална демонстрация на три дизайна за Slavi Cars. Не е договор, оферта или потвърждение от търговеца.";
	const usageNotice =
		"Проектът представя оформление и работа с подбрани публични обяви. Не е официално одобрен сайт на Slavi Cars.";
	const photosNotice =
	...
	const updatesNotice =
		"Това не са договорни условия, одобрени от Slavi Cars. Публично представяне и реални интеграции изискват отделно потвърждение.";
