...
export async function submitImportRequest(
	...
	if (daynightSite.previewMode) return {ok:false,status:503,error:'Демонстрационна форма: съобщението не е изпратено. Свържете се с Slavi Cars на 0895 714 484.'};
	try {
