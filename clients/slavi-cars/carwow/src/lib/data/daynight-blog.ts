...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Как да следите наличността на Slavi Cars',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Slavi Cars съдейства с документи, регистрация, финансиране и оглед на място в Дупница.'
				]
			}
		],
	...
	article({
		...
		title: 'Лизинг за употребяван автомобил в Дупница',
		description:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Екипът на Slavi Cars може да насочи клиента към подходящи варианти за финансиране според автомобила, бюджета и желания срок.',
					'При конкретен автомобил е най-добре параметрите да се обсъдят преди финално решение.'
				]
			}
		],
		tags: ['лизинг', 'финансиране', 'Дупница']
	}),
	article({
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Slavi Cars предлага съдействие с документи и регистрация, за да не се губи време между огледа и предаването.'
				]
			}
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'В наличността на Slavi Cars често има BMW, Mercedes-Benz и Audi, подходящи за оглед и сравнение на място.'
				]
			}
		],
	...
	article({
		...
		description:
			'Какво да подготвите, ако искате оценка, продажба или замяна на автомобил чрез Slavi Cars.',
		category: 'Съвети',
		kind: 'guide',
		date: '2026-05-21',
		author: 'Slavi Cars',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Slavi Cars помага на клиента да сравни тези фактори преди финализиране.'
				]
			}
		],
