...
const organizationSuggestions: readonly SearchSuggestionDefinition[] = [
  {
    descriptionBg: "Проверен дилър · Дупница",
    descriptionEn: "Verified dealer · Дупница",
    id: "sofia-premium-cars",
    keywords: "sofia premium cars dealer дилър софия bmw audi",
    kind: "dealer",
    label: "Дупница Premium Cars",
    popular: true,
    value: "Дупница Premium Cars",
  },
  {
    descriptionBg: "Вносител от Китай · Дупница",
    descriptionEn: "Importer from China · Дупница",
    id: "china-ev-import",
  ...
  {
    descriptionBg: "Дилъри и вносители в Дупница",
    descriptionEn: "Dealers and importers in Дупница",
