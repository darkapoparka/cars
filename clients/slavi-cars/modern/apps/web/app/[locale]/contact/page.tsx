...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с Slavi Cars за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в път E79.",
    locationLabel: "Шоурум · път E79",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на Slavi Cars, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · път E79",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with Slavi Cars about your next vehicle.",
    inventoryAction: "View available vehicles",
    phoneAction: "Call us",
    contactTitle: "Speak directly with us.",
    contactDescription:
      "One phone number for vehicles, imports, or finance. Showroom in път E79.",
    locationLabel: "Showroom · път E79",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call Slavi Cars to arrange an inspection and a concrete offer.",
    ...
    sellYearLabel: "Year",
    sellLocationLabel: "Showroom · път E79",
    services: [
      {
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Slavi Cars, път E79 — подбрани обяви, снимки и контакт за оглед."
      : "Slavi Cars, път E79 — selected advertisements, photos and viewing contact.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | Slavi Cars"
      : "About and contact | Slavi Cars",
  });
};
