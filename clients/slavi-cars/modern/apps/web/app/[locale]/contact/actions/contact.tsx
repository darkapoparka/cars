...
const getCopy = (isBg: boolean, isImportRequest: boolean) => {
  ...
  return {
    ...
    notConfigured: isImportRequest
      ? localized(
          "Формата е готова, но каналът за съобщения още не е конфигуриран. Обадете се директно на Slavi Cars.",
          "The form is ready, but message delivery is not configured yet. Call Slavi Cars directly."
        )
      : localized(
          "Каналът за съобщения още не е конфигуриран. Обадете се директно на Slavi Cars.",
          "Message delivery is not configured yet. Call Slavi Cars directly."
        ),
    ...
    success: localized(
      isImportRequest
        ? "Заявката е изпратена до екипа на Slavi Cars."
        : "Запитването е изпратено до екипа на Slavi Cars.",
      "Your request has been sent to the Slavi Cars team."
    ),
  };
};
