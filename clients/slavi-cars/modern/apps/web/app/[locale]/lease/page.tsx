...
const pageCopy = {
  bg: {
    badge: "Финансиране от Slavi Cars",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на Slavi Cars ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from Slavi Cars",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The Slavi Cars team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от Slavi Cars."
      : "A tailored vehicle financing offer from Slavi Cars.",
    locale,
    path: "/lease",
