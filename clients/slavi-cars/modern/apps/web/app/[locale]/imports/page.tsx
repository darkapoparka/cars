...
const importFaqs = {
  bg: [
    ...
    {
      answer:
        "Демонстрационна форма без изпращане. Обадете се, за да уточните дали Slavi Cars разглежда заявка за внос.",
  ...
  en: [
    ...
    {
      answer:
        "Demonstration form with no message delivery. Call to discuss whether Slavi Cars can consider an import request.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Подгответе линк или данни за разговор. Възможността за внос се уточнява с Slavi Cars, не през тази форма."
      : "Prepare a listing link or details for a conversation. Discuss import possibilities with Slavi Cars; this form does not send requests.",
    locale,
    path,
    title: isBg
      ? "Внос на автомобил по заявка | Slavi Cars"
      : "Vehicle import request | Slavi Cars",
  });
};
