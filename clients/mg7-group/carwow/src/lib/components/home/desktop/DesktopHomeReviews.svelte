	...
	const actionCards: ActionCard[] = [
		...
		},
		{
			...
			bullets: [
				...
				'Получете обратна връзка от екипа на MG7 Group.',
		...
		>
			<div class="daynight-home-review-grid">
				<div class="daynight-home-review-grid__items">
					{#if daynightReviews.length === 0}<div class="testimonior-box"><p>Няма добавени клиентски мнения в този преглед. Вместо примерни оценки показваме само данните от публичните обяви.</p><a href="https://mg7group.mobile.bg/" target="_blank" rel="noreferrer">Публичен профил</a></div>{/if}
