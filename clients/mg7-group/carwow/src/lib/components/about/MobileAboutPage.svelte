...
<div class="mobile-about-app" aria-label="За MG7 Group">
	<header class="mobile-about-hero">
		...
		<div class="mobile-about-hero__copy">
			...
			<p>MG7 Group · Бургас. Публични обяви, информация за автомобилите и директен контакт за оглед.</p>
		</div>
