...
const pageCopy = {
  bg: {
    ...
    description:
      "Вижте автомобилите в наличност или говорете директно с MG7 Group за следващия си автомобил.",
    inventoryAction: "Вижте наличностите",
    phoneAction: "Обадете се",
    contactTitle: "Говорете директно с нас.",
    contactDescription:
      "Един телефон за автомобил, внос или финансиране. Шоурум в Промишлена зона — Север.",
    locationLabel: "Шоурум · Промишлена зона — Север",
    ...
    sellHandoffDescription:
      "Данните за автомобила са готови. Обадете се на MG7 Group, за да уточним оглед и конкретна оферта.",
    ...
    sellLocationLabel: "Шоурум · Промишлена зона — Север",
    services: [
      {
  ...
  en: {
    ...
    description:
      "Browse the vehicles in stock or speak directly with MG7 Group about your next vehicle.",
    ...
    sellHandoffDescription:
      "Your vehicle details are ready. Call MG7 Group to arrange an inspection and a concrete offer.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "MG7 Group в Бургас — автомобили в наличност, внос по заявка и условия за плащане."
      : "MG7 Group in Бургас — vehicles in stock, import on request, and in-house leasing.",
    locale,
    path: "/contact",
    robots: getPublicSearchRobots(query),
    title: isBg
      ? "За нас и контакти | MG7 Group"
      : "About and contact | MG7 Group",
  });
};
