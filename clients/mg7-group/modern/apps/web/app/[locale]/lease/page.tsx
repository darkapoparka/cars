...
const pageCopy = {
  bg: {
    badge: "Финансиране от MG7 Group",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Необходимите документи зависят от конкретния случай. Екипът на MG7 Group ще ви даде точен списък още при първия разговор.",
  ...
  en: {
    badge: "Financing from MG7 Group",
    description:
    ...
    faqs: [
      ...
      {
        answer:
          "Required documents depend on the individual case. The MG7 Group team will give you an exact list during the first conversation.",
...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? "Индивидуална оферта за финансиране на автомобил от MG7 Group."
      : "A tailored vehicle financing offer from MG7 Group.",
    locale,
    path: "/lease",
