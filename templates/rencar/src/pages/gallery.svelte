<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Our Gallery</h3>
          ...
          <div class="row">
            <div class="col-lg-7 mx-auto">
              <div class="site-heading text-center wow fadeInUp" data-wow-delay=".2s">
                <span class="site-title-tagline"><i class="far fa-car"></i>our Gallery</span>
                <h3 class="site-title">Let's Check Our <span>Photo Gallery</span></h3>
            ...
            <div class="col-md-3">
              <div class="gallery-item wow fadeInUp" data-wow-delay=".2s">
                ...
                <div class="gallery-content">
                  <a class="popup-img gallery-link" href="/assets/img/gallery/01.jpg" aria-label="plus"><i class="fal fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="gallery-item wow fadeInUp" data-wow-delay=".4s">
                ...
                <div class="gallery-content">
                  <a class="popup-img gallery-link" href="/assets/img/gallery/02.jpg" aria-label="plus"><i class="fal fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="gallery-item wow fadeInUp" data-wow-delay=".6s">
                ...
                <div class="gallery-content">
                  <a class="popup-img gallery-link" href="/assets/img/gallery/03.jpg" aria-label="plus"><i class="fal fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="gallery-item wow fadeInUp" data-wow-delay=".8s">
                ...
                <div class="gallery-content">
                  <a class="popup-img gallery-link" href="/assets/img/gallery/04.jpg" aria-label="plus"><i class="fal fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="gallery-item wow fadeInUp" data-wow-delay=".2s">
                ...
                <div class="gallery-content">
                  <a class="popup-img gallery-link" href="/assets/img/gallery/05.jpg" aria-label="plus"><i class="fal fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="gallery-item wow fadeInUp" data-wow-delay=".4s">
                ...
                <div class="gallery-content">
                  <a class="popup-img gallery-link" href="/assets/img/gallery/06.jpg" aria-label="plus"><i class="fal fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="gallery-item wow fadeInUp" data-wow-delay=".6s">
                ...
                <div class="gallery-content">
                  <a class="popup-img gallery-link" href="/assets/img/gallery/07.jpg" aria-label="plus"><i class="fal fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="gallery-item wow fadeInUp" data-wow-delay=".8s">
                ...
                <div class="gallery-content">
                  <a class="popup-img gallery-link" href="/assets/img/gallery/08.jpg" aria-label="plus"><i class="fal fa-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
