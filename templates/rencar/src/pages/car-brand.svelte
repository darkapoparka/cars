<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Car Brands</h3>
        ...
        <div class="container">
          <div class="row g-4">
            <div class="col-6 col-md-3 col-lg-3 col-xl-2">
              <a href="/car.html" class="brand-item wow fadeInUp" data-wow-delay=".1s">
                <div class="brand-img">
            ...
            <div class="col-6 col-md-3 col-lg-3 col-xl-2">
              <a href="/car.html" class="brand-item wow fadeInUp" data-wow-delay=".2s">
                <div class="brand-img">
            ...
            <div class="col-6 col-md-3 col-lg-3 col-xl-2">
              <a href="/car.html" class="brand-item wow fadeInUp" data-wow-delay=".3s">
                <div class="brand-img">
            ...
            <div class="col-6 col-md-3 col-lg-3 col-xl-2">
              <a href="/car.html" class="brand-item wow fadeInUp" data-wow-delay=".4s">
                <div class="brand-img">
            ...
            <div class="col-6 col-md-3 col-lg-3 col-xl-2">
              <a href="/car.html" class="brand-item wow fadeInUp" data-wow-delay=".5s">
                <div class="brand-img">
            ...
            <div class="col-6 col-md-3 col-lg-3 col-xl-2">
              <a href="/car.html" class="brand-item wow fadeInUp" data-wow-delay=".6s">
                <div class="brand-img">
