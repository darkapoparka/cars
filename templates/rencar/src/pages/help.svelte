<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Help Center</h3>
      ...
      <div class="help-area py-120">
        <div class="container">
                  ...
                  <form action="#">
                    <div class="form-group">
                      ...
                      <div class="help-search-keyword">
                        ...
                        <a href="#top">Payment</a>, <a href="#top">Refunds</a>,
            ...
            <div class="col-lg-4">
              <div class="help-item">
                ...
                <div class="help-content">
                  ...
                  <p>
                    There are many variations of passages of Lorem Ipsum available but the majority have alteration in some form, by
                    injected humour words which don't look even slightly believable.
                  </p>
                  <a href="#top" class="theme-btn">Read More<i class="fas fa-arrow-right"></i></a>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
          ...
          <div class="help-bottom">
            ...
            <a href="#top" class="theme-btn">Submit A Ticket<i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
