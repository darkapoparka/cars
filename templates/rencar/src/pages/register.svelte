          ...
          <div class="col-md-5 mx-auto">
            <div class="auth-form">
              <div class="auth-header">
                <img src="/assets/img/logo/logo.png" alt="">
                <p>Create your free rencar account</p>
              </div>
              <form action="#">
                <div class="form-group">
                  <div class="form-icon">
                ...
                <div class="auth-group">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="agree">
                      I agree with the <a href="/terms.html" class="auth-group-link">Terms Of Service.</a>
                    </label>
                  </div>
                </div>
                <div class="auth-btn">
              ...
              <div class="auth-bottom">
                <div class="auth-social">
                  ...
                  <div class="auth-social-list">
                    ...
                    <a href="#top" aria-label="google"><i class="fab fa-google"></i></a>
                    <a href="#top" aria-label="x twitter"><i class="fab fa-x-twitter"></i></a>
                  </div>
                </div>
                <p class="auth-bottom-text">Already have an account? <a href="/login.html">Login.</a></p>
              </div>
            </div>
          </div>
        </div>
