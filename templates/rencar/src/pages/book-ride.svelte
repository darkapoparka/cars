<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Book A Ride</h3>
            ...
            <div class="col-md-10 mx-auto">
              <div class="booking-form">
                <div class="book-ride-head">
                  <h4 class="title">Make Your Booking Today</h4>
                  <p>
                    It is a long established fact that a reader will be distracted by the readable content of a page when looking at its
                    layout. The point of using is that it has distribution of letters to using content here making it look like readable.
                  </p>
                </div>
                <form action="#">
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-label" for="field-0">Full Name</label>
                        <div class="form-icon">
                          <i class="far fa-user-tie-hair"></i>
                          <input type="text" class="form-control" name="full-name" placeholder="Your Name" aria-label="Your Name" id="field-0">
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <div class="form-icon">
                          <i class="far fa-phone-incoming"></i>
                          <input type="text" class="form-control" name="phone" placeholder="Your Phone" aria-label="Your Phone" id="field-1">
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <div class="form-icon">
                          ...
                          <input type="text" class="form-control" name="email" placeholder="Your Email" aria-label="Your Email" id="field-2">
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-label" for="field-3">Pick Up Location</label>
                        <div class="form-icon">
                          <i class="far fa-location-dot"></i>
                          <select class="select" name="pu-location" data-slim-search="true" aria-label="Pick Up Location" id="field-3">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-label" for="field-4">Pick Up Date &amp; Time</label>
                        <div class="form-icon">
                          <i class="far fa-calendar-range"></i>
                          <input type="text" class="form-control date-picker" data-datetime="true" name="pu-date" placeholder="Pick Up Date &amp; Time" aria-label="Pick Up Date &amp; Time" id="field-4">
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-label" for="field-5">Drop Off Location</label>
                        <div class="form-icon">
                          <i class="far fa-location-dot"></i>
                          <select class="select" data-slim-search="true" name="do-location" aria-label="Drop Off Location" id="field-5">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-label" for="field-6">Drop Off Date &amp; Time</label>
                        <div class="form-icon">
                          <i class="far fa-calendar-range"></i>
                          <input type="text" class="form-control date-picker" data-datetime="true" name="do-date" placeholder="Drop Off Date &amp; Time" aria-label="Drop Off Date &amp; Time" id="field-6">
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-label" for="field-7">Car Traveler</label>
                        <div class="form-icon">
                          <i class="far fa-user-tie-hair"></i>
                          <select class="select" name="passenger" aria-label="Choose Traveler" id="field-7">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-label" for="field-8">Driver Age</label>
                        <div class="form-icon">
                          <i class="far fa-user-pilot"></i>
                          <select class="select" name="driver-age" aria-label="Choose Driver Age" id="field-8">
                            <option value="">Choose Driver Age</option>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-label" for="field-9">Car Type</label>
                        <div class="form-icon">
                          <i class="far fa-steering-wheel"></i>
                          <select class="select" name="type" aria-label="Choose Car Type" id="field-9">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-label" for="field-10">Car Brands</label>
                        <div class="form-icon">
                          <i class="far fa-circle-half-stroke"></i>
                          <select class="select" data-slim-search="true" name="brands" aria-label="Choose Car Brands" id="field-10">
                            <option value="">Choose Car Brands</option>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-label" for="field-11">Car Model</label>
                        <div class="form-icon">
                          <i class="far fa-car"></i>
                          <select class="select" data-slim-search="true" name="car-model" aria-label="Choose Car Model" id="field-11">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-label" for="field-12">Your Message</label>
                        <div class="form-icon">
                          <i class="far fa-pencil"></i>
                          <textarea class="form-control" rows="5" placeholder="Write Your Message" name="message" aria-label="Write Your Message" id="field-12"></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="condition">
                          By using this form you agree to our <a href="#top">terms &amp; conditions</a>.
                        </label>
                      </div>
                    </div>
