<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Settings</h3>
            ...
            <div class="col-lg-4 col-xl-3">
              <div class="user-sidebar">
                ...
                <ul class="sidebar-list">
                  ...
                  <li>
                    <a class="active" href="/profile-setting.html"><i class="far fa-gear icon"></i> Settings</a>
                  </li>
                  <li>
            ...
            <div class="col-lg-8 col-xl-9">
              <div class="user-wrapper">
                <div class="user-card user-setting">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <h5 class="mb-3">Privacy Setting</h5>
                      <div class="privacy-setting">
                        <form action="#">
                          <div class="form-check form-switch">
                            <input class="form-check-input" name="privacy" value="1" type="checkbox" id="privacy-1" checked="">
                            <label class="form-check-label" for="privacy-1">Enable Messages.</label>
                          </div>
                          <div class="form-check form-switch">
                            <input class="form-check-input" name="privacy" value="2" type="checkbox" id="privacy-2">
                            <label class="form-check-label" for="privacy-2">I Want To Receive Email Notify.</label>
                          </div>
                          <div class="form-check form-switch">
                            <input class="form-check-input" name="privacy" value="3" type="checkbox" id="privacy-3" checked="">
                            <label class="form-check-label" for="privacy-3">Hide My Phone Number From Public.</label>
                          </div>
                          <div class="form-check form-switch">
                            <input class="form-check-input" name="privacy" value="4" type="checkbox" id="privacy-4">
                            <label class="form-check-label" for="privacy-4">I Want To Receive Message.</label>
                          </div>
                          <div class="form-check form-switch">
                            <input class="form-check-input" name="privacy" value="5" type="checkbox" id="privacy-5" checked="">
                            <label class="form-check-label" for="privacy-5">Make My Profile Private.</label>
                          </div>
                          <div class="form-check form-switch">
                            <input class="form-check-input" name="privacy" value="6" type="checkbox" id="privacy-6" checked="">
                            <label class="form-check-label" for="privacy-6">Notify Me Via Email When Logging In.</label>
                          </div>
                          <div class="mt-4">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="user-form">
                        <form action="#">
                          <div class="form-group">
                            <select class="select mb-4" aria-label="Choose Reason">
                          ...
                          <div class="form-group">
                            <textarea class="form-control" cols="30" rows="4" placeholder="Describe Your Reason" aria-label="Describe Your Reason"></textarea>
                          </div>
