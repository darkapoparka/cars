<svelte:options runes={true} />
    ...
    <main class="main">
      ...
      <div class="site-breadcrumb ng-mt" style="background: url(/assets/img/breadcrumb/01.jpg)">
        <div class="container">
          <h3 class="breadcrumb-title">Cancel Booking</h3>
            ...
            <div class="col-lg-4 col-xl-3">
              <div class="user-sidebar">
                ...
                <ul class="sidebar-list">
                  ...
                  <li>
                    <a class="active" href="/profile-cancel-booking.html"><i class="far fa-xmark-circle icon"></i> Cancel Booking</a>
                  </li>
                  <li>
            ...
            <div class="col-lg-8 col-xl-9">
              <div class="user-wrapper">
                <div class="row g-4">
                  <div class="col-lg-12">
                    <div class="user-card">
                      <h4 class="title">Cancel Booking</h4>
                      <div class="user-form">
                        <form action="#">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="form-label" for="field-0">Booking Id</label>
                                <input type="text" class="form-control" placeholder="Enter Booking Id" aria-label="Enter Booking Id" id="field-0">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="form-label" for="field-1">Reason For Cancellation</label>
                                <select class="select" aria-label="Choose Reason" id="field-1">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <label class="form-label" for="field-2">Your Comment</label>
                                <textarea class="form-control" rows="4" placeholder="Write Here..." aria-label="Write Here..." id="field-2"></textarea>
                              </div>
                            </div>
                          </div>
                          <button type="submit" class="theme-btn"><span class="far fa-xmark-circle"></span> Cancel Booking</button>
                        </form>
                      </div>
                    </div>
                  </div>
