// Applies the Eliq Auto brand grade to generated raster assets.
//
...
// off-white -- the same tokens used in eliqauto.css.
//
...
const TARGET = process.argv[2] ?? 'static/assets/eliqauto/codex-generated';
const STRENGTH = clamp(Number(process.env.STRENGTH ?? '0.6'), 0, 1);
const QUALITY = 80;
const SUFFIX = '-graded';

// Brand anchors (sRGB), straight from eliqauto.css.
