export const garageFavoriteKey = 'eliqauto:favorites';
export const garageCompareKey = 'eliqauto:compare';
export const garageSessionKey = 'eliqauto:session';
export const garageCompareSlotsKey = 'eliqauto:compare:mobile-slots';
