...
import { eliqautoBrand } from '$lib/data/eliqauto';
...
export const sellYourCarHero: AuxeroPageBanner = {
	description:
		'Изпрати VIN, пробег, очаквана цена и телефон. Eliqauto ще прегледа автомобила и ще предложи реалистичен следващ ход.',
	eyebrow: 'Eliqauto оценка',
	image: '/assets/eliqauto/services/sell-car-service.webp',
	title: 'Продай автомобила си с Eliqauto'
};
...
export const auxeroSellSteps: AuxeroSellCarStep[] = [
	...
	},
	{
		...
		text: 'Eliqauto преглежда информацията и уточнява липсващите детайли преди препоръка.'
	},
	{
...
export const sellCarMobileCopy: AuxeroSellCarMobileCopy = {
	...
	logoAlt: eliqautoBrand.name,
	logoSrc: '/assets/eliqauto/brand/eliqauto-logo-dark.svg',
	messageLabel: 'Пиши ни',
	statusMessage: 'Заявката е изпратена. Eliqauto ще се свърже с вас скоро.',
