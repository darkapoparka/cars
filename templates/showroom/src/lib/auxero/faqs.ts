...
export const supportFaqs: AuxeroFaq[] = [
	{
		topic: 'Import',
		question: 'Защо да внеса автомобил с проверена история?',
		answer:
			'внос често предлага добре оборудвани автомобили с проследима история и конкурентна цена. Eliqauto проверява конкретния автомобил, документи, пробег, снимки и ориентировъчна крайна цена преди препоръка.'
	},
	{
		topic: 'Timing',
	...
	{
		topic: 'Checks',
		question: 'Какво проверява Eliqauto преди покупка?',
		answer:
	...
	},
	{
		...
		answer:
			'Документите зависят от конкретния автомобил и сделка. Eliqauto потвърждава наличните документи за покупка, транспорт, митница и регистрация преди предаване.'
	},
	{
		topic: 'Warranty',
	...
	{
		topic: 'Selling',
		question: 'Може ли Eliqauto да помогне при продажба на моя автомобил?',
		answer:
			'Да. Изпратете VIN, пробег, снимки, сервизна история, състояние, документи и очаквана цена. Eliqauto може да предложи директна оферта, клиентска обява или съдействие при продажба.'
	},
	{
		topic: 'Viewing',
	...
	{
		topic: 'Compare',
		question: 'Може ли Eliqauto да сравни няколко модела?',
		answer:
