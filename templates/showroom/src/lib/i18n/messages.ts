...
export const messages: Record<Locale, PublicMessages> = {
	en: {
		header: {
			...
			megaDetails: 'Details',
			megaView: 'View',
			searchPlaceholder: 'Search Eliq Auto inventory',
			signIn: 'Sign In',
			wishlist: 'Wishlist'
		},
		home: {
			actionBand: {
				buyBody: 'Discuss import, documents, viewing and next steps with an Eliq Auto consultant.',
				buyCta: 'Book time',
				buyTitle: 'Book A Consultation',
				importBody: 'Selection, inspection, documents and 100% leasing.',
				importCta: 'See the process',
				importTitle: 'Premium Cars & Leasing'
			},
			...
			budgetTitle: 'Eliq Auto by Budget',
			byline: 'by Eliq Auto',
			commonCta: 'View All',
			compareEmpty: 'Your compare is currently empty',
			compareTitle: 'Compare Top Rated Vehicles',
			featuredTitle: 'Newest Vehicles',
			newsTitle: 'Eliq Auto notes',
			readMore: 'Read more',
			reviewsTitle: 'Client Reviews',
			seo: {
				description:
					'Eliq Auto: verified cars with clear origin, plus import and financing support — selection, inspection, documents and delivery for Bulgaria.',
				title: 'Eliq Auto — Premium Cars'
			},
		...
		hero: {
			...
			heading: 'Browse, Compare, Drive With Eliq Auto!',
			searchSubmitPrefix: 'Show',
			searchSubmitSuffix: 'Matches',
			slideSubtitle: 'Premium vehicles with verified history and clear appointment support.',
		...
		inventory: {
			emptyBody: 'Clear filters or contact Eliq Auto for an import request.',
			emptyTitle: 'No Eliq Auto vehicles match these filters',
			reset: 'Reset inventory',
			vehicleCard: vehicleCardEn
		},
		detail: {
			callEliqauto: 'Call Eliq Auto',
			carOverview: 'Car Overview',
			cash: 'Cash',
			chatOnViber: 'Chat on Viber',
			compare: 'Compare',
			consultantLabel: 'Eliq Auto Consultant',
			description: 'Description',
			detailDescriptionFallback:
				'is available through Eliq Auto with source review and viewing by appointment.',
			directions: 'Get Directions',
			email: 'Email',
			finance: 'Finance',
			financeIntro: 'Estimated payment before final taxes, registration, and transport costs.',
			financeTerms: 'Estimated over 72 months. Final terms confirmed by Eliq Auto.',
			formConsent:
			...
			inquiryCta: 'Inquire',
			inquiryIntro: 'Leave your details and Eliq Auto will get back to you about this car.',
			inquirySuccess: 'Done — Eliq Auto will be in touch as soon as possible.',
			callCta: 'Call',
			message: 'Message',
	...
	bg: {
		...
		home: {
			actionBand: {
				...
				importBody: 'Подбор, проверка, документи и доставка с възможност за лизинг до 100%.',
				importCta: 'Виж процеса',
				importTitle: 'Внос и лизинг'
			},
			...
			newsTitle: 'Съвети от Eliq Auto',
			readMore: 'Прочети повече',
			reviewsTitle: 'Отзиви от клиенти',
			seo: {
				description:
					'Eliq Auto: проверени автомобили с ясен произход, съдействие при внос и възможност за лизинг до 100%.',
				title: 'Eliq Auto — проверени премиум автомобили'
			},
		...
		hero: {
			checksTitle: 'Проверки от Eliq Auto',
			...
			features: [
				...
				'Проверка на пробег',
				'Документална следа',
				'Съдействие за внос и финансиране',
				'Готовност за регистрация',
				'Оглед с предварителна уговорка',
				'Прием на клиентски автомобили'
			],
			heading: 'Разгледай, сравни и избери с Eliq Auto!',
			searchSubmitPrefix: 'Покажи',
			searchSubmitSuffix: 'автомобила',
			slideSubtitle: 'Премиум автомобили с проверена история и ясни следващи стъпки преди оглед.',
		...
		inventory: {
			emptyBody: 'Изчисти филтрите или се свържи с Eliq Auto за автомобил по заявка.',
			emptyTitle: 'Няма автомобили, които отговарят на тези филтри',
			reset: 'Изчисти филтрите',
			vehicleCard: vehicleCardBg
		},
		detail: {
			callEliqauto: 'Обади се на Eliq Auto',
			carOverview: 'Основни данни',
			cash: 'В брой',
			chatOnViber: 'Пиши във Viber',
			compare: 'Сравни',
			consultantLabel: 'Консултант на Eliq Auto',
			description: 'Описание',
			detailDescriptionFallback:
				'е наличен в Eliq Auto с проверка на източника и оглед с предварителна уговорка.',
			directions: 'Виж упътване',
			email: 'Имейл',
			finance: 'Финансиране',
			financeIntro:
				'Ориентировъчна вноска преди окончателни данъци, регистрация и транспортни разходи.',
			financeTerms: 'Ориентировъчно за 72 месеца. Финалните условия се потвърждават от Eliq Auto.',
			formConsent:
			...
			formTermsLink: 'условия за ползване.',
...
const auxeroBgReplacements: Array<[RegExp, string]> = [
	...
	[
		/Showing (\d+)\s*[-–]\s*(\d+) of (\d+) matching(?: Eliqauto)? Listings/g,
		'Показани $1 – $2 от $3 съвпадащи обяви'
	],
	[/Showing (\d+)\s*[-–]\s*(\d+) of (\d+)(?: Eliqauto)? Listings/g, 'Показани $1 – $2 от $3 обяви'],
	[/Showing 0 of (\d+)(?: Eliqauto)? Listings/g, 'Показани 0 от $1 обяви'],
	// Inventory banner + searchbar
	[/Eliqauto current stock/gi, 'Налични автомобили в Eliq Auto'],
	[
	...
	[/Search Eliqauto inventory/g, 'Търси в Eliq Auto'],
	...
	[/Eliqauto Inventory/g, 'Инвентар'],
	[/\bFilters\b/g, 'Филтри'],
	[/\bMake\b/g, 'Марка'],
	[/\bModel\b/g, 'Модел'],
	[/\bGearbox\b/g, 'Трансмисия'],
	[/\bBody\b/g, 'Купе'],
	[/\bExtras\b/g, 'Екстри'],
	...
	[/Contact Eliqauto/g, 'Контакт с Eliq Auto'],
	[/Buying With Eliqauto/g, 'Покупка с Eliq Auto'],
	[/Inventory Map/g, 'Карта на наличните'],
	[/Import Calculator/g, 'Калкулатор за внос'],
	[/Eliqauto Online/g, 'Eliq Auto онлайн'],
	...
	[/Eliqauto Notes/g, 'Съвети от Eliq Auto'],
	[
	...
	[
		/Estimated over 72 months\. Final terms confirmed by Eliqauto\./g,
		'Прогноза за 72 месеца. Крайните условия се потвърждават от Eliq Auto.'
	],
	[
	...
	[/Import history review/g, 'Проверка при внос'],
	...
	[
		/Inventory refreshed from Eliqauto source data/g,
		'Наличността е обновена от данните на Eliq Auto'
	],
	...
	[/Eliqauto Consultants/g, 'Консултанти на Eliq Auto'],
	[/Eliqauto Consultant/g, 'Консултант на Eliq Auto'],
	[/Call Eliqauto/g, 'Обади се на Eliq Auto'],
	...
	[/Eliqauto Support/g, 'Съдействие от Eliq Auto'],
	...
	[/Eliqauto Notes/g, 'Съвети от Eliq Auto'],
	[/Compare Eliqauto Vehicles Side-by-Side/g, 'Сравни автомобили от Eliq Auto'],
	[
