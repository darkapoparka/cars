...
<div class="eliqauto-calculator-desktop-route">
	<AuxeroPublicShell
		copy={shellCopy}
		footer={shellFooter}
		header={shellHeader}
		...
		title="Калкулатор за внос — Eliqauto"
	>
		<div data-eliqauto-calculator-page>
			<section class="pb-100">
				<div class="tf-spacing-style3"></div>
				<div class="container">
					<h1 class="h2 eliqauto-calculator-title mb-12 text-center">Калкулатор за внос</h1>
					<p class="h7 line-height-28 text-secondary mb-40 text-center">
						Изчисли ориентировъчна крайна цена за автомобил с проверена история преди точна разбивка
						от Eliqauto.
					</p>
...
<div class="eliqauto-calculator-mobile-route">
	<CalculatorMobilePage {budgetLinks} {calculator} {faqs} />
</div>

<style>
	.eliqauto-calculator-mobile-route {
		display: none;
	}

	.eliqauto-calculator-title {
	...
	@media (max-width: 767.98px) {
		...
		.eliqauto-calculator-desktop-route {
			display: none;
		}
