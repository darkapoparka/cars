...
<div class="innerpage__sidebar">
	...
	<div class="mb-32">
		<div class="listing-details--contact-dealer style-3 mb-20">
			...
			<div class="content">
				<a
					href={resolve(sidebar.consultantHref as '/agents/eliqauto-import')}
			...
			<a href={resolve(`/blog/${post.slug}`)} class="recent-post mb-16 overflow-hidden">
				...
				<div class="content">
					<div class="md-gap-6 mb-6 flex justify-start gap-12">
						<span class="text-xs">от Eliqauto</span><span class="text-xs">{post.date}</span>
					</div>
	...
	<form action="#" class="widget-search eliqauto-newsletter-form mb-34 w-full" novalidate>
		<input
			class="input-normal"
			type="email"
			name="email"
