...
<AuxeroPublicShell
	...
	title={`${post.title} — Eliqauto`}
>
	<div data-eliqauto-blog-detail-page>
			...
			<div class="content">
				<div class="container">
					...
					<ul class="flex flex-wrap items-center gap-20">
						<li><a class="text-white" href={resolve('/agents')}>от Eliqauto</a></li>
...
<style>
	@media (max-width: 767.98px) {
		...
		:global([data-eliqauto-blog-detail-page] .blog-details-banner .breadcrumb li:last-child),
		:global(
			[data-eliqauto-blog-detail-page] .blog-details-banner .breadcrumb li:nth-last-child(2)
		) {
			display: none;
		}

		/* Tame the desktop-sized hero title (40px) to the mobile display scale. */
		:global([data-eliqauto-blog-detail-page] .blog-details-banner .content h1) {
			font-size: 30px;
			line-height: 38px;
		}
		...
		:global([data-eliqauto-blog-detail-page] .blog-details-banner::after) {
			content: '';
			position: absolute;
			inset: 0;
			z-index: 2;
		...
		:global([data-eliqauto-blog-detail-page] .blog-details-banner .content h1),
		:global([data-eliqauto-blog-detail-page] .blog-details-banner .content ul) {
