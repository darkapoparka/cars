	...
	<div class="xl-grid-cols-2 sm-grid-cols-1 mb-30 grid grid-cols-4 gap-30">
		{#each dashboard.stats as stat (stat.id)}
			<a
				...
				data-eliqauto-dashboard-stat={stat.id}
				data-eliqauto-stat-value={stat.value}
			>
				<div>
...
<style>
	...
	:global(body.dashboard .eliqauto-dashboard-context-heading) {
		display: none;
	}

	:global(body.dashboard .eliqauto-dashboard-context-links .menu-item-main > a),
	:global(body.dashboard .eliqauto-dashboard-context-links .current-menu-item > a) {
