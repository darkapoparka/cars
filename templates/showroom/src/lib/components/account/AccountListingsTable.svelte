...
<section class="dash-card" data-eliqauto-account-listings>
		...
		<table class="dash-table">
			...
			<tbody>
				{#each listings.rows as row (row.id)}
					<tr
						data-eliqauto-slug={row.kind === 'inventory' ? row.id : undefined}
						data-eliqauto-submission-id={row.kind === 'submission' ? row.id : undefined}
					>
						<td>
