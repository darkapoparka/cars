<script lang="ts">
	...
	const serviceTabs = [
		...
		{ href: '/import', label: 'Внос и лизинг' }
	] as const;
</script>
...
{#if hero}
	<section class="home2-hero" aria-labelledby="home2-title">
		<img
			...
			src="/assets/eliqauto/hero/home-hero-available-inventory-two-car-v13.webp"
			alt=""
			loading="eager"
			aria-hidden="true"
		/>

		<h1 id="home2-title">Сменяш автомобила? Eliqauto помага</h1>
