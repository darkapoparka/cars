...
<AuxeroHead assets={pageDocument.headAssets} title="Eliqauto Marketplace | Home2" />
...
<svelte:head>
	<meta
		name="description"
		content="Купи, продай или внеси автомобил с Eliqauto през Carwow-вдъхновена marketplace начална страница."
	/>
</svelte:head>

<div id="wrapper" class="eliqauto-home-two-shell">
...
<style>
	:global(body:has(.eliqauto-home-two-shell)) {
		background: #f3f4f6;
		color: #121214;
	}

	.eliqauto-home-two-shell {
		background: #f3f4f6;
		color: #121214;
		font-family:
			Inter,
	...
	.eliqauto-home-two-shell :global(a) {
		color: inherit;
		text-decoration: none;
	}

	.eliqauto-home-two-shell :global(button),
	.eliqauto-home-two-shell :global(input) {
		font: inherit;
		letter-spacing: 0;
	}

	.eliqauto-home-two-shell :global(img) {
		display: block;
		max-width: 100%;
	}
