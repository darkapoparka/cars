...
<section class="home2-partners" aria-labelledby="home2-partners-title">
	<div class="home2-partners__inner">
		...
		<div class="home2-browse-cta-grid" aria-label="Бързи Eliqauto действия">
			<a class="home2-browse-cta home2-browse-cta--inventory" href={resolve('/inventory')}>
				<img
					src="/assets/eliqauto/home2/home2-cta-browse-generated-v1.webp"
					alt=""
					loading="lazy"
					aria-hidden="true"
				/>
			...
			<a class="home2-browse-cta home2-browse-cta--request" href={resolve('/import')}>
				<img
					...
					src="/assets/eliqauto/home2/home2-action-import.webp"
					alt=""
					loading="lazy"
					aria-hidden="true"
				/>
