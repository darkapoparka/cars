...
{#if header}
	<header class="home2-header">
		<div class="home2-header__inner">
			<a class="home2-header__logo" href={resolve('/home2')} aria-label="Eliqauto Home2">
				<img src="/assets/eliqauto/brand/eliqauto-logo-dark.svg" alt={header.logo.alt} />
			</a>
