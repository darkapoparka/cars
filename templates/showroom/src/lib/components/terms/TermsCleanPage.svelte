...
<main class="bg-bc-bg font-bc-body">
	<div class="bc-container py-10 md:py-14">
		...
		<h1 class="mt-5 text-[clamp(2.5rem,4vw,3.25rem)] leading-tight font-semibold text-bc-ink">
			{title}
		</h1>
		...
		<div class="mt-10 grid gap-10 md:mt-12 md:grid-cols-[300px_minmax(0,1fr)] md:gap-16">
			...
			<aside class="md:sticky md:top-[150px] md:self-start">
				<p class="mb-4 text-[14px] font-bold tracking-normal text-bc-muted uppercase">Съдържание</p>
				<nav class="flex flex-col" aria-label="Съдържание">
					{#each sections as section (section.id)}
						<a
							...
							class={[
								'bc-press border-l-[3px] py-2.5 pl-4 text-base leading-snug font-semibold transition-colors',
								activeId === section.id
			...
			<div class="flex flex-col gap-5">
				{#each sections as section, i (section.id)}
					...
					>
						<div class="flex items-center gap-4">
							...
							<h2 class="text-2xl leading-tight font-semibold text-bc-ink md:text-3xl">
				...
				>
					...
					<a
						...
						class="bc-calm-hover bc-press inline-flex h-12 shrink-0 items-center gap-2 rounded-bc-md bg-bc-accent px-7 font-semibold text-bc-accent-contrast hover:bg-bc-accent-hover"
					>
