<script lang="ts">
	...
	import { eliqautoAssets, isPrimaryNavActive, mainNavigation } from '$lib/data/eliqauto';
...
<header class={cn('site-header', variant === 'home' && 'site-header--home')}>
	<div class="site-header__inner">
		<a class="site-header__logo" href={resolve('/')} aria-label="Eliqauto начало">
			<img
				src={variant === 'home' ? eliqautoAssets.logoDark : eliqautoAssets.logoLight}
				alt="Eliqauto"
			/>
		</a>
