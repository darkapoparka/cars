...
<main class="bg-bc-bg font-bc-body">
	<div class="bc-container py-10 md:py-14">
		<h1 class="text-[clamp(2.5rem,4vw,3.25rem)] leading-tight font-semibold text-bc-ink">
			{reviewsPage.title}
		</h1>
		...
		<nav class="mt-9 flex items-center gap-3" aria-label="Страници с отзиви">
			...
			<a
				...
				target="_blank"
				rel="noreferrer"
				class="bc-calm-hover bc-press inline-flex h-11 items-center gap-2 rounded-bc-md border border-bc-border bg-white px-5 font-semibold text-bc-ink hover:border-bc-accent hover:text-bc-accent"
			>
