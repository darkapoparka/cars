...
<AuxeroPublicShell
	...
	title="Отзиви — Eliqauto"
>
	<section class="pb-100" data-eliqauto-reviews-page>
		<div class="container">
			<h1 class="h2">{reviewsPage.title}</h1>
			<div class="tf-spacing-style3"></div>
			<AuxeroReviewsGrid {cards} />
			<ul class="pagination eliqauto-reviews-pagination justify-center">
				<li>
...
<style>
	...
	.eliqauto-reviews-pagination .pagination__link--cta {
		width: auto;
		min-width: 40px;
		padding-right: 18px;
		padding-left: 18px;
