<script lang="ts">
	...
	import HeroFilterPopover from '../home/HeroFilterPopover.svelte';
		...
		if (mode === 'import') {
			return isEnglish
				? [
						...
						{ href: '/contact', label: 'Ask Eliqauto' },
				...
				: [
						...
						{ href: '/contact', label: 'Попитай Eliqauto' },
...
{#if hero}
	<div class="eliqauto-mobile-home" data-eliqauto-search-form={activeMobileAction?.mode ?? 'buy'}>
		...
		/>
		<section
			class={`eliqauto-mobile-hero eliqauto-mobile-hero--${mobileTabsVariant}`}
		...
		>
			<div class="container">
				...
				<div
					class={`eliqauto-mobile-hero__search-module eliqauto-mobile-hero__search-module--${mobileTabsVariant}`}
				>
					<div class="eliqauto-mobile-hero__box">
						<div
		...
		<div class="eliqauto-mobile-location-sheet">
			...
			>
				...
				<header>
					<div>
						<p>{isEnglish ? 'Eliqauto showroom' : 'Eliqauto шоурум'}</p>
				...
				<div class="eliqauto-mobile-location-map" aria-hidden="true">
					...
					<span class="eliqauto-mobile-location-map__badge">Eliqauto</span>
				</div>
...
<style>
	:global(.page-title.page-title-style-4) {
		...
		background:
			...
			linear-gradient(115deg, #121214 0%, #18181b 48%, #3a2424 100%);
	}
	...
	@media (max-width: 767.98px) {
		:global(body.auxero-template-home-05-html.auxero-template-home-05-html) {
			--eliqauto-mobile-hero-top: #a51717;
			--eliqauto-mobile-hero-bg: #a51717;
			--eliqauto-mobile-hero-bottom: #a51717;
			--eliqauto-mobile-hero-fill: #a51717;
			--eliqauto-mobile-ink: #1c1c1c;
			--eliqauto-mobile-ink-muted: rgba(28, 28, 28, 0.82);
			--eliqauto-mobile-ink-strong: #1c1c1c;
			--eliqauto-mobile-cta: rgba(251, 252, 247, 0.32);
			--eliqauto-mobile-cta-ink: #2a0c0c;
			--eliqauto-mobile-action: #2a0c0c;
			--eliqauto-mobile-action-focus: var(--bc-accent-hover);
			--eliqauto-mobile-surface: var(--bc-surface-soft);
		...
		.eliqauto-mobile-hero--underline .eliqauto-mobile-hero__search-module {
			margin-top: 6px;
		}
		...
		.eliqauto-mobile-hero__box {
			display: contents;
		}

		.eliqauto-mobile-hero__search-module--boxed .eliqauto-mobile-hero__box {
			display: grid;
			gap: 9px;
			border-radius: 16px;
		...
		.eliqauto-mobile-hero__search-module--boxed .eliqauto-mobile-hero__tabs {
			background: var(--bc-surface-soft);
			padding: 3px;
		}

		.eliqauto-mobile-hero__search-module--boxed .eliqauto-mobile-hero__tab {
			color: rgba(20, 33, 15, 0.62);
		}

		.eliqauto-mobile-hero__search-module--boxed .eliqauto-mobile-hero__tab.active {
			background: #2a0c0c;
			box-shadow: none;
			color: #ffffff;
		}
		...
		.eliqauto-mobile-hero__search-module--boxed .eliqauto-mobile-hero__search {
			height: 52px;
		...
		/* Underline tabs (underline-tab style): full-width, each label takes an equal share
		...
		.eliqauto-mobile-hero__search-module--underline .eliqauto-mobile-hero__tabs {
			position: relative;
			display: flex;
			align-items: stretch;
			gap: 0;
		...
		.eliqauto-mobile-hero__search-module--underline .eliqauto-mobile-hero__tabs::after {
			content: '';
			position: absolute;
			right: 0;
			bottom: 0;
		...
		.eliqauto-mobile-hero__search-module--underline .eliqauto-mobile-hero__tabs button {
			position: relative;
			flex: 1 1 0;
			width: auto;
			min-height: 42px;
		...
		.eliqauto-mobile-hero__search-module--underline .eliqauto-mobile-hero__tab.active {
			background: transparent;
			box-shadow: none;
			color: #ffffff;
			font-weight: 800;
		...
		.eliqauto-mobile-hero__search-module--underline .eliqauto-mobile-hero__tab.active::after {
			content: '';
			position: absolute;
			right: 4px;
			bottom: -1px;
		...
		.eliqauto-mobile-location-map {
			...
			border-radius: 12px;
			background:
				linear-gradient(135deg, rgba(165, 23, 23, 0.12), rgba(165, 23, 23, 0.18)), #fff8f8;
		}
		...
		:global(body.auxero-template-home-05-html .header-wrapper-style-4 .header.header-style-4) {
			border-bottom: 0;
			background: var(--eliqauto-mobile-hero-top, #7a1212);
			box-shadow: none;
			height: 56px;
			min-height: 56px;
		}
