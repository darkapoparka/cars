import { eliqautoVehicles } from './eliqauto';
...
const imageForVehicle = (vehicle: { id: string; image: string }) => vehicle.image;
...
export const vehicles: Vehicle[] = eliqautoVehicles.map((vehicle, index) => ({
	slug: vehicle.id,
	title: vehicle.model,
	brand: vehicle.make,
	...
	images: vehicle.images.length ? vehicle.images : [imageForVehicle(vehicle)],
	gallery: vehicle.images.length ? vehicle.images : [imageForVehicle(vehicle)],
