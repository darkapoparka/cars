...
<svelte:head>
	<title>Общи условия — Eliqauto</title>
	<meta
		name="description"
		content="Условия за използване на Eliqauto — информация за автомобилите, процес на внос, разходи и калкулатор, огледи, клиентски автомобили и контакт."
	/>
