...
<svelte:head>
	<title>Eliqauto Admin - Agents</title>
</svelte:head>
...
<AdminShell title="Agents" activePath="/admin/agents">
	...
	<section
		...
		data-eliqauto-agent-management="true"
	>
		{#each data.cms.agents as agent (agent.slug)}
			<Card.Root data-eliqauto-agent-card={agent.slug} data-eliqauto-agent-status={agent.status}>
