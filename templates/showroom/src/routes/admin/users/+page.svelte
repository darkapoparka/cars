...
<svelte:head>
	<title>Eliqauto Admin - Users</title>
</svelte:head>
...
<AdminShell title="Users" activePath="/admin/users">
	...
	<section class="px-4 lg:px-6" data-eliqauto-users-table>
		<Card.Root class="overflow-hidden">
			<Card.Header class="border-b">
				<div>
					<Card.Title>Accounts and leads</Card.Title>
					<Card.Description
						>Admin, agent, customer, and lead records visible to Eliqauto.</Card.Description
					>
				</div>
			</Card.Header>
					...
					<Table.Root class="min-w-[64rem]">
						...
						<Table.Body>
							{#each data.users as user (user.id)}
								<Table.Row data-eliqauto-user-id={user.id} data-eliqauto-user-role={user.role}>
									<Table.Cell>
										<div class="min-w-64">
