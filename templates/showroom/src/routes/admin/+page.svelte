<script lang="ts">
	...
	const dashboardVehicleFallbackImage =
		'/assets/eliqauto/hero/home-hero-available-inventory-two-car-v3.webp';
...
<svelte:head>
	<title>Eliqauto Admin - Dashboard</title>
</svelte:head>
...
>
				...
				<Card.Content class="grid gap-2 p-3 sm:grid-cols-2">
					{#each quickActions as action (action.href)}
						...
						<Button
							...
							data-eliqauto-dashboard-action={action.dashboardAction}
						>
	...
	<section class="grid grid-cols-1 gap-4 px-4 lg:px-6 @6xl/main:grid-cols-[minmax(0,1fr)_25rem]">
		...
		<div class="grid content-start gap-4">
			<Card.Root class="overflow-hidden" data-eliqauto-dashboard-recent>
				<Card.Header class="border-b">
					<div>
