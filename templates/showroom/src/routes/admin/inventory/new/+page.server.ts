...
export const load: PageServerLoad = ({ request, url }) => {
	const session = requireEliqautoPageSession(request, 'admin/inventory/new', url.searchParams);
...
export const actions: Actions = {
	default: async ({ request, url }) => {
		requireEliqautoPageSession(request, 'admin/inventory/new', url.searchParams);
