...
const inventoryScopeBodyClass = 'eliqauto-inventory-template';
...
export const load: PageServerLoad = ({ request, url }) => {
	...
	const seoTitle = locale === 'bg' ? 'Автомобили — Eliqauto' : 'Cars — Eliqauto';
	...
	pageDocument.headAssets = ensureDescriptionMeta(
		...
		locale === 'bg'
			? 'Разгледай наличните автомобили на Eliqauto — филтрирай по марка, тип, цена и пробег. Внос и лизинг и съдействие при регистрация.'
			: 'Browse Eliqauto inventory — filter by brand, type, price and mileage. Import & leasing and registration support.'
	);
