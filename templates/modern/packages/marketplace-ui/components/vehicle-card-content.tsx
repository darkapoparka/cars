...
const MobileDealerVehicleCardContent = ({
  ...
  <Link
    className="flex min-w-0 flex-1 flex-col justify-center gap-2 px-2.5 py-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset lg:hidden"
    href={listingHref}
  >
