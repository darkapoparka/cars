...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? `${leadSite.name} в Dubai — автомобили в наличност, внос по заявка и собствен лизинг.`
      : `${leadSite.name} in Dubai — vehicles in stock, import on request, and in-house leasing.`,
    locale,
    path: "/contact",
