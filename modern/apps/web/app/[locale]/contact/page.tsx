...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? `${leadSite.name} в Пазарджик — автомобили в наличност, внос по заявка и собствен лизинг.`
      : `${leadSite.name} in Пазарджик — vehicles in stock, import on request, and in-house leasing.`,
    locale,
    path: "/contact",
        ...
        <section className="relative isolate hidden overflow-hidden border-white/10 border-b lg:block">
          <div className="absolute inset-0 -z-20 bg-[#08090a]">
            <Image
              ...
              priority
              sizes="100vw"
              src="/variant-2/day-night-contact-hero-v1.png"
            />
          </div>
          <div
            aria-hidden="true"
