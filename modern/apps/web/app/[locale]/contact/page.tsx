...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? `${leadSite.name} в Пловдив — автомобили в наличност, внос по заявка и собствен лизинг.`
      : `${leadSite.name} in Пловдив — vehicles in stock, import on request, and in-house leasing.`,
    locale,
    path: "/contact",
