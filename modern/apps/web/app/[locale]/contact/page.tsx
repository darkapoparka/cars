...
export const generateMetadata = async ({
  ...
  return createPublicLocalizedMetadata({
    ...
    description: isBg
      ? `${leadSite.name} в Dallas — автомобили в наличност, внос по заявка и собствен лизинг.`
      : `${leadSite.name} in Dallas — vehicles in stock, import on request, and in-house leasing.`,
    locale,
    path: "/contact",
