...
async function project(slug,indexEntry={}) {
  ...
  return {slug,exists:true,variants,variantCount:variants.length,stockCount:stock,mediaCount:media,business:facts.business||null,logoPath:logo,heroPath:hero,qaComplete,qaPassed:qa.filter(Boolean).length,qaChecked:qa.length,indexSynced,runtime:runtimeRows,path:`clients/${slug}`};
}
