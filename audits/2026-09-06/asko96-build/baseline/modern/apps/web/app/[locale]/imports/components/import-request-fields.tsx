  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        ...
        <Textarea
          className="h-24 min-h-24 resize-none rounded-xl border-transparent bg-zinc-100 text-base shadow-none placeholder:text-zinc-600 focus-visible:ring-[3px] focus-visible:ring-[var(--lead-site-accent-ring)] lg:h-20 lg:min-h-20 lg:rounded-lg lg:bg-secondary"
