...
const MobileTaxonomyTrigger = ({
  ...
  <div className="grid gap-1.5">
    ...
    <button
      ...
      className="flex h-12 min-w-0 items-center justify-between gap-2 rounded-xl bg-zinc-100 px-3 text-left outline-none transition-colors focus-visible:ring-[3px] focus-visible:ring-ring/50 active:bg-control-hover disabled:cursor-not-allowed disabled:opacity-55"
      disabled={disabled}
      id={id}
      onClick={onClick}
      ref={triggerRef}
