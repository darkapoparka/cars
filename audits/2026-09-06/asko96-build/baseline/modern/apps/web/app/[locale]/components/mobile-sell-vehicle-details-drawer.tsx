...
import {
  ...
  mobileSellSelectClassName,
  mobileSellVehicleCategoryOptions,
        ...
        <div className="mt-3 grid grid-cols-2 gap-3">
          <div className="grid gap-1.5">
            <Label
              ...
              htmlFor="mobile-sell-category"
            >
              {content.category}
            </Label>
            <select
              className={mobileSellSelectClassName}
              defaultValue={draft.category ?? "car"}
              id="mobile-sell-category"
              name="category"
              required
            >
              {mobileSellVehicleCategoryOptions[locale].map((option) => (
