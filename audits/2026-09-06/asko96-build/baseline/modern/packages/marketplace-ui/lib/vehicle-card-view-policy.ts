...
export const getVehicleCardImageSizes = (
  ...
  if (isDesktopGrid) {
    return "(max-width: 1023px) 7.5rem, (max-width: 1279px) 33vw, 25vw";
  }
  if (isCompact) {
    return isGrid
      ? "(max-width: 1023px) 7.5rem, (max-width: 1280px) 28vw, 20vw"
      : "(max-width: 1023px) 7.5rem, (max-width: 1280px) 13rem, 15rem";
  }
  return isGrid
    ? "(max-width: 1023px) 7.5rem, 25vw"
    : "(max-width: 1023px) 7.5rem, 50vw";
};
