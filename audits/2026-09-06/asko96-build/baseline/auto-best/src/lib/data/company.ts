...
export const companyServices: CompanyService[] = [
  {
    ...
    description: `Уговорете посещение на ${brand.addressLine}.`,
  ...
  },
  {
    ...
    description: 'Обсъдете търсене, транспорт и подготовката за регистрация.',
  ...
  },
  {
    ...
    description: 'Попитайте за актуалните условия според избрания автомобил.',
  ...
  },
  {
    ...
    description: 'Предложете автомобил за бартер и поискайте индивидуална оценка от екипа.',
