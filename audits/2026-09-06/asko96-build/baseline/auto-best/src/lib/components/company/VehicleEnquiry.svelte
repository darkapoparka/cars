...
<div class="dn-enquiry-entry">
  {#if selling}
    ...
    <p>Данни за автомобила, снимки и преглед.</p>
  {:else}
    <label class="dn-enquiry-link-label" for="enquiry-listing-link">Имате избрана обява?</label>
    ...
    <button class="dn-enquiry-text-button" type="button" onclick={(event) => open(event, true)} aria-haspopup="dialog">Нямам обява — опиши търсенето <Icon name="arrow-right" size={17} /></button>
  {/if}
</div>
...
<style>
  ...
  @media (max-width: 991px) {
    ...
    .dn-enquiry-link-label { text-align: center; }
    .dn-enquiry-entry > .dn-enquiry-text-button { justify-content: center; }
  }
  ...
  .dn-enquiry-link-label { display: block; margin-bottom: 10px; font-size: 17px; font-weight: 600; }
