  ...
  <div class="container">
    <div class="dn-videos__panel">
      <div class="dn-videos__heading dn-home-section-heading">
        <h2 id="videos-title" class="dn-home-section-title"><span class="dn-videos__brand-mark"><SocialBrandIcon name="youtube" size={32} /></span>YouTube</h2>
      ...
      <div class="dn-videos__grid">
        ...
        <a class="dn-videos__all-card" href={brand.youtubeUrl} target="_blank" rel="noopener noreferrer">
          ...
          <span class="dn-videos__all-arrow"><Icon name="arrow-right" size={24} /></span>
...
<style>
  ...
  @media (max-width: 767px) {
    ...
    .dn-videos__heading h2 { font-size: 22px; font-weight: 700; }
    ...
    .dn-videos__all-arrow { display: grid; width: 48px; height: 48px; place-items: center; margin-top: 4px; border-radius: 50%; background: var(--dn-red); color: #fff; }
