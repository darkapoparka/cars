<script lang="ts">
	...
	const contactCards = [
		...
		},
		{
			id: 'hours',
			title: 'Работно време',
			value: 'Понеделник - Събота: 9:00 - 18:00',
			href: null,
			icon: Clock
		}
	] as const;
...
<div class="mobile-contact-app">
	<header class:mobile-contact-hero--import={isImportMode} class="mobile-contact-hero">
		<img
			...
			aria-hidden="true"
		/>
		<div class="mobile-contact-hero__bar">
	...
	<main id="main-content" tabindex="-1" class={{ 'mobile-contact-main--sheet': isImportMode }}>
			...
			>
				<div class="mobile-contact-heading">
					...
					<h2 id="mobile-contact-form-title">
						{isImportMode ? 'Уточнете търсенето' : 'Пишете ни за автомобил'}
					</h2>
				</div>
		...
		{#if isImportMode}
			<nav class="mobile-import-disclosures" aria-label="Повече за вноса">
				<button
					class="mobile-import-disclosures__card mobile-import-disclosures__card--review"
					type="button"
					onclick={() => openImportInfo('process')}
				>
					<img
						class="mobile-import-disclosures__art"
						src={resolve('/assets/images/import/import-review-red-campaign-v2.webp')}
						alt=""
						aria-hidden="true"
					/>
					<span class="mobile-import-disclosures__copy">
						<span class="mobile-import-disclosures__heading">
							<img
								class="mobile-import-disclosures__brand"
								src={resolve('/brand/daynight-logo-generated.png')}
								alt=""
								aria-hidden="true"
							/>
							<strong>Как работи вносът</strong>
						</span>
						<small>От обявата до конкретна оферта и срок.</small>
						<span class="mobile-import-disclosures__cta">
				...
				<button
					class="mobile-import-disclosures__card mobile-import-disclosures__card--handoff"
					type="button"
					onclick={() => openImportInfo('coverage')}
				>
					<img
						class="mobile-import-disclosures__art"
						src={resolve('/assets/images/import/import-handoff-graphite-campaign-v2.webp')}
						alt=""
						aria-hidden="true"
					/>
					<span class="mobile-import-disclosures__copy">
						<span class="mobile-import-disclosures__heading">
							<img
								...
								aria-hidden="true"
							/>
							<strong>Какво поемаме ние</strong>
						</span>
						<small>Проверка, транспорт, документи и предаване.</small>
						<span class="mobile-import-disclosures__cta">
...
<style>
	...
	.mobile-import-disclosures > button {
		position: relative;
		display: flex;
		width: 100%;
		min-height: 176px;
	...
	.mobile-import-disclosures > button::after {
		position: absolute;
		inset: 0;
		z-index: -1;
		content: '';
	...
	.mobile-import-disclosures__card--review {
		background: #c9002b !important;
	}

	.mobile-import-disclosures__card--review::after {
		background:
			linear-gradient(
				90deg,
				rgba(112, 0, 22, 0.94) 0%,
				rgba(112, 0, 22, 0.74) 52%,
				rgba(112, 0, 22, 0.12) 82%
			),
			linear-gradient(180deg, rgba(112, 0, 22, 0.02) 34%, rgba(65, 0, 14, 0.28) 100%);
	}

	.mobile-import-disclosures__card--handoff::after {
		background:
			linear-gradient(
				90deg,
				rgba(3, 5, 8, 0.98) 0%,
			...
			linear-gradient(180deg, rgba(3, 5, 8, 0.02) 30%, rgba(3, 5, 8, 0.58) 100%);
	}

	.mobile-import-disclosures__art {
		position: absolute;
		inset: 0;
		z-index: -2;
		width: 100%;
	...
	.mobile-import-disclosures > button:active > .mobile-import-disclosures__art {
		transform: scale(1.025);
	}

	.mobile-import-disclosures__brand {
		display: block;
		width: 80px;
		height: auto;
	...
	.mobile-import-disclosures > button:focus-visible {
		outline: 2px solid var(--sa-red);
		outline-offset: 2px;
	}

	.mobile-import-disclosures__copy {
		display: grid;
		gap: 4px;
		width: 100%;
		min-width: 0;
	...
	.mobile-import-disclosures__heading {
		display: grid;
	...
	.mobile-import-disclosures__copy strong {
		color: #fff;
		font-size: 20px;
		font-weight: 850;
		line-height: 1.08;
	...
	.mobile-import-disclosures__copy small {
		max-width: 246px;
	...
	.mobile-import-disclosures__cta {
		display: inline-flex;
		width: max-content;
		min-height: 36px;
		align-items: center;
	...
	.mobile-import-disclosures__cta :global(svg),
	.mobile-import-disclosures__cta :global(svg *) {
		color: #090b0e !important;
		stroke: #090b0e !important;
	}

	.mobile-import-disclosures__card--review .mobile-import-disclosures__cta {
		background: #090b0e;
		color: #fff !important;
	}

	.mobile-import-disclosures__card--review .mobile-import-disclosures__cta > span {
		color: #fff !important;
	}

	.mobile-import-disclosures__card--review .mobile-import-disclosures__cta :global(svg),
	.mobile-import-disclosures__card--review .mobile-import-disclosures__cta :global(svg *) {
		color: #fff !important;
		stroke: #fff !important;
	}

	.mobile-import-disclosures__card--handoff .mobile-import-disclosures__cta,
	.mobile-import-disclosures__card--handoff .mobile-import-disclosures__cta > span {
		color: #090b0e !important;
	}
