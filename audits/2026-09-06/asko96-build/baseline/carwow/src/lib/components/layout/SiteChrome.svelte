...
<style>
	@media (min-width: 992px) {
		...
		.site-chrome :global([data-daynight-header-tool]:not([data-daynight-header-tool='sell'])) {
	...
	@media (min-width: 1200px) {
		...
		.site-chrome
			:global(
				.header-style-2-main [data-daynight-header-tool]:not([data-daynight-header-tool='sell'])
			) {
			background: transparent !important;
		...
		.site-chrome
			:global(
				.header-style-2-main
					[data-daynight-header-tool]:not([data-daynight-header-tool='sell']):is(
						:hover,
						:focus-visible
					)
			) {
		...
		.site-chrome :global(.header-style-2-main [data-daynight-header-tool='sell']) {
			background: transparent !important;
			border-color: transparent !important;
			color: var(--sa-header-ink) !important;
		...
		.site-chrome
			:global(.header-style-2-main [data-daynight-header-tool='sell']:is(:hover, :focus-visible)) {
			background: rgba(15, 20, 23, 0.08) !important;
			border-color: transparent !important;
			color: var(--sa-header-ink) !important;
		}
		...
		.site-chrome
			:global(
				.header-style-2-main [data-daynight-header-tool]:not([data-daynight-header-tool='sell']) svg
			) {
			color: var(--sa-header-ink) !important;
			fill: none !important;
			height: 24px !important;
		...
		.site-chrome
			:global(
				.header-style-2-main
					[data-daynight-header-tool]:not([data-daynight-header-tool='sell'])
					svg
					path
			) {
			color: var(--sa-header-ink) !important;
