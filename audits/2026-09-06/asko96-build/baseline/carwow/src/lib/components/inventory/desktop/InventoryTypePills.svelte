...
<div class="daynight-inventory-type-pills" data-daynight-shortcut-pills aria-label="Бърз избор">
	{#each inventoryShortcuts as pill (pill.label)}
		...
		<a
			class={['daynight-inventory-type-pill', active && 'is-active', active && 'is-selected']}
			href={pillHref(pill)}
...
<style>
	...
	:global(
		.inventory-template-shell .daynight-inventory-quick-form .daynight-inventory-type-pill.is-selected
	) {
		background: #B00000;
		border-color: #B00000;
		color: #fff;
