<script lang="ts">
	...
	const shareUrl = $derived(`https://daynight.mobile.bg/blog/${article.slug}`);
		...
		<div class="bloc-details-container">
			...
			<div class="mb-40">
				...
				<p class="h7 line-height-28">
					Day Night Auto публикува практични съвети и новини за наличност, покупка, оглед, документи,
