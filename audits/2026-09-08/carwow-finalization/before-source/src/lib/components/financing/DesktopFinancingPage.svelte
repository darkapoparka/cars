					...
					<div>
						...
						<div class="hero-actions">
							...
							<p class="hero-actions__call">
								...
								<a class="text-underline" href="tel:+359888626117">Обадете се</a>
							</p>
						</div>
					</div>
				</div>
		...
		<section class="bg-white py-100">
			<div class="container">
				<div class="mb-40">
					...
					<p class="text-secondary h7 line-height-28">
						Съвети и насоки преди покупка — подбрани от екипа на Day Night Auto.
					</p>
				</div>
						...
						<a href={resolve('/blog/kak-da-kupim-upotrebyavan-avtomobil')} class="post-card">
							...
							<div class="post-card__content">
								<div class="post-card__meta">
									<span class="text-sm">Day Night Auto</span>
