...
export const daynightArticles: DayNightArticle[] = [
	article({
		...
		title: 'Дневни новини от Day Night Auto',
		description:
			'Кратък дневен преглед на наличността, търсените марки и практичните стъпки за оглед в Day Night Auto.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-28',
	...
	article({
		...
		description:
			'Обновления за интересни автомобили, които пристигат в наличността на Day Night Auto София.',
		category: 'Новини',
		kind: 'news',
		date: '2026-05-27',
		author: 'Day Night Auto',
