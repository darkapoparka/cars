...
export const contactTopics: ContactTopic[] = [
  {
    ...
    "description": "Свържете се с Аутолайф, за да потвърдите наличност, данни и следваща стъпка."
  },
  {
    "id": "inspection",
    "label": "Оглед",
...
export const showroomCoordinates = {"latitude":43.22861,"longitude":27.8253778} as const;
