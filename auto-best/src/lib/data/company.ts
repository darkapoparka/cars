...
export const companyServices: CompanyService[] = [
  {
    "index": "01",
    "icon": "inspection",
    "title": "Viewing in Dallas",
    "description": "Monday–Saturday 10 AM–6 PM; Sunday closed",
...
export const contactTopics: ContactTopic[] = [
  {
    ...
    "description": "Contact Texas Drive Auto to confirm availability, details, and the next step."
  },
  {
    "id": "inspection",
    "label": "Viewing",
