...
(() => {
  ...
  const config = {"language":"bg","labels":{"design":"Дизайн","choose":"Избор на дизайн","title":"Изберете визия за сайта"},"accent":"#c58a1f","variants":[{"key":"auto-best","base":"","entry":"/"},{"key":"modern","base":"/variant-2","entry":"/variant-2/cars"},{"key":"carwow","base":"/variant-3","entry":"/variant-3/"}]};
